...
echo [GDB] Hit JIT registration (helpers). Finishing...\n
finish

# Continue to inner_jit compilation
continue

# 2. inner_jit registration
echo [GDB] Hit JIT registration (inner_jit). Finishing...\n
finish
break inner_jit

# Continue to outer_jit compilation
continue

# 3. outer_jit registration
echo [GDB] Hit JIT registration (outer_jit). Finishing...\n
finish
break outer_jit
