...
public record ReflectiveWrite(Expression promise, NamedVariable variable, Expression value)
    implements Expression {
  @Override
  public @NotNull String toString() {
    return promise + "$" + variable + " = " + value;
  }

  @Override
  public @UnmodifiableView Collection<Expression> immediateChildren() {
    return List.of(promise, variable, value);
  }
}
