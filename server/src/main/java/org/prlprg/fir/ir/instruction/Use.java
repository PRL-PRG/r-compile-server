...
/// A single occurrence where a [org.prlprg.fir.ir.variable.Register]'s value is used: the [#index]-th argument slot of
/// [#instruction].
///
/// A Register tracks the set of its [Use]s, so replacing every use of a register
/// ([org.prlprg.fir.ir.variable.Register#substUsesWith]) is a local operation, and def-use information stays accurate as the
