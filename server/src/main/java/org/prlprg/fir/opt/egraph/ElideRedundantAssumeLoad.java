...
/// Rewrite that removes [AssumeLoadFun]/[AssumeLoadVar] instructions that are dominated by an
...
///
/// e-graph equivalent of [org.prlprg.fir.opt.specialize.ElideRedundantAssumeLoad].
public record ElideRedundantAssumeLoad() implements RewriteOptimization {
  @Override
