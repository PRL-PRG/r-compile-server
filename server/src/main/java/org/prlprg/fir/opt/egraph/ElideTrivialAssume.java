...
/// Rewrite that removes [Assume](org.prlprg.fir.ir.expression.Assume)s that statically succeed.
///
/// e-graph equivalent of [org.prlprg.fir.opt.specialize.ElideTrivialAssume].
public record ElideTrivialAssume() implements RewriteOptimization {
  @Override
