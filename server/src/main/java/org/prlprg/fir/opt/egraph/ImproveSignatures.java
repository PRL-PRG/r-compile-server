...
/// Rewrite that infers and improves the explicit return type and effects of [Promise]s, then
/// improves the explicit return type, effects, and strictness of the target [Abstraction].
///
/// e-graph equivalent of [org.prlprg.fir.opt.specialize.ImproveSignatures].
public record ImproveSignatures() implements RewriteOptimization {
  @Override
