...
/// Rewrite that converts non-static closures to static closures when the closure cannot observe or
/// mutate its captured local environment hierarchy.
///
/// e-graph equivalent of [org.prlprg.fir.opt.specialize.StaticClosure].
public record StaticClosure() implements RewriteOptimization {
  @Override
