 ...
 */
public interface BCCompilation extends GNURBasedTests {
     ...
     * be an AST.
     */
    default SEXP compileBody(String fun, int optimizationLevel) {
        var code = "eval(parse(text = '" + fun + "'))";
        return compileBody((CloSXP) R.eval(code), optimizationLevel);
    }

    default SEXP compileBody(CloSXP fun, int optimizationLevel) {
