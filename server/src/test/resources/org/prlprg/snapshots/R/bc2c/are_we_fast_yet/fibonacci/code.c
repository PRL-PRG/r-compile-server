#include <runtime.h>
SEXP f_n1401663904_0(SEXP RHO, SEXP CCP);
SEXP f_n1401663904_0_1(SEXP RHO, SEXP CCP);
SEXP f_n1401663904_0(SEXP RHO, SEXP CCP) {
  int STACK_SAVE = 3;
  CHECK_OVERFLOW(3);
  // CELLS
  DEFINE_BCELL2(C3); // symbol: 'fibonacci' (used: 1)
  // REGISTERS
  DEFINE_VAL(R1);
  DEFINE_VAL(R2);
  DEFINE_VAL(R3);

  Rsh_MakeClosure(R1, Rsh_const(CCP, 0), &f_n1401663904_0_1, Rsh_const(CCP, 1), RHO) /* stack: 1 */;
  Rsh_SetVar(R1, Rsh_const(CCP, 2), &C3, RHO) /* symbol: 'fibonacci', stack: 1 */;
  Rsh_Pop(*R1) /* stack: 0 */;
...
SEXP f_n1401663904_0_1(SEXP RHO, SEXP CCP) {
  ...
  CHECK_OVERFLOW(4);
  // CELLS
  DEFINE_BCELL2(C1); // symbol: 'n' (used: 2)
  // REGISTERS
  DEFINE_VAL(R1);
  DEFINE_VAL(R2);
  DEFINE_VAL(R3);
  ...
  Rsh_Le(R1, *R2, Rsh_const(CCP, 2), RHO) /* stack: 1 */;
...
L8: /* stack: 1 */
  ...
  Rsh_MakeProm(R2, R3, R4, Rsh_const(CCP, 7), RHO) /* stack: 4 */;
  Rsh_Call(R2, *R3, *R4, Rsh_const(CCP, 8), RHO) /* stack: 2 */;
  Rsh_Add(R1, *R2, Rsh_const(CCP, 9), RHO) /* stack: 1 */;
  Rsh_Return(R1, STACK_SAVE) /* stack: 1 */;
}
