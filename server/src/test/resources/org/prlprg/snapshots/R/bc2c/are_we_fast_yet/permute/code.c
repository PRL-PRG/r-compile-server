#include <runtime.h>
SEXP f_2133058816_0(SEXP RHO, SEXP CCP);
SEXP f_2133058816_0_1(SEXP RHO, SEXP CCP);
SEXP f_2133058816_0_2(SEXP RHO, SEXP CCP);
SEXP f_2133058816_0(SEXP RHO, SEXP CCP) {
  int STACK_SAVE = 3;
  CHECK_OVERFLOW(3);
  // CELLS
  ...
  Rsh_MakeClosure(R1, Rsh_const(CCP, 0), &f_2133058816_0_1, Rsh_const(CCP, 1), RHO) /* stack: 1 */;
  Rsh_SetVar(R1, Rsh_const(CCP, 2), &C3, RHO) /* symbol: 'permute', stack: 1 */;
  Rsh_Pop(*R1) /* stack: 0 */;
  Rsh_MakeClosure(R1, Rsh_const(CCP, 3), &f_2133058816_0_2, Rsh_const(CCP, 4), RHO) /* stack: 1 */;
