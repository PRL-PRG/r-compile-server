#include <runtime.h>
SEXP f_n432073536_0(SEXP RHO, SEXP CCP);
SEXP f_n432073536_0_1(SEXP RHO, SEXP CCP);
SEXP f_n432073536_0(SEXP RHO, SEXP CCP) {
  int STACK_SAVE = 3;
  CHECK_OVERFLOW(3);
  // CELLS
  ...
  Rsh_MakeClosure(R1, Rsh_const(CCP, 0), &f_n432073536_0_1, Rsh_const(CCP, 1), RHO) /* stack: 1 */;
...
SEXP f_n432073536_0_1(SEXP RHO, SEXP CCP) {
  ...
  CHECK_OVERFLOW(1);
  // CELLS
  DEFINE_BCELL2(C1); // symbol: '..1' (used: 1)
  DEFINE_BCELL2(C2); // symbol: 'x' (used: 1)
  // REGISTERS
  DEFINE_VAL(R1);

  Rsh_DdVal(R1, Rsh_const(CCP, 0), &C1, RHO) /* symbol: '..1', stack: 1 */;
