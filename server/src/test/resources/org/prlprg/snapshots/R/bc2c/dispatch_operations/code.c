#include <runtime.h>
SEXP f_n2019673472_0(SEXP RHO, SEXP CCP);
SEXP f_n2019673472_0_1(SEXP RHO, SEXP CCP);
SEXP f_n2019673472_0(SEXP RHO, SEXP CCP) {
  int STACK_SAVE = 3;
  CHECK_OVERFLOW(3);
  // CELLS
  ...
  Rsh_Pop(*R1) /* stack: 0 */;
  Rsh_MakeClosure(R1, Rsh_const(CCP, 10), &f_n2019673472_0_1, Rsh_const(CCP, 11), RHO) /* stack: 1 */;
