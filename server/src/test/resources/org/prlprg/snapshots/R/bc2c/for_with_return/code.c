#include <runtime.h>
SEXP f_n1172671200_0(SEXP RHO, SEXP CCP);
SEXP f_n1172671200_0_1(SEXP RHO, SEXP CCP);
SEXP f_n1172671200_0(SEXP RHO, SEXP CCP) {
  int STACK_SAVE = 3;
  CHECK_OVERFLOW(3);
  // CELLS
  ...
  Rsh_MakeClosure(R1, Rsh_const(CCP, 0), &f_n1172671200_0_1, Rsh_const(CCP, 1), RHO) /* stack: 1 */;
