#include <runtime.h>
SEXP f_n1591450784_0(SEXP RHO, SEXP CCP);
SEXP f_n1591450784_0_1(SEXP RHO, SEXP CCP);
SEXP f_n1591450784_0(SEXP RHO, SEXP CCP) {
  int STACK_SAVE = 3;
  CHECK_OVERFLOW(3);
  // CELLS
  ...
  Rsh_MakeClosure(R1, Rsh_const(CCP, 0), &f_n1591450784_0_1, Rsh_const(CCP, 1), RHO) /* stack: 1 */;
...
SEXP f_n1591450784_0_1(SEXP RHO, SEXP CCP) {
  ...
  Rsh_DoDots(R1, R2, R3, RHO) /* stack: 3 */;
  Rsh_Call(R1, *R2, *R3, Rsh_const(CCP, 1), RHO) /* stack: 1 */;
  Rsh_Return(R1, STACK_SAVE) /* stack: 1 */;
}
