#include <runtime.h>
SEXP f_n725609664_0(SEXP RHO, SEXP CCP);
SEXP f_n725609664_0_1(SEXP RHO, SEXP CCP);
SEXP f_n725609664_0(SEXP RHO, SEXP CCP) {
  int STACK_SAVE = 3;
  CHECK_OVERFLOW(3);
  // CELLS
  ...
  Rsh_MakeClosure(R1, Rsh_const(CCP, 0), &f_n725609664_0_1, Rsh_const(CCP, 1), RHO) /* stack: 1 */;
...
SEXP f_n725609664_0_1(SEXP RHO, SEXP CCP) {
  ...
  Rsh_Gt(R1, *R2, Rsh_const(CCP, 2), RHO) /* stack: 1 */;
