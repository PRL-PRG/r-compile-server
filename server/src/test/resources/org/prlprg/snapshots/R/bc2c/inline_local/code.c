#include <runtime.h>
SEXP f_1996554240_0(SEXP RHO, SEXP CCP);
SEXP f_1996554240_0_1(SEXP RHO, SEXP CCP);
SEXP f_1996554240_0(SEXP RHO, SEXP CCP) {
  int STACK_SAVE = 3;
  CHECK_OVERFLOW(3);
  // CELLS
  ...
  Rsh_Pop(*R1) /* stack: 0 */;
  Rsh_MakeClosure(R1, Rsh_const(CCP, 1), &f_1996554240_0_1, Rsh_const(CCP, 2), RHO) /* stack: 1 */;
