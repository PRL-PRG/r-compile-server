#include <runtime.h>
SEXP f_1984172384_0(SEXP RHO, SEXP CCP);
SEXP f_1984172384_0(SEXP RHO, SEXP CCP) {
  int STACK_SAVE = 3;
  CHECK_OVERFLOW(3);
  // CELLS
  ...
  if (Rsh_Or1st(R1, Rsh_const(CCP, 2)) /* stack: 1 */) {
	goto L10;
}
  Rsh_GetVar(R2, Rsh_const(CCP, 1), &C5, RHO) /* symbol: 'y', stack: 2 */;
  Rsh_Or2nd(R1, *R2, Rsh_const(CCP, 2)) /* stack: 1 */;
L10: /* stack: 1 */
  if (Rsh_Or1st(R1, Rsh_const(CCP, 3)) /* stack: 1 */) {
	goto L16;
}
  Rsh_GetVar(R2, Rsh_const(CCP, 0), &C2, RHO) /* symbol: 'x', stack: 2 */;
  if (Rsh_Or1st(R2, Rsh_const(CCP, 2)) /* stack: 2 */) {
	goto L15;
}
  Rsh_GetVar(R3, Rsh_const(CCP, 1), &C5, RHO) /* symbol: 'y', stack: 3 */;
  Rsh_Or2nd(R2, *R3, Rsh_const(CCP, 2)) /* stack: 2 */;
L15: /* stack: 2 */
  Rsh_Or2nd(R1, *R2, Rsh_const(CCP, 3)) /* stack: 1 */;
L16: /* stack: 1 */
