#include <runtime.h>
SEXP f_n1111235520_0(SEXP RHO, SEXP CCP);
SEXP f_n1111235520_0(SEXP RHO, SEXP CCP) {
  int STACK_SAVE = 3;
  CHECK_OVERFLOW(3);
  // REGISTERS
  ...
  Rsh_MakeProm(R1, R2, R3, Rsh_const(CCP, 9), RHO) /* stack: 3 */;
  Rsh_Call(R1, *R2, *R3, Rsh_const(CCP, 10), RHO) /* stack: 1 */;
  Rsh_Pop(*R1) /* stack: 0 */;
  Rsh_GetFun(R1, R2, R3, Rsh_const(CCP, 0), RHO) /* stack: 3 */;
  Rsh_MakeProm(R1, R2, R3, Rsh_const(CCP, 11), RHO) /* stack: 3 */;
  Rsh_MakeProm(R1, R2, R3, Rsh_const(CCP, 12), RHO) /* stack: 3 */;
