...
SEXP Rsh_Fir_user_function_inner922305347_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner922305347_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_promise_inner922305347_(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner922305347_1(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner922305347_2(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner922305347_3(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner922305347_4(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner922305347_5(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner922305347_6(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner922305347_7(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner922305347_, RHO, CCP);
  // st towers = r
...
L0_:;
  ...
  SEXP Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_towers, 4, Rsh_Fir_array_args, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
SEXP Rsh_Fir_user_function_inner922305347_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  ...
  return Rsh_Fir_user_version_inner922305347_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner922305347_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  // n1 = ld n
  SEXP Rsh_Fir_reg_n1_ = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // check L2() else D0()
  // L2()
  goto L2_;
...
L6_:;
  ...
  //   return r3;
  // }
  SEXP Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner922305347_, CCP, RHO);
  // p1 = prom<V +>{
  ...
  //   return from_peg2;
  // }
  SEXP Rsh_Fir_reg_p1_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner922305347_1, CCP, RHO);
  // p2 = prom<V +>{
  ...
  //   return using_peg2;
  // }
  SEXP Rsh_Fir_reg_p2_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner922305347_2, CCP, RHO);
  // p3 = prom<V +>{
  //   to_peg1 = ld to_peg;
  ...
  //   return to_peg2;
  // }
  SEXP Rsh_Fir_reg_p3_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner922305347_3, CCP, RHO);
  ...
  SEXP Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_towers1, 4, Rsh_Fir_array_args9, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L7() else D2()
  // L7()
  goto L7_;
...
L8_:;
  // moves1 = force? moves
  SEXP Rsh_Fir_reg_moves1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_moves);
  // checkMissing(moves1)
  ...
  // moves2 = ld moves
  SEXP Rsh_Fir_reg_moves2_ = Rsh_Fir_load(Rsh_const(CCP, 9), RHO);
  // check L9() else D4()
  // L9()
  goto L9_;
...
L9_:;
  // moves3 = force? moves2
  SEXP Rsh_Fir_reg_moves3_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_moves2_);
  // checkMissing(moves3)
  SEXP Rsh_Fir_array_args12[1];
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_moves3_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args12, Rsh_Fir_param_types_empty()));
  // towers1 = ldf towers
  SEXP Rsh_Fir_reg_towers1_ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 0), RHO);
  // check L10() else D5()
  // L10()
  goto L10_;
...
L10_:;
  ...
  //   return r10;
  // }
  SEXP Rsh_Fir_reg_p4_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner922305347_4, CCP, RHO);
  // p5 = prom<V +>{
  ...
  //   return using_peg4;
  // }
  SEXP Rsh_Fir_reg_p5_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner922305347_5, CCP, RHO);
  // p6 = prom<V +>{
  //   to_peg3 = ld to_peg;
  ...
  //   return to_peg4;
  // }
  SEXP Rsh_Fir_reg_p6_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner922305347_6, CCP, RHO);
  // p7 = prom<V +>{
  ...
  //   return from_peg4;
  // }
  SEXP Rsh_Fir_reg_p7_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner922305347_7, CCP, RHO);
  ...
  SEXP Rsh_Fir_reg_r15_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_towers1_, 4, Rsh_Fir_array_args18, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L11() else D6()
  // L11()
  goto L11_;
...
L11_:;
  ...
  SEXP Rsh_Fir_reg_r16_ = Rsh_Fir_call_builtin(66, CCP, RHO, 2, Rsh_Fir_array_args19, Rsh_Fir_param_types_empty());
  // st moves = r16
  Rsh_Fir_store(Rsh_const(CCP, 9), Rsh_Fir_reg_r16_, RHO);
  (void)(Rsh_Fir_reg_r16_);
  // moves4 = ld moves
  SEXP Rsh_Fir_reg_moves4_ = Rsh_Fir_load(Rsh_const(CCP, 9), RHO);
  // check L12() else D7()
  // L12()
  goto L12_;
...
L12_:;
  // moves5 = force? moves4
  SEXP Rsh_Fir_reg_moves5_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_moves4_);
  // checkMissing(moves5)
...
SEXP Rsh_Fir_user_promise_inner922305347_(SEXP CCP, SEXP RHO) {
  // n3 = ld n
  SEXP Rsh_Fir_reg_n3_ = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // n4 = force? n3
  ...
  SEXP Rsh_Fir_reg_r3_ = Rsh_Fir_call_builtin(67, CCP, RHO, 2, Rsh_Fir_array_args5, Rsh_Fir_param_types_empty());
  // return r3
  return Rsh_Fir_reg_r3_;
}
SEXP Rsh_Fir_user_promise_inner922305347_1(SEXP CCP, SEXP RHO) {
  // from_peg1 = ld from_peg
  SEXP Rsh_Fir_reg_from_peg1_ = Rsh_Fir_load(Rsh_const(CCP, 6), RHO);
  // from_peg2 = force? from_peg1
  SEXP Rsh_Fir_reg_from_peg2_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_from_peg1_);
  // checkMissing(from_peg2)
...
SEXP Rsh_Fir_user_promise_inner922305347_2(SEXP CCP, SEXP RHO) {
  // using_peg1 = ld using_peg
  SEXP Rsh_Fir_reg_using_peg1_ = Rsh_Fir_load(Rsh_const(CCP, 8), RHO);
  // using_peg2 = force? using_peg1
  SEXP Rsh_Fir_reg_using_peg2_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_using_peg1_);
  // checkMissing(using_peg2)
...
SEXP Rsh_Fir_user_promise_inner922305347_3(SEXP CCP, SEXP RHO) {
  // to_peg1 = ld to_peg
  SEXP Rsh_Fir_reg_to_peg1_ = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // to_peg2 = force? to_peg1
  SEXP Rsh_Fir_reg_to_peg2_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_to_peg1_);
  // checkMissing(to_peg2)
...
SEXP Rsh_Fir_user_promise_inner922305347_4(SEXP CCP, SEXP RHO) {
  // n5 = ld n
  SEXP Rsh_Fir_reg_n5_ = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // n6 = force? n5
  ...
  SEXP Rsh_Fir_reg_r10_ = Rsh_Fir_call_builtin(67, CCP, RHO, 2, Rsh_Fir_array_args14, Rsh_Fir_param_types_empty());
  // return r10
  return Rsh_Fir_reg_r10_;
}
SEXP Rsh_Fir_user_promise_inner922305347_5(SEXP CCP, SEXP RHO) {
  // using_peg3 = ld using_peg
  SEXP Rsh_Fir_reg_using_peg3_ = Rsh_Fir_load(Rsh_const(CCP, 8), RHO);
  // using_peg4 = force? using_peg3
  SEXP Rsh_Fir_reg_using_peg4_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_using_peg3_);
  // checkMissing(using_peg4)
...
SEXP Rsh_Fir_user_promise_inner922305347_6(SEXP CCP, SEXP RHO) {
  // to_peg3 = ld to_peg
  SEXP Rsh_Fir_reg_to_peg3_ = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // to_peg4 = force? to_peg3
  SEXP Rsh_Fir_reg_to_peg4_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_to_peg3_);
  // checkMissing(to_peg4)
...
SEXP Rsh_Fir_user_promise_inner922305347_7(SEXP CCP, SEXP RHO) {
  // from_peg3 = ld from_peg
  SEXP Rsh_Fir_reg_from_peg3_ = Rsh_Fir_load(Rsh_const(CCP, 6), RHO);
  // from_peg4 = force? from_peg3
  SEXP Rsh_Fir_reg_from_peg4_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_from_peg3_);
  // checkMissing(from_peg4)
