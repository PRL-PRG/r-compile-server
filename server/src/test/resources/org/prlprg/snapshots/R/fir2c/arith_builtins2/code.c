...
L0_:;
  ...
  // ___ = ldf `%/%` in base
  SEXP Rsh_Fir_reg____ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 2), RHO);
  // r = dyn ___(x1, 5.0)
  ...
  SEXP Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 2, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
