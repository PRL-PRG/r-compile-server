...
L0_:;
  ...
  // y = ld y
  SEXP Rsh_Fir_reg_y = Rsh_Fir_load(Rsh_const(CCP, 1), RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack2[1] = Rsh_Fir_reg_y;
...
L1_:;
  ...
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg_y1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args2, Rsh_Fir_param_types_empty()));
  // r = `+`(x2, y1)
  SEXP Rsh_Fir_array_args3[2];
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_x2_;
  Rsh_Fir_array_args3[1] = Rsh_Fir_reg_y1_;
  SEXP Rsh_Fir_reg_r1 = Rsh_Fir_call_builtin(66, CCP, RHO, 2, Rsh_Fir_array_args3, Rsh_Fir_param_types_empty());
  // popenv
  Rsh_Fir_pop_env(&RHO);
  (void)(R_NilValue);
  // return r
