...
L0_:;
  // diag__ = ldf `diag<-`
  SEXP Rsh_Fir_reg_diag__ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 1), RHO);
  // check L8() else D4()
  // L8()
  goto L8_;
...
L1_:;
  ...
  SEXP Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg_matrix, 3, Rsh_Fir_array_args, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L2() else D1()
  // L2()
  goto L2_;
...
L2_:;
  // st b = r
  Rsh_Fir_store(Rsh_const(CCP, 4), Rsh_Fir_reg_r, RHO);
  (void)(Rsh_Fir_reg_r);
  // l = ld b
  SEXP Rsh_Fir_reg_l = Rsh_Fir_load(Rsh_const(CCP, 4), RHO);
  // diag = ldf diag
  SEXP Rsh_Fir_reg_diag = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 5), RHO);
  // check L3() else D2()
  // L3()
  goto L3_;
...
L3_:;
  ...
  SEXP Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_diag, 2, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L4() else D3()
  // L4()
  goto L4_;
...
L4_:;
  ...
  // L6(5.0, l, r1)
    SEXP Rsh_Fir_reg_r4_ = Rsh_const(CCP, 6);
    SEXP Rsh_Fir_reg_l2_ = Rsh_Fir_reg_l;
    SEXP Rsh_Fir_reg_r5_ = Rsh_Fir_reg_r1_;
    goto L6_;
  }
...
L5_:;
  ...
  SEXP Rsh_Fir_reg_dr = Rsh_Fir_intrinsic_tryDispatchBuiltin_v0(CCP, RHO, 3, Rsh_Fir_array_args3);
  ...
  // L6(5.0, l, dr)
    SEXP Rsh_Fir_reg_r4_ = Rsh_const(CCP, 6);
    SEXP Rsh_Fir_reg_l2_ = Rsh_Fir_reg_l;
    SEXP Rsh_Fir_reg_r5_ = Rsh_Fir_reg_dr;
    goto L6_;
  }

L6_:;
  // ___ = ldf `[<-` in base
  SEXP Rsh_Fir_reg____ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 9), RHO);
  ...
  SEXP Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 3, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L0(r4, l2, r8)
  // L0(r4, l2, r8)
  SEXP Rsh_Fir_reg_r7_ = Rsh_Fir_reg_r4_;
  SEXP Rsh_Fir_reg_l4_ = Rsh_Fir_reg_l2_;
  SEXP Rsh_Fir_reg_dx1_ = Rsh_Fir_reg_r8_;
  goto L0_;
...
L7_:;
  ...
  // goto L0(5.0, l, dx)
  // L0(5.0, l, dx)
  SEXP Rsh_Fir_reg_r7_ = Rsh_const(CCP, 6);
  SEXP Rsh_Fir_reg_l4_ = Rsh_Fir_reg_l;
...
L8_:;
  ...
  SEXP Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_diag__, 3, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L9() else D5()
  // L9()
  goto L9_;
