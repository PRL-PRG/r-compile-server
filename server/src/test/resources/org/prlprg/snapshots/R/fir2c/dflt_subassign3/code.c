...
L0:;
  // st x = dx1
  Rsh_Fir_store(Rsh_const(CCP, 1), Rsh_Fir_reg_dx1, RHO);
  (void)(Rsh_Fir_reg_dx1);
  // x = ld x
...
L2:;
  ...
  // L4(42.0)
    SEXP Rsh_Fir_reg_r2 = Rsh_const(CCP, 8);
    goto L4;
  }
...
L4:;
  // ___ = ldf `[<-` in base
  SEXP Rsh_Fir_reg____ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 10), RHO);
  ...
  SEXP Rsh_Fir_reg_r5 = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 3, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names1, CCP, RHO);
  // goto L0(r5)
  // L0(r5)
  SEXP Rsh_Fir_reg_dx1 = Rsh_Fir_reg_r5;
  goto L0;
