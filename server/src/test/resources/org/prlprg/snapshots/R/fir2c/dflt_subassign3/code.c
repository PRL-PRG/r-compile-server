...
L2_:;
  ...
  // L4(42.0)
    SEXP Rsh_Fir_reg_r2_ = Rsh_const(CCP, 8);
    goto L4_;
  }
...
L4_:;
  ...
  SEXP Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 3, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names1, CCP, RHO);
  // goto L0(r5)
  // L0(r5)
  SEXP Rsh_Fir_reg_dx1_ = Rsh_Fir_reg_r5_;
  goto L0_;
