...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  // names = ldf names
  SEXP Rsh_Fir_reg_names = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 2), RHO);
  // check L1() else D0()
  // L1()
  goto L1_;
...
L0_:;
  // names__ = ldf `names<-`
  SEXP Rsh_Fir_reg_names__ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 3), RHO);
  // check L6() else D2()
  // L6()
  goto L6_;
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_const(CCP, 4);
...
L1_:;
  ...
  SEXP Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg_names, 2, Rsh_Fir_array_args, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L2() else D1()
  // L2()
  goto L2_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_const(CCP, 4);
  Rsh_Fir_array_deopt_stack1[1] = Rsh_Fir_reg_l;
  Rsh_Fir_array_deopt_stack1[2] = Rsh_const(CCP, 4);
...
L2_:;
  ...
  // L4("a", l, r)
    SEXP Rsh_Fir_reg_r3_ = Rsh_const(CCP, 4);
    SEXP Rsh_Fir_reg_l2_ = Rsh_Fir_reg_l;
    SEXP Rsh_Fir_reg_r4_ = Rsh_Fir_reg_r;
    goto L4_;
  }
...
L3_:;
  ...
  // L4("a", l, dr)
    SEXP Rsh_Fir_reg_r3_ = Rsh_const(CCP, 4);
    SEXP Rsh_Fir_reg_l2_ = Rsh_Fir_reg_l;
    SEXP Rsh_Fir_reg_r4_ = Rsh_Fir_reg_dr;
    goto L4_;
  }
...
L4_:;
  ...
  SEXP Rsh_Fir_reg_r7_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 3, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names1, CCP, RHO);
  // goto L0(r3, l2, r7)
  // L0(r3, l2, r7)
  SEXP Rsh_Fir_reg_r6_ = Rsh_Fir_reg_r3_;
  SEXP Rsh_Fir_reg_l4_ = Rsh_Fir_reg_l2_;
  SEXP Rsh_Fir_reg_dx1_ = Rsh_Fir_reg_r7_;
  goto L0_;
...
L5_:;
  ...
  // goto L0("a", l, dx)
  // L0("a", l, dx)
  SEXP Rsh_Fir_reg_r6_ = Rsh_const(CCP, 4);
...
L6_:;
  ...
  SEXP Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_names__, 3, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L7() else D3()
  // L7()
  goto L7_;
