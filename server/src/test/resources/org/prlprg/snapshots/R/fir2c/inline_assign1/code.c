...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  // l = ld a
  SEXP Rsh_Fir_reg_l = Rsh_Fir_load(Rsh_const(CCP, 4), RHO);
  // ____ = ldf `::<-`
  SEXP Rsh_Fir_reg_____ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 5), RHO);
  // check L0() else D0()
  // L0()
  goto L0_;
...
L0_:;
  ...
  SEXP Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_____, 4, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
L1_:;
  ...
  // l1 = ld a
  SEXP Rsh_Fir_reg_l1_ = Rsh_Fir_load(Rsh_const(CCP, 4), RHO);
  // _____ = ldf `:::<-`
  SEXP Rsh_Fir_reg______ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 8), RHO);
  // check L2() else D2()
  // L2()
  goto L2_;
...
L2_:;
  ...
  SEXP Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg______, 4, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L3() else D3()
  // L3()
  goto L3_;
...
L3_:;
  ...
  // l2 = sld a
  SEXP Rsh_Fir_reg_l2_ = Rsh_Fir_super_load(Rsh_const(CCP, 4), RHO);
  // _____1 = ldf `:::<-`
  SEXP Rsh_Fir_reg______1_ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 8), RHO);
  // check L4() else D4()
  // L4()
  goto L4_;
...
L4_:;
  ...
  SEXP Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg______1_, 4, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L5() else D5()
  // L5()
  goto L5_;
...
SEXP Rsh_Fir_user_promise_main(SEXP CCP, SEXP RHO) {
  // b = ld b
  SEXP Rsh_Fir_reg_b = Rsh_Fir_load(Rsh_const(CCP, 6), RHO);
  // b1 = force? b
...
SEXP Rsh_Fir_user_promise_main1(SEXP CCP, SEXP RHO) {
  // b2 = ld b
  SEXP Rsh_Fir_reg_b2_ = Rsh_Fir_load(Rsh_const(CCP, 6), RHO);
  // b3 = force? b2
...
SEXP Rsh_Fir_user_promise_main2(SEXP CCP, SEXP RHO) {
  // b4 = ld b
  SEXP Rsh_Fir_reg_b4_ = Rsh_Fir_load(Rsh_const(CCP, 6), RHO);
  // b5 = force? b4
  SEXP Rsh_Fir_reg_b5_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_b4_);
  // checkMissing(b5)
