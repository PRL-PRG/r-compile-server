...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // v = ld v
  SEXP Rsh_Fir_reg_v = Rsh_Fir_load(Rsh_const(CCP, 0), RHO);
  // check L0() else D0()
  // L0()
  goto L0_;
...
L0_:;
  // v1 = force? v
  SEXP Rsh_Fir_reg_v1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_v);
  // checkMissing(v1)
  ...
  // h = ldf h
  SEXP Rsh_Fir_reg_h = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 2), RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
L1_:;
  ...
  SEXP Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_h, 3, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L2() else D2()
  // L2()
  goto L2_;
...
L2_:;
  // g = ldf g
  SEXP Rsh_Fir_reg_g = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 5), RHO);
  // check L3() else D3()
  // L3()
  goto L3_;
...
L3_:;
  ...
  SEXP Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_g, 3, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L4() else D4()
  // L4()
  goto L4_;
...
L4_:;
  // f__ = ldf `f<-`
  SEXP Rsh_Fir_reg_f__ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 7), RHO);
  // check L5() else D5()
  // L5()
  goto L5_;
...
L5_:;
  ...
  //   return i1;
  // }
  SEXP Rsh_Fir_reg_p2_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_main2, CCP, RHO);
  ...
  SEXP Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_f__, 4, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L6() else D6()
  // L6()
  goto L6_;
...
L6_:;
  // g__ = ldf `g<-`
  SEXP Rsh_Fir_reg_g__ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 9), RHO);
  // check L7() else D7()
  // L7()
  goto L7_;
...
L7_:;
  ...
  //   return j3;
  // }
  SEXP Rsh_Fir_reg_p3_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_main3, CCP, RHO);
  ...
  SEXP Rsh_Fir_reg_r7_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_g__, 4, Rsh_Fir_array_args8, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L8() else D8()
  // L8()
  goto L8_;
...
L8_:;
  // h__ = ldf `h<-`
  SEXP Rsh_Fir_reg_h__ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 10), RHO);
  // check L9() else D9()
  // L9()
  goto L9_;
...
L9_:;
  ...
  //   return k3;
  // }
  SEXP Rsh_Fir_reg_p4_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_main4, CCP, RHO);
  ...
  SEXP Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_h__, 4, Rsh_Fir_array_args10, Rsh_Fir_array_arg_names4, CCP, RHO);
  // check L10() else D10()
  // L10()
  goto L10_;
...
SEXP Rsh_Fir_user_promise_main(SEXP CCP, SEXP RHO) {
  // k = ld k
  SEXP Rsh_Fir_reg_k = Rsh_Fir_load(Rsh_const(CCP, 3), RHO);
  // k1 = force? k
  SEXP Rsh_Fir_reg_k1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_k);
  // checkMissing(k1)
...
SEXP Rsh_Fir_user_promise_main1(SEXP CCP, SEXP RHO) {
  // j = ld j
  SEXP Rsh_Fir_reg_j = Rsh_Fir_load(Rsh_const(CCP, 6), RHO);
  // j1 = force? j
  SEXP Rsh_Fir_reg_j1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_j);
  // checkMissing(j1)
...
SEXP Rsh_Fir_user_promise_main2(SEXP CCP, SEXP RHO) {
  // i = ld i
  SEXP Rsh_Fir_reg_i = Rsh_Fir_load(Rsh_const(CCP, 8), RHO);
  // i1 = force? i
  SEXP Rsh_Fir_reg_i1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_i);
  // checkMissing(i1)
...
SEXP Rsh_Fir_user_promise_main3(SEXP CCP, SEXP RHO) {
  // j2 = ld j
  SEXP Rsh_Fir_reg_j2_ = Rsh_Fir_load(Rsh_const(CCP, 6), RHO);
  // j3 = force? j2
  SEXP Rsh_Fir_reg_j3_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_j2_);
  // checkMissing(j3)
...
SEXP Rsh_Fir_user_promise_main4(SEXP CCP, SEXP RHO) {
  // k2 = ld k
  SEXP Rsh_Fir_reg_k2_ = Rsh_Fir_load(Rsh_const(CCP, 3), RHO);
  // k3 = force? k2
  SEXP Rsh_Fir_reg_k3_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_k2_);
  // checkMissing(k3)
