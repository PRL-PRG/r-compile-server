...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // l = ld x
  SEXP Rsh_Fir_reg_l = Rsh_Fir_load(Rsh_const(CCP, 0), RHO);
  // c = `is.object`(l)
  SEXP Rsh_Fir_array_args[1];
  Rsh_Fir_array_args[0] = Rsh_Fir_reg_l;
  SEXP Rsh_Fir_reg_c = Rsh_Fir_call_builtin(397, CCP, RHO, 1, Rsh_Fir_array_args, Rsh_Fir_param_types_empty());
  ...
  // L2(1.0, l)
    SEXP Rsh_Fir_reg_r1_ = Rsh_const(CCP, 1);
...
L0_:;
  ...
  // l3 = ld x
  SEXP Rsh_Fir_reg_l3_ = Rsh_Fir_load(Rsh_const(CCP, 0), RHO);
  // c1 = `is.object`(l3)
  SEXP Rsh_Fir_array_args1[1];
  Rsh_Fir_array_args1[0] = Rsh_Fir_reg_l3_;
  SEXP Rsh_Fir_reg_c1_ = Rsh_Fir_call_builtin(397, CCP, RHO, 1, Rsh_Fir_array_args1, Rsh_Fir_param_types_empty());
  ...
  // L6(2.0, l3)
    SEXP Rsh_Fir_reg_r6_ = Rsh_const(CCP, 2);
    SEXP Rsh_Fir_reg_l5_ = Rsh_Fir_reg_l3_;
    goto L6_;
  }
...
L2_:;
  ...
  SEXP Rsh_Fir_reg_r4_ = Rsh_Fir_call_builtin(21, CCP, RHO, 3, Rsh_Fir_array_args4, Rsh_Fir_param_types_empty());
  // goto L0(r4)
  // L0(r4)
  SEXP Rsh_Fir_reg_dx1_ = Rsh_Fir_reg_r4_;
  goto L0_;
...
L4_:;
  ...
  // l6 = ld a
  SEXP Rsh_Fir_reg_l6_ = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // __ = ldf `::`
  SEXP Rsh_Fir_reg___ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 6), RHO);
  // check L8() else D0()
  // L8()
  goto L8_;
...
L5_:;
  ...
  SEXP Rsh_Fir_reg_dr2_ = Rsh_Fir_intrinsic_tryDispatchBuiltin_v0(CCP, RHO, 3, Rsh_Fir_array_args6);
  // dc1 = getTryDispatchBuiltinDispatched(dr2)
  SEXP Rsh_Fir_array_args7[1];
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_dr2_;
  SEXP Rsh_Fir_reg_dc1_ = Rsh_Fir_intrinsic_getTryDispatchBuiltinDispatched(CCP, RHO, 1, Rsh_Fir_array_args7, Rsh_Fir_param_types_empty());
  ...
  // L6(2.0, dr2)
    SEXP Rsh_Fir_reg_r6_ = Rsh_const(CCP, 2);
    SEXP Rsh_Fir_reg_l5_ = Rsh_Fir_reg_dr2_;
    goto L6_;
  }
...
L6_:;
  ...
  SEXP Rsh_Fir_reg_r9_ = Rsh_Fir_call_builtin(21, CCP, RHO, 3, Rsh_Fir_array_args8, Rsh_Fir_param_types_empty());
  // goto L4(r9)
  // L4(r9)
  SEXP Rsh_Fir_reg_dx3_ = Rsh_Fir_reg_r9_;
  goto L4_;
...
L7_:;
  ...
  SEXP Rsh_Fir_reg_dx2_ = Rsh_Fir_intrinsic_getTryDispatchBuiltinValue(CCP, RHO, 1, Rsh_Fir_array_args9, Rsh_Fir_param_types_empty());
  // goto L4(dx2)
  // L4(dx2)
  SEXP Rsh_Fir_reg_dx3_ = Rsh_Fir_reg_dx2_;
  goto L4_;
...
L8_:;
  ...
  SEXP Rsh_Fir_reg_r11_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 3, Rsh_Fir_array_args11, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L9() else D1()
  // L9()
  goto L9_;
...
L9_:;
  ...
  SEXP Rsh_Fir_reg_c2_ = Rsh_Fir_call_builtin(397, CCP, RHO, 1, Rsh_Fir_array_args12, Rsh_Fir_param_types_empty());
  ...
  // L12(3.0, l6, r11)
    SEXP Rsh_Fir_reg_r14_ = Rsh_const(CCP, 8);
    SEXP Rsh_Fir_reg_l8_ = Rsh_Fir_reg_l6_;
    SEXP Rsh_Fir_reg_r15_ = Rsh_Fir_reg_r11_;
    goto L12_;
  }

L10_:;
  // ____ = ldf `::<-`
  SEXP Rsh_Fir_reg_____ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 11), RHO);
  // check L14() else D2()
  // L14()
  goto L14_;
...
L11_:;
  ...
  SEXP Rsh_Fir_reg_dr4_ = Rsh_Fir_intrinsic_tryDispatchBuiltin_v0(CCP, RHO, 3, Rsh_Fir_array_args13);
  // dc2 = getTryDispatchBuiltinDispatched(dr4)
  SEXP Rsh_Fir_array_args14[1];
  Rsh_Fir_array_args14[0] = Rsh_Fir_reg_dr4_;
  SEXP Rsh_Fir_reg_dc2_ = Rsh_Fir_intrinsic_getTryDispatchBuiltinDispatched(CCP, RHO, 1, Rsh_Fir_array_args14, Rsh_Fir_param_types_empty());
  ...
  // L12(3.0, l6, dr4)
    SEXP Rsh_Fir_reg_r14_ = Rsh_const(CCP, 8);
    SEXP Rsh_Fir_reg_l8_ = Rsh_Fir_reg_l6_;
    SEXP Rsh_Fir_reg_r15_ = Rsh_Fir_reg_dr4_;
    goto L12_;
  }
...
L12_:;
  ...
  SEXP Rsh_Fir_reg_r18_ = Rsh_Fir_call_builtin(21, CCP, RHO, 3, Rsh_Fir_array_args15, Rsh_Fir_param_types_empty());
  // goto L10(r14, l8, r18)
  // L10(r14, l8, r18)
  SEXP Rsh_Fir_reg_r17_ = Rsh_Fir_reg_r14_;
  SEXP Rsh_Fir_reg_l10_ = Rsh_Fir_reg_l8_;
  SEXP Rsh_Fir_reg_dx5_ = Rsh_Fir_reg_r18_;
  goto L10_;
...
L13_:;
  ...
  SEXP Rsh_Fir_reg_dx4_ = Rsh_Fir_intrinsic_getTryDispatchBuiltinValue(CCP, RHO, 1, Rsh_Fir_array_args16, Rsh_Fir_param_types_empty());
  // goto L10(3.0, l6, dx4)
  // L10(3.0, l6, dx4)
  SEXP Rsh_Fir_reg_r17_ = Rsh_const(CCP, 8);
  SEXP Rsh_Fir_reg_l10_ = Rsh_Fir_reg_l6_;
  SEXP Rsh_Fir_reg_dx5_ = Rsh_Fir_reg_dx4_;
  goto L10_;
...
L14_:;
  ...
  //   return b3;
  // }
  SEXP Rsh_Fir_reg_p1_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_main1, CCP, RHO);
  ...
  SEXP Rsh_Fir_reg_r20_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_____, 4, Rsh_Fir_array_args18, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L15() else D3()
  // L15()
  goto L15_;
...
SEXP Rsh_Fir_user_promise_main(SEXP CCP, SEXP RHO) {
  // b = ld b
  SEXP Rsh_Fir_reg_b = Rsh_Fir_load(Rsh_const(CCP, 9), RHO);
  // b1 = force? b
  SEXP Rsh_Fir_reg_b1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_b);
  // checkMissing(b1)
...
SEXP Rsh_Fir_user_promise_main1(SEXP CCP, SEXP RHO) {
  // b2 = ld b
  SEXP Rsh_Fir_reg_b2_ = Rsh_Fir_load(Rsh_const(CCP, 9), RHO);
  // b3 = force? b2
  SEXP Rsh_Fir_reg_b3_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_b2_);
  // checkMissing(b3)
