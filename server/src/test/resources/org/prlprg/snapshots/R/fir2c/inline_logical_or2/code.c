...
L4_:;
  ...
  SEXP Rsh_Fir_reg_c4_ = Rsh_Fir_call_builtin(84, CCP, RHO, 2, Rsh_Fir_array_args5, Rsh_Fir_param_types_empty());
  // goto L0(c4)
  // L0(c4)
...
L7_:;
  ...
  SEXP Rsh_Fir_reg_c10_ = Rsh_Fir_call_builtin(84, CCP, RHO, 2, Rsh_Fir_array_args8, Rsh_Fir_param_types_empty());
  // goto L1(c10)
  // L1(c10)
  SEXP Rsh_Fir_reg_c7_ = Rsh_Fir_reg_c10_;
  goto L1_;
}
