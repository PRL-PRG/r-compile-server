...
L2_:;
  ...
  // x = ld x
  SEXP Rsh_Fir_reg_x = Rsh_Fir_load(Rsh_const(CCP, 4), RHO);
  // check L3() else D2()
  // L3()
  goto L3_;
...
L3_:;
  ...
  // L5(x1)
    SEXP Rsh_Fir_reg_x3_ = Rsh_Fir_reg_x1_;
    goto L5_;
  }
...
L4_:;
  ...
  // L5(dr)
    SEXP Rsh_Fir_reg_x3_ = Rsh_Fir_reg_dr;
    goto L5_;
  }

L5_:;
  // __ = ldf `[` in base
  SEXP Rsh_Fir_reg___ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 6), RHO);
  ...
  SEXP Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 3, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names1, CCP, RHO);
  // goto L0(r2)
  // L0(r2)
  SEXP Rsh_Fir_reg_dx1_ = Rsh_Fir_reg_r2_;
  goto L0_;
