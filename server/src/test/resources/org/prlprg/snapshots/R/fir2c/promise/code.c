...
SEXP Rsh_Fir_user_promise_main(SEXP CCP, SEXP RHO) {
  // y = ld y
  SEXP Rsh_Fir_reg_y = Rsh_Fir_load(Rsh_const(CCP, 2), RHO);
  // y1 = force? y
  SEXP Rsh_Fir_reg_y1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_y);
  // checkMissing(y1)
  SEXP Rsh_Fir_array_args[1];
  Rsh_Fir_array_args[0] = Rsh_Fir_reg_y1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args, Rsh_Fir_param_types_empty()));
  // r1 = `*`(y1, 2.0)
  SEXP Rsh_Fir_array_args1[2];
  Rsh_Fir_array_args1[0] = Rsh_Fir_reg_y1_;
  Rsh_Fir_array_args1[1] = Rsh_const(CCP, 1);
  SEXP Rsh_Fir_reg_r1_ = Rsh_Fir_call_builtin(68, CCP, RHO, 2, Rsh_Fir_array_args1, Rsh_Fir_param_types_empty());
  // return r1
...
L0_:;
  ...
  SEXP Rsh_Fir_reg_r1 = Rsh_Fir_call_builtin(66, CCP, RHO, 2, Rsh_Fir_array_args4, Rsh_Fir_param_types_empty());
  // popenv
  Rsh_Fir_pop_env(&RHO);
  (void)(R_NilValue);
  // return r
