...
L1:;
  ...
  // L0(c)
    SEXP Rsh_Fir_reg_c1 = Rsh_Fir_reg_c;
    goto L0;
  } else {
  // L2()
    goto L2;
...
L3:;
  ...
  SEXP Rsh_Fir_reg_c4 = Rsh_Fir_call_builtin(84, CCP, RHO, 2, Rsh_Fir_array_args4, Rsh_Fir_param_types_empty());
  // goto L0(c4)
  // L0(c4)
  SEXP Rsh_Fir_reg_c1 = Rsh_Fir_reg_c4;
  goto L0;
}
