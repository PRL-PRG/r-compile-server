...
D1:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_x1;
...
L1:;
  ...
  Rsh_Fir_array_args1[0] = Rsh_Fir_reg_y1;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args1, Rsh_Fir_param_types_empty()));
  // r = `||`(x1, y1)
  SEXP Rsh_Fir_array_args2[2];
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg_x1;
  Rsh_Fir_array_args2[1] = Rsh_Fir_reg_y1;
  SEXP Rsh_Fir_reg_r = Rsh_Fir_call_builtin(84, CCP, RHO, 2, Rsh_Fir_array_args2, Rsh_Fir_param_types_empty());
  // popenv
  Rsh_Fir_pop_env(&RHO);
  (void)(R_NilValue);
  // return r
