...
L11_:;
  ...
  Rsh_Fir_reg_r11_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_permute1, 2, Rsh_Fir_array_args19, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L12() else D4()
  // L12()
  goto L12_;
...
SEXP Rsh_Fir_user_promise_inner1871978492_1(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_swap, 3, Rsh_Fir_array_args18, Rsh_Fir_array_arg_names1, CCP, RHO);
  // return r9
...
L8_:;
  ...
  Rsh_Fir_reg_r2 = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 2, Rsh_Fir_array_args26, Rsh_Fir_array_arg_names3, CCP, RHO);
  // goto L0(r)
  // L0(r)
