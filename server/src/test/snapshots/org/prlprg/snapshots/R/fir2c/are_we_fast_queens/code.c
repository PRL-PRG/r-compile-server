...
L8_:;
  ...
  Rsh_Fir_array_args11[0] = Rsh_Fir_reg_n2_1;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args11, Rsh_Fir_param_types_empty()));
  // r = `+`(n2, 1.0)
  SEXP Rsh_Fir_array_args12[2];
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_n2_1;
  Rsh_Fir_array_args12[1] = Rsh_const(CCP, 8);
  Rsh_Fir_reg_r2 = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args12);
  // r1 = `==`(row2, r)
  SEXP Rsh_Fir_array_args13[2];
  Rsh_Fir_array_args13[0] = Rsh_Fir_reg_row2_;
  Rsh_Fir_array_args13[1] = Rsh_Fir_reg_r2;
  Rsh_Fir_reg_r1_2 = Rsh_Fir_call_builtin(74, RHO, 2, Rsh_Fir_array_args13);
  // c = `as.logical`(r1)
  SEXP Rsh_Fir_array_args14[1];
  Rsh_Fir_array_args14[0] = Rsh_Fir_reg_r1_2;
...
L12_:;
  ...
  Rsh_Fir_array_args16[1] = Rsh_Fir_reg_n4_;
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_builtin(85, RHO, 2, Rsh_Fir_array_args16);
  // s = toForSeq(r4)
...
L15_:;
  ...
  Rsh_Fir_array_args24[0] = Rsh_Fir_reg_r9_;
...
L16_:;
  // col2 = ld col
  Rsh_Fir_reg_col2_ = Rsh_Fir_load(Rsh_const(CCP, 14), RHO);
  // check L17() else D5()
  // L17()
  goto L17_;
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack7[1] = Rsh_Fir_reg_col2_;
...
L17_:;
  ...
  Rsh_Fir_array_args25[0] = Rsh_Fir_reg_col3_;
...
L18_:;
  ...
  Rsh_Fir_array_args27[1] = Rsh_Fir_reg_l1_;
  Rsh_Fir_array_args27[2] = Rsh_Fir_reg_col3_;
...
D6_:;
  ...
  Rsh_Fir_array_deopt_stack8[1] = Rsh_Fir_reg_col5_;
  Rsh_Fir_array_deopt_stack8[2] = Rsh_Fir_reg_l3_;
  Rsh_Fir_array_deopt_stack8[3] = Rsh_Fir_reg_col3_;
  Rsh_Fir_array_deopt_stack8[4] = Rsh_Fir_reg_row5_;
  Rsh_Fir_deopt(28, 5, Rsh_Fir_array_deopt_stack8, CCP, RHO);
  return R_NilValue;
...
L21_:;
  ...
  Rsh_Fir_array_args30[0] = Rsh_Fir_reg_l3_;
  Rsh_Fir_array_args30[1] = Rsh_Fir_reg_col3_;
  Rsh_Fir_array_args30[2] = Rsh_Fir_reg_row6_;
  SEXP Rsh_Fir_array_arg_names5[3];
  Rsh_Fir_array_arg_names5[0] = R_MissingArg;
  Rsh_Fir_array_arg_names5[1] = R_MissingArg;
  Rsh_Fir_array_arg_names5[2] = R_MissingArg;
  Rsh_Fir_reg_r10_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 3, Rsh_Fir_array_args30, Rsh_Fir_array_arg_names5, CCP, RHO);
  // goto L4(i8, r10)
  // L4(i8, r10)
...
D7_:;
  ...
  Rsh_Fir_array_deopt_stack9[1] = Rsh_Fir_reg_count;
...
L22_:;
  ...
  Rsh_Fir_array_args31[0] = Rsh_Fir_reg_count1_;
...
D8_:;
  ...
  Rsh_Fir_array_deopt_stack10[1] = Rsh_Fir_reg_count1_;
...
L23_:;
  ...
  Rsh_Fir_reg_r15_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_solve_queens1, 3, Rsh_Fir_array_args36, Rsh_Fir_array_arg_names6, CCP, RHO);
  // check L24() else D9()
  // L24()
  goto L24_;
...
L24_:;
  ...
  Rsh_Fir_array_args37[0] = Rsh_Fir_reg_count1_;
  Rsh_Fir_array_args37[1] = Rsh_Fir_reg_r15_;
  Rsh_Fir_reg_r16_ = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args37);
  // st count = r16
...
D10_:;
  ...
  Rsh_Fir_array_deopt_stack12[0] = Rsh_Fir_reg_count2_;
...
L26_:;
  ...
  Rsh_Fir_array_args38[0] = Rsh_Fir_reg_count3_;
...
SEXP Rsh_Fir_user_promise_inner139384502_2(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  // col = ld col
  Rsh_Fir_reg_col = Rsh_Fir_load(Rsh_const(CCP, 14), RHO);
  // col1 = force? col
...
SEXP Rsh_Fir_user_promise_inner139384502_4(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_array_args32[0] = Rsh_Fir_reg_board4_;
...
SEXP Rsh_Fir_user_promise_inner139384502_5(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_array_args33[0] = Rsh_Fir_reg_row8_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args33, Rsh_Fir_param_types_empty()));
  // r12 = `+`(row8, 1.0)
  SEXP Rsh_Fir_array_args34[2];
  Rsh_Fir_array_args34[0] = Rsh_Fir_reg_row8_;
  Rsh_Fir_array_args34[1] = Rsh_const(CCP, 8);
  Rsh_Fir_reg_r12_ = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args34);
  // return r12
...
SEXP Rsh_Fir_user_promise_inner139384502_6(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_array_args35[0] = Rsh_Fir_reg_n8_;
...
SEXP Rsh_Fir_user_version_inner69251918_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  // st col = col
  Rsh_Fir_store(Rsh_const(CCP, 14), Rsh_Fir_reg_col1, RHO);
...
L0_:;
  ...
  Rsh_Fir_array_args39[0] = Rsh_Fir_reg_i1_1;
  Rsh_Fir_array_args39[1] = Rsh_const(CCP, 11);
  Rsh_Fir_reg_i2_1 = Rsh_Fir_builtin_add_v1(CCP, RHO, 2, Rsh_Fir_array_args39);
  // c = `<`.1(l, i2)
  SEXP Rsh_Fir_array_args40[2];
  Rsh_Fir_array_args40[0] = Rsh_Fir_reg_l1;
  Rsh_Fir_array_args40[1] = Rsh_Fir_reg_i2_1;
  Rsh_Fir_reg_c1 = Rsh_Fir_builtin_lt_v1(CCP, RHO, 2, Rsh_Fir_array_args40);
...
L1_:;
  // col1 = ld col
  Rsh_Fir_reg_col1_1 = Rsh_Fir_load(Rsh_const(CCP, 14), RHO);
  // check L17() else D3()
  // L17()
  goto L17_;
...
L5_:;
  // col3 = ld col
  Rsh_Fir_reg_col3_1 = Rsh_Fir_load(Rsh_const(CCP, 14), RHO);
  // check L28() else D6()
  // L28()
  goto L28_;
...
L6_:;
  ...
  Rsh_Fir_reg_r18_ = Rsh_Fir_call_builtin(74, RHO, 2, Rsh_Fir_array_args43);
  // c4 = `as.logical`(r18)
  SEXP Rsh_Fir_array_args44[1];
  Rsh_Fir_array_args44[0] = Rsh_Fir_reg_r18_;
...
L9_:;
  ...
  Rsh_Fir_array_args45[2] = Rsh_const(CCP, 12);
  Rsh_Fir_array_args45[3] = Rsh_const(CCP, 13);
...
L10_:;
  ...
  Rsh_Fir_array_args46[0] = Rsh_Fir_reg_row2_1;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args46, Rsh_Fir_param_types_empty()));
  // r = `:`(1.0, row2)
  SEXP Rsh_Fir_array_args47[2];
  Rsh_Fir_array_args47[0] = Rsh_const(CCP, 8);
  Rsh_Fir_array_args47[1] = Rsh_Fir_reg_row2_1;
  Rsh_Fir_reg_r3 = Rsh_Fir_call_builtin(85, RHO, 2, Rsh_Fir_array_args47);
  // s = toForSeq(r)
  SEXP Rsh_Fir_array_args48[1];
  Rsh_Fir_array_args48[0] = Rsh_Fir_reg_r3;
  Rsh_Fir_reg_s1 = Rsh_Fir_intrinsic_toForSeq(CCP, RHO, 1, Rsh_Fir_array_args48, Rsh_Fir_param_types_empty());
  // l = length(s)
  SEXP Rsh_Fir_array_args49[1];
  Rsh_Fir_array_args49[0] = Rsh_Fir_reg_s1;
  Rsh_Fir_reg_l1 = Rsh_Fir_call_builtin(94, RHO, 1, Rsh_Fir_array_args49);
  // i = 0
  Rsh_Fir_reg_i1 = Rsh_const(CCP, 15);
  // goto L0(i)
  // L0(i)
...
L12_:;
  ...
  Rsh_Fir_array_args50[0] = Rsh_Fir_reg_board2_1;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args50, Rsh_Fir_param_types_empty()));
  // c1 = `is.object`(board2)
  SEXP Rsh_Fir_array_args51[1];
  Rsh_Fir_array_args51[0] = Rsh_Fir_reg_board2_1;
...
L13_:;
  ...
  Rsh_Fir_array_args52[1] = Rsh_Fir_reg_board2_1;
...
L14_:;
  // i9 = ld i
  Rsh_Fir_reg_i9_ = Rsh_Fir_load(Rsh_const(CCP, 19), RHO);
  // check L16() else D2()
  // L16()
  goto L16_;
...
L15_:;
  ...
  Rsh_Fir_array_args54[0] = Rsh_Fir_reg_dr1;
  Rsh_Fir_reg_dx1 = Rsh_Fir_intrinsic_getTryDispatchBuiltinValue(CCP, RHO, 1, Rsh_Fir_array_args54, Rsh_Fir_param_types_empty());
  // goto L1(i2, dx)
  // L1(i2, dx)
...
L16_:;
  ...
  Rsh_Fir_array_args55[0] = Rsh_Fir_reg_board4_1;
  Rsh_Fir_array_args55[1] = Rsh_Fir_reg_i10_1;
  SEXP Rsh_Fir_array_arg_names7[2];
  Rsh_Fir_array_arg_names7[0] = R_MissingArg;
  Rsh_Fir_array_arg_names7[1] = R_MissingArg;
  Rsh_Fir_reg_r1_3 = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 2, Rsh_Fir_array_args55, Rsh_Fir_array_arg_names7, CCP, RHO);
  // goto L1(i6, r1)
  // L1(i6, r1)
...
L17_:;
  ...
  Rsh_Fir_array_args56[0] = Rsh_Fir_reg_col2_1;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args56, Rsh_Fir_param_types_empty()));
  // r2 = `==`(dx1, col2)
  SEXP Rsh_Fir_array_args57[2];
  Rsh_Fir_array_args57[0] = Rsh_Fir_reg_dx1_1;
  Rsh_Fir_array_args57[1] = Rsh_Fir_reg_col2_1;
  Rsh_Fir_reg_r2_2 = Rsh_Fir_call_builtin(74, RHO, 2, Rsh_Fir_array_args57);
  // c2 = `as.logical`(r2)
  SEXP Rsh_Fir_array_args58[1];
  Rsh_Fir_array_args58[0] = Rsh_Fir_reg_r2_2;
...
L22_:;
  ...
  Rsh_Fir_array_args59[0] = Rsh_const(CCP, 23);
  SEXP Rsh_Fir_array_arg_names8[1];
  Rsh_Fir_array_arg_names8[0] = R_MissingArg;
  Rsh_Fir_reg_r5_1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1, 1, Rsh_Fir_array_args59, Rsh_Fir_array_arg_names8, CCP, RHO);
  // goto L4(i8, r5)
  // L4(i8, r5)
...
L24_:;
  ...
  Rsh_Fir_array_args62[1] = Rsh_Fir_reg_board6_;
...
L25_:;
  // i22 = ld i
  Rsh_Fir_reg_i22_ = Rsh_Fir_load(Rsh_const(CCP, 19), RHO);
  // check L27() else D5()
  // L27()
  goto L27_;
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack18[1] = Rsh_Fir_reg_board8_;
  Rsh_Fir_array_deopt_stack18[2] = Rsh_Fir_reg_i22_;
  Rsh_Fir_deopt(20, 3, Rsh_Fir_array_deopt_stack18, CCP, RHO);
  return R_NilValue;
...
L27_:;
  ...
  Rsh_Fir_array_args65[0] = Rsh_Fir_reg_board8_;
  Rsh_Fir_array_args65[1] = Rsh_Fir_reg_i23_;
  SEXP Rsh_Fir_array_arg_names9[2];
  Rsh_Fir_array_arg_names9[0] = R_MissingArg;
  Rsh_Fir_array_arg_names9[1] = R_MissingArg;
  Rsh_Fir_reg_r7_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___1_, 2, Rsh_Fir_array_args65, Rsh_Fir_array_arg_names9, CCP, RHO);
  // goto L5(i19, r7)
  // L5(i19, r7)
...
D6_:;
  ...
  Rsh_Fir_array_deopt_stack19[0] = Rsh_Fir_reg_i21_;
  Rsh_Fir_array_deopt_stack19[1] = Rsh_Fir_reg_dx3_;
  Rsh_Fir_array_deopt_stack19[2] = Rsh_Fir_reg_col3_1;
  Rsh_Fir_deopt(22, 3, Rsh_Fir_array_deopt_stack19, CCP, RHO);
  return R_NilValue;
...
L28_:;
  ...
  Rsh_Fir_array_args66[0] = Rsh_Fir_reg_col4_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args66, Rsh_Fir_param_types_empty()));
  // r8 = `-`(dx3, col4)
  SEXP Rsh_Fir_array_args67[2];
  Rsh_Fir_array_args67[0] = Rsh_Fir_reg_dx3_;
  Rsh_Fir_array_args67[1] = Rsh_Fir_reg_col4_;
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_builtin(67, RHO, 2, Rsh_Fir_array_args67);
  // abs = ldf abs in base
  Rsh_Fir_reg_abs = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 18), RHO);
  // r9 = dyn abs(r8)
  SEXP Rsh_Fir_array_args68[1];
  Rsh_Fir_array_args68[0] = Rsh_Fir_reg_r8_;
  SEXP Rsh_Fir_array_arg_names10[1];
  Rsh_Fir_array_arg_names10[0] = R_MissingArg;
  Rsh_Fir_reg_r9_1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_abs, 1, Rsh_Fir_array_args68, Rsh_Fir_array_arg_names10, CCP, RHO);
  // check L29() else D7()
  // L29()
  goto L29_;
...
D7_:;
  ...
  Rsh_Fir_deopt(26, 2, Rsh_Fir_array_deopt_stack20, CCP, RHO);
  return R_NilValue;
...
L30_:;
  // i27 = ld i
  Rsh_Fir_reg_i27_ = Rsh_Fir_load(Rsh_const(CCP, 19), RHO);
  // check L32() else D8()
  // L32()
  goto L32_;
...
L31_:;
  ...
  Rsh_Fir_reg_r12_1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 1, Rsh_Fir_array_args69, Rsh_Fir_array_arg_names11, CCP, RHO);
  // goto L6(i17, r6, r12)
  // L6(i17, r6, r12)
...
D8_:;
  ...
  Rsh_Fir_array_deopt_stack21[2] = Rsh_Fir_reg_i27_;
  Rsh_Fir_deopt(28, 3, Rsh_Fir_array_deopt_stack21, CCP, RHO);
  return R_NilValue;
...
L32_:;
  ...
  Rsh_Fir_array_args70[0] = Rsh_Fir_reg_i28_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args70, Rsh_Fir_param_types_empty()));
  // r15 = `-`(i28, 1.0)
  SEXP Rsh_Fir_array_args71[2];
  Rsh_Fir_array_args71[0] = Rsh_Fir_reg_i28_;
  Rsh_Fir_array_args71[1] = Rsh_const(CCP, 8);
  Rsh_Fir_reg_r15_1 = Rsh_Fir_call_builtin(67, RHO, 2, Rsh_Fir_array_args71);
  // row3 = ld row
...
D9_:;
  ...
  Rsh_Fir_array_deopt_stack22[1] = Rsh_Fir_reg_r6_;
  Rsh_Fir_array_deopt_stack22[2] = Rsh_Fir_reg_r15_1;
  Rsh_Fir_array_deopt_stack22[3] = Rsh_Fir_reg_row3_1;
  Rsh_Fir_deopt(31, 4, Rsh_Fir_array_deopt_stack22, CCP, RHO);
  return R_NilValue;
...
L33_:;
  ...
  Rsh_Fir_reg_abs1_ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 18), RHO);
  // r17 = dyn abs1(r16)
