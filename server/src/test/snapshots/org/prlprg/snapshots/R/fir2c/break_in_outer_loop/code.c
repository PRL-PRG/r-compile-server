...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack1[2] = Rsh_Fir_reg_x2_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack2[1] = Rsh_Fir_reg_i13_;
  Rsh_Fir_deopt(17, 2, Rsh_Fir_array_deopt_stack2, CCP, RHO);
  return R_NilValue;
