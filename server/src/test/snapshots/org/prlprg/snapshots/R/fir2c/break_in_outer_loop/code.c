...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[2] = Rsh_Fir_reg_x2_;
...
L9_:;
  ...
  Rsh_Fir_reg_r = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args11);
  // st x = r
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[1] = Rsh_Fir_reg_i13_;
  Rsh_Fir_deopt(17, 2, Rsh_Fir_array_deopt_stack1, CCP, RHO);
  return R_NilValue;
...
L10_:;
  ...
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_i14_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args12, Rsh_Fir_param_types_empty()));
  // r1 = `==`(i14, 2.0)
  SEXP Rsh_Fir_array_args13[2];
  Rsh_Fir_array_args13[0] = Rsh_Fir_reg_i14_;
  Rsh_Fir_array_args13[1] = Rsh_const(CCP, 10);
  Rsh_Fir_reg_r1_ = Rsh_Fir_call_builtin(74, RHO, 2, Rsh_Fir_array_args13);
  // c2 = `as.logical`(r1)
