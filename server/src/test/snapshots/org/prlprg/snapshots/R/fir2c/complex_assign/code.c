...
L3_:;
  ...
  Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_diag, 2, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names1, RHO);
  // check L4() else D3()
  // L4()
  goto L4_;
...
L6_:;
  ...
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 3, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names2, RHO);
  // goto L0(r4, l2, r8)
  // L0(r4, l2, r8)
...
L8_:;
  ...
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_diag__, 3, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names3, RHO);
  // check L9() else D5()
  // L9()
  goto L9_;
