...
L1_:;
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c, 2, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names, RHO);
  // check L3() else D0()
  // L3()
  goto L3_;

L2_:;
  // r2 = dyn base(10.0, 11.0)
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 2, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names1, RHO);
  // goto L0(TRUE, r2)
  // L0(TRUE, r2)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[1] = Rsh_Fir_reg_r5_;
  Rsh_Fir_deopt(6, 2, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;
