...
L7_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_rep, 2, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names1, RHO);
  // goto L0(r4)
  // L0(r4)
...
L8_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 2, Rsh_Fir_array_args8, Rsh_Fir_array_arg_names2, RHO);
  // goto L0(r2)
  // L0(r2)
...
L21_:;
  ...
  Rsh_Fir_reg_r10_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 3, Rsh_Fir_array_args32, Rsh_Fir_array_arg_names3, RHO);
  // goto L2(i10, r10)
  // L2(i10, r10)
