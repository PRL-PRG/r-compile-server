...
L6_:;
  ...
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_n6_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args4, Rsh_Fir_param_types_empty()));
  // r1 = `+`(r, n6)
  SEXP Rsh_Fir_array_args5[2];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_r1;
  Rsh_Fir_array_args5[1] = Rsh_Fir_reg_n6_;
  Rsh_Fir_reg_r1_1 = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args5);
  // st m = r1
  Rsh_Fir_store(Rsh_const(CCP, 3), Rsh_Fir_reg_r1_1, RHO);
...
L7_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_rep, 2, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names1, CCP, RHO);
  // goto L0(r4)
  // L0(r4)
...
L8_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 2, Rsh_Fir_array_args8, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L0(r2)
  // L0(r2)
...
L9_:;
  ...
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_n8_;
  Rsh_Fir_array_args10[1] = Rsh_const(CCP, 10);
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args10);
  // st value = r5
...
L10_:;
  ...
  Rsh_Fir_array_args11[0] = Rsh_Fir_reg_limit1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args11, Rsh_Fir_param_types_empty()));
  // r6 = `:`(1, limit1)
  SEXP Rsh_Fir_array_args12[2];
  Rsh_Fir_array_args12[0] = Rsh_const(CCP, 1);
  Rsh_Fir_array_args12[1] = Rsh_Fir_reg_limit1_;
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_builtin(85, RHO, 2, Rsh_Fir_array_args12);
  // s = toForSeq(r6)
  SEXP Rsh_Fir_array_args13[1];
  Rsh_Fir_array_args13[0] = Rsh_Fir_reg_r6_;
  Rsh_Fir_reg_s = Rsh_Fir_intrinsic_toForSeq(CCP, RHO, 1, Rsh_Fir_array_args13, Rsh_Fir_param_types_empty());
  // l = length(s)
  SEXP Rsh_Fir_array_args14[1];
  Rsh_Fir_array_args14[0] = Rsh_Fir_reg_s;
  Rsh_Fir_reg_l = Rsh_Fir_call_builtin(94, RHO, 1, Rsh_Fir_array_args14);
  // i = 0
...
L1_:;
  ...
  Rsh_Fir_reg_c = Rsh_Fir_builtin_lt_v1(CCP, RHO, 2, Rsh_Fir_array_args16);
...
L3_:;
  ...
  Rsh_Fir_array_args17[3] = Rsh_const(CCP, 13);
  Rsh_Fir_reg_x = Rsh_Fir_call_builtin(16, RHO, 4, Rsh_Fir_array_args17);
  // st i = x
...
L11_:;
  // totals = ld totals
  Rsh_Fir_reg_totals = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // check L22() else D12()
  // L22()
  goto L22_;
...
D12_:;
  ...
  Rsh_Fir_array_deopt_stack7[0] = Rsh_Fir_reg_totals;
...
L22_:;
  ...
  Rsh_Fir_array_args19[0] = Rsh_Fir_reg_totals1_;
...
D6_:;
  ...
  Rsh_Fir_array_deopt_stack8[1] = Rsh_Fir_reg_value1_;
  Rsh_Fir_array_deopt_stack8[2] = Rsh_Fir_reg_i5_;
  Rsh_Fir_deopt(27, 3, Rsh_Fir_array_deopt_stack8, CCP, RHO);
  return R_NilValue;
...
L13_:;
  ...
  Rsh_Fir_array_args21[0] = Rsh_Fir_reg_value1_;
  Rsh_Fir_array_args21[1] = Rsh_Fir_reg_i6_;
  Rsh_Fir_reg_r7_ = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args21);
  // i7 = ld i
  Rsh_Fir_reg_i7_ = Rsh_Fir_load(Rsh_const(CCP, 14), RHO);
  // check L14() else D7()
  // L14()
  goto L14_;
...
D7_:;
  ...
  Rsh_Fir_array_deopt_stack9[1] = Rsh_Fir_reg_r7_;
  Rsh_Fir_array_deopt_stack9[2] = Rsh_Fir_reg_i7_;
...
L14_:;
  ...
  Rsh_Fir_array_args22[0] = Rsh_Fir_reg_i8_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args22, Rsh_Fir_param_types_empty()));
  // r8 = `*`(r7, i8)
  SEXP Rsh_Fir_array_args23[2];
  Rsh_Fir_array_args23[0] = Rsh_Fir_reg_r7_;
  Rsh_Fir_array_args23[1] = Rsh_Fir_reg_i8_;
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_builtin(68, RHO, 2, Rsh_Fir_array_args23);
  // st step = r8
  Rsh_Fir_store(Rsh_const(CCP, 15), Rsh_Fir_reg_r8_, RHO);
  (void)(Rsh_Fir_reg_r8_);
  // running = ld running
  Rsh_Fir_reg_running = Rsh_Fir_load(Rsh_const(CCP, 9), RHO);
  // check L15() else D8()
  // L15()
  goto L15_;
...
D8_:;
  ...
  Rsh_Fir_array_deopt_stack10[1] = Rsh_Fir_reg_running;
  Rsh_Fir_deopt(33, 2, Rsh_Fir_array_deopt_stack10, CCP, RHO);
  return R_NilValue;
...
L15_:;
  ...
  Rsh_Fir_array_args24[0] = Rsh_Fir_reg_running1_;
...
D9_:;
  ...
  Rsh_Fir_array_deopt_stack11[1] = Rsh_Fir_reg_running1_;
  Rsh_Fir_array_deopt_stack11[2] = Rsh_Fir_reg_step;
  Rsh_Fir_deopt(34, 3, Rsh_Fir_array_deopt_stack11, CCP, RHO);
  return R_NilValue;
...
L16_:;
  ...
  Rsh_Fir_array_args25[0] = Rsh_Fir_reg_step1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args25, Rsh_Fir_param_types_empty()));
  // r9 = `+`(running1, step1)
  SEXP Rsh_Fir_array_args26[2];
  Rsh_Fir_array_args26[0] = Rsh_Fir_reg_running1_;
  Rsh_Fir_array_args26[1] = Rsh_Fir_reg_step1_;
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args26);
  // st running = r9
  Rsh_Fir_store(Rsh_const(CCP, 9), Rsh_Fir_reg_r9_, RHO);
  (void)(Rsh_Fir_reg_r9_);
  // running2 = ld running
  Rsh_Fir_reg_running2_ = Rsh_Fir_load(Rsh_const(CCP, 9), RHO);
  // check L17() else D10()
  // L17()
  goto L17_;
...
D10_:;
  ...
  Rsh_Fir_array_deopt_stack12[1] = Rsh_Fir_reg_running2_;
...
L17_:;
  ...
  Rsh_Fir_array_args27[0] = Rsh_Fir_reg_running3_;
  ...
  Rsh_Fir_reg_c1_ = Rsh_Fir_call_builtin(397, RHO, 1, Rsh_Fir_array_args28);
...
L18_:;
  ...
  Rsh_Fir_array_args29[2] = Rsh_Fir_reg_running3_;
...
L19_:;
  // i13 = ld i
  Rsh_Fir_reg_i13_ = Rsh_Fir_load(Rsh_const(CCP, 14), RHO);
  // check L21() else D11()
  // L21()
  goto L21_;
...
D11_:;
  ...
  Rsh_Fir_array_deopt_stack13[1] = Rsh_Fir_reg_running5_;
  Rsh_Fir_array_deopt_stack13[2] = Rsh_Fir_reg_l3_;
  Rsh_Fir_array_deopt_stack13[3] = Rsh_Fir_reg_running3_;
  Rsh_Fir_array_deopt_stack13[4] = Rsh_Fir_reg_i13_;
  Rsh_Fir_deopt(41, 5, Rsh_Fir_array_deopt_stack13, CCP, RHO);
  return R_NilValue;
...
L21_:;
  ...
  Rsh_Fir_array_args32[1] = Rsh_Fir_reg_running3_;
  Rsh_Fir_array_args32[2] = Rsh_Fir_reg_i14_;
  SEXP Rsh_Fir_array_arg_names3[3];
  Rsh_Fir_array_arg_names3[0] = R_MissingArg;
  Rsh_Fir_array_arg_names3[1] = R_MissingArg;
  Rsh_Fir_array_arg_names3[2] = R_MissingArg;
  Rsh_Fir_reg_r10_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 3, Rsh_Fir_array_args32, Rsh_Fir_array_arg_names3, CCP, RHO);
  // goto L2(i10, r10)
  // L2(i10, r10)
