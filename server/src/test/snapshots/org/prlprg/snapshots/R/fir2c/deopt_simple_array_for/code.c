...
L4_:;
  ...
  Rsh_Fir_reg_r1 = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args5);
  // st m = r
...
L5_:;
  // rep = ldf rep in base
  Rsh_Fir_reg_rep = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 8), RHO);
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_rep, 2, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names1, CCP, RHO);
  // goto L0(r3)
  // L0(r3)
...
L6_:;
  ...
  Rsh_Fir_reg_r1_1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 2, Rsh_Fir_array_args8, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L0(r1)
  // L0(r1)
...
L7_:;
  ...
  Rsh_Fir_reg_l = Rsh_Fir_call_builtin(94, RHO, 1, Rsh_Fir_array_args12);
  // i = 0
...
D3_:;
  ...
  Rsh_Fir_array_deopt_stack4[1] = Rsh_Fir_reg_n4_;
  Rsh_Fir_array_deopt_stack4[2] = Rsh_Fir_reg_i5_;
...
L10_:;
  ...
  Rsh_Fir_array_args14[0] = Rsh_Fir_reg_i6_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args14, Rsh_Fir_param_types_empty()));
  // r5 = `*`(n4, i6)
  SEXP Rsh_Fir_array_args15[2];
  Rsh_Fir_array_args15[0] = Rsh_Fir_reg_n4_;
  Rsh_Fir_array_args15[1] = Rsh_Fir_reg_i6_;
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_builtin(68, RHO, 2, Rsh_Fir_array_args15);
  // l1 = ld x
...
D4_:;
  ...
  Rsh_Fir_array_deopt_stack5[2] = Rsh_Fir_reg_l3_;
  Rsh_Fir_array_deopt_stack5[3] = Rsh_Fir_reg_r5_;
  Rsh_Fir_array_deopt_stack5[4] = Rsh_Fir_reg_i11_;
  Rsh_Fir_deopt(18, 5, Rsh_Fir_array_deopt_stack5, CCP, RHO);
  return R_NilValue;
...
L14_:;
  ...
  Rsh_Fir_reg_r10_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 3, Rsh_Fir_array_args20, Rsh_Fir_array_arg_names3, CCP, RHO);
  // goto L2(i8, r10)
  // L2(i8, r10)
