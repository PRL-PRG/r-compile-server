...
L0_:;
  ...
  // if c1 then L5() else L6(42.0)
  if (Rsh_Fir_is_true(Rsh_Fir_reg_c1_)) {
  // L5()
    goto L5_;
  } else {
  // L6(42.0)
    Rsh_Fir_reg_r4_ = Rsh_const(CCP, 2);
    goto L6_;
  }
...
L6_:;
  ...
  Rsh_Fir_reg_r7_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 3, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L1(r7)
  // L1(r7)
