...
L5_:;
  ...
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_a1_;
...
L6_:;
  ...
  Rsh_Fir_array_args5[1] = Rsh_Fir_reg_a1_;
...
L7_:;
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 2, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names2, RHO);
  // goto L1(r3)
  // L1(r3)
