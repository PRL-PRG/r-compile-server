...
L1_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_list, 2, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, RHO);
  // check L3() else D0()
  // L3()
  goto L3_;
...
L7_:;
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_builtin(17, RHO, 2, Rsh_Fir_array_args7);
  // goto L5(r3)
  // L5(r3)
