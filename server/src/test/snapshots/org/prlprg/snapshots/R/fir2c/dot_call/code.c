...
L2_:;
  // r = dyn base(<lang `:::`(tools, C_nonASCII)>, "\u0158")
...
L3_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 2, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names1, RHO);
  // check L4() else D1()
  // L4()
  goto L4_;
