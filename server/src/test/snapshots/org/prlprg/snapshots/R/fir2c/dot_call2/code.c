...
L2_:;
  // r = dyn base(<lang `:::`(tools, C_check_nonASCII)>, "\u0158", TRUE)
...
L3_:;
  // r2 = dyn ___("tools", "C_check_nonASCII")
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 2, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L4() else D1()
  // L4()
  goto L4_;
...
L4_:;
  ...
  Rsh_Fir_array_vector_values[0] = Rsh_const(CCP, 3);
  Rsh_Fir_array_vector_values[1] = Rsh_const(CCP, 4);
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_builtin(438, RHO, 3, Rsh_Fir_array_args3);
  // goto L0(r3)
  // L0(r3)
