...
L2_:;
  ...
  Rsh_Fir_array_args3[0] = Rsh_const(CCP, 0);
  ...
  Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg_seq, 3, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L3() else D1()
  // L3()
  goto L3_;
...
L3_:;
  ...
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_r;
