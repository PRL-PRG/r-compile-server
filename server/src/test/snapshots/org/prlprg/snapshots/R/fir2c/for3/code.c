...
L3_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c, 3, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L5() else D0()
  // L5()
  goto L5_;

L4_:;
  // r = dyn base(<sym T>, <sym F>, <sym T>)
  ...
  Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 3, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names1, CCP, RHO);
  // goto L0(r)
  // L0(r)
...
D2_:;
  ...
  Rsh_Fir_deopt(11, 3, Rsh_Fir_array_deopt_stack2, CCP, RHO);
  return R_NilValue;
...
L8_:;
  ...
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_s2_;
  Rsh_Fir_array_args10[1] = Rsh_Fir_reg_i6_;
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args10);
  // st s = r3
...
L9_:;
  ...
  Rsh_Fir_array_args11[0] = Rsh_Fir_reg_s4_;
