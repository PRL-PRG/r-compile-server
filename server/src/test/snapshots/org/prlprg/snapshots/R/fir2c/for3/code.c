...
L4_:;
  ...
  Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 3, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names1, RHO);
  // goto L0(r)
  // L0(r)
...
D2_:;
  ...
  Rsh_Fir_deopt(11, 3, Rsh_Fir_array_deopt_stack3, CCP, RHO);
  return R_NilValue;
...
L8_:;
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args11);
  // st s = r3
