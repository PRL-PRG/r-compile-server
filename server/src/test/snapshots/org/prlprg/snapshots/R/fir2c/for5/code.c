...
L4_:;
  // r = dyn base(<lang `+`(0.0, 1.0i)>, <lang `+`(1.0, 2.0i)>)
  ...
  Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 2, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names1, CCP, RHO);
  // goto L0(r)
  // L0(r)
