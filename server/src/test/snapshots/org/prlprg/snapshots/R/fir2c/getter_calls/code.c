...
L1_:;
  ...
  Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg_names, 2, Rsh_Fir_array_args, Rsh_Fir_array_arg_names, RHO);
  // check L2() else D1()
  // L2()
  goto L2_;
...
L4_:;
  ...
  Rsh_Fir_reg_r7_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 3, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names1, RHO);
  // goto L0(r3, l2, r7)
  // L0(r3, l2, r7)
...
L6_:;
  ...
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_names__, 3, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names2, RHO);
  // check L7() else D3()
  // L7()
  goto L7_;
