...
L2_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_builtin(21, RHO, 3, Rsh_Fir_array_args4);
  // goto L0(r4)
  // L0(r4)
...
L6_:;
  ...
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_builtin(21, RHO, 3, Rsh_Fir_array_args8);
  // goto L4(r9)
  // L4(r9)
...
L8_:;
  ...
  Rsh_Fir_reg_r11_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 3, Rsh_Fir_array_args11, Rsh_Fir_array_arg_names, RHO);
  // check L9() else D1()
  // L9()
  goto L9_;
...
L12_:;
  ...
  Rsh_Fir_reg_r18_ = Rsh_Fir_call_builtin(21, RHO, 3, Rsh_Fir_array_args15);
  // goto L10(r14, l8, r18)
  // L10(r14, l8, r18)
...
L14_:;
  ...
  Rsh_Fir_reg_r20_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_____, 4, Rsh_Fir_array_args18, Rsh_Fir_array_arg_names1, RHO);
  // check L15() else D3()
  // L15()
  goto L15_;
