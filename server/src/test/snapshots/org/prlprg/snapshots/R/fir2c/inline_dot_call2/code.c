...
L2_:;
  ...
  Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 4, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, CCP, RHO);
  // goto L0(r)
  // L0(r)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[1] = Rsh_Fir_reg_x;
...
L3_:;
  ...
  Rsh_Fir_array_vector_values[0] = Rsh_Fir_reg_x1_;
  Rsh_Fir_array_vector_values[1] = Rsh_const(CCP, 4);
  Rsh_Fir_array_vector_values[2] = Rsh_const(CCP, 5);
