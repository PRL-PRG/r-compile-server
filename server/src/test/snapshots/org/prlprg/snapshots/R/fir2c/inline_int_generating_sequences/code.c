...
L2_:;
  ...
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_list, 3, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L12() else D3()
  // L12()
  goto L12_;
...
L5_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_builtin(85, RHO, 2, Rsh_Fir_array_args5);
  // sym1 = ldf seq_along
