...
L2_:;
  ...
  Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 9, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, CCP, RHO);
  // goto L0(r)
  // L0(r)
...
L19_:;
  ...
  Rsh_Fir_reg_r11_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_list, 9, Rsh_Fir_array_args28, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L20() else D17()
  // L20()
  goto L20_;
