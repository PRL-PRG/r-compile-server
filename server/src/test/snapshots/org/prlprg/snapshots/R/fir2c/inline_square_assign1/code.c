...
L1_:;
  ...
  // L11(1.0, l)
    Rsh_Fir_reg_r7_ = Rsh_const(CCP, 3);
...
L2_:;
  ...
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_l3_;
...
L7_:;
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c1_, 3, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L9() else D1()
  // L9()
  goto L9_;
...
L8_:;
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 3, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names3, CCP, RHO);
  // goto L1(r3)
  // L1(r3)
...
D2_:;
  ...
  Rsh_Fir_array_deopt_stack2[2] = Rsh_const(CCP, 3);
...
L13_:;
  ...
  Rsh_Fir_reg_r10_ = Rsh_Fir_call_builtin(74, CCP, RHO, 2, Rsh_Fir_array_args12, Rsh_Fir_param_types_empty());
  // ___ = ldf `[<-` in base
  ...
  Rsh_Fir_reg_r11_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 3, Rsh_Fir_array_args13, Rsh_Fir_array_arg_names4, CCP, RHO);
  // goto L2(r11)
  // L2(r11)
...
L16_:;
  ...
  // goto L3(1.0, dx2)
  // L3(1.0, dx2)
  Rsh_Fir_reg_r15_ = Rsh_const(CCP, 3);
...
D3_:;
  ...
  Rsh_Fir_array_deopt_stack3[2] = Rsh_const(CCP, 3);
...
L17_:;
  ...
  Rsh_Fir_reg_r16_ = Rsh_Fir_call_builtin(74, CCP, RHO, 2, Rsh_Fir_array_args18, Rsh_Fir_param_types_empty());
  // ____ = ldf `[[<-` in base
  ...
  Rsh_Fir_reg_r17_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_____, 3, Rsh_Fir_array_args19, Rsh_Fir_array_arg_names5, CCP, RHO);
  // goto L3(r13, r17)
  // L3(r13, r17)
