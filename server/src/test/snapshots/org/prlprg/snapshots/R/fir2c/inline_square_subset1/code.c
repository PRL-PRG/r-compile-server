...
L4_:;
  ...
  // r2 = dyn c(10.0, 20.0, 30.0, 40.0, 50.0)
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c, 5, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names, RHO);
  // check L6() else D0()
  // L6()
  goto L6_;

L5_:;
  // r = dyn base(10.0, 20.0, 30.0, 40.0, 50.0)
  ...
  Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 5, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names1, RHO);
  // goto L0(r)
  // L0(r)
...
L7_:;
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c1_, 5, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names2, RHO);
  // check L9() else D1()
  // L9()
  goto L9_;

L8_:;
  // r3 = dyn base1(1.0, 0.0, 1.0, 0.0, 1.0)
  ...
  Rsh_Fir_array_args5[4] = Rsh_const(CCP, 8);
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 5, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names3, RHO);
  // goto L1(r3)
  // L1(r3)
...
L11_:;
  ...
  Rsh_Fir_array_args8[1] = Rsh_Fir_reg_x1_;
...
L14_:;
  ...
  Rsh_Fir_reg_r7_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 2, Rsh_Fir_array_args13, Rsh_Fir_array_arg_names4, RHO);
  // goto L2()
  // L2()
  goto L2_;
...
L15_:;
  ...
  Rsh_Fir_reg_c3_ = Rsh_Fir_call_builtin(397, RHO, 1, Rsh_Fir_array_args15);
  // if c3 then L16() else L17(x5)
...
L16_:;
  ...
  Rsh_Fir_array_args16[1] = Rsh_Fir_reg_x5_;
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack5[1] = Rsh_Fir_reg_y2_;
...
L19_:;
  ...
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_builtin(74, RHO, 2, Rsh_Fir_array_args20);
  // __1 = ldf `[[` in base
  Rsh_Fir_reg___1_ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 13), RHO);
  // r9 = dyn __1(x7, r8)
  SEXP Rsh_Fir_array_args21[2];
  Rsh_Fir_array_args21[0] = Rsh_Fir_reg_x7_;
  Rsh_Fir_array_args21[1] = Rsh_Fir_reg_r8_;
  SEXP Rsh_Fir_array_arg_names5[2];
  Rsh_Fir_array_arg_names5[0] = R_MissingArg;
  Rsh_Fir_array_arg_names5[1] = R_MissingArg;
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___1_, 2, Rsh_Fir_array_args21, Rsh_Fir_array_arg_names5, RHO);
  // goto L3(r9)
  // L3(r9)
