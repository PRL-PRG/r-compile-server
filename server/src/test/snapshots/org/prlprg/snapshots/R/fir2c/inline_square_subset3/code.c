...
L3_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_data_frame, 2, Rsh_Fir_array_args, Rsh_Fir_array_arg_names, RHO);
  // check L4() else D1()
  // L4()
  goto L4_;
...
L5_:;
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c, 5, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names1, RHO);
  // check L7() else D2()
  // L7()
  goto L7_;

L6_:;
  // r3 = dyn base(0.0, 1.0, 0.0, 1.0, 0.0)
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 5, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names2, RHO);
  // goto L0(r3)
  // L0(r3)
...
L12_:;
  ...
  Rsh_Fir_reg_r7_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 3, Rsh_Fir_array_args11, Rsh_Fir_array_arg_names3, RHO);
  // goto L1()
  // L1()
  goto L1_;
...
L14_:;
  ...
  Rsh_Fir_array_args14[1] = Rsh_Fir_reg_x5_;
...
L17_:;
  ...
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_builtin(74, RHO, 2, Rsh_Fir_array_args18);
  // __1 = ldf `[[` in base
  Rsh_Fir_reg___1_ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 14), RHO);
  // r9 = dyn __1(x5, r8, <missing>)
  ...
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___1_, 3, Rsh_Fir_array_args19, Rsh_Fir_array_arg_names4, RHO);
  // goto L2(r9)
  // L2(r9)
