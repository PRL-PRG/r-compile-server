...
L6_:;
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 3, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names1, RHO);
  // goto L0()
  // L0()
  goto L0_;
...
L10_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___1_, 3, Rsh_Fir_array_args11, Rsh_Fir_array_arg_names2, RHO);
  // goto L1(r4)
  // L1(r4)
