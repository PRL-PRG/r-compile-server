...
L6_:;
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 1, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L1(r3)
  // L1(r3)
...
L7_:;
  ...
  Rsh_Fir_reg_c1_ = Rsh_Fir_call_builtin(386, RHO, 1, Rsh_Fir_array_args6);
  // goto L1(c1)
  // L1(c1)
