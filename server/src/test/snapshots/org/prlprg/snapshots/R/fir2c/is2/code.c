...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[1] = Rsh_Fir_reg_a;
...
L1_:;
  ...
  Rsh_Fir_array_args1[1] = Rsh_Fir_reg_a1_;
  Rsh_Fir_reg_r = Rsh_Fir_call_builtin(85, RHO, 2, Rsh_Fir_array_args1);
  // st x = r
...
L3_:;
  ...
  Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 1, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names, RHO);
  // goto L0(r1)
  // L0(r1)
...
L4_:;
  ...
  Rsh_Fir_reg_c = Rsh_Fir_call_builtin(386, RHO, 1, Rsh_Fir_array_args5);
  // goto L0(c)
  // L0(c)
