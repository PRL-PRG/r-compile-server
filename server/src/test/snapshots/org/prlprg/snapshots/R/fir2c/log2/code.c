...
L3_:;
  // r = dyn base(<lang c(1.0, 10.0, 100.0, NA_LGL)>)
  SEXP Rsh_Fir_array_args2[1];
  Rsh_Fir_array_args2[0] = Rsh_const(CCP, 2);
  SEXP Rsh_Fir_array_arg_names[1];
  Rsh_Fir_array_arg_names[0] = R_MissingArg;
  Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 1, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names, RHO);
  // goto L0(r)
  // L0(r)
...
L1_:;
  // r5 = log(r3, 2.718281828459045)
  SEXP Rsh_Fir_array_args3[2];
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_r3_;
  Rsh_Fir_array_args3[1] = Rsh_const(CCP, 3);
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_builtin(163, RHO, 2, Rsh_Fir_array_args3);
  // goto L0(r5)
  // L0(r5)
...
L4_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c, 4, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names1, RHO);
  // check L6() else D0()
  // L6()
  goto L6_;
...
L5_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 4, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names2, RHO);
  // goto L1(r2)
  // L1(r2)
