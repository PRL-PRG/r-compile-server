...
L0_:;
  // r1 = dyn outer_func()
  Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_outer_func, 0, NULL, NULL, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
L4_:;
  // r2 = dyn inner_func()
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_inner_func, 0, NULL, NULL, RHO);
  // check L5() else D2()
  // L5()
  goto L5_;
