...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(Rsh_Fir_reg_r);
  // outer_func = ldf outer_func
  Rsh_Fir_reg_outer_func = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 0), RHO);
  // check L0() else D0()
  // L0()
  goto L0_;
...
L0_:;
  // r1 = dyn outer_func()
  Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_outer_func, 0, NULL, NULL, CCP, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
SEXP Rsh_Fir_user_version_inner2708337952_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  Rsh_Fir_reg_r1_1 = Rsh_Fir_call_builtin(85, RHO, 2, Rsh_Fir_array_args);
  // s = toForSeq(r1)
  SEXP Rsh_Fir_array_args1[1];
  Rsh_Fir_array_args1[0] = Rsh_Fir_reg_r1_1;
...
L3_:;
  ...
  // inner_func = ldf inner_func
  Rsh_Fir_reg_inner_func = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 1), RHO);
  // check L4() else D1()
  // L4()
  goto L4_;
...
L4_:;
  // r2 = dyn inner_func()
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_inner_func, 0, NULL, NULL, CCP, RHO);
  // check L5() else D2()
  // L5()
  goto L5_;
...
L5_:;
  ...
  Rsh_Fir_array_args8[1] = Rsh_Fir_reg_r2_;
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args8);
  // st x = r3
