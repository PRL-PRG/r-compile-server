...
L6_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_helper, 1, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L7() else D1()
  // L7()
  goto L7_;
...
D1_:;
  ...
  Rsh_Fir_deopt(13, 2, Rsh_Fir_array_deopt_stack1, CCP, RHO);
  return R_NilValue;
...
L12_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args10);
  // st x = r4
