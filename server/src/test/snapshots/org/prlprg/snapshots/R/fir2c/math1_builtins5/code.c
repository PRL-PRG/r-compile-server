...
L3_:;
  ...
  Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 1, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names, CCP, RHO);
  // goto L0(r)
  // L0(r)
...
L1_:;
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_builtin(169, RHO, 1, Rsh_Fir_array_args3);
  // goto L0(r5)
  // L0(r5)
