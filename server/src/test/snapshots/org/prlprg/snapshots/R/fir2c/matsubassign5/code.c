...
L1_:;
  ...
  //   goto L0(r6);
  // L2():
  //   r4 = dyn base1(3.0, 4.0);
  //   goto L0(r4);
  // }
  Rsh_Fir_reg_p1_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_main1, 0, NULL, CCP, RHO);
  // r8 = dyn data_frame[a, b](p, p1)
  ...
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_data_frame, 2, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names4, RHO);
  // check L2() else D1()
  // L2()
  goto L2_;
...
L2_:;
  ...
  // if c2 then L3() else L4(42.0, l)
  if (Rsh_Fir_is_true(Rsh_Fir_reg_c2_)) {
  // L3()
    goto L3_;
  } else {
  // L4(42.0, l)
    Rsh_Fir_reg_r10_ = Rsh_const(CCP, 9);
...
L4_:;
  // ____ = ldf `[[<-` in base
  Rsh_Fir_reg_____ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 11), RHO);
  // r13 = dyn ____(l2, 42.0, 1.0, 2.0)
  ...
  Rsh_Fir_reg_r13_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_____, 4, Rsh_Fir_array_args10, Rsh_Fir_array_arg_names5, RHO);
  // goto L0(r13)
  // L0(r13)
...
L1_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c, 2, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, RHO);
  // goto L0(r2)
  // L0(r2)
...
L2_:;
  ...
  Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 2, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names1, RHO);
  // goto L0(r)
  // L0(r)
...
L1_:;
  ...
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c1_, 2, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names2, RHO);
  // goto L0(r6)
  // L0(r6)
...
L2_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 2, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names3, RHO);
  // goto L0(r4)
  // L0(r4)
