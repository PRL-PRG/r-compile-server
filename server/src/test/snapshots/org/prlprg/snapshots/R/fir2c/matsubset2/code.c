...
L3_:;
  ...
  Rsh_Fir_reg_c2_ = Rsh_Fir_call_builtin(397, RHO, 1, Rsh_Fir_array_args8);
  // if c2 then L4() else L5(x1)
...
L4_:;
  ...
  Rsh_Fir_array_args9[1] = Rsh_Fir_reg_x1_;
...
L5_:;
  ...
  // r9 = dyn __(x3, 1.0, 2.0)
  SEXP Rsh_Fir_array_args11[3];
  Rsh_Fir_array_args11[0] = Rsh_Fir_reg_x3_;
  Rsh_Fir_array_args11[1] = Rsh_const(CCP, 2);
  Rsh_Fir_array_args11[2] = Rsh_const(CCP, 3);
  SEXP Rsh_Fir_array_arg_names5[3];
  Rsh_Fir_array_arg_names5[0] = R_MissingArg;
  Rsh_Fir_array_arg_names5[1] = R_MissingArg;
  Rsh_Fir_array_arg_names5[2] = R_MissingArg;
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 3, Rsh_Fir_array_args11, Rsh_Fir_array_arg_names5, RHO);
  // goto L0(r9)
  // L0(r9)
