...
SEXP Rsh_Fir_user_function_from_R_inner2148457334_(SEXP CCP, SEXP RHO, SEXP PARAMS_LIST);
...
SEXP Rsh_Fir_user_function_from_R_inner177517877_(SEXP CCP, SEXP RHO, SEXP PARAMS_LIST);
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(Rsh_Fir_reg_r);
  // f = ldf f
  Rsh_Fir_reg_f = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 2), RHO);
  // check L0() else D0()
  // L0()
  goto L0_;
...
L1_:;
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_r2_, 1, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names1, RHO);
  // check L2() else D2()
  // L2()
  goto L2_;
...
SEXP Rsh_Fir_user_function_from_R_inner2148457334_(SEXP CCP, SEXP RHO, SEXP PARAMS_LIST) {
  // FIR inner2148457334 dynamic dispatch from R ([z])
  if (TYPEOF(PARAMS_LIST) != VECSXP) { Rf_PrintValue(PARAMS_LIST); Rsh_error("FIŘ expected a list for params"); }
  int NPARAMS = Rf_length(PARAMS_LIST);
  SEXP const *PARAMS = STDVEC_DATAPTR(PARAMS_LIST);
  return Rsh_Fir_user_function_inner2148457334_(CCP, RHO, NPARAMS, PARAMS, NULL);
}
SEXP Rsh_Fir_user_function_inner2148457334_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_inner2148457334_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  // r = clos inner177517877
  Rsh_Fir_reg_r1 = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner177517877_, RHO, CCP);
  // st g = r
  Rsh_Fir_store(Rsh_const(CCP, 8), Rsh_Fir_reg_r1, RHO);
  (void)(Rsh_Fir_reg_r1);
  // g = ldf g
  Rsh_Fir_reg_g = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 8), RHO);
  // check L0() else D0()
  // L0()
  goto L0_;
...
L0_:;
  ...
  Rsh_Fir_reg_r1_1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_g, 1, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names2, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
SEXP Rsh_Fir_user_function_from_R_inner177517877_(SEXP CCP, SEXP RHO, SEXP PARAMS_LIST) {
  // FIR inner177517877 dynamic dispatch from R ([y])
  if (TYPEOF(PARAMS_LIST) != VECSXP) { Rf_PrintValue(PARAMS_LIST); Rsh_error("FIŘ expected a list for params"); }
  int NPARAMS = Rf_length(PARAMS_LIST);
  SEXP const *PARAMS = STDVEC_DATAPTR(PARAMS_LIST);
  return Rsh_Fir_user_function_inner177517877_(CCP, RHO, NPARAMS, PARAMS, NULL);
}
SEXP Rsh_Fir_user_function_inner177517877_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_inner177517877_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(Rsh_Fir_reg_r2);
  // h = ld h
  Rsh_Fir_reg_h = Rsh_Fir_load(Rsh_const(CCP, 13), RHO);
  // check L0() else D0()
  // L0()
  goto L0_;
...
L0_:;
  ...
  // c = ld c
  Rsh_Fir_reg_c = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
L1_:;
  ...
  Rsh_Fir_reg_r3 = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args7);
  // e = ld e
  Rsh_Fir_reg_e = Rsh_Fir_load(Rsh_const(CCP, 12), RHO);
  // check L2() else D2()
  // L2()
  goto L2_;
...
L2_:;
  ...
  Rsh_Fir_reg_r1_2 = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args9);
  // x1 = ld x
...
L3_:;
  ...
  Rsh_Fir_reg_r2_1 = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args11);
  // y = ld y
  Rsh_Fir_reg_y1 = Rsh_Fir_load(Rsh_const(CCP, 10), RHO);
  // check L4() else D4()
  // L4()
  goto L4_;
...
L4_:;
  ...
  Rsh_Fir_reg_r3_1 = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args13);
  // z = ld z
  Rsh_Fir_reg_z1 = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // check L5() else D5()
  // L5()
  goto L5_;
...
L5_:;
  // z1 = force? z
  Rsh_Fir_reg_z1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_z1);
  // checkMissing(z1)
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args15);
  // popenv
  Rsh_Fir_pop_env(&RHO);
  (void)(R_NilValue);
  // return r4
