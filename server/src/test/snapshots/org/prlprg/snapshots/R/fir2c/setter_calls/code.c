...
L5_:;
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c1_, 3, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names2, RHO);
  // check L7() else D1()
  // L7()
  goto L7_;
...
L6_:;
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 3, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names3, RHO);
  // goto L1(r3)
  // L1(r3)
...
L8_:;
  ...
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_names__, 3, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names4, RHO);
  // check L9() else D3()
  // L9()
  goto L9_;
