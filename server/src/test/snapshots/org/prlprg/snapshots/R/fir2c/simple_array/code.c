...
L4_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_rep, 2, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names, CCP, RHO);
  // goto L0(r2)
  // L0(r2)
...
L5_:;
  ...
  Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 2, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names1, CCP, RHO);
  // goto L0(r)
  // L0(r)
...
L1_:;
  ...
  Rsh_Fir_reg_c = Rsh_Fir_builtin_lt_v1(CCP, RHO, 2, Rsh_Fir_array_args7);
...
L3_:;
  ...
  Rsh_Fir_reg_x = Rsh_Fir_call_builtin(16, RHO, 4, Rsh_Fir_array_args8);
  // st i = x
...
L8_:;
  ...
  Rsh_Fir_array_args13[1] = Rsh_Fir_reg_l1_;
  Rsh_Fir_array_args13[2] = Rsh_Fir_reg_r4_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack2[2] = Rsh_Fir_reg_l3_;
  Rsh_Fir_array_deopt_stack2[3] = Rsh_Fir_reg_r4_;
  Rsh_Fir_array_deopt_stack2[4] = Rsh_Fir_reg_i11_;
  Rsh_Fir_deopt(13, 5, Rsh_Fir_array_deopt_stack2, CCP, RHO);
  return R_NilValue;
...
L11_:;
  ...
  Rsh_Fir_array_args16[2] = Rsh_Fir_reg_i12_;
  SEXP Rsh_Fir_array_arg_names2[3];
  Rsh_Fir_array_arg_names2[0] = R_MissingArg;
  Rsh_Fir_array_arg_names2[1] = R_MissingArg;
  Rsh_Fir_array_arg_names2[2] = R_MissingArg;
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 3, Rsh_Fir_array_args16, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L2(i8, r9)
  // L2(i8, r9)
