...
L4_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_rep, 2, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names, RHO);
  // goto L0(r2)
  // L0(r2)
...
L5_:;
  ...
  Rsh_Fir_reg_r = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 2, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names1, RHO);
  // goto L0(r)
  // L0(r)
...
L11_:;
  ...
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg____, 3, Rsh_Fir_array_args16, Rsh_Fir_array_arg_names2, RHO);
  // goto L2(i8, r9)
  // L2(i8, r9)
