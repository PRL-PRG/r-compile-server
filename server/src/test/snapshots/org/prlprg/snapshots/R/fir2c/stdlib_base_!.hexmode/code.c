...
L0_:;
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_as_hexmode, 1, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names3, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
SEXP Rsh_Fir_user_promise_inner119611165_1(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_reg_r1_1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_as_hexmode1_, 1, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names1, RHO);
  // return r1
