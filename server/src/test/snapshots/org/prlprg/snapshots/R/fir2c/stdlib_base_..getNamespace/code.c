...
SEXP Rsh_Fir_user_function_from_R_inner896732164_(SEXP CCP, SEXP RHO, SEXP PARAMS_LIST);
...
SEXP Rsh_Fir_user_function_from_R_inner896732164_(SEXP CCP, SEXP RHO, SEXP PARAMS_LIST) {
  // FIR inner896732164 dynamic dispatch from R ([name, where])
  if (TYPEOF(PARAMS_LIST) != VECSXP) { Rf_PrintValue(PARAMS_LIST); Rsh_error("FIŘ expected a list for params"); }
  int NPARAMS = Rf_length(PARAMS_LIST);
  SEXP const *PARAMS = STDVEC_DATAPTR(PARAMS_LIST);
  return Rsh_Fir_user_function_inner896732164_(CCP, RHO, NPARAMS, PARAMS, NULL);
}
SEXP Rsh_Fir_user_function_inner896732164_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
L0_:;
  ...
  Rsh_Fir_reg_r11_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_____, 2, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names4, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
L1_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_getRegisteredNamespace, 1, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names, RHO);
  // goto L0(r2)
  // L0(r2)
...
SEXP Rsh_Fir_user_promise_inner896732164_1(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_tryCatch, 2, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names3, RHO);
  // return r9
...
SEXP Rsh_Fir_user_promise_inner896732164_2(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_loadNamespace, 1, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names2, RHO);
  // return r5
...
L8_:;
  ...
  Rsh_Fir_reg_r2 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_Sys_getenv, 1, Rsh_Fir_array_args8, Rsh_Fir_array_arg_names5, RHO);
  // check L9() else D1()
  // L9()
  goto L9_;
...
L9_:;
  ...
  (void)(Rsh_Fir_reg_r2);
  // tr = ld tr
  Rsh_Fir_reg_tr = Rsh_Fir_load(Rsh_const(CCP, 13), RHO);
  // check L10() else D2()
  // L10()
  goto L10_;
...
L10_:;
  ...
  Rsh_Fir_array_args9[0] = Rsh_Fir_reg_tr1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args9, Rsh_Fir_param_types_empty()));
  // r1 = `==`(tr1, "false")
  SEXP Rsh_Fir_array_args10[2];
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_tr1_;
  Rsh_Fir_array_args10[1] = Rsh_const(CCP, 14);
  Rsh_Fir_reg_r1_1 = Rsh_Fir_call_builtin(74, RHO, 2, Rsh_Fir_array_args10);
  // c = `as.logical`(r1)
...
L0_:;
  ...
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_c1_;
...
L7_:;
  ...
  Rsh_Fir_reg__GlobalEnv = Rsh_Fir_load(Rsh_const(CCP, 15), RHO);
  // check L33() else D13()
  // L33()
  goto L33_;
...
L12_:;
  ...
  Rsh_Fir_array_args13[0] = Rsh_Fir_reg_where1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args13, Rsh_Fir_param_types_empty()));
  // r2 = `!=`(where1, "<unknown>")
  SEXP Rsh_Fir_array_args14[2];
  Rsh_Fir_array_args14[0] = Rsh_Fir_reg_where1_;
  Rsh_Fir_array_args14[1] = Rsh_const(CCP, 16);
  Rsh_Fir_reg_r2_1 = Rsh_Fir_call_builtin(75, RHO, 2, Rsh_Fir_array_args14);
  // c3 = `as.logical`(r2)
  SEXP Rsh_Fir_array_args15[1];
  Rsh_Fir_array_args15[0] = Rsh_Fir_reg_r2_1;
...
D13_:;
  ...
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg__GlobalEnv;
...
L1_:;
  ...
  Rsh_Fir_array_args16[0] = Rsh_Fir_reg_c7_;
  ...
  Rsh_Fir_reg_c19_ = Rsh_Fir_call_builtin(84, RHO, 2, Rsh_Fir_array_args17);
  // goto L0(c19)
  // L0(c19)
...
L21_:;
  ...
  Rsh_Fir_array_args29[0] = Rsh_Fir_reg_p4_1;
  ...
  Rsh_Fir_array_arg_names10[2] = Rsh_const(CCP, 29);
  Rsh_Fir_array_arg_names10[3] = Rsh_const(CCP, 30);
  Rsh_Fir_reg_r18_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_warning, 4, Rsh_Fir_array_args29, Rsh_Fir_array_arg_names10, RHO);
  // check L22() else D7()
  // L22()
  goto L22_;
...
L2_:;
  ...
  Rsh_Fir_array_args31[0] = Rsh_Fir_reg_r4_;
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_builtin(82, RHO, 1, Rsh_Fir_array_args31);
  // c14 = `as.logical`(r6)
  SEXP Rsh_Fir_array_args32[1];
  Rsh_Fir_array_args32[0] = Rsh_Fir_reg_r6_;
  Rsh_Fir_reg_c14_ = Rsh_Fir_call_builtin(324, RHO, 1, Rsh_Fir_array_args32);
  // c15 = `&&`(c13, c14)
  SEXP Rsh_Fir_array_args33[2];
  Rsh_Fir_array_args33[0] = Rsh_Fir_reg_c13_;
  Rsh_Fir_array_args33[1] = Rsh_Fir_reg_c14_;
  Rsh_Fir_reg_c15_ = Rsh_Fir_call_builtin(83, RHO, 2, Rsh_Fir_array_args33);
  // goto L1(c12, c15)
  // L1(c12, c15)
...
L14_:;
  // tr2 = ld tr
  Rsh_Fir_reg_tr2_ = Rsh_Fir_load(Rsh_const(CCP, 13), RHO);
  // check L16() else D4()
  // L16()
  goto L16_;
...
L15_:;
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1, 1, Rsh_Fir_array_args34, Rsh_Fir_array_arg_names11, RHO);
  // goto L2(c, c3, r3)
  // L2(c, c3, r3)
...
D4_:;
  ...
  Rsh_Fir_array_deopt_stack6[2] = Rsh_Fir_reg_tr2_;
  Rsh_Fir_deopt(15, 3, Rsh_Fir_array_deopt_stack6, CCP, RHO);
  return R_NilValue;
...
L16_:;
  ...
  Rsh_Fir_array_args37[0] = Rsh_Fir_reg_tr3_;
  ...
  Rsh_Fir_array_args38[0] = Rsh_Fir_reg_tr3_;
  SEXP Rsh_Fir_array_arg_names12[1];
  Rsh_Fir_array_arg_names12[0] = R_MissingArg;
  Rsh_Fir_reg_r5_1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_nzchar, 1, Rsh_Fir_array_args38, Rsh_Fir_array_arg_names12, RHO);
  // check L17() else D5()
  // L17()
  goto L17_;
...
L24_:;
  ...
  Rsh_Fir_reg_r19_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 1, Rsh_Fir_array_args39, Rsh_Fir_array_arg_names13, RHO);
  // goto L4(r19)
  // L4(r19)
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack7[2] = Rsh_Fir_reg_r5_1;
...
L5_:;
  // goto L6(NULL)
  // L6(NULL)
  Rsh_Fir_reg_r26_ = Rsh_const(CCP, 32);
  goto L6_;
...
L25_:;
  ...
  Rsh_Fir_reg_r21_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_Sys_getenv1_, 1, Rsh_Fir_array_args40, Rsh_Fir_array_arg_names14, RHO);
  // check L26() else D9()
  // L26()
  goto L26_;
...
L26_:;
  ...
  Rsh_Fir_reg_r22_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_nzchar1_, 1, Rsh_Fir_array_args41, Rsh_Fir_array_arg_names15, RHO);
  // check L27() else D10()
  // L27()
  goto L27_;
...
L29_:;
  ...
  Rsh_Fir_reg_r25_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_print, 1, Rsh_Fir_array_args42, Rsh_Fir_array_arg_names16, RHO);
  // check L30() else D12()
  // L30()
  goto L30_;
...
SEXP Rsh_Fir_user_promise_inner3708401697_(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_array_args28[1] = Rsh_Fir_reg_p1_1;
  Rsh_Fir_array_args28[2] = Rsh_Fir_reg_p3_1;
  SEXP Rsh_Fir_array_arg_names9[3];
  Rsh_Fir_array_arg_names9[0] = R_MissingArg;
  Rsh_Fir_array_arg_names9[1] = R_MissingArg;
  Rsh_Fir_array_arg_names9[2] = R_MissingArg;
  Rsh_Fir_reg_r16_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_gettextf, 3, Rsh_Fir_array_args28, Rsh_Fir_array_arg_names9, RHO);
  // return r16
...
SEXP Rsh_Fir_user_promise_inner3708401697_1(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_sQuote, 1, Rsh_Fir_array_args20, Rsh_Fir_array_arg_names6, RHO);
  // c22 = `is.object`(r8)
  SEXP Rsh_Fir_array_args21[1];
  Rsh_Fir_array_args21[0] = Rsh_Fir_reg_r8_;
  Rsh_Fir_reg_c22_ = Rsh_Fir_call_builtin(397, RHO, 1, Rsh_Fir_array_args21);
  // if c22 then L1() else L2(r8)
...
L1_:;
  ...
  Rsh_Fir_array_args22[1] = Rsh_Fir_reg_r8_;
...
L2_:;
  ...
  Rsh_Fir_reg_r11_1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 2, Rsh_Fir_array_args24, Rsh_Fir_array_arg_names7, RHO);
  // goto L0(r11)
  // L0(r11)
...
SEXP Rsh_Fir_user_promise_inner3708401697_2(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_array_args19[0] = Rsh_Fir_reg_name1_1;
...
SEXP Rsh_Fir_user_promise_inner3708401697_3(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  // sQuote1 = ldf sQuote
  Rsh_Fir_reg_sQuote1_ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 20), RHO);
  // p2 = prom<V +>{
  //   where2 = ld where;
  //   where3 = force? where2;
  //   checkMissing(where3);
  ...
  Rsh_Fir_reg_r14_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_sQuote1_, 1, Rsh_Fir_array_args27, Rsh_Fir_array_arg_names8, RHO);
  // return r14
...
SEXP Rsh_Fir_user_promise_inner3708401697_4(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_array_args26[0] = Rsh_Fir_reg_where3_;
...
SEXP Rsh_Fir_user_promise_inner3708401697_5(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  // r23 = dyn sys_calls()
  Rsh_Fir_reg_r23_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_sys_calls, 0, NULL, NULL, RHO);
  // return r23
