...
L5_:;
  ...
  Rsh_Fir_reg_r1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_getOption, 1, Rsh_Fir_array_args, Rsh_Fir_array_arg_names, RHO);
  // check L6() else D1()
  // L6()
  goto L6_;
...
L8_:;
  // require = ldf require
  Rsh_Fir_reg_require = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 8), RHO);
  // check L10() else D2()
  // L10()
  goto L10_;
...
L9_:;
  ...
  Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 4, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names1, RHO);
  // goto L1(i2, r1)
  // L1(i2, r1)
...
D4_:;
  ...
  Rsh_Fir_array_deopt_stack2[1] = Rsh_Fir_reg_res;
...
L10_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_require, 4, Rsh_Fir_array_args9, Rsh_Fir_array_arg_names2, RHO);
  // check L11() else D3()
  // L11()
  goto L11_;
...
L14_:;
  ...
  Rsh_Fir_reg_r11_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_warning, 3, Rsh_Fir_array_args16, Rsh_Fir_array_arg_names5, RHO);
  // check L15() else D6()
  // L15()
  goto L15_;
...
SEXP Rsh_Fir_user_promise_inner2708337952_(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  // pkg = ld pkg
  Rsh_Fir_reg_pkg = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // pkg1 = force? pkg
...
SEXP Rsh_Fir_user_promise_inner2708337952_1(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_gettextf, 2, Rsh_Fir_array_args15, Rsh_Fir_array_arg_names4, RHO);
  // return r9
...
SEXP Rsh_Fir_user_promise_inner2708337952_2(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_reg_r7_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_sQuote, 1, Rsh_Fir_array_args14, Rsh_Fir_array_arg_names3, RHO);
  // return r7
...
SEXP Rsh_Fir_user_promise_inner2708337952_3(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  // pkg2 = ld pkg
  Rsh_Fir_reg_pkg2_ = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // pkg3 = force? pkg2
