...
SEXP Rsh_Fir_user_function_from_R_inner1868478793_(SEXP CCP, SEXP RHO, SEXP PARAMS_LIST);
...
SEXP Rsh_Fir_user_function_from_R_inner1868478793_(SEXP CCP, SEXP RHO, SEXP PARAMS_LIST) {
  // FIR inner1868478793 dynamic dispatch from R ([arg, error])
  if (TYPEOF(PARAMS_LIST) != VECSXP) { Rf_PrintValue(PARAMS_LIST); Rsh_error("FIŘ expected a list for params"); }
  int NPARAMS = Rf_length(PARAMS_LIST);
  SEXP const *PARAMS = STDVEC_DATAPTR(PARAMS_LIST);
  return Rsh_Fir_user_function_inner1868478793_(CCP, RHO, NPARAMS, PARAMS, NULL);
}
SEXP Rsh_Fir_user_function_inner1868478793_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
L2_:;
  ...
  Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_gettextf, 2, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names, RHO);
  // check L3() else D1()
  // L3()
  goto L3_;
...
L6_:;
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_stop, 3, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names1, RHO);
  // check L7() else D4()
  // L7()
  goto L7_;
...
L9_:;
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_warning, 3, Rsh_Fir_array_args8, Rsh_Fir_array_arg_names2, RHO);
  // check L10() else D6()
  // L10()
  goto L10_;
