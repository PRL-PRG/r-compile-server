...
L3_:;
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__in_, 2, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names1, RHO);
  // check L4() else D1()
  // L4()
  goto L4_;
...
L7_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 4, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names2, RHO);
  // goto L1(r4)
  // L1(r4)
...
L8_:;
  ...
  Rsh_Fir_reg_r7_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_require, 4, Rsh_Fir_array_args9, Rsh_Fir_array_arg_names3, RHO);
  // check L9() else D3()
  // L9()
  goto L9_;
...
L11_:;
  ...
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_warning, 2, Rsh_Fir_array_args10, Rsh_Fir_array_arg_names4, RHO);
  // check L12() else D5()
  // L12()
  goto L12_;
...
SEXP Rsh_Fir_user_promise_inner2708337952_(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_array_args[0] = Rsh_Fir_reg_pkg1_;
...
SEXP Rsh_Fir_user_promise_inner2708337952_1(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_getOption, 1, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, RHO);
  // return r1
