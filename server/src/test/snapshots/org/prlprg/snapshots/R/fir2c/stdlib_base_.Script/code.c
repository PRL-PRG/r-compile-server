...
SEXP Rsh_Fir_user_function_from_R_inner3971500816_(SEXP CCP, SEXP RHO, SEXP PARAMS_LIST);
...
SEXP Rsh_Fir_user_function_from_R_inner3971500816_(SEXP CCP, SEXP RHO, SEXP PARAMS_LIST) {
  // FIR inner3971500816 dynamic dispatch from R ([interpreter, script, args, `...`])
  if (TYPEOF(PARAMS_LIST) != VECSXP) { Rf_PrintValue(PARAMS_LIST); Rsh_error("FIŘ expected a list for params"); }
  int NPARAMS = Rf_length(PARAMS_LIST);
  SEXP const *PARAMS = STDVEC_DATAPTR(PARAMS_LIST);
  return Rsh_Fir_user_function_inner3971500816_(CCP, RHO, NPARAMS, PARAMS, NULL);
}
SEXP Rsh_Fir_user_function_inner3971500816_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
L0_:;
  // system1 = ldf system
  Rsh_Fir_reg_system1_ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 9), RHO);
  // check L12() else D5()
  // L12()
  goto L12_;
...
L7_:;
  ...
  Rsh_Fir_reg_r13_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_paste, 3, Rsh_Fir_array_args15, Rsh_Fir_array_arg_names4, RHO);
  // check L8() else D2()
  // L8()
  goto L8_;
...
L12_:;
  ...
  //   return r32;
  // }
  Rsh_Fir_reg_p18_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3971500816_7, 0, NULL, CCP, RHO);
  // ddd1 = ld `...`
  Rsh_Fir_reg_ddd1_ = Rsh_Fir_load(Rsh_const(CCP, 4), RHO);
  // r34 = dyn system1[, `...`](p18, ddd1)
  SEXP Rsh_Fir_array_args27[2];
  Rsh_Fir_array_args27[0] = Rsh_Fir_reg_p18_;
  Rsh_Fir_array_args27[1] = Rsh_Fir_reg_ddd1_;
  SEXP Rsh_Fir_array_arg_names12[2];
  Rsh_Fir_array_arg_names12[0] = R_MissingArg;
  Rsh_Fir_array_arg_names12[1] = Rsh_const(CCP, 4);
  Rsh_Fir_reg_r34_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_system1_, 2, Rsh_Fir_array_args27, Rsh_Fir_array_arg_names12, RHO);
  // check L13() else D6()
  // L13()
  goto L13_;
...
D6_:;
  ...
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_r34_;
...
L8_:;
  ...
  // system = ldf system
  Rsh_Fir_reg_system = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 9), RHO);
  // check L9() else D3()
  // L9()
  goto L9_;
...
L9_:;
  ...
  //   return cmd1;
  // }
  Rsh_Fir_reg_p7_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3971500816_18, 0, NULL, CCP, RHO);
  ...
  Rsh_Fir_reg_r15_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_system, 2, Rsh_Fir_array_args29, Rsh_Fir_array_arg_names13, RHO);
  // check L10() else D4()
  // L10()
  goto L10_;
...
SEXP Rsh_Fir_user_promise_inner3971500816_(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_shQuote, 1, Rsh_Fir_array_args10, Rsh_Fir_array_arg_names2, RHO);
  // return r6
...
SEXP Rsh_Fir_user_promise_inner3971500816_1(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_file_path, 2, Rsh_Fir_array_args9, Rsh_Fir_array_arg_names1, RHO);
  // return r4
...
SEXP Rsh_Fir_user_promise_inner3971500816_2(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_R_home, 1, Rsh_Fir_array_args8, Rsh_Fir_array_arg_names, RHO);
  // return r2
...
SEXP Rsh_Fir_user_promise_inner3971500816_3(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_reg_r10_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_file_path1_, 4, Rsh_Fir_array_args13, Rsh_Fir_array_arg_names3, RHO);
  // return r10
...
SEXP Rsh_Fir_user_promise_inner3971500816_7(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  //   return r20;
  // }
  Rsh_Fir_reg_p10_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3971500816_8, 0, NULL, CCP, RHO);
  // p11 = prom<V +>{
  //   interpreter3 = ld interpreter;
  //   interpreter4 = force? interpreter3;
  //   checkMissing(interpreter4);
  //   return interpreter4;
  // }
  Rsh_Fir_reg_p11_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3971500816_11, 0, NULL, CCP, RHO);
  // p16 = prom<V +>{
  //   shQuote2 = ldf shQuote;
  //   p15 = prom<V +>{
  //     file_path3 = ldf `file.path`;
  ...
  //   return r29;
  // }
  Rsh_Fir_reg_p16_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3971500816_12, 0, NULL, CCP, RHO);
  // p17 = prom<V +>{
  //   args3 = ld args;
  //   args4 = force? args3;
  //   checkMissing(args4);
  //   return args4;
  // }
  Rsh_Fir_reg_p17_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3971500816_17, 0, NULL, CCP, RHO);
  // r32 = dyn paste1(p10, p11, p16, p17)
  SEXP Rsh_Fir_array_args26[4];
  Rsh_Fir_array_args26[0] = Rsh_Fir_reg_p10_;
  Rsh_Fir_array_args26[1] = Rsh_Fir_reg_p11_;
  Rsh_Fir_array_args26[2] = Rsh_Fir_reg_p16_;
  Rsh_Fir_array_args26[3] = Rsh_Fir_reg_p17_;
  SEXP Rsh_Fir_array_arg_names11[4];
  Rsh_Fir_array_arg_names11[0] = R_MissingArg;
  Rsh_Fir_array_arg_names11[1] = R_MissingArg;
  Rsh_Fir_array_arg_names11[2] = R_MissingArg;
  Rsh_Fir_array_arg_names11[3] = R_MissingArg;
  Rsh_Fir_reg_r32_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_paste1_, 4, Rsh_Fir_array_args26, Rsh_Fir_array_arg_names11, RHO);
  // return r32
...
SEXP Rsh_Fir_user_promise_inner3971500816_8(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  //   return r18;
  // }
  Rsh_Fir_reg_p9_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3971500816_9, 0, NULL, CCP, RHO);
  // r20 = dyn shQuote1(p9)
  SEXP Rsh_Fir_array_args18[1];
  Rsh_Fir_array_args18[0] = Rsh_Fir_reg_p9_;
  SEXP Rsh_Fir_array_arg_names7[1];
  Rsh_Fir_array_arg_names7[0] = R_MissingArg;
  Rsh_Fir_reg_r20_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_shQuote1_, 1, Rsh_Fir_array_args18, Rsh_Fir_array_arg_names7, RHO);
  // return r20
...
SEXP Rsh_Fir_user_promise_inner3971500816_9(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  //   return r16;
  // }
  Rsh_Fir_reg_p8_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3971500816_10, 0, NULL, CCP, RHO);
  // r18 = dyn file_path2(p8, "Rcmd")
  ...
  Rsh_Fir_reg_r18_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_file_path2_, 2, Rsh_Fir_array_args17, Rsh_Fir_array_arg_names6, RHO);
  // return r18
...
SEXP Rsh_Fir_user_promise_inner3971500816_10(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_reg_r16_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_R_home1_, 1, Rsh_Fir_array_args16, Rsh_Fir_array_arg_names5, RHO);
  // return r16
...
SEXP Rsh_Fir_user_promise_inner3971500816_11(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_array_args19[0] = Rsh_Fir_reg_interpreter4_;
...
SEXP Rsh_Fir_user_promise_inner3971500816_12(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  //   return r27;
  // }
  Rsh_Fir_reg_p15_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3971500816_13, 0, NULL, CCP, RHO);
  // r29 = dyn shQuote2(p15)
  SEXP Rsh_Fir_array_args24[1];
  Rsh_Fir_array_args24[0] = Rsh_Fir_reg_p15_;
  SEXP Rsh_Fir_array_arg_names10[1];
  Rsh_Fir_array_arg_names10[0] = R_MissingArg;
  Rsh_Fir_reg_r29_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_shQuote2_, 1, Rsh_Fir_array_args24, Rsh_Fir_array_arg_names10, RHO);
  // return r29
...
SEXP Rsh_Fir_user_promise_inner3971500816_13(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  //   return r23;
  // }
  Rsh_Fir_reg_p12_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3971500816_14, 0, NULL, CCP, RHO);
  // p13 = prom<V +>{
  //   interpreter5 = ld interpreter;
  //   interpreter6 = force? interpreter5;
  //   checkMissing(interpreter6);
  //   return interpreter6;
  // }
  Rsh_Fir_reg_p13_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3971500816_15, 0, NULL, CCP, RHO);
  // p14 = prom<V +>{
  //   script3 = ld script;
  //   script4 = force? script3;
  //   checkMissing(script4);
  //   return script4;
  // }
  Rsh_Fir_reg_p14_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3971500816_16, 0, NULL, CCP, RHO);
  // r27 = dyn file_path3(p12, p13, p14)
  SEXP Rsh_Fir_array_args23[3];
  Rsh_Fir_array_args23[0] = Rsh_Fir_reg_p12_;
  Rsh_Fir_array_args23[1] = Rsh_Fir_reg_p13_;
  Rsh_Fir_array_args23[2] = Rsh_Fir_reg_p14_;
  SEXP Rsh_Fir_array_arg_names9[3];
  Rsh_Fir_array_arg_names9[0] = R_MissingArg;
  Rsh_Fir_array_arg_names9[1] = R_MissingArg;
  Rsh_Fir_array_arg_names9[2] = R_MissingArg;
  Rsh_Fir_reg_r27_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_file_path3_, 3, Rsh_Fir_array_args23, Rsh_Fir_array_arg_names9, RHO);
  // return r27
...
SEXP Rsh_Fir_user_promise_inner3971500816_14(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_reg_r23_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_R_home2_, 1, Rsh_Fir_array_args20, Rsh_Fir_array_arg_names8, RHO);
  // return r23
...
SEXP Rsh_Fir_user_promise_inner3971500816_15(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_array_args21[0] = Rsh_Fir_reg_interpreter6_;
...
SEXP Rsh_Fir_user_promise_inner3971500816_16(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_array_args22[0] = Rsh_Fir_reg_script4_;
...
SEXP Rsh_Fir_user_promise_inner3971500816_17(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_array_args25[0] = Rsh_Fir_reg_args4_;
...
SEXP Rsh_Fir_user_promise_inner3971500816_18(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_array_args28[0] = Rsh_Fir_reg_cmd1_;
