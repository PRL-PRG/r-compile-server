...
SEXP Rsh_Fir_user_function_from_R_inner1385503804_(SEXP CCP, SEXP RHO, SEXP PARAMS_LIST);
...
SEXP Rsh_Fir_user_function_from_R_inner1385503804_(SEXP CCP, SEXP RHO, SEXP PARAMS_LIST) {
  // FIR inner1385503804 dynamic dispatch from R ([`...`, `deparse.level`])
  if (TYPEOF(PARAMS_LIST) != VECSXP) { Rf_PrintValue(PARAMS_LIST); Rsh_error("FIŘ expected a list for params"); }
  int NPARAMS = Rf_length(PARAMS_LIST);
  SEXP const *PARAMS = STDVEC_DATAPTR(PARAMS_LIST);
  return Rsh_Fir_user_function_inner1385503804_(CCP, RHO, NPARAMS, PARAMS, NULL);
}
SEXP Rsh_Fir_user_function_inner1385503804_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_inner1385503804_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_deparse_level;
  SEXP Rsh_Fir_reg_deparse_level_isMissing;
  SEXP Rsh_Fir_reg_deparse_level_orDefault;
  SEXP Rsh_Fir_reg__Defunct;
  SEXP Rsh_Fir_reg_r1;
...
L1_:;
  // r = dyn _Defunct("base::cbind")
  SEXP Rsh_Fir_array_args1[1];
  Rsh_Fir_array_args1[0] = Rsh_const(CCP, 5);
  SEXP Rsh_Fir_array_arg_names[1];
  Rsh_Fir_array_arg_names[0] = R_MissingArg;
  Rsh_Fir_reg_r1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg__Defunct, 1, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, RHO);
  // check L2() else D1()
  // L2()
  goto L2_;
