...
SEXP Rsh_Fir_user_function_from_R_inner417981748_(SEXP CCP, SEXP RHO, SEXP PARAMS_LIST);
...
SEXP Rsh_Fir_user_function_from_R_inner417981748_(SEXP CCP, SEXP RHO, SEXP PARAMS_LIST) {
  // FIR inner417981748 dynamic dispatch from R ([expr, msg])
  if (TYPEOF(PARAMS_LIST) != VECSXP) { Rf_PrintValue(PARAMS_LIST); Rsh_error("FIŘ expected a list for params"); }
  int NPARAMS = Rf_length(PARAMS_LIST);
  SEXP const *PARAMS = STDVEC_DATAPTR(PARAMS_LIST);
  return Rsh_Fir_user_function_inner417981748_(CCP, RHO, NPARAMS, PARAMS, NULL);
}
SEXP Rsh_Fir_user_function_inner417981748_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
L10_:;
  ...
  Rsh_Fir_reg_r1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_tracingState, 1, Rsh_Fir_array_args, Rsh_Fir_array_arg_names, RHO);
  // check L11() else D1()
  // L11()
  goto L11_;
...
L11_:;
  ...
  (void)(Rsh_Fir_reg_r1);
  // on = ld on
  Rsh_Fir_reg_on = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // check L12() else D2()
  // L12()
  goto L12_;
...
L12_:;
  ...
  Rsh_Fir_array_args1[0] = Rsh_Fir_reg_on1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args1, Rsh_Fir_param_types_empty()));
  // c = `as.logical`(on1)
  SEXP Rsh_Fir_array_args2[1];
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg_on1_;
...
L14_:;
  ...
  Rsh_Fir_reg_on_exit = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 7), RHO);
  // r3 = dyn on_exit(<lang tracingState(TRUE)>)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_const(CCP, 9);
  SEXP Rsh_Fir_array_arg_names1[1];
  Rsh_Fir_array_arg_names1[0] = R_MissingArg;
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_on_exit, 1, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names1, RHO);
  // goto L1()
  // L1()
  goto L1_;
...
L15_:;
  ...
  Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 1, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names2, RHO);
  // goto L1()
  // L1()
  goto L1_;
...
L2_:;
  ...
  Rsh_Fir_reg_r7_ = Rsh_Fir_call_builtin(82, RHO, 1, Rsh_Fir_array_args7);
  // c1 = `as.logical`(r7)
...
L16_:;
  ...
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_missing, 1, Rsh_Fir_array_args9, Rsh_Fir_array_arg_names3, RHO);
  // goto L2(r6)
  // L2(r6)
...
L17_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 1, Rsh_Fir_array_args10, Rsh_Fir_array_arg_names4, RHO);
  // goto L2(r4)
  // L2(r4)
...
L8_:;
  ...
  Rsh_Fir_reg_eval_parent = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 13), RHO);
  // check L34() else D11()
  // L34()
  goto L34_;
...
L19_:;
  ...
  Rsh_Fir_reg_r12_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_deparse, 1, Rsh_Fir_array_args14, Rsh_Fir_array_arg_names7, RHO);
  // check L20() else D4()
  // L20()
  goto L20_;
...
L32_:;
  ...
  Rsh_Fir_reg_r27_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_substitute, 1, Rsh_Fir_array_args15, Rsh_Fir_array_arg_names8, RHO);
  // goto L8(r27)
  // L8(r27)
...
L33_:;
  ...
  Rsh_Fir_reg_r25_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base3_, 1, Rsh_Fir_array_args16, Rsh_Fir_array_arg_names9, RHO);
  // goto L8(r25)
  // L8(r25)
...
L20_:;
  // st call = r12
  Rsh_Fir_store(Rsh_const(CCP, 17), Rsh_Fir_reg_r12_, RHO);
...
L34_:;
  ...
  //   return exprObj1;
  // }
  Rsh_Fir_reg_p5_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner417981748_2, 0, NULL, CCP, RHO);
  // r29 = dyn eval_parent(p5)
  SEXP Rsh_Fir_array_args19[1];
  Rsh_Fir_array_args19[0] = Rsh_Fir_reg_p5_;
  SEXP Rsh_Fir_array_arg_names10[1];
  Rsh_Fir_array_arg_names10[0] = R_MissingArg;
  Rsh_Fir_reg_r29_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_eval_parent, 1, Rsh_Fir_array_args19, Rsh_Fir_array_arg_names10, RHO);
  // check L35() else D12()
  // L35()
  goto L35_;
...
D12_:;
  ...
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_r29_;
  Rsh_Fir_deopt(51, 1, Rsh_Fir_array_deopt_stack3, CCP, RHO);
  return R_NilValue;
...
L4_:;
  ...
  Rsh_Fir_reg_r16_ = Rsh_Fir_call_builtin(79, RHO, 2, Rsh_Fir_array_args20);
  // c2 = `as.logical`(r16)
...
L21_:;
  // call = ld call
  Rsh_Fir_reg_call = Rsh_Fir_load(Rsh_const(CCP, 17), RHO);
  // check L23() else D5()
  // L23()
  goto L23_;
...
L22_:;
  ...
  Rsh_Fir_reg_r13_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base2_, 1, Rsh_Fir_array_args22, Rsh_Fir_array_arg_names11, RHO);
  // goto L4(r13)
  // L4(r13)
...
L6_:;
  // cat = ldf cat
  Rsh_Fir_reg_cat = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 19), RHO);
  // check L29() else D9()
  // L29()
  goto L29_;
...
L23_:;
  ...
  Rsh_Fir_array_args23[0] = Rsh_Fir_reg_call1_;
  ...
  Rsh_Fir_array_args24[0] = Rsh_Fir_reg_call1_;
  SEXP Rsh_Fir_array_arg_names12[1];
  Rsh_Fir_array_arg_names12[0] = R_MissingArg;
  Rsh_Fir_reg_r15_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_length, 1, Rsh_Fir_array_args24, Rsh_Fir_array_arg_names12, RHO);
  // check L24() else D6()
  // L24()
  goto L24_;
...
L26_:;
  ...
  //   goto L0(dx);
  // }
  Rsh_Fir_reg_p2_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner417981748_3, 0, NULL, CCP, RHO);
  // r19 = dyn paste(p2, "....")
  ...
  Rsh_Fir_reg_r19_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_paste, 2, Rsh_Fir_array_args31, Rsh_Fir_array_arg_names14, RHO);
  // check L27() else D8()
  // L27()
  goto L27_;
...
L29_:;
  ...
  //   return call7;
  // }
  Rsh_Fir_reg_p3_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner417981748_4, 0, NULL, CCP, RHO);
  // p4 = prom<V +>{
  //   msg1 = ld msg;
  //   msg2 = force? msg1;
  //   checkMissing(msg2);
  //   return msg2;
  // }
  Rsh_Fir_reg_p4_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner417981748_5, 0, NULL, CCP, RHO);
  ...
  Rsh_Fir_reg_r23_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_cat, 4, Rsh_Fir_array_args34, Rsh_Fir_array_arg_names15, RHO);
  // check L30() else D10()
  // L30()
  goto L30_;
...
SEXP Rsh_Fir_user_promise_inner417981748_(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  // sys_call = ldf `sys.call`
  Rsh_Fir_reg_sys_call = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 14), RHO);
  // p = prom<V +>{
  //   sys_parent = ldf `sys.parent`;
  //   r8 = dyn sys_parent(1);
  //   return r8;
  ...
  Rsh_Fir_reg_r10_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_sys_call, 1, Rsh_Fir_array_args13, Rsh_Fir_array_arg_names6, RHO);
  // return r10
...
SEXP Rsh_Fir_user_promise_inner417981748_1(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  // sys_parent = ldf `sys.parent`
  Rsh_Fir_reg_sys_parent = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 15), RHO);
  // r8 = dyn sys_parent(1)
  SEXP Rsh_Fir_array_args12[1];
  Rsh_Fir_array_args12[0] = Rsh_const(CCP, 16);
  SEXP Rsh_Fir_array_arg_names5[1];
  Rsh_Fir_array_arg_names5[0] = R_MissingArg;
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_sys_parent, 1, Rsh_Fir_array_args12, Rsh_Fir_array_arg_names5, RHO);
  // return r8
...
SEXP Rsh_Fir_user_promise_inner417981748_2(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  // exprObj = ld exprObj
  Rsh_Fir_reg_exprObj = Rsh_Fir_load(Rsh_const(CCP, 12), RHO);
  // exprObj1 = force? exprObj
  Rsh_Fir_reg_exprObj1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_exprObj);
  // checkMissing(exprObj1)
  SEXP Rsh_Fir_array_args18[1];
  Rsh_Fir_array_args18[0] = Rsh_Fir_reg_exprObj1_;
...
SEXP Rsh_Fir_user_promise_inner417981748_3(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  // call2 = ld call
  Rsh_Fir_reg_call2_ = Rsh_Fir_load(Rsh_const(CCP, 17), RHO);
  // call3 = force? call2
  Rsh_Fir_reg_call3_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_call2_);
  // checkMissing(call3)
  SEXP Rsh_Fir_array_args25[1];
  Rsh_Fir_array_args25[0] = Rsh_Fir_reg_call3_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args25, Rsh_Fir_param_types_empty()));
  // c3 = `is.object`(call3)
  SEXP Rsh_Fir_array_args26[1];
  Rsh_Fir_array_args26[0] = Rsh_Fir_reg_call3_;
...
L1_:;
  ...
  Rsh_Fir_array_args27[1] = Rsh_Fir_reg_call3_;
...
L2_:;
  ...
  Rsh_Fir_array_args29[0] = Rsh_Fir_reg_call5_;
  Rsh_Fir_array_args29[1] = Rsh_const(CCP, 16);
  SEXP Rsh_Fir_array_arg_names13[2];
  Rsh_Fir_array_arg_names13[0] = R_MissingArg;
  Rsh_Fir_array_arg_names13[1] = R_MissingArg;
  Rsh_Fir_reg_r17_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 2, Rsh_Fir_array_args29, Rsh_Fir_array_arg_names13, RHO);
  // goto L0(r17)
  // L0(r17)
...
SEXP Rsh_Fir_user_promise_inner417981748_4(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  // call6 = ld call
  Rsh_Fir_reg_call6_ = Rsh_Fir_load(Rsh_const(CCP, 17), RHO);
  // call7 = force? call6
  Rsh_Fir_reg_call7_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_call6_);
  // checkMissing(call7)
  SEXP Rsh_Fir_array_args32[1];
  Rsh_Fir_array_args32[0] = Rsh_Fir_reg_call7_;
