...
L3_:;
  // r = dyn base(<lang rowMeans(x, m, n, na.rm)>)
...
L7_:;
  ...
  Rsh_Fir_reg_rowMeans = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 8), RHO);
  // r2 = dyn rowMeans(x2, m2, n2, na_rm2)
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_rowMeans, 4, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L8() else D4()
  // L8()
  goto L8_;
