...
L1_:;
  ...
  // r2 = dyn list("[[:alpha:]][[:alnum:].]*[[:alnum:]]", "([[:digit:]]+[.-]){1,}[[:digit:]]+", "[[:digit:]]+\\.[[:digit:]]+\\.[[:digit:]]+", "([[:digit:]]+[.-])*[[:digit:]]+")
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_list, 4, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L3() else D0()
  // L3()
  goto L3_;

L2_:;
  // r = dyn base[valid_package_name, valid_package_version, valid_R_system_version, valid_numeric_version]("[[:alpha:]][[:alnum:].]*[[:alnum:]]", "([[:digit:]]+[.-]){1,}[[:digit:]]+", "[[:digit:]]+\\.[[:digit:]]+\\.[[:digit:]]+", "([[:digit:]]+[.-])*[[:digit:]]+")
  ...
  Rsh_Fir_reg_r1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 4, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names1, CCP, RHO);
  // goto L0(r)
  // L0(r)
