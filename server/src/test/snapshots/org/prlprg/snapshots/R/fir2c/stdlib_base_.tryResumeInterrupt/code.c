...
SEXP Rsh_Fir_user_version_inner2708337952_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_invokeRestart;  // invokeRestart
  ...
  Rsh_Fir_reg_findRestart = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 1), RHO);
  // check L2() else D0()
  // L2()
  goto L2_;
...
L0_:;
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_builtin(82, CCP, RHO, 1, Rsh_Fir_array_args, Rsh_Fir_param_types_empty());
  // c1 = `as.logical`(r5)
...
L2_:;
  // r = dyn findRestart("resume")
  SEXP Rsh_Fir_array_args2[1];
  Rsh_Fir_array_args2[0] = Rsh_const(CCP, 3);
  SEXP Rsh_Fir_array_arg_names[1];
  Rsh_Fir_array_arg_names[0] = R_MissingArg;
  Rsh_Fir_reg_r1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_findRestart, 1, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L3() else D1()
  // L3()
  goto L3_;
...
L4_:;
  // r3 = ld r
  Rsh_Fir_reg_r3_ = Rsh_Fir_load(Rsh_const(CCP, 4), RHO);
  // check L6() else D2()
  // L6()
  goto L6_;
...
L7_:;
  // invokeRestart = ldf invokeRestart
  Rsh_Fir_reg_invokeRestart = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 6), RHO);
  // check L8() else D3()
  // L8()
  goto L8_;
...
L8_:;
  ...
  // r9 = dyn invokeRestart(p)
  SEXP Rsh_Fir_array_args8[1];
  Rsh_Fir_array_args8[0] = Rsh_Fir_reg_p;
  SEXP Rsh_Fir_array_arg_names2[1];
  Rsh_Fir_array_arg_names2[0] = R_MissingArg;
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_invokeRestart, 1, Rsh_Fir_array_args8, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L9() else D4()
  // L9()
  goto L9_;
...
SEXP Rsh_Fir_user_promise_inner2708337952_(SEXP CCP, SEXP RHO) {
  // r6 = ld r
  Rsh_Fir_reg_r6_ = Rsh_Fir_load(Rsh_const(CCP, 4), RHO);
  // r7 = force? r6
