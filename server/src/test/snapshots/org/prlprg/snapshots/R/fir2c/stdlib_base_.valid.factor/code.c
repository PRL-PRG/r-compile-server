...
SEXP Rsh_Fir_user_version_inner4102710431_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_levs;
  SEXP Rsh_Fir_reg_levs1_;
  SEXP Rsh_Fir_reg_c;
...
L0_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_builtin(82, RHO, 1, Rsh_Fir_array_args);
  // c1 = `as.logical`(r4)
...
L5_:;
  ...
  //   return object2;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner4102710431_, 0, NULL, CCP, RHO);
  // r1 = dyn levels(p)
...
L13_:;
  ...
  //   return levs3;
  // }
  Rsh_Fir_reg_p1_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner4102710431_1, 0, NULL, CCP, RHO);
...
L16_:;
  ...
  //   return d1;
  // }
  Rsh_Fir_reg_p2_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner4102710431_2, 0, NULL, CCP, RHO);
...
SEXP Rsh_Fir_user_promise_inner4102710431_1(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  // Declare locals
  SEXP Rsh_Fir_reg_levs2_;
  SEXP Rsh_Fir_reg_levs3_;
