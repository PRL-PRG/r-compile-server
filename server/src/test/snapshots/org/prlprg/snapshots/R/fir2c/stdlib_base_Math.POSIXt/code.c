...
L0_:;
  ...
  //     return _Generic1;
  //   };
  //   r1 = dyn gettextf("'%s' not defined for \"POSIXt\" objects", p);
  //   return r1;
  // }
  Rsh_Fir_reg_p1_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2044426018_, 0, NULL, CCP, RHO);
  // r3 = dyn stop[, domain](p1, NA_LGL)
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_stop, 2, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
SEXP Rsh_Fir_user_promise_inner2044426018_(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  //   return _Generic1;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2044426018_1, 0, NULL, CCP, RHO);
  // r1 = dyn gettextf("'%s' not defined for \"POSIXt\" objects", p)
  ...
  Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_gettextf, 2, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, CCP, RHO);
  // return r1
...
SEXP Rsh_Fir_user_promise_inner2044426018_1(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  // _Generic = ld `.Generic`
  Rsh_Fir_reg__Generic = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // _Generic1 = force? _Generic
