...
L0_:;
  ...
  //   return r3;
  // }
  Rsh_Fir_reg_p2_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2044426018_, 0, NULL, CCP, RHO);
  // r5 = dyn stop(p2)
...
SEXP Rsh_Fir_user_promise_inner2044426018_1(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  //   return _Generic1;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2044426018_2, 0, NULL, CCP, RHO);
  // r1 = dyn sQuote(p)
