...
SEXP Rsh_Fir_user_function_inner2331250374_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner2331250374_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_promise_inner2331250374_(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner2331250374
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner2331250374_, RHO, CCP);
  // st `Sys.setFileTime` = r
...
SEXP Rsh_Fir_user_function_inner2331250374_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner2331250374 dynamic dispatch ([path, time])

  return Rsh_Fir_user_version_inner2331250374_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner2331250374_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner2331250374 version 0 (*, * -+> V)

  if (NPARAMS != 2) Rsh_error("FIŘ arity mismatch for inner2331250374/0: expected 2, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_time1_;  // time1
  SEXP Rsh_Fir_reg_time2_;  // time2
  ...
  SEXP Rsh_Fir_reg_time3_;  // time3
  SEXP Rsh_Fir_reg_time4_;  // time4
  ...
  SEXP Rsh_Fir_reg_time5_;  // time5
  SEXP Rsh_Fir_reg_time6_;  // time6
  SEXP Rsh_Fir_reg_setFileTime;  // setFileTime
  SEXP Rsh_Fir_reg_r14_;  // r14

  // Bind parameters
  Rsh_Fir_reg_path = PARAMS[0];
  Rsh_Fir_reg_time = PARAMS[1];
  ...
  // st time = time
  Rsh_Fir_store(Rsh_const(CCP, 2), Rsh_Fir_reg_time, RHO);
  (void)(Rsh_Fir_reg_time);
...
L2_:;
  ...
  Rsh_Fir_reg_as_POSIXct = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 4), RHO);
  // check L14() else D3()
  // L14()
  goto L14_;
...
L9_:;
  ...
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_path2_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args6, Rsh_Fir_param_types_empty()));
  // c = `is.character`(path2)
  SEXP Rsh_Fir_array_args7[1];
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_path2_;
...
L11_:;
  // r3 = dyn stop("invalid 'path' argument")
  SEXP Rsh_Fir_array_args8[1];
  Rsh_Fir_array_args8[0] = Rsh_const(CCP, 7);
  SEXP Rsh_Fir_array_arg_names1[1];
  Rsh_Fir_array_arg_names1[0] = R_MissingArg;
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_stop, 1, Rsh_Fir_array_args8, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L12() else D2()
  // L12()
  goto L12_;
...
L14_:;
  ...
  //   return time2;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2331250374_, CCP, RHO);
  // r6 = dyn as_POSIXct(p)
  SEXP Rsh_Fir_array_args10[1];
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_p;
  SEXP Rsh_Fir_array_arg_names2[1];
  Rsh_Fir_array_arg_names2[0] = R_MissingArg;
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_as_POSIXct, 1, Rsh_Fir_array_args10, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L15() else D4()
  // L15()
  goto L15_;
...
L16_:;
  // time3 = ld time
  Rsh_Fir_reg_time3_ = Rsh_Fir_load(Rsh_const(CCP, 2), RHO);
  // check L18() else D5()
  // L18()
  goto L18_;

L17_:;
  // r7 = dyn base1(<sym time>)
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_time3_;
  Rsh_Fir_deopt(18, 1, Rsh_Fir_array_deopt_stack3, CCP, RHO);
  return R_NilValue;

L18_:;
  // time4 = force? time3
  Rsh_Fir_reg_time4_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_time3_);
  // checkMissing(time4)
  SEXP Rsh_Fir_array_args13[1];
  Rsh_Fir_array_args13[0] = Rsh_Fir_reg_time4_;
  ...
  Rsh_Fir_array_args14[0] = Rsh_Fir_reg_time4_;
  SEXP Rsh_Fir_array_arg_names4[1];
  Rsh_Fir_array_arg_names4[0] = R_MissingArg;
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_anyNA, 1, Rsh_Fir_array_args14, Rsh_Fir_array_arg_names4, CCP, RHO);
  // check L19() else D6()
  // L19()
  goto L19_;
...
L21_:;
  // r10 = dyn stop1("invalid 'time' argument")
  SEXP Rsh_Fir_array_args15[1];
  Rsh_Fir_array_args15[0] = Rsh_const(CCP, 9);
  SEXP Rsh_Fir_array_arg_names5[1];
  Rsh_Fir_array_arg_names5[0] = R_MissingArg;
  Rsh_Fir_reg_r10_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_stop1_, 1, Rsh_Fir_array_args15, Rsh_Fir_array_arg_names5, CCP, RHO);
  // check L22() else D8()
  // L22()
  goto L22_;
...
L24_:;
  // path3 = ld path
  Rsh_Fir_reg_path3_ = Rsh_Fir_load(Rsh_const(CCP, 1), RHO);
  // check L26() else D9()
  // L26()
  goto L26_;

L25_:;
  // r12 = dyn base2(<lang setFileTime(path, time)>)
...
D9_:;
  ...
  Rsh_Fir_array_deopt_stack6[0] = Rsh_Fir_reg_path3_;
  Rsh_Fir_deopt(30, 1, Rsh_Fir_array_deopt_stack6, CCP, RHO);
  return R_NilValue;

L26_:;
  // path4 = force? path3
  Rsh_Fir_reg_path4_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_path3_);
  // checkMissing(path4)
  SEXP Rsh_Fir_array_args17[1];
  Rsh_Fir_array_args17[0] = Rsh_Fir_reg_path4_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args17, Rsh_Fir_param_types_empty()));
  // time5 = ld time
  Rsh_Fir_reg_time5_ = Rsh_Fir_load(Rsh_const(CCP, 2), RHO);
  // check L27() else D10()
  // L27()
  goto L27_;
...
D10_:;
  ...
  Rsh_Fir_array_deopt_stack7[0] = Rsh_Fir_reg_time5_;
  Rsh_Fir_deopt(32, 1, Rsh_Fir_array_deopt_stack7, CCP, RHO);
  return R_NilValue;

L27_:;
  // time6 = force? time5
  Rsh_Fir_reg_time6_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_time5_);
  // checkMissing(time6)
  SEXP Rsh_Fir_array_args18[1];
  Rsh_Fir_array_args18[0] = Rsh_Fir_reg_time6_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args18, Rsh_Fir_param_types_empty()));
  // setFileTime = ldf setFileTime in base
  Rsh_Fir_reg_setFileTime = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 11), RHO);
  // r14 = dyn setFileTime(path4, time6)
  SEXP Rsh_Fir_array_args19[2];
  Rsh_Fir_array_args19[0] = Rsh_Fir_reg_path4_;
  Rsh_Fir_array_args19[1] = Rsh_Fir_reg_time6_;
  SEXP Rsh_Fir_array_arg_names7[2];
  Rsh_Fir_array_arg_names7[0] = R_MissingArg;
  Rsh_Fir_array_arg_names7[1] = R_MissingArg;
  Rsh_Fir_reg_r14_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_setFileTime, 2, Rsh_Fir_array_args19, Rsh_Fir_array_arg_names7, CCP, RHO);
  // check L28() else D11()
  // L28()
  goto L28_;
...
SEXP Rsh_Fir_user_promise_inner2331250374_(SEXP CCP, SEXP RHO) {
  // time1 = ld time
  Rsh_Fir_reg_time1_ = Rsh_Fir_load(Rsh_const(CCP, 2), RHO);
  // time2 = force? time1
  Rsh_Fir_reg_time2_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_time1_);
  // checkMissing(time2)
  SEXP Rsh_Fir_array_args9[1];
  Rsh_Fir_array_args9[0] = Rsh_Fir_reg_time2_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args9, Rsh_Fir_param_types_empty()));
  // return time2
  return Rsh_Fir_reg_time2_;
}
