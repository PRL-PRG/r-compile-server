...
SEXP Rsh_Fir_user_version_inner3798765097_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_locale;  // locale
  SEXP Rsh_Fir_reg_category_isMissing;  // category_isMissing
  SEXP Rsh_Fir_reg_category_orDefault;  // category_orDefault
  SEXP Rsh_Fir_reg_locale_isMissing;  // locale_isMissing
  SEXP Rsh_Fir_reg_locale_orDefault;  // locale_orDefault
  ...
  SEXP Rsh_Fir_reg_locale1_;  // locale1
  SEXP Rsh_Fir_reg_locale2_;  // locale2
  SEXP Rsh_Fir_reg_Sys_setlocale;  // Sys_setlocale
