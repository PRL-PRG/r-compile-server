...
SEXP Rsh_Fir_user_function_inner1778122203_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner1778122203_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_promise_inner1778122203_(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner1778122203
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner1778122203_, RHO, CCP);
  // st `Sys.umask` = r
...
SEXP Rsh_Fir_user_function_inner1778122203_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner1778122203 dynamic dispatch ([mode])

  return Rsh_Fir_user_version_inner1778122203_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner1778122203_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner1778122203 version 0 (* -+> V)

  if (NPARAMS != 1) Rsh_error("FIŘ arity mismatch for inner1778122203/0: expected 1, got %d", NPARAMS);
  ...
  // if mode_isMissing then L0(NA_LGL) else L0(mode)
  if (Rsh_Fir_is_true(Rsh_Fir_reg_mode_isMissing)) {
  // L0(NA_LGL)
    Rsh_Fir_reg_mode_orDefault = Rsh_const(CCP, 1);
    goto L0_;
  } else {
  // L0(mode)
...
L0_:;
  ...
  Rsh_Fir_store(Rsh_const(CCP, 2), Rsh_Fir_reg_mode_orDefault, RHO);
...
L4_:;
  // Sys_umask = ldf `Sys.umask` in base
  Rsh_Fir_reg_Sys_umask = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 0), RHO);
  // r8 = dyn Sys_umask(r5)
  SEXP Rsh_Fir_array_args3[1];
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_r5_;
  SEXP Rsh_Fir_array_arg_names[1];
  Rsh_Fir_array_arg_names[0] = R_MissingArg;
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_Sys_umask, 1, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L15() else D4()
  // L15()
  goto L15_;
...
L6_:;
  // r = dyn base(<lang Sys.umask(if(is.na(mode), NA_INT, as.octmode(mode)))>)
...
L7_:;
  // mode1 = ld mode
  Rsh_Fir_reg_mode1_ = Rsh_Fir_load(Rsh_const(CCP, 2), RHO);
  // check L9() else D0()
  // L9()
  goto L9_;

L8_:;
  // r2 = dyn base1(<sym mode>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_mode1_;
...
L9_:;
  ...
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_mode2_;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_is_na, 1, Rsh_Fir_array_args8, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L10() else D1()
  // L10()
  goto L10_;
...
L13_:;
  ...
  //   return mode4;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner1778122203_, 0, NULL, CCP, RHO);
  // r7 = dyn as_octmode(p)
  SEXP Rsh_Fir_array_args10[1];
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_p;
  SEXP Rsh_Fir_array_arg_names4[1];
  Rsh_Fir_array_arg_names4[0] = R_MissingArg;
  Rsh_Fir_reg_r7_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_as_octmode, 1, Rsh_Fir_array_args10, Rsh_Fir_array_arg_names4, CCP, RHO);
  // check L14() else D3()
  // L14()
  goto L14_;
...
SEXP Rsh_Fir_user_promise_inner1778122203_(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  // Declare locals
  SEXP Rsh_Fir_reg_mode3_;
  SEXP Rsh_Fir_reg_mode4_;

  if (NCAPTURES != 0) Rsh_error("FIŘ capture arity mismatch for inner1778122203/0: expected 0, got %d", NCAPTURES);

  // mode3 = ld mode
  Rsh_Fir_reg_mode3_ = Rsh_Fir_load(Rsh_const(CCP, 2), RHO);
  // mode4 = force? mode3
  Rsh_Fir_reg_mode4_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_mode3_);
  // checkMissing(mode4)
  SEXP Rsh_Fir_array_args9[1];
  Rsh_Fir_array_args9[0] = Rsh_Fir_reg_mode4_;
