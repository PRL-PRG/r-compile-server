...
L1_:;
  ...
  //   r4 = dyn attr(x2, "tzone");
  //   goto L0(r4);
  // L2():
  //   r2 = dyn base(<sym x>, "tzone");
  //   goto L0(r2);
  // }
  ...
  Rsh_Fir_reg_r10_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__POSIXct, 3, Rsh_Fir_array_args10, Rsh_Fir_array_arg_names5, CCP, RHO);
  // check L2() else D1()
  // L2()
  goto L2_;
