...
L1_:;
  ...
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_builtin(75, RHO, 2, Rsh_Fir_array_args2);
  // c = `as.logical`(r9)
...
L4_:;
  ...
  Rsh_Fir_reg_r30_ = Rsh_Fir_call_builtin(82, RHO, 1, Rsh_Fir_array_args5);
  // c1 = `as.logical`(r30)
...
L0_:;
  ...
  Rsh_Fir_reg_r18_ = Rsh_Fir_call_builtin(74, RHO, 2, Rsh_Fir_array_args19);
  // return r18
