...
L86_:;
  // r42 = dyn base5(<sym msg>, <lang paste0("Lengths (", lt, ", ", lc, ") differ (comparison on first ", `<-`(ll, min(lt, lc)), " components)")>)
...
L88_:;
  ...
  // r50 = dyn paste1("Lengths (", p10, ", ", p11, ") differ (comparison on first ", p12, " components)")
...
L148_:;
  // r94 = dyn base17(<sym msg>, <lang paste("1 element mismatch")>)
...
L150_:;
  // r96 = dyn paste3("1 element mismatch")
...
L160_:;
  // r102 = dyn base19(<sym msg>, <lang paste(sum(ne), "element mismatches")>)
...
L162_:;
  ...
  // r108 = dyn paste4(p15, "element mismatches")
