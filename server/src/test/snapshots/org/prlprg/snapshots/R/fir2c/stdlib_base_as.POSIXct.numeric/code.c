...
L1_:;
  ...
  //   };
  //   ddd1 = ld `...`;
  //   r4 = dyn as_POSIXct[, tz, `...`](p, "GMT", ddd1);
  //   x3 = ld x;
  //   x4 = force? x3;
  //   checkMissing(x4);
  //   r5 = `+`(r4, x4);
  ...
  //   return x2;
  // }
  Rsh_Fir_reg_p1_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner1768602929_, 0, NULL, CCP, RHO);
  // p2 = prom<V +>{
  //   tz1 = ld tz;
  //   tz2 = force? tz1;
  //   checkMissing(tz2);
  //   return tz2;
  // }
  Rsh_Fir_reg_p2_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner1768602929_2, 0, NULL, CCP, RHO);
  // r8 = dyn _POSIXct(p1, p2)
  ...
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__POSIXct, 2, Rsh_Fir_array_args11, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L2() else D1()
  // L2()
  goto L2_;
...
L1_:;
  ...
  //   return origin2;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner1768602929_1, 0, NULL, CCP, RHO);
  // ddd1 = ld `...`
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_as_POSIXct, 3, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names, CCP, RHO);
  // x3 = ld x
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_builtin(66, RHO, 2, Rsh_Fir_array_args6);
  // return r5
