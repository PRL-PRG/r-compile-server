...
L64_:;
  ...
  //   r28 = dyn gettextf("Direct call of '%s()' is deprecated.  Use '%s()' or '%s()' instead", "as.data.frame.difftime", "as.data.frame.vector", "as.data.frame");
  //   return r28;
  // }
