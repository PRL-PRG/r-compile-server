...
L2_:;
  // r = dyn base(<lang as.vector(x, "expression")>)
...
L3_:;
  ...
  // r2 = dyn as_vector(x2, "expression")
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_as_vector, 2, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L4() else D1()
  // L4()
  goto L4_;
