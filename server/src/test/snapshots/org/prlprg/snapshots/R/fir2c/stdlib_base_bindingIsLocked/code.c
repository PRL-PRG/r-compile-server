...
L12_:;
  // r5 = dyn base1(<lang bindingIsLocked(sym, env)>)
...
L14_:;
  ...
  // bindingIsLocked = ldf bindingIsLocked in base
  Rsh_Fir_reg_bindingIsLocked = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 0), RHO);
  // r7 = dyn bindingIsLocked(sym8, env2)
  ...
  Rsh_Fir_reg_r7_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_bindingIsLocked, 2, Rsh_Fir_array_args11, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L15() else D5()
  // L15()
  goto L15_;
