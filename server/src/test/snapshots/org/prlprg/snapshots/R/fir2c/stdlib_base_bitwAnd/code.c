...
SEXP Rsh_Fir_user_version_inner3950065357_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_bitwiseAnd;  // bitwiseAnd
...
L2_:;
  // r = dyn base(<lang bitwiseAnd(a, b)>)
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_b1_;
...
L4_:;
  ...
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_b2_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args3, Rsh_Fir_param_types_empty()));
  // bitwiseAnd = ldf bitwiseAnd in base
  Rsh_Fir_reg_bitwiseAnd = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 5), RHO);
  // r2 = dyn bitwiseAnd(a2, b2)
  SEXP Rsh_Fir_array_args4[2];
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_a2_;
  Rsh_Fir_array_args4[1] = Rsh_Fir_reg_b2_;
  SEXP Rsh_Fir_array_arg_names1[2];
  Rsh_Fir_array_arg_names1[0] = R_MissingArg;
  Rsh_Fir_array_arg_names1[1] = R_MissingArg;
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_bitwiseAnd, 2, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L5() else D2()
  // L5()
  goto L5_;
