...
SEXP Rsh_Fir_user_version_inner3950065357_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_bitwiseOr;  // bitwiseOr
...
L4_:;
  ...
  // bitwiseOr = ldf bitwiseOr in base
  Rsh_Fir_reg_bitwiseOr = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 5), RHO);
  // r2 = dyn bitwiseOr(a2, b2)
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_bitwiseOr, 2, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L5() else D2()
  // L5()
  goto L5_;
