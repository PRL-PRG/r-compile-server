...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner4061490079
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner4061490079_, RHO, CCP);
  // st `conditionMessage.condition` = r
...
SEXP Rsh_Fir_user_version_inner4061490079_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // st c = c
  Rsh_Fir_store(Rsh_const(CCP, 1), Rsh_Fir_reg_c, RHO);
  (void)(Rsh_Fir_reg_c);
  // c1 = ld c
  Rsh_Fir_reg_c1_ = Rsh_Fir_load(Rsh_const(CCP, 1), RHO);
  // check L0() else D0()
  // L0()
  goto L0_;
...
L0_:;
  ...
  Rsh_Fir_reg_c3_ = Rsh_Fir_call_builtin(397, CCP, RHO, 1, Rsh_Fir_array_args1, Rsh_Fir_param_types_empty());
  // if c3 then L2() else L3(c2)
  if (Rsh_Fir_is_true(Rsh_Fir_reg_c3_)) {
  // L2()
    goto L2_;
  } else {
  // L3(c2)
    Rsh_Fir_reg_c5_ = Rsh_Fir_reg_c2_;
    goto L3_;
  }
...
L2_:;
  // dr = tryDispatchBuiltin.1("$", c2)
  SEXP Rsh_Fir_array_args2[2];
  Rsh_Fir_array_args2[0] = Rsh_const(CCP, 2);
  Rsh_Fir_array_args2[1] = Rsh_Fir_reg_c2_;
  ...
  // L3(dr)
    Rsh_Fir_reg_c5_ = Rsh_Fir_reg_dr;
    goto L3_;
  }
