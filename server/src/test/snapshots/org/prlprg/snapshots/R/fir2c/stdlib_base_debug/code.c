...
L12_:;
  // r2 = dyn base1(<lang debug(fun, text, condition)>)
...
L15_:;
  ...
  // debug = ldf debug in base
  Rsh_Fir_reg_debug = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 0), RHO);
  // r4 = dyn debug(fun2, text2, condition2)
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_debug, 3, Rsh_Fir_array_args13, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L16() else D4()
  // L16()
  goto L16_;
...
L22_:;
  ...
  // r12 = dyn r7[, , , , once](p, p1, p2, p3, FALSE)
