...
SEXP Rsh_Fir_user_function_inner3481829019_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner3481829019_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_promise_inner3481829019_(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner3481829019
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner3481829019_, RHO, CCP);
  // st fifo = r
...
SEXP Rsh_Fir_user_function_inner3481829019_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner3481829019 dynamic dispatch ([description, open, blocking, encoding])

  return Rsh_Fir_user_version_inner3481829019_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner3481829019_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner3481829019 version 0 (*, *, *, * -+> V)

  if (NPARAMS != 4) Rsh_error("FIŘ arity mismatch for inner3481829019/0: expected 4, got %d", NPARAMS);
...
L0_:;
  ...
  // if blocking_isMissing then L1(FALSE) else L1(blocking)
...
L2_:;
  ...
  //   return r;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3481829019_, CCP, RHO);
  // goto L3(p)
  // L3(p)
...
L6_:;
  // r2 = dyn base(<lang fifo(description, open, blocking, encoding)>)
...
L9_:;
  ...
  Rsh_Fir_array_args8[0] = Rsh_Fir_reg_blocking2_;
...
L10_:;
  ...
  // fifo = ldf fifo in base
  Rsh_Fir_reg_fifo = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 0), RHO);
  // r4 = dyn fifo(description2, open2, blocking2, encoding2)
  SEXP Rsh_Fir_array_args10[4];
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_description2_;
  Rsh_Fir_array_args10[1] = Rsh_Fir_reg_open2_;
  Rsh_Fir_array_args10[2] = Rsh_Fir_reg_blocking2_;
  Rsh_Fir_array_args10[3] = Rsh_Fir_reg_encoding2_;
  SEXP Rsh_Fir_array_arg_names2[4];
  Rsh_Fir_array_arg_names2[0] = R_MissingArg;
  Rsh_Fir_array_arg_names2[1] = R_MissingArg;
  Rsh_Fir_array_arg_names2[2] = R_MissingArg;
  Rsh_Fir_array_arg_names2[3] = R_MissingArg;
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_fifo, 4, Rsh_Fir_array_args10, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L11() else D4()
  // L11()
  goto L11_;
