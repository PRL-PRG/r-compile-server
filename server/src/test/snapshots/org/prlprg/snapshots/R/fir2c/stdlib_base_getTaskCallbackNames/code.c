...
SEXP Rsh_Fir_user_version_inner2708337952_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg__C_R_getTaskCallbackNames;  // _C_R_getTaskCallbackNames
  SEXP Rsh_Fir_reg__C_R_getTaskCallbackNames1_;  // _C_R_getTaskCallbackNames1
...
L1_:;
  // _C_R_getTaskCallbackNames = ld `.C_R_getTaskCallbackNames`
  Rsh_Fir_reg__C_R_getTaskCallbackNames = Rsh_Fir_load(Rsh_const(CCP, 2), RHO);
  // check L3() else D0()
  // L3()
  goto L3_;

L2_:;
  // r = dyn base(<sym .C_R_getTaskCallbackNames>)
...
D0_:;
  // deopt 1 [_C_R_getTaskCallbackNames]
  SEXP Rsh_Fir_array_deopt_stack[1];
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg__C_R_getTaskCallbackNames;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L3_:;
  // _C_R_getTaskCallbackNames1 = force? _C_R_getTaskCallbackNames
  Rsh_Fir_reg__C_R_getTaskCallbackNames1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg__C_R_getTaskCallbackNames);
  // checkMissing(_C_R_getTaskCallbackNames1)
  SEXP Rsh_Fir_array_args2[1];
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg__C_R_getTaskCallbackNames1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args2, Rsh_Fir_param_types_empty()));
  // vargs = dots[]
  Rsh_Fir_reg_vargs = Rsh_Fir_mk_vector(Rsh_Fir_kind_dots, 0, NULL, NULL);
  // r2 = `.Call`(_C_R_getTaskCallbackNames1, vargs, <missing>)
  SEXP Rsh_Fir_array_args3[3];
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg__C_R_getTaskCallbackNames1_;
