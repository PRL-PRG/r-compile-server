...
L6_:;
  // r2 = dyn base(<lang gzfile(description, open, encoding, compression)>)
...
L10_:;
  ...
  // gzfile = ldf gzfile in base
  Rsh_Fir_reg_gzfile = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 0), RHO);
  // r4 = dyn gzfile(description2, open2, encoding2, compression2)
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_gzfile, 4, Rsh_Fir_array_args10, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L11() else D4()
  // L11()
  goto L11_;
