...
SEXP Rsh_Fir_user_function_inner4216788095_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner4216788095_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner4216788095
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner4216788095_, RHO, CCP);
  // st inherits = r
...
SEXP Rsh_Fir_user_function_inner4216788095_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner4216788095 dynamic dispatch ([x, what, which])

  return Rsh_Fir_user_version_inner4216788095_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner4216788095_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner4216788095 version 0 (*, *, * -+> V)

  if (NPARAMS != 3) Rsh_error("FIŘ arity mismatch for inner4216788095/0: expected 3, got %d", NPARAMS);
  ...
  (void)(Rsh_Fir_reg_x);
  // st what = what
  Rsh_Fir_store(Rsh_const(CCP, 2), Rsh_Fir_reg_what, RHO);
  ...
  // if which_isMissing then L0(FALSE) else L0(which)
  if (Rsh_Fir_is_true(Rsh_Fir_reg_which_isMissing)) {
  // L0(FALSE)
    Rsh_Fir_reg_which_orDefault = Rsh_const(CCP, 3);
    goto L0_;
  } else {
  // L0(which)
...
L0_:;
  ...
  Rsh_Fir_store(Rsh_const(CCP, 4), Rsh_Fir_reg_which_orDefault, RHO);
...
L3_:;
  // r = dyn base(<lang inherits(x, what, which)>)
...
L4_:;
  ...
  // what1 = ld what
  Rsh_Fir_reg_what1_ = Rsh_Fir_load(Rsh_const(CCP, 2), RHO);
  // check L5() else D1()
  // L5()
  goto L5_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_what1_;
...
L5_:;
  ...
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_what2_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args4, Rsh_Fir_param_types_empty()));
  // which1 = ld which
  Rsh_Fir_reg_which1_ = Rsh_Fir_load(Rsh_const(CCP, 4), RHO);
  // check L6() else D2()
  // L6()
  goto L6_;
...
D2_:;
  ...
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_which1_;
...
L6_:;
  ...
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_which2_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args5, Rsh_Fir_param_types_empty()));
  // inherits = ldf inherits in base
  Rsh_Fir_reg_inherits = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 0), RHO);
  // r2 = dyn inherits(x2, what2, which2)
  SEXP Rsh_Fir_array_args6[3];
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_x2_;
  Rsh_Fir_array_args6[1] = Rsh_Fir_reg_what2_;
  Rsh_Fir_array_args6[2] = Rsh_Fir_reg_which2_;
