...
L2_:;
  // r = dyn base(<sym x>, "numeric_version")
...
L3_:;
  ...
  // r2 = dyn inherits(x2, "numeric_version", FALSE)
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_inherits, 3, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L4() else D1()
  // L4()
  goto L4_;
