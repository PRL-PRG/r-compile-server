...
SEXP Rsh_Fir_user_version_inner3672943467_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_isRegisteredNamespace;  // isRegisteredNamespace
...
L2_:;
  // r = dyn base(<lang isRegisteredNamespace(name)>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_name1_;
...
L3_:;
  ...
  // isRegisteredNamespace = ldf isRegisteredNamespace in base
  Rsh_Fir_reg_isRegisteredNamespace = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 4), RHO);
  // r2 = dyn isRegisteredNamespace(name2)
  SEXP Rsh_Fir_array_args3[1];
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_name2_;
  SEXP Rsh_Fir_array_arg_names1[1];
  Rsh_Fir_array_arg_names1[0] = R_MissingArg;
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_isRegisteredNamespace, 1, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L4() else D1()
  // L4()
  goto L4_;
