...
L3_:;
  ...
  Rsh_Fir_reg_class = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 4), RHO);
  // r2 = dyn class(x2)
  SEXP Rsh_Fir_array_args3[1];
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_x2_;
  SEXP Rsh_Fir_array_arg_names1[1];
  Rsh_Fir_array_arg_names1[0] = R_MissingArg;
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_class, 1, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L4() else D1()
  // L4()
  goto L4_;
...
L5_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_levels, 1, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L6() else D3()
  // L6()
  goto L6_;
...
L6_:;
  ...
  Rsh_Fir_reg_NextMethod = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 8), RHO);
  // check L7() else D4()
  // L7()
  goto L7_;
...
L7_:;
  // r5 = dyn NextMethod()
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_NextMethod, 0, NULL, NULL, CCP, RHO);
  // check L8() else D5()
  // L8()
  goto L8_;
...
L9_:;
  ...
  // r9 = dyn structure[, levels, class](p1, p2, p3)
  ...
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_structure, 3, Rsh_Fir_array_args9, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L10() else D7()
  // L10()
  goto L10_;
...
SEXP Rsh_Fir_user_promise_inner736444261_2(SEXP CCP, SEXP RHO) {
  // levs = ld levs
  Rsh_Fir_reg_levs = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // levs1 = force? levs
...
SEXP Rsh_Fir_user_promise_inner736444261_3(SEXP CCP, SEXP RHO) {
  ...
  Rsh_Fir_array_args8[0] = Rsh_Fir_reg_cl1_;
