...
SEXP Rsh_Fir_user_function_inner2412395281_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner2412395281_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_promise_inner2412395281_(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner2412395281
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner2412395281_, RHO, CCP);
...
SEXP Rsh_Fir_user_function_inner2412395281_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner2412395281 dynamic dispatch ([sym, fun, env])

  return Rsh_Fir_user_version_inner2412395281_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner2412395281_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner2412395281 version 0 (*, *, * -+> V)

  if (NPARAMS != 3) Rsh_error("FIŘ arity mismatch for inner2412395281/0: expected 3, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_makeActiveBinding;  // makeActiveBinding
  SEXP Rsh_Fir_reg_r7_;  // r7

  // Bind parameters
  Rsh_Fir_reg_sym = PARAMS[0];
  ...
  (void)(R_NilValue);
  // st sym = sym
  Rsh_Fir_store(Rsh_const(CCP, 1), Rsh_Fir_reg_sym, RHO);
  (void)(Rsh_Fir_reg_sym);
  // st fun = fun
  Rsh_Fir_store(Rsh_const(CCP, 2), Rsh_Fir_reg_fun, RHO);
  (void)(Rsh_Fir_reg_fun);
  // st env = env
  Rsh_Fir_store(Rsh_const(CCP, 3), Rsh_Fir_reg_env, RHO);
...
L4_:;
  // sym2 = ld sym
  Rsh_Fir_reg_sym2_ = Rsh_Fir_load(Rsh_const(CCP, 1), RHO);
  // check L6() else D0()
  // L6()
  goto L6_;
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_sym2_;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L6_:;
  // sym3 = force? sym2
  Rsh_Fir_reg_sym3_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_sym2_);
  // checkMissing(sym3)
...
L7_:;
  // as_name = ldf `as.name`
  Rsh_Fir_reg_as_name = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 6), RHO);
  // check L8() else D1()
  // L8()
  goto L8_;
...
L8_:;
  ...
  //   return sym5;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2412395281_, CCP, RHO);
  // r3 = dyn as_name(p)
  SEXP Rsh_Fir_array_args7[1];
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_p;
  SEXP Rsh_Fir_array_arg_names1[1];
  Rsh_Fir_array_arg_names1[0] = R_MissingArg;
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_as_name, 1, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L9() else D2()
  // L9()
  goto L9_;
...
L11_:;
  // sym7 = ld sym
  Rsh_Fir_reg_sym7_ = Rsh_Fir_load(Rsh_const(CCP, 1), RHO);
  // check L13() else D3()
  // L13()
  goto L13_;

L12_:;
  // r5 = dyn base1(<lang makeActiveBinding(sym, fun, env)>)
...
D3_:;
  ...
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_sym7_;
  Rsh_Fir_deopt(13, 1, Rsh_Fir_array_deopt_stack2, CCP, RHO);
  return R_NilValue;

L13_:;
  // sym8 = force? sym7
  Rsh_Fir_reg_sym8_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_sym7_);
  // checkMissing(sym8)
  SEXP Rsh_Fir_array_args9[1];
  Rsh_Fir_array_args9[0] = Rsh_Fir_reg_sym8_;
...
D4_:;
  ...
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_fun1_;
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_env1_;
...
L15_:;
  ...
  // makeActiveBinding = ldf makeActiveBinding in base
  Rsh_Fir_reg_makeActiveBinding = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 0), RHO);
  // r7 = dyn makeActiveBinding(sym8, fun2, env2)
  SEXP Rsh_Fir_array_args12[3];
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_sym8_;
  Rsh_Fir_array_args12[1] = Rsh_Fir_reg_fun2_;
  Rsh_Fir_array_args12[2] = Rsh_Fir_reg_env2_;
  SEXP Rsh_Fir_array_arg_names3[3];
  Rsh_Fir_array_arg_names3[0] = R_MissingArg;
  Rsh_Fir_array_arg_names3[1] = R_MissingArg;
  Rsh_Fir_array_arg_names3[2] = R_MissingArg;
  Rsh_Fir_reg_r7_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_makeActiveBinding, 3, Rsh_Fir_array_args12, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L16() else D6()
  // L16()
  goto L16_;
...
SEXP Rsh_Fir_user_promise_inner2412395281_(SEXP CCP, SEXP RHO) {
  // sym4 = ld sym
  Rsh_Fir_reg_sym4_ = Rsh_Fir_load(Rsh_const(CCP, 1), RHO);
  // sym5 = force? sym4
  Rsh_Fir_reg_sym5_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_sym4_);
  // checkMissing(sym5)
  SEXP Rsh_Fir_array_args6[1];
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_sym5_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args6, Rsh_Fir_param_types_empty()));
  // return sym5
  return Rsh_Fir_reg_sym5_;
}
