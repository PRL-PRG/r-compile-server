...
SEXP Rsh_Fir_user_function_inner2127750096_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner2127750096_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_promise_inner2127750096_(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner2127750096_1(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner2127750096
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner2127750096_, RHO, CCP);
  // st packBits = r
...
SEXP Rsh_Fir_user_function_inner2127750096_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner2127750096 dynamic dispatch ([x, type])

  return Rsh_Fir_user_version_inner2127750096_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner2127750096_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner2127750096 version 0 (*, * -+> V)

  if (NPARAMS != 2) Rsh_error("FIŘ arity mismatch for inner2127750096/0: expected 2, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_packBits;  // packBits
...
L0_:;
  ...
  // L1():
  //   c = ldf c in base;
  //   r2 = dyn c("raw", "integer", "double");
  //   goto L0(r2);
  // L2():
  //   r = dyn base("raw", "integer", "double");
  //   goto L0(r);
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2127750096_, CCP, RHO);
  // goto L1(p)
  // L1(p)
...
L3_:;
  ...
  //   return type2;
  // }
  Rsh_Fir_reg_p1_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2127750096_1, CCP, RHO);
  // r5 = dyn match_arg(p1)
...
L6_:;
  // r6 = dyn base1(<lang packBits(x, type)>)
...
L7_:;
  ...
  // type3 = ld type
  Rsh_Fir_reg_type3_ = Rsh_Fir_load(Rsh_const(CCP, 6), RHO);
  // check L8() else D3()
  // L8()
  goto L8_;
...
L8_:;
  ...
  // packBits = ldf packBits in base
  Rsh_Fir_reg_packBits = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 0), RHO);
  // r8 = dyn packBits(x2, type4)
  SEXP Rsh_Fir_array_args10[2];
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_x2_;
  Rsh_Fir_array_args10[1] = Rsh_Fir_reg_type4_;
  SEXP Rsh_Fir_array_arg_names4[2];
  Rsh_Fir_array_arg_names4[0] = R_MissingArg;
  Rsh_Fir_array_arg_names4[1] = R_MissingArg;
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_packBits, 2, Rsh_Fir_array_args10, Rsh_Fir_array_arg_names4, CCP, RHO);
  // check L9() else D4()
  // L9()
  goto L9_;
