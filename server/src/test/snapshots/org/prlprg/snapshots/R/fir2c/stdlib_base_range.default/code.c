...
L2_:;
  ...
  // r3 = dyn _rangeNum[`...`, `na.rm`, finite, isNumeric](ddd1, p, p1, p2)
  ...
  Rsh_Fir_array_args5[3] = Rsh_Fir_reg_p2_;
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__rangeNum, 4, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L3() else D1()
  // L3()
  goto L3_;
...
SEXP Rsh_Fir_user_promise_inner1471137731_2(SEXP CCP, SEXP RHO) {
  // is_numeric = ld `is.numeric`
  Rsh_Fir_reg_is_numeric = Rsh_Fir_load(Rsh_const(CCP, 6), RHO);
  // is_numeric1 = force? is_numeric
  Rsh_Fir_reg_is_numeric1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_is_numeric);
  // checkMissing(is_numeric1)
  SEXP Rsh_Fir_array_args4[1];
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_is_numeric1_;
