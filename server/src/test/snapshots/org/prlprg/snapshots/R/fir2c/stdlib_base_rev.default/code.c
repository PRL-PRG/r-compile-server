...
L3_:;
  ...
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_builtin(85, CCP, RHO, 2, Rsh_Fir_array_args2, Rsh_Fir_param_types_empty());
  // __ = ldf `[` in base
  Rsh_Fir_reg___ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 4), RHO);
  // r7 = dyn __(x9, r6)
  SEXP Rsh_Fir_array_args3[2];
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_x9_;
...
D3_:;
  ...
  Rsh_Fir_array_deopt_stack3[1] = Rsh_Fir_reg_x10_;
...
L15_:;
  ...
  Rsh_Fir_array_args15[0] = Rsh_Fir_reg_x11_;
  SEXP Rsh_Fir_array_arg_names4[1];
  Rsh_Fir_array_arg_names4[0] = R_MissingArg;
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_length1_, 1, Rsh_Fir_array_args15, Rsh_Fir_array_arg_names4, CCP, RHO);
  // check L16() else D4()
  // L16()
  goto L16_;
