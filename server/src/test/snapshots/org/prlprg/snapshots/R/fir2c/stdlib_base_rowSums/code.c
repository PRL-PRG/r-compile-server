...
SEXP Rsh_Fir_user_version_inner3834575331_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_rowSums;  // rowSums
  ...
  SEXP Rsh_Fir_reg_rowSums1_;  // rowSums1
  ...
  SEXP Rsh_Fir_reg_rowSums2_;  // rowSums2
...
L90_:;
  // r37 = dyn base7(<lang rowSums(Re(x), prod(dn), p, na.rm)>)
...
L100_:;
  ...
  // rowSums = ldf rowSums in base
  Rsh_Fir_reg_rowSums = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 0), RHO);
  // r45 = dyn rowSums(r40, r43, p3, na_rm2)
  ...
  Rsh_Fir_reg_r45_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_rowSums, 4, Rsh_Fir_array_args87, Rsh_Fir_array_arg_names23, CCP, RHO);
  // check L101() else D29()
  // L101()
  goto L101_;
...
L103_:;
  // r50 = dyn base10(<lang rowSums(Im(x), prod(dn), p, na.rm)>)
...
L113_:;
  ...
  // rowSums1 = ldf rowSums in base
  Rsh_Fir_reg_rowSums1_ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 0), RHO);
  // r72 = dyn rowSums1(r61, r70, p5, na_rm4)
  ...
  Rsh_Fir_reg_r72_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_rowSums1_, 4, Rsh_Fir_array_args98, Rsh_Fir_array_arg_names29, CCP, RHO);
  // check L114() else D36()
  // L114()
  goto L114_;
...
L117_:;
  // r76 = dyn base13(<lang rowSums(x, prod(dn), p, na.rm)>)
...
L124_:;
  ...
  // rowSums2 = ldf rowSums in base
  Rsh_Fir_reg_rowSums2_ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 0), RHO);
  // r80 = dyn rowSums2(x16, r78, p7, na_rm6)
  ...
  Rsh_Fir_reg_r80_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_rowSums2_, 4, Rsh_Fir_array_args107, Rsh_Fir_array_arg_names33, CCP, RHO);
  // check L125() else D42()
  // L125()
  goto L125_;
