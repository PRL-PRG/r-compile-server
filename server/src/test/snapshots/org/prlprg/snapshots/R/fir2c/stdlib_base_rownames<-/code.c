...
L26_:;
  ...
  Rsh_Fir_reg_row_names__ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 11), RHO);
  // check L27() else D3()
  // L27()
  goto L27_;
...
L27_:;
  // r2 = dyn row_names__(l, NULL, value2)
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_row_names__, 3, Rsh_Fir_array_args19, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L28() else D4()
  // L28()
  goto L28_;
...
L53_:;
  // r19 = dyn stop("attempt to set 'rownames' on an object with no dimensions")
...
L66_:;
  // r29 = dyn stop1("attempt to set 'rownames' on an object with no dimensions")
