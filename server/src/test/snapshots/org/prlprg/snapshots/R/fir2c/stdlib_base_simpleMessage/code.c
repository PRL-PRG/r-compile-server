...
L1_:;
  ...
  // L1():
  //   c = ldf c in base;
  //   r6 = dyn c("simpleMessage", "message", "condition");
  //   goto L0(r6);
  // L2():
  //   r4 = dyn base1("simpleMessage", "message", "condition");
  //   goto L0(r4);
  // }
...
L1_:;
  ...
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c, 3, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L0(r6)
  // L0(r6)
...
L2_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 3, Rsh_Fir_array_args8, Rsh_Fir_array_arg_names3, CCP, RHO);
  // goto L0(r4)
  // L0(r4)
