...
SEXP Rsh_Fir_user_promise_inner4125524309_(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner4125524309_1(SEXP CCP, SEXP RHO);
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  // st suppressPackageStartupMessages = r
...
SEXP Rsh_Fir_user_version_inner4125524309_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  Rsh_Fir_reg_withCallingHandlers = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 2), RHO);
  // check L0() else D0()
  // L0()
  goto L0_;
...
L0_:;
  ...
  //   return expr2;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner4125524309_, CCP, RHO);
  // p1 = prom<V +>{
  //   r1 = clos inner4061490079;
  //   return r1;
  // }
  Rsh_Fir_reg_p1_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner4125524309_1, CCP, RHO);
  // r3 = dyn withCallingHandlers[, packageStartupMessage](p, p1)
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_withCallingHandlers, 2, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
SEXP Rsh_Fir_user_promise_inner4125524309_(SEXP CCP, SEXP RHO) {
  ...
  Rsh_Fir_array_args[0] = Rsh_Fir_reg_expr2_;
...
SEXP Rsh_Fir_user_version_inner4061490079_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // st c = c
  Rsh_Fir_store(Rsh_const(CCP, 4), Rsh_Fir_reg_c, RHO);
  (void)(Rsh_Fir_reg_c);
  // tryInvokeRestart = ldf tryInvokeRestart
  Rsh_Fir_reg_tryInvokeRestart = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 5), RHO);
  // check L0() else D0()
  // L0()
  goto L0_;
...
L0_:;
  // r = dyn tryInvokeRestart("muffleMessage")
  SEXP Rsh_Fir_array_args2[1];
  Rsh_Fir_array_args2[0] = Rsh_const(CCP, 6);
  SEXP Rsh_Fir_array_arg_names1[1];
  Rsh_Fir_array_arg_names1[0] = R_MissingArg;
  Rsh_Fir_reg_r1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_tryInvokeRestart, 1, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
