...
SEXP Rsh_Fir_user_function_inner1525449764_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner1525449764_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_promise_inner1525449764_(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner1525449764_1(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_function_inner530606259_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner530606259_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner1525449764
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner1525449764_, RHO, CCP);
  // st suppressWarnings = r
...
SEXP Rsh_Fir_user_function_inner1525449764_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner1525449764 dynamic dispatch ([expr, classes])

  return Rsh_Fir_user_version_inner1525449764_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner1525449764_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner1525449764 version 0 (*, * -+> V)

  if (NPARAMS != 2) Rsh_error("FIŘ arity mismatch for inner1525449764/0: expected 2, got %d", NPARAMS);
  ...
  // if classes_isMissing then L0("warning") else L0(classes)
...
L1_:;
  ...
  //   return expr2;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner1525449764_, CCP, RHO);
  // p1 = prom<V +>{
  //   r1 = clos inner530606259;
  //   return r1;
  // }
  Rsh_Fir_reg_p1_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner1525449764_1, CCP, RHO);
  // r3 = dyn withCallingHandlers[, warning](p, p1)
...
SEXP Rsh_Fir_user_promise_inner1525449764_1(SEXP CCP, SEXP RHO) {
  // r1 = clos inner530606259
  Rsh_Fir_reg_r1_ = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner530606259_, RHO, CCP);
  // return r1
  return Rsh_Fir_reg_r1_;
}
SEXP Rsh_Fir_user_function_inner530606259_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner530606259 dynamic dispatch ([w])

  return Rsh_Fir_user_version_inner530606259_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner530606259_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner530606259 version 0 (* -+> V)

  if (NPARAMS != 1) Rsh_error("FIŘ arity mismatch for inner530606259/0: expected 1, got %d", NPARAMS);
  ...
  // Bind parameters
  Rsh_Fir_reg_w = PARAMS[0];

  // mkenv
  Rsh_Fir_push_env(&RHO);
  (void)(R_NilValue);
  // st w = w
  Rsh_Fir_store(Rsh_const(CCP, 6), Rsh_Fir_reg_w, RHO);
  (void)(Rsh_Fir_reg_w);
  // sym = ldf inherits
...
L2_:;
  // w1 = ld w
  Rsh_Fir_reg_w1_ = Rsh_Fir_load(Rsh_const(CCP, 6), RHO);
  // check L4() else D0()
  // L4()
  goto L4_;

L3_:;
  // r = dyn base(<sym w>, <sym classes>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_w1_;
...
L4_:;
  ...
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_w2_;
...
L5_:;
  ...
  // r2 = dyn inherits(w2, classes1, FALSE)
  SEXP Rsh_Fir_array_args8[3];
  Rsh_Fir_array_args8[0] = Rsh_Fir_reg_w2_;
...
L8_:;
  // r3 = dyn tryInvokeRestart("muffleWarning")
