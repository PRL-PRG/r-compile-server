...
SEXP Rsh_Fir_user_version_inner4125524309_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_interruptsSuspended;  // interruptsSuspended
  SEXP Rsh_Fir_reg_r2_;  // r2
  SEXP Rsh_Fir_reg_suspended;  // suspended
  SEXP Rsh_Fir_reg_suspended1_;  // suspended1
  ...
  SEXP Rsh_Fir_reg_interruptsSuspended1_;  // interruptsSuspended1
...
L4_:;
  ...
  Rsh_Fir_reg_interruptsSuspended = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 5), RHO);
...
L7_:;
  ...
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_suspended1_;
...
D2_:;
  ...
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_expr1_;
...
L11_:;
  ...
  Rsh_Fir_reg_on_exit = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 4), RHO);
  // r5 = dyn on_exit(<lang .Internal(interruptsSuspended(suspended))>)
  SEXP Rsh_Fir_array_args7[1];
  Rsh_Fir_array_args7[0] = Rsh_const(CCP, 7);
  SEXP Rsh_Fir_array_arg_names1[1];
  Rsh_Fir_array_arg_names1[0] = R_MissingArg;
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_on_exit, 1, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names1, CCP, RHO);
  // goto L2()
  // L2()
  goto L2_;
...
L13_:;
  ...
  Rsh_Fir_reg_interruptsSuspended1_ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 5), RHO);
  // r8 = dyn interruptsSuspended1(TRUE)
  SEXP Rsh_Fir_array_args9[1];
  Rsh_Fir_array_args9[0] = Rsh_const(CCP, 8);
  SEXP Rsh_Fir_array_arg_names3[1];
  Rsh_Fir_array_arg_names3[0] = R_MissingArg;
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_interruptsSuspended1_, 1, Rsh_Fir_array_args9, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L15() else D3()
  // L15()
  goto L15_;

L14_:;
  // r6 = dyn base2(<lang interruptsSuspended(TRUE)>)
