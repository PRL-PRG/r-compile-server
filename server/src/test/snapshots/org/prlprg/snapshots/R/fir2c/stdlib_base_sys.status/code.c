...
L1_:;
  ...
  Rsh_Fir_reg_sys_calls = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 2), RHO);
  // check L3() else D0()
  // L3()
  goto L3_;

L2_:;
  // r = dyn base[`sys.calls`, `sys.parents`, `sys.frames`](<lang sys.calls()>, <lang sys.parents()>, <lang sys.frames()>)
...
L4_:;
  // sys_parents = ldf `sys.parents`
  Rsh_Fir_reg_sys_parents = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 6), RHO);
  // check L5() else D2()
  // L5()
  goto L5_;
...
L5_:;
  // r3 = dyn sys_parents()
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_sys_parents, 0, NULL, NULL, CCP, RHO);
  // check L6() else D3()
  // L6()
  goto L6_;
...
L6_:;
  // sys_frames = ldf `sys.frames`
  Rsh_Fir_reg_sys_frames = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 7), RHO);
  // check L7() else D4()
  // L7()
  goto L7_;
...
L7_:;
  // r4 = dyn sys_frames()
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_sys_frames, 0, NULL, NULL, CCP, RHO);
  // check L8() else D5()
  // L8()
  goto L8_;
...
L8_:;
  ...
  // r5 = dyn list(r2, r3, r4)
  SEXP Rsh_Fir_array_args2[3];
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg_r2_;
  Rsh_Fir_array_args2[1] = Rsh_Fir_reg_r3_;
  Rsh_Fir_array_args2[2] = Rsh_Fir_reg_r4_;
  SEXP Rsh_Fir_array_arg_names1[3];
  Rsh_Fir_array_arg_names1[0] = R_MissingArg;
  Rsh_Fir_array_arg_names1[1] = R_MissingArg;
  Rsh_Fir_array_arg_names1[2] = R_MissingArg;
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_list, 3, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L9() else D6()
  // L9()
  goto L9_;
