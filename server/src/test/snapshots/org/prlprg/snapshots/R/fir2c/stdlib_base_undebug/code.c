...
SEXP Rsh_Fir_user_version_inner2799144507_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_undebug;  // undebug
...
L11_:;
  ...
  // undebug = ldf undebug in base
  Rsh_Fir_reg_undebug = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 0), RHO);
  // r4 = dyn undebug(fun2)
  SEXP Rsh_Fir_array_args9[1];
  Rsh_Fir_array_args9[0] = Rsh_Fir_reg_fun2_;
  SEXP Rsh_Fir_array_arg_names2[1];
  Rsh_Fir_array_arg_names2[0] = R_MissingArg;
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_undebug, 1, Rsh_Fir_array_args9, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L12() else D2()
  // L12()
  goto L12_;
...
L17_:;
  // r6 = dyn ___("methods", ".undebugMethod")
...
L21_:;
  // r11 = dyn stop("failed to load methods package for undebugging by signature")
