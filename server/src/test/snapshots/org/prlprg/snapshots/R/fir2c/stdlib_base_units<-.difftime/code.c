...
SEXP Rsh_Fir_user_version_inner736444261_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_cumprod;  // cumprod
  ...
  SEXP Rsh_Fir_reg_sc4_;  // sc4
  SEXP Rsh_Fir_reg_sc5_;  // sc5
  SEXP Rsh_Fir_reg_c5_;  // c5
  SEXP Rsh_Fir_reg_dx3_;  // dx3
  SEXP Rsh_Fir_reg_sc7_;  // sc7
  ...
  SEXP Rsh_Fir_reg_newx;  // newx
  SEXP Rsh_Fir_reg_newx1_;  // newx1
  ...
  // units = ldf units
  Rsh_Fir_reg_units = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 1), RHO);
  // check L7() else D0()
  // L7()
  goto L7_;
...
L5_:;
  // cumprod = ldf cumprod in base
  Rsh_Fir_reg_cumprod = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 5), RHO);
  // r19 = dyn cumprod(r17)
  SEXP Rsh_Fir_array_args2[1];
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg_r17_;
  SEXP Rsh_Fir_array_arg_names[1];
  Rsh_Fir_array_arg_names[0] = R_MissingArg;
  Rsh_Fir_reg_r19_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_cumprod, 1, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L26() else D10()
  // L26()
  goto L26_;
...
L7_:;
  ...
  Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_units, 1, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L8() else D1()
  // L8()
  goto L8_;
...
L8_:;
  ...
  // from = ld from
  Rsh_Fir_reg_from = Rsh_Fir_load(Rsh_const(CCP, 9), RHO);
  // check L9() else D2()
  // L9()
  goto L9_;
...
D2_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_from;
  Rsh_Fir_deopt(5, 1, Rsh_Fir_array_deopt_stack1, CCP, RHO);
  return R_NilValue;

L9_:;
  // from1 = force? from
  Rsh_Fir_reg_from1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_from);
  // checkMissing(from1)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_from1_;
...
D3_:;
  // deopt 6 [from1, value1]
  SEXP Rsh_Fir_array_deopt_stack2[2];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_from1_;
  Rsh_Fir_array_deopt_stack2[1] = Rsh_Fir_reg_value1_;
...
L10_:;
  ...
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_from1_;
  Rsh_Fir_array_args7[1] = Rsh_Fir_reg_value2_;
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_builtin(74, CCP, RHO, 2, Rsh_Fir_array_args7, Rsh_Fir_param_types_empty());
  // c = `as.logical`(r2)
...
L15_:;
  ...
  // L1():
  //   c1 = ldf c in base;
  //   r8 = dyn c1("secs", "mins", "hours", "days", "weeks");
  //   goto L0(r8);
  // L2():
  //   r6 = dyn base("secs", "mins", "hours", "days", "weeks");
  //   goto L0(r6);
  // }
...
L16_:;
  ...
  Rsh_Fir_reg_r11_ = Rsh_Fir_call_builtin(82, CCP, RHO, 1, Rsh_Fir_array_args15, Rsh_Fir_param_types_empty());
  // c2 = `as.logical`(r11)
...
L18_:;
  // r12 = dyn stop("invalid units specified")
  SEXP Rsh_Fir_array_args17[1];
  Rsh_Fir_array_args17[0] = Rsh_const(CCP, 17);
  SEXP Rsh_Fir_array_arg_names5[1];
  Rsh_Fir_array_arg_names5[0] = R_MissingArg;
  Rsh_Fir_reg_r12_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_stop, 1, Rsh_Fir_array_args17, Rsh_Fir_array_arg_names5, CCP, RHO);
  // check L19() else D8()
  // L19()
  goto L19_;
...
L22_:;
  // r14 = dyn base1(<lang c(secs=1.0, mins=60.0, hours=60.0, days=24.0, weeks=7.0)>)
  SEXP Rsh_Fir_array_args19[1];
  Rsh_Fir_array_args19[0] = Rsh_const(CCP, 18);
  SEXP Rsh_Fir_array_arg_names6[1];
  Rsh_Fir_array_arg_names6[0] = R_MissingArg;
  Rsh_Fir_reg_r14_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 1, Rsh_Fir_array_args19, Rsh_Fir_array_arg_names6, CCP, RHO);
  // goto L4(r14)
  // L4(r14)
...
L23_:;
  ...
  // r18 = dyn c3(1.0, 60.0, 60.0, 24.0, 7.0)
  ...
  Rsh_Fir_array_args20[3] = Rsh_const(CCP, 21);
  Rsh_Fir_array_args20[4] = Rsh_const(CCP, 22);
  ...
  Rsh_Fir_reg_r18_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c3_, 5, Rsh_Fir_array_args20, Rsh_Fir_array_arg_names7, CCP, RHO);
  // check L25() else D9()
  // L25()
  goto L25_;

L24_:;
  // r16 = dyn base2[secs, mins, hours, days, weeks](1.0, 60.0, 60.0, 24.0, 7.0)
  SEXP Rsh_Fir_array_args21[5];
  Rsh_Fir_array_args21[0] = Rsh_const(CCP, 19);
  Rsh_Fir_array_args21[1] = Rsh_const(CCP, 20);
  Rsh_Fir_array_args21[2] = Rsh_const(CCP, 20);
  Rsh_Fir_array_args21[3] = Rsh_const(CCP, 21);
  Rsh_Fir_array_args21[4] = Rsh_const(CCP, 22);
  SEXP Rsh_Fir_array_arg_names8[5];
  Rsh_Fir_array_arg_names8[0] = Rsh_const(CCP, 23);
  Rsh_Fir_array_arg_names8[1] = Rsh_const(CCP, 24);
  Rsh_Fir_array_arg_names8[2] = Rsh_const(CCP, 25);
  Rsh_Fir_array_arg_names8[3] = Rsh_const(CCP, 26);
  Rsh_Fir_array_arg_names8[4] = Rsh_const(CCP, 27);
  Rsh_Fir_reg_r16_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base2_, 5, Rsh_Fir_array_args21, Rsh_Fir_array_arg_names8, CCP, RHO);
  // goto L5(r16)
  // L5(r16)
...
L28_:;
  ...
  Rsh_Fir_reg_r20_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base3_, 1, Rsh_Fir_array_args22, Rsh_Fir_array_arg_names9, CCP, RHO);
  // goto L6(r20)
  // L6(r20)
...
L29_:;
  ...
  Rsh_Fir_reg_r22_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_unclass, 1, Rsh_Fir_array_args24, Rsh_Fir_array_arg_names10, CCP, RHO);
  // check L30() else D12()
  // L30()
  goto L30_;
...
L31_:;
  ...
  //   checkMissing(sc1);
  //   c4 = `is.object`(sc1);
  //   if c4 then L2() else L3(sc1);
  // L0(dx1):
  //   sc4 = ld sc;
  //   sc5 = force? sc4;
  //   checkMissing(sc5);
  //   c5 = `is.object`(sc5);
  //   if c5 then L5() else L6(dx1, sc5);
  // L2():
  //   dr = tryDispatchBuiltin.1("[", sc1);
  ...
  //   goto L0(dx);
  // L5():
  //   dr2 = tryDispatchBuiltin.1("[", sc5);
  //   dc1 = getTryDispatchBuiltinDispatched(dr2);
  //   if dc1 then L7() else L6(dx1, dr2);
  // L6(dx3, sc7):
  //   value5 = ld value;
  //   value6 = force? value5;
  //   __1 = ldf `[` in base;
  //   r24 = dyn __1(sc7, value6);
  //   goto L1(dx3, r24);
  // L7():
  ...
  // r27 = dyn as_vector(p3)
  SEXP Rsh_Fir_array_args38[1];
  Rsh_Fir_array_args38[0] = Rsh_Fir_reg_p3_;
  SEXP Rsh_Fir_array_arg_names13[1];
  Rsh_Fir_array_arg_names13[0] = R_MissingArg;
  Rsh_Fir_reg_r27_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_as_vector, 1, Rsh_Fir_array_args38, Rsh_Fir_array_arg_names13, CCP, RHO);
  // check L32() else D14()
  // L32()
  goto L32_;
...
L32_:;
  ...
  Rsh_Fir_array_args39[1] = Rsh_Fir_reg_r27_;
  Rsh_Fir_reg_r28_ = Rsh_Fir_call_builtin(68, CCP, RHO, 2, Rsh_Fir_array_args39, Rsh_Fir_param_types_empty());
  // st newx = r28
  Rsh_Fir_store(Rsh_const(CCP, 30), Rsh_Fir_reg_r28_, RHO);
  (void)(Rsh_Fir_reg_r28_);
  // _difftime = ldf `.difftime`
  Rsh_Fir_reg__difftime = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 0), RHO);
  // check L33() else D15()
  // L33()
  goto L33_;
...
L33_:;
  ...
  Rsh_Fir_reg_r31_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__difftime, 2, Rsh_Fir_array_args42, Rsh_Fir_array_arg_names14, CCP, RHO);
  // check L34() else D16()
  // L34()
  goto L34_;
...
SEXP Rsh_Fir_user_promise_inner736444261_1(SEXP CCP, SEXP RHO) {
  ...
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_value4_;
...
L1_:;
  ...
  Rsh_Fir_array_args12[4] = Rsh_const(CCP, 15);
  ...
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c1_, 5, Rsh_Fir_array_args12, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L0(r8)
  // L0(r8)
...
L2_:;
  ...
  Rsh_Fir_array_args13[2] = Rsh_const(CCP, 13);
  ...
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 5, Rsh_Fir_array_args13, Rsh_Fir_array_arg_names3, CCP, RHO);
  // goto L0(r6)
  // L0(r6)
...
SEXP Rsh_Fir_user_promise_inner736444261_3(SEXP CCP, SEXP RHO) {
  // sc = ld sc
  Rsh_Fir_reg_sc = Rsh_Fir_load(Rsh_const(CCP, 6), RHO);
  // sc1 = force? sc
  Rsh_Fir_reg_sc1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_sc);
  // checkMissing(sc1)
  SEXP Rsh_Fir_array_args25[1];
  Rsh_Fir_array_args25[0] = Rsh_Fir_reg_sc1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args25, Rsh_Fir_param_types_empty()));
  // c4 = `is.object`(sc1)
  SEXP Rsh_Fir_array_args26[1];
  Rsh_Fir_array_args26[0] = Rsh_Fir_reg_sc1_;
  ...
  // L3(sc1)
    Rsh_Fir_reg_sc3_ = Rsh_Fir_reg_sc1_;
    goto L3_;
  }

L0_:;
  // sc4 = ld sc
  Rsh_Fir_reg_sc4_ = Rsh_Fir_load(Rsh_const(CCP, 6), RHO);
  // sc5 = force? sc4
  Rsh_Fir_reg_sc5_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_sc4_);
  // checkMissing(sc5)
  SEXP Rsh_Fir_array_args27[1];
  Rsh_Fir_array_args27[0] = Rsh_Fir_reg_sc5_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args27, Rsh_Fir_param_types_empty()));
  // c5 = `is.object`(sc5)
  SEXP Rsh_Fir_array_args28[1];
  Rsh_Fir_array_args28[0] = Rsh_Fir_reg_sc5_;
  ...
  // L6(dx1, sc5)
    ...
    Rsh_Fir_reg_sc7_ = Rsh_Fir_reg_sc5_;
    goto L6_;
  }
...
L1_:;
  ...
  Rsh_Fir_array_args29[0] = Rsh_Fir_reg_dx6_;
  Rsh_Fir_array_args29[1] = Rsh_Fir_reg_dx7_;
  Rsh_Fir_reg_r25_ = Rsh_Fir_call_builtin(69, CCP, RHO, 2, Rsh_Fir_array_args29, Rsh_Fir_param_types_empty());
  // return r25
...
L2_:;
  ...
  // L3(dr)
    Rsh_Fir_reg_sc3_ = Rsh_Fir_reg_dr;
    goto L3_;
  }

L3_:;
  // from2 = ld from
  Rsh_Fir_reg_from2_ = Rsh_Fir_load(Rsh_const(CCP, 9), RHO);
  // from3 = force? from2
  Rsh_Fir_reg_from3_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_from2_);
  // __ = ldf `[` in base
  Rsh_Fir_reg___ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 29), RHO);
  // r23 = dyn __(sc3, from3)
  SEXP Rsh_Fir_array_args32[2];
  Rsh_Fir_array_args32[0] = Rsh_Fir_reg_sc3_;
  Rsh_Fir_array_args32[1] = Rsh_Fir_reg_from3_;
  SEXP Rsh_Fir_array_arg_names11[2];
  Rsh_Fir_array_arg_names11[0] = R_MissingArg;
  Rsh_Fir_array_arg_names11[1] = R_MissingArg;
  Rsh_Fir_reg_r23_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 2, Rsh_Fir_array_args32, Rsh_Fir_array_arg_names11, CCP, RHO);
  // goto L0(r23)
  // L0(r23)
...
L5_:;
  ...
  Rsh_Fir_array_args34[1] = Rsh_Fir_reg_sc5_;
  ...
  // L6(dx1, dr2)
    Rsh_Fir_reg_dx3_ = Rsh_Fir_reg_dx1_;
    Rsh_Fir_reg_sc7_ = Rsh_Fir_reg_dr2_;
    goto L6_;
  }
...
L6_:;
  ...
  Rsh_Fir_array_args36[0] = Rsh_Fir_reg_sc7_;
  Rsh_Fir_array_args36[1] = Rsh_Fir_reg_value6_;
  SEXP Rsh_Fir_array_arg_names12[2];
  Rsh_Fir_array_arg_names12[0] = R_MissingArg;
  Rsh_Fir_array_arg_names12[1] = R_MissingArg;
  Rsh_Fir_reg_r24_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___1_, 2, Rsh_Fir_array_args36, Rsh_Fir_array_arg_names12, CCP, RHO);
  // goto L1(dx3, r24)
  // L1(dx3, r24)
...
L7_:;
  ...
  Rsh_Fir_reg_dx5_ = Rsh_Fir_intrinsic_getTryDispatchBuiltinValue(CCP, RHO, 1, Rsh_Fir_array_args37, Rsh_Fir_param_types_empty());
  // goto L1(dx1, dx5)
  // L1(dx1, dx5)
...
SEXP Rsh_Fir_user_promise_inner736444261_4(SEXP CCP, SEXP RHO) {
  // newx = ld newx
  Rsh_Fir_reg_newx = Rsh_Fir_load(Rsh_const(CCP, 30), RHO);
  // newx1 = force? newx
  Rsh_Fir_reg_newx1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_newx);
  // checkMissing(newx1)
  SEXP Rsh_Fir_array_args40[1];
  Rsh_Fir_array_args40[0] = Rsh_Fir_reg_newx1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args40, Rsh_Fir_param_types_empty()));
  // return newx1
  return Rsh_Fir_reg_newx1_;
}
SEXP Rsh_Fir_user_promise_inner736444261_5(SEXP CCP, SEXP RHO) {
  // value7 = ld value
  ...
  Rsh_Fir_array_args41[0] = Rsh_Fir_reg_value8_;
