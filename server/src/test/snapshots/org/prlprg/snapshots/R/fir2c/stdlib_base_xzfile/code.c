...
SEXP Rsh_Fir_user_function_inner49449181_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner49449181_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_promise_inner49449181_(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner49449181
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner49449181_, RHO, CCP);
  // st xzfile = r
...
SEXP Rsh_Fir_user_function_inner49449181_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner49449181 dynamic dispatch ([description, open, encoding, compression])

  return Rsh_Fir_user_version_inner49449181_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner49449181_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner49449181 version 0 (*, *, *, * -+> V)

  if (NPARAMS != 4) Rsh_error("FIŘ arity mismatch for inner49449181/0: expected 4, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_xzfile;  // xzfile
...
L1_:;
  ...
  //   return r;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner49449181_, CCP, RHO);
  // goto L2(p)
  // L2(p)
...
L2_:;
  ...
  // if compression_isMissing then L3(6.0) else L3(compression)
...
L6_:;
  // r2 = dyn base(<lang xzfile(description, open, encoding, compression)>)
...
L10_:;
  ...
  // xzfile = ldf xzfile in base
  Rsh_Fir_reg_xzfile = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 0), RHO);
  // r4 = dyn xzfile(description2, open2, encoding2, compression2)
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_xzfile, 4, Rsh_Fir_array_args10, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L11() else D4()
  // L11()
  goto L11_;
