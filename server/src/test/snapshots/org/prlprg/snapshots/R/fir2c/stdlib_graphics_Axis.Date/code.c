...
SEXP Rsh_Fir_user_version_inner794228160_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_axis_Date;  // axis_Date
...
L2_:;
  ...
  // axis_Date = ldf `axis.Date`
  Rsh_Fir_reg_axis_Date = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 8), RHO);
  // check L3() else D0()
  // L3()
  goto L3_;
...
L3_:;
  ...
  // r4 = dyn axis_Date[side, x, at, labels, `...`](p, p1, p2, p3, ddd1)
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_axis_Date, 5, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L4() else D1()
  // L4()
  goto L4_;
