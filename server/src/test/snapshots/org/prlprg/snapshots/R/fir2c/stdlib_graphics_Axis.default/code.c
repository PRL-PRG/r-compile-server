...
L2_:;
  ...
  // axis = ldf axis
  Rsh_Fir_reg_axis = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 7), RHO);
  // check L3() else D0()
  // L3()
  goto L3_;
...
L3_:;
  ...
  // r3 = dyn axis[side, at, labels, `...`](p, p1, p2, ddd1)
  ...
  Rsh_Fir_array_args6[3] = Rsh_Fir_reg_ddd1_;
  ...
  Rsh_Fir_array_arg_names[3] = Rsh_const(CCP, 4);
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_axis, 4, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L4() else D1()
  // L4()
  goto L4_;
...
SEXP Rsh_Fir_user_promise_inner2989570553_1(SEXP CCP, SEXP RHO) {
  ...
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_at2_;
...
SEXP Rsh_Fir_user_promise_inner2989570553_2(SEXP CCP, SEXP RHO) {
  ...
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_labels2_;
