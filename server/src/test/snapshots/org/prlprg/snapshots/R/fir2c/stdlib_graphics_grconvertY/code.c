...
SEXP Rsh_Fir_user_function_inner3538033796_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner3538033796_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_promise_inner3538033796_(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner3538033796_1(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner3538033796_2(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner3538033796_3(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner3538033796
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner3538033796_, RHO, CCP);
  // st grconvertY = r
...
SEXP Rsh_Fir_user_function_inner3538033796_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner3538033796 dynamic dispatch ([y, from, to])

  return Rsh_Fir_user_version_inner3538033796_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner3538033796_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner3538033796 version 0 (*, *, * -+> V)

  if (NPARAMS != 3) Rsh_error("FIŘ arity mismatch for inner3538033796/0: expected 3, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_convertY;  // C_convertY
  SEXP Rsh_Fir_reg_C_convertY1_;  // C_convertY1
...
L4_:;
  ...
  //   return from2;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3538033796_, CCP, RHO);
  // p1 = prom<V +>{
  //   _units = ld `.units`;
  ...
  //   return _units1;
  // }
  Rsh_Fir_reg_p1_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3538033796_1, CCP, RHO);
  // r2 = dyn pmatch(p, p1)
...
L6_:;
  ...
  //   return to2;
  // }
  Rsh_Fir_reg_p2_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3538033796_2, CCP, RHO);
  // p3 = prom<V +>{
  //   _units2 = ld `.units`;
  ...
  //   return _units3;
  // }
  Rsh_Fir_reg_p3_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3538033796_3, CCP, RHO);
...
L8_:;
  // C_convertY = ld C_convertY
  Rsh_Fir_reg_C_convertY = Rsh_Fir_load(Rsh_const(CCP, 8), RHO);
  // check L10() else D4()
  // L10()
  goto L10_;

L9_:;
  // r6 = dyn base(<sym C_convertY>, <lang as.double(y)>, <sym from>, <sym to>)
...
D4_:;
  ...
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_convertY;
  Rsh_Fir_deopt(14, 1, Rsh_Fir_array_deopt_stack2, CCP, RHO);
  return R_NilValue;

L10_:;
  // C_convertY1 = force? C_convertY
  Rsh_Fir_reg_C_convertY1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_convertY);
  // checkMissing(C_convertY1)
  SEXP Rsh_Fir_array_args10[1];
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_C_convertY1_;
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_y1_;
...
L16_:;
  ...
  // r11 = dyn _External(C_convertY1, r9, from4, to4)
  SEXP Rsh_Fir_array_args17[4];
  Rsh_Fir_array_args17[0] = Rsh_Fir_reg_C_convertY1_;
