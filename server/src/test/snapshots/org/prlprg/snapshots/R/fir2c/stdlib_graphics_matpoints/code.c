...
SEXP Rsh_Fir_user_function_inner2815229838_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner2815229838_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_promise_inner2815229838_(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner2815229838_1(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner2815229838_2(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner2815229838_3(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner2815229838_4(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner2815229838_5(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner2815229838_6(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner2815229838_7(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner2815229838_8(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner2815229838
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner2815229838_, RHO, CCP);
  // st matpoints = r
...
SEXP Rsh_Fir_user_function_inner2815229838_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner2815229838 dynamic dispatch ([x, y, type, lty, lwd, pch, col, `...`])

  return Rsh_Fir_user_version_inner2815229838_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner2815229838_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner2815229838 version 0 (*, *, *, *, *, *, *, dots -+> V)

  if (NPARAMS != 8) Rsh_error("FIŘ arity mismatch for inner2815229838/0: expected 8, got %d", NPARAMS);
  ...
  // if type_isMissing then L0("p") else L0(type)
...
L1_:;
  ...
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2815229838_, CCP, RHO);
  // goto L2(p)
  // L2(p)
...
L5_:;
  ...
  // }
  Rsh_Fir_reg_p1_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2815229838_1, CCP, RHO);
  // goto L6(p1)
  // L6(p1)
...
L7_:;
  ...
  //   return x2;
  // }
  Rsh_Fir_reg_p2_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2815229838_2, CCP, RHO);
  // p3 = prom<V +>{
  //   y1 = ld y;
  //   y2 = force? y1;
  //   checkMissing(y2);
  //   return y2;
  // }
  Rsh_Fir_reg_p3_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2815229838_3, CCP, RHO);
  // p4 = prom<V +>{
  //   type1 = ld type;
  //   type2 = force? type1;
  //   checkMissing(type2);
  //   return type2;
  // }
  Rsh_Fir_reg_p4_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2815229838_4, CCP, RHO);
  // p5 = prom<V +>{
  //   lty1 = ld lty;
  //   lty2 = force? lty1;
  //   checkMissing(lty2);
  //   return lty2;
  // }
  Rsh_Fir_reg_p5_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2815229838_5, CCP, RHO);
  // p6 = prom<V +>{
  //   lwd1 = ld lwd;
  //   lwd2 = force? lwd1;
  //   checkMissing(lwd2);
  //   return lwd2;
  // }
  Rsh_Fir_reg_p6_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2815229838_6, CCP, RHO);
  // p7 = prom<V +>{
  //   pch1 = ld pch;
  //   pch2 = force? pch1;
  //   checkMissing(pch2);
  //   return pch2;
  // }
  Rsh_Fir_reg_p7_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2815229838_7, CCP, RHO);
  // p8 = prom<V +>{
  //   col1 = ld col;
  //   col2 = force? col1;
  //   checkMissing(col2);
  //   return col2;
  // }
  Rsh_Fir_reg_p8_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2815229838_8, CCP, RHO);
  // ddd1 = ld `...`
