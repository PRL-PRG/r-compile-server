...
L11_:;
  ...
  // points = ldf points
  Rsh_Fir_reg_points = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 17), RHO);
  // check L42() else D12()
  // L42()
  goto L42_;
...
L40_:;
  ...
  Rsh_Fir_reg_r28_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_seq_int, 1, Rsh_Fir_array_args46, Rsh_Fir_array_arg_names16, CCP, RHO);
  // check L41() else D11()
  // L41()
  goto L41_;
...
L42_:;
  ...
  // r36 = dyn points[, , type, lwd, `...`](p1, p2, p3, p4, ddd1)
  ...
  Rsh_Fir_array_arg_names19[2] = Rsh_const(CCP, 5);
  Rsh_Fir_array_arg_names19[3] = Rsh_const(CCP, 7);
  Rsh_Fir_array_arg_names19[4] = Rsh_const(CCP, 8);
  Rsh_Fir_reg_r36_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_points, 5, Rsh_Fir_array_args54, Rsh_Fir_array_arg_names19, CCP, RHO);
  // check L43() else D13()
  // L43()
  goto L43_;
...
L45_:;
  ...
  Rsh_Fir_reg_r37_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_stop, 1, Rsh_Fir_array_args55, Rsh_Fir_array_arg_names20, CCP, RHO);
  // check L46() else D15()
  // L46()
  goto L46_;
...
L1_:;
  ...
  Rsh_Fir_reg_r32_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_unclass, 1, Rsh_Fir_array_args50, Rsh_Fir_array_arg_names17, CCP, RHO);
  // goto L0(r32)
  // L0(r32)
...
L2_:;
  ...
  Rsh_Fir_reg_r30_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base8_, 1, Rsh_Fir_array_args51, Rsh_Fir_array_arg_names18, CCP, RHO);
  // goto L0(r30)
  // L0(r30)
