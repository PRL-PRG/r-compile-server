...
SEXP Rsh_Fir_user_function_inner3562470093_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner3562470093_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_promise_inner3562470093_(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner3562470093
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner3562470093_, RHO, CCP);
  // st xinch = r
...
SEXP Rsh_Fir_user_function_inner3562470093_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner3562470093 dynamic dispatch ([x, `warn.log`])

  return Rsh_Fir_user_version_inner3562470093_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner3562470093_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner3562470093 version 0 (*, * -+> V)

  if (NPARAMS != 2) Rsh_error("FIŘ arity mismatch for inner3562470093/0: expected 2, got %d", NPARAMS);
  ...
  // if x_isMissing then L0(1.0) else L0(x)
...
L12_:;
  // r1 = dyn warning("x log scale:  xinch() is nonsense")
...
L16_:;
  ...
  // L2(r5):
  //   __ = ldf `[` in base;
  //   r6 = dyn __(r5, <int 1, 2>);
  //   goto L0(r6);
  // L3():
  //   dx = getTryDispatchBuiltinValue(dr);
  //   goto L0(dx);
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3562470093_, CCP, RHO);
  // r8 = dyn diff(p)
...
D7_:;
  ...
  Rsh_Fir_array_deopt_stack6[0] = Rsh_Fir_reg_x2_;
