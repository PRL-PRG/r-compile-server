...
SEXP Rsh_Fir_user_version_inner3253127715_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg__actionMetaName;  // _actionMetaName
  SEXP Rsh_Fir_reg_r1;  // r
  SEXP Rsh_Fir_reg_exists;  // exists
  SEXP Rsh_Fir_reg_actionListName;  // actionListName
  SEXP Rsh_Fir_reg_actionListName1_;  // actionListName1
  ...
  SEXP Rsh_Fir_reg_actionListName2_;  // actionListName2
  SEXP Rsh_Fir_reg_actionListName3_;  // actionListName3
  ...
  // _actionMetaName = ldf `.actionMetaName`
  Rsh_Fir_reg__actionMetaName = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 2), RHO);
  // check L1() else D0()
  // L1()
  goto L1_;
...
L1_:;
  // r = dyn _actionMetaName("")
  SEXP Rsh_Fir_array_args[1];
  Rsh_Fir_array_args[0] = Rsh_const(CCP, 4);
  SEXP Rsh_Fir_array_arg_names[1];
  Rsh_Fir_array_arg_names[0] = R_MissingArg;
  Rsh_Fir_reg_r1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg__actionMetaName, 1, Rsh_Fir_array_args, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L2() else D1()
  // L2()
  goto L2_;
...
L3_:;
  // p = prom<V +>{
  //   actionListName = ld actionListName;
  //   actionListName1 = force? actionListName;
  //   checkMissing(actionListName1);
  //   return actionListName1;
  // }
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_exists, 3, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L4() else D3()
  // L4()
  goto L4_;
...
L5_:;
  // get = ldf get
  Rsh_Fir_reg_get = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 10), RHO);
  // check L6() else D4()
  // L6()
  goto L6_;
...
L6_:;
  // p2 = prom<V +>{
  //   actionListName2 = ld actionListName;
  //   actionListName3 = force? actionListName2;
  //   checkMissing(actionListName3);
  //   return actionListName3;
  // }
  ...
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_get, 2, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L7() else D5()
  // L7()
  goto L7_;
...
SEXP Rsh_Fir_user_promise_inner3253127715_(SEXP CCP, SEXP RHO) {
  // actionListName = ld actionListName
  Rsh_Fir_reg_actionListName = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // actionListName1 = force? actionListName
  Rsh_Fir_reg_actionListName1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_actionListName);
  // checkMissing(actionListName1)
  SEXP Rsh_Fir_array_args1[1];
  Rsh_Fir_array_args1[0] = Rsh_Fir_reg_actionListName1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args1, Rsh_Fir_param_types_empty()));
  // return actionListName1
  return Rsh_Fir_reg_actionListName1_;
}
SEXP Rsh_Fir_user_promise_inner3253127715_1(SEXP CCP, SEXP RHO) {
  // where1 = ld where
...
SEXP Rsh_Fir_user_promise_inner3253127715_2(SEXP CCP, SEXP RHO) {
  // actionListName2 = ld actionListName
  Rsh_Fir_reg_actionListName2_ = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // actionListName3 = force? actionListName2
  Rsh_Fir_reg_actionListName3_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_actionListName2_);
  // checkMissing(actionListName3)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_actionListName3_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args5, Rsh_Fir_param_types_empty()));
  // return actionListName3
  return Rsh_Fir_reg_actionListName3_;
}
SEXP Rsh_Fir_user_promise_inner3253127715_3(SEXP CCP, SEXP RHO) {
  // where3 = ld where
  ...
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_where4_;
