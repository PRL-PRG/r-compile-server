...
SEXP Rsh_Fir_user_version_inner2656251490_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg__cacheGenericTable;  // _cacheGenericTable
  ...
  // _cacheGenericTable = ldf `.cacheGenericTable`
  Rsh_Fir_reg__cacheGenericTable = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 3), RHO);
  // check L0() else D0()
  // L0()
  goto L0_;
...
L0_:;
  ...
  // r3 = dyn _cacheGenericTable(p, p1, p2)
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__cacheGenericTable, 3, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
SEXP Rsh_Fir_user_promise_inner2656251490_2(SEXP CCP, SEXP RHO) {
  // _implicitTable = ld `.implicitTable`
  Rsh_Fir_reg__implicitTable = Rsh_Fir_load(Rsh_const(CCP, 4), RHO);
  // _implicitTable1 = force? _implicitTable
  Rsh_Fir_reg__implicitTable1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg__implicitTable);
  // checkMissing(_implicitTable1)
  SEXP Rsh_Fir_array_args2[1];
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg__implicitTable1_;
