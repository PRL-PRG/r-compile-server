...
L1_:;
  ...
  Rsh_Fir_reg_C_R_getClassFromCache = Rsh_Fir_load(Rsh_const(CCP, 3), RHO);
  // check L3() else D0()
  // L3()
  goto L3_;

L2_:;
  // r = dyn base(<sym C_R_getClassFromCache>, <sym name>, <sym .classTable>)
...
D0_:;
  // deopt 1 [C_R_getClassFromCache]
  SEXP Rsh_Fir_array_deopt_stack[1];
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_R_getClassFromCache;
...
L3_:;
  ...
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg_C_R_getClassFromCache1_;
...
D1_:;
  // deopt 2 [C_R_getClassFromCache1, name1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_R_getClassFromCache1_;
...
D2_:;
  // deopt 3 [C_R_getClassFromCache1, name2, _classTable]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_R_getClassFromCache1_;
  Rsh_Fir_array_deopt_stack2[1] = Rsh_Fir_reg_name2_;
  Rsh_Fir_array_deopt_stack2[2] = Rsh_Fir_reg__classTable;
...
L5_:;
  ...
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg__classTable1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args4, Rsh_Fir_param_types_empty()));
  // vargs = dots[name2, _classTable1]
  SEXP Rsh_Fir_array_vector_values[2];
  Rsh_Fir_array_vector_values[0] = Rsh_Fir_reg_name2_;
  ...
  // r2 = `.Call`(C_R_getClassFromCache1, vargs, <missing>)
  SEXP Rsh_Fir_array_args5[3];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_C_R_getClassFromCache1_;
