...
SEXP Rsh_Fir_user_version_inner2708337952_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_C_R_externalptr_prototype_object;  // C_R_externalptr_prototype_object
  SEXP Rsh_Fir_reg_C_R_externalptr_prototype_object1_;  // C_R_externalptr_prototype_object1
...
L1_:;
  // C_R_externalptr_prototype_object = ld C_R_externalptr_prototype_object
  Rsh_Fir_reg_C_R_externalptr_prototype_object = Rsh_Fir_load(Rsh_const(CCP, 2), RHO);
  // check L3() else D0()
  // L3()
  goto L3_;

L2_:;
  // r = dyn base(<sym C_R_externalptr_prototype_object>)
...
D0_:;
  // deopt 1 [C_R_externalptr_prototype_object]
  SEXP Rsh_Fir_array_deopt_stack[1];
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_R_externalptr_prototype_object;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L3_:;
  // C_R_externalptr_prototype_object1 = force? C_R_externalptr_prototype_object
  Rsh_Fir_reg_C_R_externalptr_prototype_object1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_R_externalptr_prototype_object);
  // checkMissing(C_R_externalptr_prototype_object1)
  SEXP Rsh_Fir_array_args2[1];
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg_C_R_externalptr_prototype_object1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args2, Rsh_Fir_param_types_empty()));
  // vargs = dots[]
  Rsh_Fir_reg_vargs = Rsh_Fir_mk_vector(Rsh_Fir_kind_dots, 0, NULL, NULL);
  // r2 = `.Call`(C_R_externalptr_prototype_object1, vargs, <missing>)
  SEXP Rsh_Fir_array_args3[3];
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_C_R_externalptr_prototype_object1_;
