...
SEXP Rsh_Fir_user_version_inner4102710431_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg__packageForGeneric;  // _packageForGeneric
  SEXP Rsh_Fir_reg__packageForGeneric1_;  // _packageForGeneric1
...
L5_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_is_list, 1, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L6() else D1()
  // L6()
  goto L6_;
...
L8_:;
  ...
  // p1 = prom<V +>{
  //   _packageForGeneric = ld `.packageForGeneric`;
  //   _packageForGeneric1 = force? _packageForGeneric;
  //   checkMissing(_packageForGeneric1);
  //   return _packageForGeneric1;
  // }
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_lapply, 2, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L9() else D3()
  // L9()
  goto L9_;
...
L11_:;
  ...
  Rsh_Fir_reg_r7_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_is, 2, Rsh_Fir_array_args9, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L12() else D5()
  // L12()
  goto L12_;
...
L13_:;
  ...
  // r8 = dyn __(<sym object>, <sym package>)
...
SEXP Rsh_Fir_user_promise_inner4102710431_1(SEXP CCP, SEXP RHO) {
  // _packageForGeneric = ld `.packageForGeneric`
  Rsh_Fir_reg__packageForGeneric = Rsh_Fir_load(Rsh_const(CCP, 0), RHO);
  // _packageForGeneric1 = force? _packageForGeneric
  Rsh_Fir_reg__packageForGeneric1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg__packageForGeneric);
  // checkMissing(_packageForGeneric1)
  SEXP Rsh_Fir_array_args6[1];
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg__packageForGeneric1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args6, Rsh_Fir_param_types_empty()));
  // return _packageForGeneric1
  return Rsh_Fir_reg__packageForGeneric1_;
}
SEXP Rsh_Fir_user_promise_inner4102710431_2(SEXP CCP, SEXP RHO) {
  // object5 = ld object
