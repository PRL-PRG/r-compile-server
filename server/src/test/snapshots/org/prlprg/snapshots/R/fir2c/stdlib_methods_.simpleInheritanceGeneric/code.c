...
L1_:;
  ...
  // r6 = dyn identical(r3, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE)
  ...
  Rsh_Fir_array_args1[4] = Rsh_const(CCP, 3);
  Rsh_Fir_array_args1[5] = Rsh_const(CCP, 3);
  Rsh_Fir_array_args1[6] = Rsh_const(CCP, 4);
  Rsh_Fir_array_args1[7] = Rsh_const(CCP, 3);
  ...
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_identical, 9, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L7() else D1()
  // L7()
  goto L7_;
...
L3_:;
  // r = dyn base(<lang attr(`@`(fdef, signature), "simpleOnly")>, TRUE)
...
L4_:;
  ...
  // r4 = dyn __(<sym fdef>, <sym signature>)
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 2, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names2, CCP, RHO);
  // attr = ldf attr in base
  Rsh_Fir_reg_attr = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 5), RHO);
  // r5 = dyn attr(r4, "simpleOnly")
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_attr, 2, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L6() else D0()
  // L6()
  goto L6_;

L5_:;
  // r2 = dyn base1(<lang `@`(fdef, signature)>, "simpleOnly")
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 2, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names4, CCP, RHO);
  // goto L1(r2)
  // L1(r2)
