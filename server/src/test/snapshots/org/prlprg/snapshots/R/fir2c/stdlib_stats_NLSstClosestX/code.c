...
SEXP Rsh_Fir_user_function_inner1908530717_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner1908530717_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_NLSstClosestX;
  ...
  (void)(R_NilValue);
  // r = clos inner1908530717
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner1908530717_, RHO, CCP);
  // st NLSstClosestX = r
...
L11_:;
  ...
  // NLSstClosestX = ldf NLSstClosestX
  Rsh_Fir_reg_NLSstClosestX = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 0), RHO);
  // check L12() else D4()
  // L12()
  goto L12_;
...
L12_:;
  ...
  Rsh_Fir_reg_r15_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_NLSstClosestX, 2, Rsh_Fir_array_args22, Rsh_Fir_array_arg_names6, CCP, RHO);
  // check L13() else D5()
  // L13()
  goto L13_;
...
SEXP Rsh_Fir_user_function_inner1908530717_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner1908530717 dynamic dispatch ([xy, yval])

  return Rsh_Fir_user_version_inner1908530717_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner1908530717_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner1908530717 version 0 (*, * -+> V)

  if (NPARAMS != 2) Rsh_error("FIŘ arity mismatch for inner1908530717/0: expected 2, got %d", NPARAMS);

  // Declare locals
  SEXP Rsh_Fir_reg_xy;
  SEXP Rsh_Fir_reg_yval;
  ...
  Rsh_Fir_reg_yval = PARAMS[1];

  // mkenv
  Rsh_Fir_push_env(&RHO);
  (void)(R_NilValue);
  // st xy = xy
  Rsh_Fir_store(Rsh_const(CCP, 15), Rsh_Fir_reg_xy, RHO);
  (void)(Rsh_Fir_reg_xy);
  // st yval = yval
  Rsh_Fir_store(Rsh_const(CCP, 16), Rsh_Fir_reg_yval, RHO);
  (void)(Rsh_Fir_reg_yval);
  // sym = ldf UseMethod
...
L1_:;
  ...
  // r2 = dyn UseMethod("NLSstClosestX")
