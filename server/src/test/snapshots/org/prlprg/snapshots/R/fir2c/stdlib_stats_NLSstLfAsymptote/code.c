...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_NLSstLfAsymptote;
...
L11_:;
  ...
  // NLSstLfAsymptote = ldf NLSstLfAsymptote
  Rsh_Fir_reg_NLSstLfAsymptote = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 0), RHO);
  // check L12() else D4()
  // L12()
  goto L12_;
...
L12_:;
  ...
  // r15 = dyn NLSstLfAsymptote(p3)
  SEXP Rsh_Fir_array_args22[1];
  Rsh_Fir_array_args22[0] = Rsh_Fir_reg_p3_;
  SEXP Rsh_Fir_array_arg_names6[1];
  Rsh_Fir_array_arg_names6[0] = R_MissingArg;
  Rsh_Fir_reg_r15_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_NLSstLfAsymptote, 1, Rsh_Fir_array_args22, Rsh_Fir_array_arg_names6, CCP, RHO);
  // check L13() else D5()
  // L13()
  goto L13_;
...
L1_:;
  ...
  // r2 = dyn UseMethod("NLSstLfAsymptote")
