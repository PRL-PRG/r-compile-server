...
SEXP Rsh_Fir_user_version_inner2560675370_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_fbcv;  // fbcv
  SEXP Rsh_Fir_reg_fbcv1_;  // fbcv1
...
SEXP Rsh_Fir_user_promise_inner2560675370_7(SEXP CCP, SEXP RHO) {
  // fbcv = ld fbcv
  Rsh_Fir_reg_fbcv = Rsh_Fir_load(Rsh_const(CCP, 19), RHO);
  // fbcv1 = force? fbcv
  Rsh_Fir_reg_fbcv1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_fbcv);
  // checkMissing(fbcv1)
  SEXP Rsh_Fir_array_args78[1];
  Rsh_Fir_array_args78[0] = Rsh_Fir_reg_fbcv1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args78, Rsh_Fir_param_types_empty()));
  // return fbcv1
  return Rsh_Fir_reg_fbcv1_;
}
SEXP Rsh_Fir_user_promise_inner2560675370_8(SEXP CCP, SEXP RHO) {
  // sym7 = ldf c
...
SEXP Rsh_Fir_user_version_inner1031285476_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_C_bw_bcv;  // C_bw_bcv
  SEXP Rsh_Fir_reg_C_bw_bcv1_;  // C_bw_bcv1
...
L1_:;
  // C_bw_bcv = ld C_bw_bcv
  Rsh_Fir_reg_C_bw_bcv = Rsh_Fir_load(Rsh_const(CCP, 46), RHO);
  // check L3() else D0()
  // L3()
  goto L3_;

L2_:;
  // r = dyn base(<sym C_bw_bcv>, <sym n>, <sym d>, <sym cnt>, <sym h>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack34[0] = Rsh_Fir_reg_C_bw_bcv;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack34, CCP, RHO);
  return R_NilValue;

L3_:;
  // C_bw_bcv1 = force? C_bw_bcv
  Rsh_Fir_reg_C_bw_bcv1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_bw_bcv);
  // checkMissing(C_bw_bcv1)
  SEXP Rsh_Fir_array_args108[1];
  Rsh_Fir_array_args108[0] = Rsh_Fir_reg_C_bw_bcv1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack35[0] = Rsh_Fir_reg_C_bw_bcv1_;
...
D2_:;
  // deopt 3 [C_bw_bcv1, n1, d]
  SEXP Rsh_Fir_array_deopt_stack36[3];
  Rsh_Fir_array_deopt_stack36[0] = Rsh_Fir_reg_C_bw_bcv1_;
...
D3_:;
  // deopt 4 [C_bw_bcv1, n1, d1, cnt]
  SEXP Rsh_Fir_array_deopt_stack37[4];
  Rsh_Fir_array_deopt_stack37[0] = Rsh_Fir_reg_C_bw_bcv1_;
...
D4_:;
  // deopt 5 [C_bw_bcv1, n1, d1, cnt1, h1]
  SEXP Rsh_Fir_array_deopt_stack38[5];
  Rsh_Fir_array_deopt_stack38[0] = Rsh_Fir_reg_C_bw_bcv1_;
...
L7_:;
  ...
  // r2 = `.Call`(C_bw_bcv1, vargs, <missing>)
  SEXP Rsh_Fir_array_args113[3];
  Rsh_Fir_array_args113[0] = Rsh_Fir_reg_C_bw_bcv1_;
