...
SEXP Rsh_Fir_user_function_inner2847418551_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner2847418551_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner2847418551
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner2847418551_, RHO, CCP);
  // st dbeta = r
...
SEXP Rsh_Fir_user_function_inner2847418551_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner2847418551 dynamic dispatch ([x, shape1, shape2, ncp, log])

  return Rsh_Fir_user_version_inner2847418551_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner2847418551_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner2847418551 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner2847418551/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_dbeta;  // C_dbeta
  SEXP Rsh_Fir_reg_C_dbeta1_;  // C_dbeta1
  ...
  SEXP Rsh_Fir_reg_C_dnbeta;  // C_dnbeta
  SEXP Rsh_Fir_reg_C_dnbeta1_;  // C_dnbeta1
...
L9_:;
  // C_dbeta = ld C_dbeta
  Rsh_Fir_reg_C_dbeta = Rsh_Fir_load(Rsh_const(CCP, 10), RHO);
  // check L11() else D0()
  // L11()
  goto L11_;

L10_:;
  // r3 = dyn base1(<sym C_dbeta>, <sym x>, <sym shape1>, <sym shape2>, <sym log>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_dbeta;
  Rsh_Fir_deopt(4, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L11_:;
  // C_dbeta1 = force? C_dbeta
  Rsh_Fir_reg_C_dbeta1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_dbeta);
  // checkMissing(C_dbeta1)
  SEXP Rsh_Fir_array_args9[1];
  Rsh_Fir_array_args9[0] = Rsh_Fir_reg_C_dbeta1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_dbeta1_;
...
D2_:;
  // deopt 6 [C_dbeta1, x2, shape3]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_dbeta1_;
...
L13_:;
  ...
  Rsh_Fir_array_args11[0] = Rsh_Fir_reg_shape4_;
...
D3_:;
  // deopt 7 [C_dbeta1, x2, shape4, shape5]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_dbeta1_;
...
L14_:;
  ...
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_shape6_;
...
D4_:;
  // deopt 8 [C_dbeta1, x2, shape4, shape6, log1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_dbeta1_;
...
L15_:;
  ...
  Rsh_Fir_array_args13[0] = Rsh_Fir_reg_log2_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args13, Rsh_Fir_param_types_empty()));
  // vargs = dots[x2, shape4, shape6, log2]
  ...
  // r5 = `.Call`(C_dbeta1, vargs, <missing>)
  SEXP Rsh_Fir_array_args14[3];
  Rsh_Fir_array_args14[0] = Rsh_Fir_reg_C_dbeta1_;
...
L17_:;
  // C_dnbeta = ld C_dnbeta
  Rsh_Fir_reg_C_dnbeta = Rsh_Fir_load(Rsh_const(CCP, 12), RHO);
  // check L19() else D5()
  // L19()
  goto L19_;

L18_:;
  // r6 = dyn base2(<sym C_dnbeta>, <sym x>, <sym shape1>, <sym shape2>, <sym ncp>, <sym log>)
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_dnbeta;
  Rsh_Fir_deopt(12, 1, Rsh_Fir_array_deopt_stack5, CCP, RHO);
  return R_NilValue;

L19_:;
  // C_dnbeta1 = force? C_dnbeta
  Rsh_Fir_reg_C_dnbeta1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_dnbeta);
  // checkMissing(C_dnbeta1)
  SEXP Rsh_Fir_array_args16[1];
  Rsh_Fir_array_args16[0] = Rsh_Fir_reg_C_dnbeta1_;
...
D6_:;
  // deopt 13 [C_dnbeta1, x3]
  SEXP Rsh_Fir_array_deopt_stack6[2];
  Rsh_Fir_array_deopt_stack6[0] = Rsh_Fir_reg_C_dnbeta1_;
...
D7_:;
  // deopt 14 [C_dnbeta1, x4, shape7]
  SEXP Rsh_Fir_array_deopt_stack7[3];
  Rsh_Fir_array_deopt_stack7[0] = Rsh_Fir_reg_C_dnbeta1_;
  Rsh_Fir_array_deopt_stack7[1] = Rsh_Fir_reg_x4_;
  Rsh_Fir_array_deopt_stack7[2] = Rsh_Fir_reg_shape7_;
...
L21_:;
  ...
  Rsh_Fir_array_args18[0] = Rsh_Fir_reg_shape8_;
...
D8_:;
  // deopt 15 [C_dnbeta1, x4, shape8, shape9]
  SEXP Rsh_Fir_array_deopt_stack8[4];
  Rsh_Fir_array_deopt_stack8[0] = Rsh_Fir_reg_C_dnbeta1_;
  Rsh_Fir_array_deopt_stack8[1] = Rsh_Fir_reg_x4_;
  Rsh_Fir_array_deopt_stack8[2] = Rsh_Fir_reg_shape8_;
  Rsh_Fir_array_deopt_stack8[3] = Rsh_Fir_reg_shape9_;
...
L22_:;
  ...
  Rsh_Fir_array_args19[0] = Rsh_Fir_reg_shape10_;
...
D9_:;
  // deopt 16 [C_dnbeta1, x4, shape8, shape10, ncp1]
  SEXP Rsh_Fir_array_deopt_stack9[5];
  Rsh_Fir_array_deopt_stack9[0] = Rsh_Fir_reg_C_dnbeta1_;
  Rsh_Fir_array_deopt_stack9[1] = Rsh_Fir_reg_x4_;
  Rsh_Fir_array_deopt_stack9[2] = Rsh_Fir_reg_shape8_;
  Rsh_Fir_array_deopt_stack9[3] = Rsh_Fir_reg_shape10_;
...
L23_:;
  ...
  // log3 = ld log
  Rsh_Fir_reg_log3_ = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // check L24() else D10()
  // L24()
  goto L24_;

D10_:;
  // deopt 17 [C_dnbeta1, x4, shape8, shape10, ncp2, log3]
  SEXP Rsh_Fir_array_deopt_stack10[6];
  Rsh_Fir_array_deopt_stack10[0] = Rsh_Fir_reg_C_dnbeta1_;
...
L24_:;
  ...
  Rsh_Fir_array_args21[0] = Rsh_Fir_reg_log4_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args21, Rsh_Fir_param_types_empty()));
  // vargs1 = dots[x4, shape8, shape10, ncp2, log4]
  ...
  // r8 = `.Call`(C_dnbeta1, vargs1, <missing>)
  SEXP Rsh_Fir_array_args22[3];
  Rsh_Fir_array_args22[0] = Rsh_Fir_reg_C_dnbeta1_;
