...
SEXP Rsh_Fir_user_function_inner312461984_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner312461984_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner312461984
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner312461984_, RHO, CCP);
  // st dbinom = r
...
SEXP Rsh_Fir_user_function_inner312461984_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner312461984 dynamic dispatch ([x, size, prob, log])

  return Rsh_Fir_user_version_inner312461984_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner312461984_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner312461984 version 0 (*, *, *, * -+> V)

  if (NPARAMS != 4) Rsh_error("FIŘ arity mismatch for inner312461984/0: expected 4, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_dbinom;  // C_dbinom
  SEXP Rsh_Fir_reg_C_dbinom1_;  // C_dbinom1
...
L2_:;
  // C_dbinom = ld C_dbinom
  Rsh_Fir_reg_C_dbinom = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // check L4() else D0()
  // L4()
  goto L4_;

L3_:;
  // r = dyn base(<sym C_dbinom>, <sym x>, <sym size>, <sym prob>, <sym log>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_dbinom;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L4_:;
  // C_dbinom1 = force? C_dbinom
  Rsh_Fir_reg_C_dbinom1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_dbinom);
  // checkMissing(C_dbinom1)
  SEXP Rsh_Fir_array_args3[1];
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_C_dbinom1_;
...
D1_:;
  // deopt 2 [C_dbinom1, x1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_dbinom1_;
...
D2_:;
  // deopt 3 [C_dbinom1, x2, size1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_dbinom1_;
...
L6_:;
  ...
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_size2_;
...
D3_:;
  // deopt 4 [C_dbinom1, x2, size2, prob1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_dbinom1_;
...
D4_:;
  // deopt 5 [C_dbinom1, x2, size2, prob2, log1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_dbinom1_;
...
L8_:;
  ...
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_log2_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args7, Rsh_Fir_param_types_empty()));
  // vargs = dots[x2, size2, prob2, log2]
  ...
  // r2 = `.Call`(C_dbinom1, vargs, <missing>)
  SEXP Rsh_Fir_array_args8[3];
  Rsh_Fir_array_args8[0] = Rsh_Fir_reg_C_dbinom1_;
