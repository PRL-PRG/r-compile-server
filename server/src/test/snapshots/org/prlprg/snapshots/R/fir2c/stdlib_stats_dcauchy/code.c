...
SEXP Rsh_Fir_user_version_inner687643580_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_C_dcauchy;  // C_dcauchy
  SEXP Rsh_Fir_reg_C_dcauchy1_;  // C_dcauchy1
...
L4_:;
  // C_dcauchy = ld C_dcauchy
  Rsh_Fir_reg_C_dcauchy = Rsh_Fir_load(Rsh_const(CCP, 9), RHO);
  // check L6() else D0()
  // L6()
  goto L6_;

L5_:;
  // r = dyn base(<sym C_dcauchy>, <sym x>, <sym location>, <sym scale>, <sym log>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_dcauchy;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L6_:;
  // C_dcauchy1 = force? C_dcauchy
  Rsh_Fir_reg_C_dcauchy1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_dcauchy);
  // checkMissing(C_dcauchy1)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_C_dcauchy1_;
...
D1_:;
  // deopt 2 [C_dcauchy1, x1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_dcauchy1_;
...
D2_:;
  // deopt 3 [C_dcauchy1, x2, location1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_dcauchy1_;
...
D3_:;
  // deopt 4 [C_dcauchy1, x2, location2, scale1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_dcauchy1_;
...
D4_:;
  // deopt 5 [C_dcauchy1, x2, location2, scale2, log1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_dcauchy1_;
...
L10_:;
  ...
  // r2 = `.Call`(C_dcauchy1, vargs, <missing>)
  SEXP Rsh_Fir_array_args10[3];
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_C_dcauchy1_;
