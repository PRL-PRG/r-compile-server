...
L3_:;
  ...
  Rsh_Fir_reg_r11_ = Rsh_Fir_call_builtin(69, CCP, RHO, 2, Rsh_Fir_array_args4, Rsh_Fir_param_types_empty());
  // popenv
  Rsh_Fir_pop_env(&RHO);
  (void)(R_NilValue);
  // return r11
...
L5_:;
  // r = dyn base(<lang `<-`(xtsp, attr(x, "tsp"))>)
...
L8_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_attr, 2, Rsh_Fir_array_args9, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L9() else D1()
  // L9()
  goto L9_;
...
L10_:;
  // xtsp = ld xtsp
  Rsh_Fir_reg_xtsp = Rsh_Fir_load(Rsh_const(CCP, 4), RHO);
  // check L11() else D2()
  // L11()
  goto L11_;
...
D2_:;
  ...
  Rsh_Fir_array_deopt_stack2[1] = Rsh_Fir_reg_xtsp;
...
L12_:;
  ...
  Rsh_Fir_array_args12[1] = Rsh_Fir_reg_xtsp1_;
  ...
  // if dc then L14() else L13(1.0, dr)
...
L13_:;
  ...
  Rsh_Fir_array_args14[0] = Rsh_Fir_reg_xtsp3_;
  Rsh_Fir_array_args14[1] = Rsh_const(CCP, 12);
  SEXP Rsh_Fir_array_arg_names3[2];
  Rsh_Fir_array_arg_names3[0] = R_MissingArg;
  Rsh_Fir_array_arg_names3[1] = R_MissingArg;
  Rsh_Fir_reg_r10_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 2, Rsh_Fir_array_args14, Rsh_Fir_array_arg_names3, CCP, RHO);
  // goto L3(r7, r10)
  // L3(r7, r10)
...
L14_:;
  ...
  // goto L3(1.0, dx)
  // L3(1.0, dx)
  Rsh_Fir_reg_r9_ = Rsh_const(CCP, 6);
