...
SEXP Rsh_Fir_user_function_inner2682058355_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner2682058355_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_promise_inner2682058355_(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner2682058355
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner2682058355_, RHO, CCP);
  // st dgamma = r
...
SEXP Rsh_Fir_user_function_inner2682058355_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner2682058355 dynamic dispatch ([x, shape, rate, scale, log])

  return Rsh_Fir_user_version_inner2682058355_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner2682058355_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner2682058355 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner2682058355/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_dgamma;  // C_dgamma
  SEXP Rsh_Fir_reg_C_dgamma1_;  // C_dgamma1
...
L1_:;
  ...
  //   return r;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2682058355_, CCP, RHO);
  // goto L2(p)
  // L2(p)
...
L2_:;
  ...
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_log;
  Rsh_Fir_reg_log_isMissing = Rsh_Fir_builtin_missing_v0(CCP, RHO, 1, Rsh_Fir_array_args4);
  // if log_isMissing then L3(FALSE) else L3(log)
...
L6_:;
  ...
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_builtin(82, CCP, RHO, 1, Rsh_Fir_array_args9, Rsh_Fir_param_types_empty());
  // c6 = `as.logical`(r9)
...
L8_:;
  ...
  Rsh_Fir_reg_r15_ = Rsh_Fir_call_builtin(76, CCP, RHO, 2, Rsh_Fir_array_args12, Rsh_Fir_param_types_empty());
  // c10 = `as.logical`(r15)
  SEXP Rsh_Fir_array_args13[1];
  Rsh_Fir_array_args13[0] = Rsh_Fir_reg_r15_;
  Rsh_Fir_reg_c10_ = Rsh_Fir_call_builtin(324, CCP, RHO, 1, Rsh_Fir_array_args13, Rsh_Fir_param_types_empty());
  // if c10 then L25() else L9()
...
L13_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_missing, 1, Rsh_Fir_array_args15, Rsh_Fir_array_arg_names, CCP, RHO);
  // goto L4(r4)
  // L4(r4)
...
L14_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 1, Rsh_Fir_array_args16, Rsh_Fir_array_arg_names1, CCP, RHO);
  // goto L4(r2)
  // L4(r2)
...
L16_:;
  ...
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_missing1_, 1, Rsh_Fir_array_args18, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L6(c, r8)
  // L6(c, r8)
...
L21_:;
  ...
  Rsh_Fir_reg_r10_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base2_, 1, Rsh_Fir_array_args21, Rsh_Fir_array_arg_names4, CCP, RHO);
  // goto L8(r10)
  // L8(r10)
...
L22_:;
  ...
  Rsh_Fir_array_args22[0] = Rsh_Fir_reg_rate4_;
...
L23_:;
  ...
  Rsh_Fir_array_args24[0] = Rsh_Fir_reg_rate4_;
  Rsh_Fir_array_args24[1] = Rsh_Fir_reg_scale2_;
  Rsh_Fir_reg_r12_ = Rsh_Fir_call_builtin(68, CCP, RHO, 2, Rsh_Fir_array_args24, Rsh_Fir_param_types_empty());
  // r13 = `-`(r12, 1.0)
  SEXP Rsh_Fir_array_args25[2];
  Rsh_Fir_array_args25[0] = Rsh_Fir_reg_r12_;
  Rsh_Fir_array_args25[1] = Rsh_const(CCP, 3);
  Rsh_Fir_reg_r13_ = Rsh_Fir_call_builtin(67, CCP, RHO, 2, Rsh_Fir_array_args25, Rsh_Fir_param_types_empty());
  // abs = ldf abs in base
  Rsh_Fir_reg_abs = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 12), RHO);
  // r14 = dyn abs(r13)
  SEXP Rsh_Fir_array_args26[1];
  Rsh_Fir_array_args26[0] = Rsh_Fir_reg_r13_;
  SEXP Rsh_Fir_array_arg_names5[1];
  Rsh_Fir_array_arg_names5[0] = R_MissingArg;
  Rsh_Fir_reg_r14_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_abs, 1, Rsh_Fir_array_args26, Rsh_Fir_array_arg_names5, CCP, RHO);
  // check L24() else D2()
  // L24()
  goto L24_;
...
L26_:;
  ...
  Rsh_Fir_reg_r16_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_warning, 1, Rsh_Fir_array_args27, Rsh_Fir_array_arg_names6, CCP, RHO);
  // check L27() else D4()
  // L27()
  goto L27_;
...
L29_:;
  ...
  Rsh_Fir_reg_r18_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_stop, 1, Rsh_Fir_array_args28, Rsh_Fir_array_arg_names7, CCP, RHO);
  // check L30() else D6()
  // L30()
  goto L30_;
...
L32_:;
  // C_dgamma = ld C_dgamma
  Rsh_Fir_reg_C_dgamma = Rsh_Fir_load(Rsh_const(CCP, 16), RHO);
  // check L34() else D7()
  // L34()
  goto L34_;

L33_:;
  // r20 = dyn base3(<sym C_dgamma>, <sym x>, <sym shape>, <sym scale>, <sym log>)
  SEXP Rsh_Fir_array_args29[5];
  Rsh_Fir_array_args29[0] = Rsh_const(CCP, 16);
  Rsh_Fir_array_args29[1] = Rsh_const(CCP, 1);
  Rsh_Fir_array_args29[2] = Rsh_const(CCP, 2);
  Rsh_Fir_array_args29[3] = Rsh_const(CCP, 5);
  Rsh_Fir_array_args29[4] = Rsh_const(CCP, 7);
  ...
  Rsh_Fir_reg_r20_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base3_, 5, Rsh_Fir_array_args29, Rsh_Fir_array_arg_names8, CCP, RHO);
  // goto L12(r20)
  // L12(r20)
...
D7_:;
  ...
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_dgamma;
  Rsh_Fir_deopt(32, 1, Rsh_Fir_array_deopt_stack5, CCP, RHO);
  return R_NilValue;

L34_:;
  // C_dgamma1 = force? C_dgamma
  Rsh_Fir_reg_C_dgamma1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_dgamma);
  // checkMissing(C_dgamma1)
  SEXP Rsh_Fir_array_args30[1];
  Rsh_Fir_array_args30[0] = Rsh_Fir_reg_C_dgamma1_;
...
D8_:;
  // deopt 33 [C_dgamma1, x1]
  SEXP Rsh_Fir_array_deopt_stack6[2];
  Rsh_Fir_array_deopt_stack6[0] = Rsh_Fir_reg_C_dgamma1_;
  Rsh_Fir_array_deopt_stack6[1] = Rsh_Fir_reg_x1_;
...
D9_:;
  // deopt 34 [C_dgamma1, x2, shape1]
  SEXP Rsh_Fir_array_deopt_stack7[3];
  Rsh_Fir_array_deopt_stack7[0] = Rsh_Fir_reg_C_dgamma1_;
...
L36_:;
  ...
  Rsh_Fir_array_args32[0] = Rsh_Fir_reg_shape2_;
...
D10_:;
  // deopt 35 [C_dgamma1, x2, shape2, scale3]
  SEXP Rsh_Fir_array_deopt_stack8[4];
  Rsh_Fir_array_deopt_stack8[0] = Rsh_Fir_reg_C_dgamma1_;
...
L37_:;
  ...
  Rsh_Fir_array_args33[0] = Rsh_Fir_reg_scale4_;
...
D11_:;
  // deopt 36 [C_dgamma1, x2, shape2, scale4, log1]
  SEXP Rsh_Fir_array_deopt_stack9[5];
  Rsh_Fir_array_deopt_stack9[0] = Rsh_Fir_reg_C_dgamma1_;
  Rsh_Fir_array_deopt_stack9[1] = Rsh_Fir_reg_x2_;
  Rsh_Fir_array_deopt_stack9[2] = Rsh_Fir_reg_shape2_;
  Rsh_Fir_array_deopt_stack9[3] = Rsh_Fir_reg_scale4_;
  Rsh_Fir_array_deopt_stack9[4] = Rsh_Fir_reg_log1_;
...
L38_:;
  ...
  Rsh_Fir_array_args34[0] = Rsh_Fir_reg_log2_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args34, Rsh_Fir_param_types_empty()));
  // vargs = dots[x2, shape2, scale4, log2]
  ...
  // r22 = `.Call`(C_dgamma1, vargs, <missing>)
  SEXP Rsh_Fir_array_args35[3];
  Rsh_Fir_array_args35[0] = Rsh_Fir_reg_C_dgamma1_;
  Rsh_Fir_array_args35[1] = Rsh_Fir_reg_vargs;
  Rsh_Fir_array_args35[2] = Rsh_const(CCP, 17);
  Rsh_Fir_reg_r22_ = Rsh_Fir_call_builtin(438, CCP, RHO, 3, Rsh_Fir_array_args35, Rsh_Fir_param_types_empty());
  // goto L12(r22)
  // L12(r22)
