...
SEXP Rsh_Fir_user_function_inner314242101_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner314242101_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner314242101_, RHO, CCP);
  // st dgeom = r
...
SEXP Rsh_Fir_user_function_inner314242101_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner314242101 dynamic dispatch ([x, prob, log])

  return Rsh_Fir_user_version_inner314242101_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner314242101_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner314242101 version 0 (*, *, * -+> V)

  if (NPARAMS != 3) Rsh_error("FIŘ arity mismatch for inner314242101/0: expected 3, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_dgeom;  // C_dgeom
  SEXP Rsh_Fir_reg_C_dgeom1_;  // C_dgeom1
...
L2_:;
  // C_dgeom = ld C_dgeom
  Rsh_Fir_reg_C_dgeom = Rsh_Fir_load(Rsh_const(CCP, 6), RHO);
  // check L4() else D0()
  // L4()
  goto L4_;
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_dgeom;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L4_:;
  // C_dgeom1 = force? C_dgeom
  Rsh_Fir_reg_C_dgeom1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_dgeom);
  // checkMissing(C_dgeom1)
  SEXP Rsh_Fir_array_args3[1];
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_C_dgeom1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_dgeom1_;
...
D2_:;
  ...
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_dgeom1_;
...
D3_:;
  ...
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_dgeom1_;
...
L7_:;
  ...
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_C_dgeom1_;
