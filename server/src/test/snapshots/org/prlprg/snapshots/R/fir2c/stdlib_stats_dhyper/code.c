...
SEXP Rsh_Fir_user_function_inner472114676_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner472114676_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner472114676
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner472114676_, RHO, CCP);
  // st dhyper = r
...
SEXP Rsh_Fir_user_function_inner472114676_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner472114676 dynamic dispatch ([x, m, n, k, log])

  return Rsh_Fir_user_version_inner472114676_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner472114676_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner472114676 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner472114676/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_dhyper;  // C_dhyper
  SEXP Rsh_Fir_reg_C_dhyper1_;  // C_dhyper1
...
L2_:;
  // C_dhyper = ld C_dhyper
  Rsh_Fir_reg_C_dhyper = Rsh_Fir_load(Rsh_const(CCP, 8), RHO);
  // check L4() else D0()
  // L4()
  goto L4_;

L3_:;
  // r = dyn base(<sym C_dhyper>, <sym x>, <sym m>, <sym n>, <sym k>, <sym log>)
  ...
  Rsh_Fir_reg_r1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 6, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names, CCP, RHO);
  // goto L1(r)
  // L1(r)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_dhyper;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L4_:;
  // C_dhyper1 = force? C_dhyper
  Rsh_Fir_reg_C_dhyper1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_dhyper);
  // checkMissing(C_dhyper1)
  SEXP Rsh_Fir_array_args3[1];
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_C_dhyper1_;
...
D1_:;
  // deopt 2 [C_dhyper1, x1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_dhyper1_;
...
D2_:;
  // deopt 3 [C_dhyper1, x2, m1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_dhyper1_;
...
L6_:;
  ...
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_m2_;
...
D3_:;
  // deopt 4 [C_dhyper1, x2, m2, n1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_dhyper1_;
...
D4_:;
  // deopt 5 [C_dhyper1, x2, m2, n2, k1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_dhyper1_;
...
D5_:;
  // deopt 6 [C_dhyper1, x2, m2, n2, k2, log1]
  SEXP Rsh_Fir_array_deopt_stack5[6];
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_dhyper1_;
  ...
  Rsh_Fir_array_deopt_stack5[5] = Rsh_Fir_reg_log1_;
...
L9_:;
  ...
  Rsh_Fir_array_vector_values[4] = Rsh_Fir_reg_log2_;
  ...
  // r2 = `.Call`(C_dhyper1, vargs, <missing>)
  SEXP Rsh_Fir_array_args9[3];
  Rsh_Fir_array_args9[0] = Rsh_Fir_reg_C_dhyper1_;
