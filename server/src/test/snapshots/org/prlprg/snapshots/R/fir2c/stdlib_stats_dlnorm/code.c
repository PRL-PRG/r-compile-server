...
SEXP Rsh_Fir_user_function_inner83473225_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner83473225_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner83473225
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner83473225_, RHO, CCP);
  // st dlnorm = r
...
SEXP Rsh_Fir_user_function_inner83473225_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner83473225 dynamic dispatch ([x, meanlog, sdlog, log])

  return Rsh_Fir_user_version_inner83473225_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner83473225_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner83473225 version 0 (*, *, *, * -+> V)

  if (NPARAMS != 4) Rsh_error("FIŘ arity mismatch for inner83473225/0: expected 4, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_dlnorm;  // C_dlnorm
  SEXP Rsh_Fir_reg_C_dlnorm1_;  // C_dlnorm1
...
L4_:;
  // C_dlnorm = ld C_dlnorm
  Rsh_Fir_reg_C_dlnorm = Rsh_Fir_load(Rsh_const(CCP, 9), RHO);
  // check L6() else D0()
  // L6()
  goto L6_;

L5_:;
  // r = dyn base(<sym C_dlnorm>, <sym x>, <sym meanlog>, <sym sdlog>, <sym log>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_dlnorm;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L6_:;
  // C_dlnorm1 = force? C_dlnorm
  Rsh_Fir_reg_C_dlnorm1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_dlnorm);
  // checkMissing(C_dlnorm1)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_C_dlnorm1_;
...
D1_:;
  // deopt 2 [C_dlnorm1, x1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_dlnorm1_;
...
D2_:;
  // deopt 3 [C_dlnorm1, x2, meanlog1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_dlnorm1_;
...
L8_:;
  ...
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_meanlog2_;
...
D3_:;
  // deopt 4 [C_dlnorm1, x2, meanlog2, sdlog1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_dlnorm1_;
...
L9_:;
  ...
  Rsh_Fir_array_args8[0] = Rsh_Fir_reg_sdlog2_;
...
D4_:;
  // deopt 5 [C_dlnorm1, x2, meanlog2, sdlog2, log1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_dlnorm1_;
...
L10_:;
  ...
  // vargs = dots[x2, meanlog2, sdlog2, log2]
  ...
  // r2 = `.Call`(C_dlnorm1, vargs, <missing>)
  SEXP Rsh_Fir_array_args10[3];
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_C_dlnorm1_;
