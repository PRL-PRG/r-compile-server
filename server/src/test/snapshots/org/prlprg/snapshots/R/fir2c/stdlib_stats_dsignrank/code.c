...
SEXP Rsh_Fir_user_function_inner2120918512_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner2120918512_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner2120918512
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner2120918512_, RHO, CCP);
  // st dsignrank = r
...
SEXP Rsh_Fir_user_function_inner2120918512_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner2120918512 dynamic dispatch ([x, n, log])

  return Rsh_Fir_user_version_inner2120918512_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner2120918512_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner2120918512 version 0 (*, *, * -+> V)

  if (NPARAMS != 3) Rsh_error("FIŘ arity mismatch for inner2120918512/0: expected 3, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_dsignrank;  // C_dsignrank
  SEXP Rsh_Fir_reg_C_dsignrank1_;  // C_dsignrank1
...
L3_:;
  ...
  Rsh_Fir_reg_on_exit = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 5), RHO);
...
L5_:;
  // C_dsignrank = ld C_dsignrank
  Rsh_Fir_reg_C_dsignrank = Rsh_Fir_load(Rsh_const(CCP, 8), RHO);
  // check L7() else D0()
  // L7()
  goto L7_;

L6_:;
  // r3 = dyn base1(<sym C_dsignrank>, <sym x>, <sym n>, <sym log>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_dsignrank;
  Rsh_Fir_deopt(4, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L7_:;
  // C_dsignrank1 = force? C_dsignrank
  Rsh_Fir_reg_C_dsignrank1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_dsignrank);
  // checkMissing(C_dsignrank1)
  SEXP Rsh_Fir_array_args6[1];
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_C_dsignrank1_;
...
D1_:;
  // deopt 5 [C_dsignrank1, x1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_dsignrank1_;
...
D2_:;
  // deopt 6 [C_dsignrank1, x2, n1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_dsignrank1_;
...
D3_:;
  // deopt 7 [C_dsignrank1, x2, n2, log1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_dsignrank1_;
...
L10_:;
  ...
  // r5 = `.Call`(C_dsignrank1, vargs, <missing>)
  SEXP Rsh_Fir_array_args10[3];
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_C_dsignrank1_;
