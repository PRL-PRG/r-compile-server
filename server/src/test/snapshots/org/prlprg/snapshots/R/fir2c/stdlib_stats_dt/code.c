...
SEXP Rsh_Fir_user_function_inner2844100249_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner2844100249_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner2844100249
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner2844100249_, RHO, CCP);
  // st dt = r
...
SEXP Rsh_Fir_user_function_inner2844100249_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner2844100249 dynamic dispatch ([x, df, ncp, log])

  return Rsh_Fir_user_version_inner2844100249_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner2844100249_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner2844100249 version 0 (*, *, *, * -+> V)

  if (NPARAMS != 4) Rsh_error("FIŘ arity mismatch for inner2844100249/0: expected 4, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_dt;  // C_dt
  SEXP Rsh_Fir_reg_C_dt1_;  // C_dt1
  ...
  SEXP Rsh_Fir_reg_C_dnt;  // C_dnt
  SEXP Rsh_Fir_reg_C_dnt1_;  // C_dnt1
...
L8_:;
  // C_dt = ld C_dt
  Rsh_Fir_reg_C_dt = Rsh_Fir_load(Rsh_const(CCP, 8), RHO);
  // check L10() else D0()
  // L10()
  goto L10_;

L9_:;
  // r3 = dyn base1(<sym C_dt>, <sym x>, <sym df>, <sym log>)
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 4, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L3(r3)
  // L3(r3)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_dt;
  Rsh_Fir_deopt(4, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L10_:;
  // C_dt1 = force? C_dt
  Rsh_Fir_reg_C_dt1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_dt);
  // checkMissing(C_dt1)
  SEXP Rsh_Fir_array_args8[1];
  Rsh_Fir_array_args8[0] = Rsh_Fir_reg_C_dt1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_dt1_;
...
D2_:;
  // deopt 6 [C_dt1, x2, df1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_dt1_;
...
D3_:;
  // deopt 7 [C_dt1, x2, df2, log1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_dt1_;
...
L13_:;
  ...
  // r5 = `.Call`(C_dt1, vargs, <missing>)
  SEXP Rsh_Fir_array_args12[3];
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_C_dt1_;
  Rsh_Fir_array_args12[1] = Rsh_Fir_reg_vargs;
  Rsh_Fir_array_args12[2] = Rsh_const(CCP, 9);
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_builtin(438, CCP, RHO, 3, Rsh_Fir_array_args12, Rsh_Fir_param_types_empty());
  // goto L3(r5)
  // L3(r5)
...
L15_:;
  // C_dnt = ld C_dnt
  Rsh_Fir_reg_C_dnt = Rsh_Fir_load(Rsh_const(CCP, 10), RHO);
  // check L17() else D4()
  // L17()
  goto L17_;

L16_:;
  // r6 = dyn base2(<sym C_dnt>, <sym x>, <sym df>, <sym ncp>, <sym log>)
  ...
  Rsh_Fir_array_args13[4] = Rsh_const(CCP, 5);
  ...
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base2_, 5, Rsh_Fir_array_args13, Rsh_Fir_array_arg_names3, CCP, RHO);
  // goto L4(r6)
  // L4(r6)
...
D4_:;
  ...
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_dnt;
  Rsh_Fir_deopt(11, 1, Rsh_Fir_array_deopt_stack4, CCP, RHO);
  return R_NilValue;

L17_:;
  // C_dnt1 = force? C_dnt
  Rsh_Fir_reg_C_dnt1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_dnt);
  // checkMissing(C_dnt1)
  SEXP Rsh_Fir_array_args14[1];
  Rsh_Fir_array_args14[0] = Rsh_Fir_reg_C_dnt1_;
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_dnt1_;
...
D6_:;
  // deopt 13 [C_dnt1, x4, df3]
  SEXP Rsh_Fir_array_deopt_stack6[3];
  Rsh_Fir_array_deopt_stack6[0] = Rsh_Fir_reg_C_dnt1_;
...
L19_:;
  ...
  Rsh_Fir_array_args16[0] = Rsh_Fir_reg_df4_;
...
D7_:;
  // deopt 14 [C_dnt1, x4, df4, ncp1]
  SEXP Rsh_Fir_array_deopt_stack7[4];
  Rsh_Fir_array_deopt_stack7[0] = Rsh_Fir_reg_C_dnt1_;
...
L20_:;
  ...
  Rsh_Fir_array_args17[0] = Rsh_Fir_reg_ncp2_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args17, Rsh_Fir_param_types_empty()));
  // log3 = ld log
  Rsh_Fir_reg_log3_ = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // check L21() else D8()
  // L21()
  goto L21_;

D8_:;
  // deopt 15 [C_dnt1, x4, df4, ncp2, log3]
  SEXP Rsh_Fir_array_deopt_stack8[5];
  Rsh_Fir_array_deopt_stack8[0] = Rsh_Fir_reg_C_dnt1_;
...
L21_:;
  ...
  Rsh_Fir_array_args18[0] = Rsh_Fir_reg_log4_;
  ...
  // r8 = `.Call`(C_dnt1, vargs1, <missing>)
  SEXP Rsh_Fir_array_args19[3];
  Rsh_Fir_array_args19[0] = Rsh_Fir_reg_C_dnt1_;
  Rsh_Fir_array_args19[1] = Rsh_Fir_reg_vargs1_;
  Rsh_Fir_array_args19[2] = Rsh_const(CCP, 9);
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_builtin(438, CCP, RHO, 3, Rsh_Fir_array_args19, Rsh_Fir_param_types_empty());
  // goto L4(r8)
  // L4(r8)
