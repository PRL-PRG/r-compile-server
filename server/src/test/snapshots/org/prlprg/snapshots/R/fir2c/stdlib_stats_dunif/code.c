...
SEXP Rsh_Fir_user_function_inner121553931_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner121553931_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner121553931
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner121553931_, RHO, CCP);
  // st dunif = r
...
SEXP Rsh_Fir_user_function_inner121553931_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner121553931 dynamic dispatch ([x, min, max, log])

  return Rsh_Fir_user_version_inner121553931_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner121553931_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner121553931 version 0 (*, *, *, * -+> V)

  if (NPARAMS != 4) Rsh_error("FIŘ arity mismatch for inner121553931/0: expected 4, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_dunif;  // C_dunif
  SEXP Rsh_Fir_reg_C_dunif1_;  // C_dunif1
...
L4_:;
  // C_dunif = ld C_dunif
  Rsh_Fir_reg_C_dunif = Rsh_Fir_load(Rsh_const(CCP, 9), RHO);
  // check L6() else D0()
  // L6()
  goto L6_;

L5_:;
  // r = dyn base(<sym C_dunif>, <sym x>, <sym min>, <sym max>, <sym log>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_dunif;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L6_:;
  // C_dunif1 = force? C_dunif
  Rsh_Fir_reg_C_dunif1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_dunif);
  // checkMissing(C_dunif1)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_C_dunif1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_dunif1_;
...
D2_:;
  // deopt 3 [C_dunif1, x2, min1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_dunif1_;
...
L8_:;
  ...
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_min2_;
...
D3_:;
  // deopt 4 [C_dunif1, x2, min2, max1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_dunif1_;
...
L9_:;
  ...
  Rsh_Fir_array_args8[0] = Rsh_Fir_reg_max2_;
...
D4_:;
  // deopt 5 [C_dunif1, x2, min2, max2, log1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_dunif1_;
...
L10_:;
  ...
  // r2 = `.Call`(C_dunif1, vargs, <missing>)
  SEXP Rsh_Fir_array_args10[3];
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_C_dunif1_;
