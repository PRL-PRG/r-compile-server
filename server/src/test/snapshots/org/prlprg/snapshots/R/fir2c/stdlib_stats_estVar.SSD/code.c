...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_dx1_;
...
L5_:;
  ...
  // if c1 then L7() else L8(dx1, object6)
...
L6_:;
  ...
  Rsh_Fir_array_args8[0] = Rsh_Fir_reg_dx6_;
...
L7_:;
  ...
  // if dc1 then L9() else L8(dx1, dr2)
...
L8_:;
  ...
  Rsh_Fir_reg_dx7_ = Rsh_Fir_reg_r1_;
  goto L6_;
...
L9_:;
  ...
  Rsh_Fir_reg_dx5_ = Rsh_Fir_intrinsic_getTryDispatchBuiltinValue(CCP, RHO, 1, Rsh_Fir_array_args12, Rsh_Fir_param_types_empty());
  // goto L6(dx1, dx5)
  // L6(dx1, dx5)
