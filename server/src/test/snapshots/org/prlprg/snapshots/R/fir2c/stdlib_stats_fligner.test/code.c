...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_fligner_test;
  SEXP Rsh_Fir_reg_p3_;
  SEXP Rsh_Fir_reg_p4_;
  SEXP Rsh_Fir_reg_r13_;
  SEXP Rsh_Fir_reg_fligner_test1_;
...
L6_:;
  // fligner_test = ldf `fligner.test`
  Rsh_Fir_reg_fligner_test = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 0), RHO);
  // check L7() else D4()
  // L7()
  goto L7_;
...
L7_:;
  ...
  //   c = `is.object`(InsectSprays3);
  //   if c then L1() else L2(InsectSprays3);
  // L0(dx1):
  //   return dx1;
  // L1():
  //   dr = tryDispatchBuiltin.1("$", InsectSprays3);
  //   dc = getTryDispatchBuiltinDispatched(dr);
  //   if dc then L3() else L2(dr);
  // L2(InsectSprays5):
  //   r9 = `$`(InsectSprays5, <sym count>);
  //   goto L0(r9);
  // L3():
  ...
  // p4 = prom<V +>{
  //   InsectSprays6 = ld InsectSprays;
  //   InsectSprays7 = force? InsectSprays6;
  //   checkMissing(InsectSprays7);
  //   c1 = `is.object`(InsectSprays7);
  //   if c1 then L1() else L2(InsectSprays7);
  // L0(dx3):
  //   return dx3;
  // L1():
  //   dr2 = tryDispatchBuiltin.1("$", InsectSprays7);
  //   dc1 = getTryDispatchBuiltinDispatched(dr2);
  //   if dc1 then L3() else L2(dr2);
  // L2(InsectSprays9):
  //   r11 = `$`(InsectSprays9, <sym spray>);
  //   goto L0(r11);
  // L3():
  ...
  Rsh_Fir_reg_r13_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_fligner_test, 2, Rsh_Fir_array_args19, Rsh_Fir_array_arg_names4, CCP, RHO);
  // check L8() else D5()
  // L8()
  goto L8_;
...
L8_:;
  // fligner_test1 = ldf `fligner.test`
  Rsh_Fir_reg_fligner_test1_ = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 0), RHO);
  // check L9() else D6()
  // L9()
  goto L9_;
...
L9_:;
  // p5 = prom<V +>{
  //   __1 = ldf `~` in base;
  //   r14 = dyn __1(<sym count>, <sym spray>);
  //   return r14;
  // }
  Rsh_Fir_reg_p5_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_main5, 0, NULL, CCP, RHO);
  // p6 = prom<V +>{
  //   InsectSprays10 = ld InsectSprays;
  //   InsectSprays11 = force? InsectSprays10;
  //   checkMissing(InsectSprays11);
  //   return InsectSprays11;
  // }
  Rsh_Fir_reg_p6_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_main6, 0, NULL, CCP, RHO);
  // r17 = dyn fligner_test1[, data](p5, p6)
  ...
  Rsh_Fir_reg_r17_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_fligner_test1_, 2, Rsh_Fir_array_args22, Rsh_Fir_array_arg_names6, CCP, RHO);
  // check L10() else D7()
  // L10()
  goto L10_;
...
SEXP Rsh_Fir_user_promise_main2(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  // InsectSprays = ld InsectSprays
  Rsh_Fir_reg_InsectSprays = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // InsectSprays1 = force? InsectSprays
  Rsh_Fir_reg_InsectSprays1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_InsectSprays);
  // checkMissing(InsectSprays1)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_InsectSprays1_;
...
SEXP Rsh_Fir_user_promise_main3(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  // InsectSprays2 = ld InsectSprays
  Rsh_Fir_reg_InsectSprays2_ = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // InsectSprays3 = force? InsectSprays2
  Rsh_Fir_reg_InsectSprays3_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_InsectSprays2_);
  // checkMissing(InsectSprays3)
  SEXP Rsh_Fir_array_args7[1];
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_InsectSprays3_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args7, Rsh_Fir_param_types_empty()));
  // c = `is.object`(InsectSprays3)
  SEXP Rsh_Fir_array_args8[1];
  Rsh_Fir_array_args8[0] = Rsh_Fir_reg_InsectSprays3_;
  ...
  // L2(InsectSprays3)
    Rsh_Fir_reg_InsectSprays5_ = Rsh_Fir_reg_InsectSprays3_;
    goto L2_;
  }
...
L1_:;
  ...
  Rsh_Fir_array_args9[1] = Rsh_Fir_reg_InsectSprays3_;
  ...
  // L2(dr)
    Rsh_Fir_reg_InsectSprays5_ = Rsh_Fir_reg_dr;
    goto L2_;
  }
...
L2_:;
  ...
  Rsh_Fir_array_args11[0] = Rsh_Fir_reg_InsectSprays5_;
  Rsh_Fir_array_args11[1] = Rsh_const(CCP, 5);
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_builtin(17, RHO, 2, Rsh_Fir_array_args11);
  // goto L0(r9)
  // L0(r9)
...
SEXP Rsh_Fir_user_promise_main4(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  // Declare locals
  SEXP Rsh_Fir_reg_InsectSprays6_;
  SEXP Rsh_Fir_reg_InsectSprays7_;
  SEXP Rsh_Fir_reg_c1_;
  SEXP Rsh_Fir_reg_InsectSprays9_;
  ...
  // InsectSprays6 = ld InsectSprays
  Rsh_Fir_reg_InsectSprays6_ = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // InsectSprays7 = force? InsectSprays6
  Rsh_Fir_reg_InsectSprays7_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_InsectSprays6_);
  // checkMissing(InsectSprays7)
  SEXP Rsh_Fir_array_args13[1];
  Rsh_Fir_array_args13[0] = Rsh_Fir_reg_InsectSprays7_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args13, Rsh_Fir_param_types_empty()));
  // c1 = `is.object`(InsectSprays7)
  SEXP Rsh_Fir_array_args14[1];
  Rsh_Fir_array_args14[0] = Rsh_Fir_reg_InsectSprays7_;
  ...
  // L2(InsectSprays7)
    Rsh_Fir_reg_InsectSprays9_ = Rsh_Fir_reg_InsectSprays7_;
    goto L2_;
  }
...
L1_:;
  ...
  Rsh_Fir_array_args15[1] = Rsh_Fir_reg_InsectSprays7_;
  ...
  // L2(dr2)
    Rsh_Fir_reg_InsectSprays9_ = Rsh_Fir_reg_dr2_;
    goto L2_;
  }
...
L2_:;
  ...
  Rsh_Fir_array_args17[0] = Rsh_Fir_reg_InsectSprays9_;
  Rsh_Fir_array_args17[1] = Rsh_const(CCP, 6);
  Rsh_Fir_reg_r11_ = Rsh_Fir_call_builtin(17, RHO, 2, Rsh_Fir_array_args17);
  // goto L0(r11)
  // L0(r11)
...
SEXP Rsh_Fir_user_promise_main5(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  ...
  Rsh_Fir_reg_r14_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___1_, 2, Rsh_Fir_array_args20, Rsh_Fir_array_arg_names5, CCP, RHO);
  // return r14
  return Rsh_Fir_reg_r14_;
}
SEXP Rsh_Fir_user_promise_main6(SEXP CCP, SEXP RHO, int NCAPTURES, SEXP const **CAPTURES) {
  // Declare locals
  SEXP Rsh_Fir_reg_InsectSprays10_;
  SEXP Rsh_Fir_reg_InsectSprays11_;

  if (NCAPTURES != 0) Rsh_error("FIŘ capture arity mismatch for main/0: expected 0, got %d", NCAPTURES);

  // InsectSprays10 = ld InsectSprays
  Rsh_Fir_reg_InsectSprays10_ = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // InsectSprays11 = force? InsectSprays10
  Rsh_Fir_reg_InsectSprays11_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_InsectSprays10_);
  // checkMissing(InsectSprays11)
  SEXP Rsh_Fir_array_args21[1];
  Rsh_Fir_array_args21[0] = Rsh_Fir_reg_InsectSprays11_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args21, Rsh_Fir_param_types_empty()));
  // return InsectSprays11
  return Rsh_Fir_reg_InsectSprays11_;
}
SEXP Rsh_Fir_user_function_inner2044426018_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
L1_:;
  ...
  // r2 = dyn UseMethod("fligner.test")
  SEXP Rsh_Fir_array_args24[1];
  Rsh_Fir_array_args24[0] = Rsh_const(CCP, 13);
  SEXP Rsh_Fir_array_arg_names7[1];
  Rsh_Fir_array_arg_names7[0] = R_MissingArg;
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_UseMethod, 1, Rsh_Fir_array_args24, Rsh_Fir_array_arg_names7, CCP, RHO);
  // goto L0(r2)
  // L0(r2)
