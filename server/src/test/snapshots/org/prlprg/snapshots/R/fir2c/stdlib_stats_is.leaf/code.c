...
L1_:;
  ...
  Rsh_Fir_reg_c = Rsh_Fir_call_builtin(385, CCP, RHO, 1, Rsh_Fir_array_args2, Rsh_Fir_param_types_empty());
  // goto L0(c)
  // L0(c)
...
L4_:;
  // r = dyn base(<lang `<-`(L, attr(object, "leaf"))>)
...
L10_:;
  ...
  Rsh_Fir_array_args10[1] = Rsh_Fir_reg_c4_;
  Rsh_Fir_reg_c5_ = Rsh_Fir_call_builtin(83, CCP, RHO, 2, Rsh_Fir_array_args10, Rsh_Fir_param_types_empty());
  // goto L2(c5)
  // L2(c5)
