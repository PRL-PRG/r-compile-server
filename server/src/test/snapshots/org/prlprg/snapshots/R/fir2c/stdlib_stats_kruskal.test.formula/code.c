...
SEXP Rsh_Fir_user_version_inner751963283_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_kruskal_test;  // kruskal_test
...
L10_:;
  ...
  Rsh_Fir_reg_r41_ = Rsh_Fir_call_builtin(79, CCP, RHO, 2, Rsh_Fir_array_args9, Rsh_Fir_param_types_empty());
  // c14 = `as.logical`(r41)
...
L56_:;
  ...
  Rsh_Fir_reg_kruskal_test = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 35), RHO);
  // check L57() else D19()
  // L57()
  goto L57_;
...
L57_:;
  ...
  // r53 = dyn kruskal_test[x, g](p6, p7)
  ...
  Rsh_Fir_reg_r53_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_kruskal_test, 2, Rsh_Fir_array_args66, Rsh_Fir_array_arg_names22, CCP, RHO);
  // check L58() else D20()
  // L58()
  goto L58_;
