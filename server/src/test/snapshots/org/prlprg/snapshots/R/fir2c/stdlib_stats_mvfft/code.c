...
SEXP Rsh_Fir_user_version_inner4148249736_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_C_mvfft;  // C_mvfft
  SEXP Rsh_Fir_reg_C_mvfft1_;  // C_mvfft1
...
L2_:;
  // C_mvfft = ld C_mvfft
  Rsh_Fir_reg_C_mvfft = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // check L4() else D0()
  // L4()
  goto L4_;

L3_:;
  // r = dyn base(<sym C_mvfft>, <sym z>, <sym inverse>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_mvfft;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L4_:;
  // C_mvfft1 = force? C_mvfft
  Rsh_Fir_reg_C_mvfft1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_mvfft);
  // checkMissing(C_mvfft1)
  SEXP Rsh_Fir_array_args3[1];
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_C_mvfft1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_mvfft1_;
...
D2_:;
  // deopt 3 [C_mvfft1, z2, inverse1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_mvfft1_;
...
L6_:;
  ...
  // r2 = `.Call`(C_mvfft1, vargs, <missing>)
  SEXP Rsh_Fir_array_args6[3];
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_C_mvfft1_;
