...
D2_:;
  ...
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_res;
...
L12_:;
  // r5 = dyn stop("no \"nobs\" attribute is available")
  SEXP Rsh_Fir_array_args9[1];
  Rsh_Fir_array_args9[0] = Rsh_const(CCP, 9);
  SEXP Rsh_Fir_array_arg_names3[1];
  Rsh_Fir_array_arg_names3[0] = R_MissingArg;
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_stop, 1, Rsh_Fir_array_args9, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L13() else D4()
  // L13()
  goto L13_;
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_res2_;
...
L15_:;
  ...
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_res3_;
