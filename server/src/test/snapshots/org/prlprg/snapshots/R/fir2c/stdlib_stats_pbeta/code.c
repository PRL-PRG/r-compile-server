...
SEXP Rsh_Fir_user_function_inner1831220544_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner1831220544_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner1831220544
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner1831220544_, RHO, CCP);
  // st pbeta = r
...
SEXP Rsh_Fir_user_function_inner1831220544_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner1831220544 dynamic dispatch ([q, shape1, shape2, ncp, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner1831220544_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner1831220544_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner1831220544 version 0 (*, *, *, *, *, * -+> V)

  if (NPARAMS != 6) Rsh_error("FIŘ arity mismatch for inner1831220544/0: expected 6, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_pbeta;  // C_pbeta
  SEXP Rsh_Fir_reg_C_pbeta1_;  // C_pbeta1
  ...
  SEXP Rsh_Fir_reg_C_pnbeta;  // C_pnbeta
  SEXP Rsh_Fir_reg_C_pnbeta1_;  // C_pnbeta1
...
L10_:;
  // C_pbeta = ld C_pbeta
  Rsh_Fir_reg_C_pbeta = Rsh_Fir_load(Rsh_const(CCP, 12), RHO);
  // check L12() else D0()
  // L12()
  goto L12_;

L11_:;
  // r3 = dyn base1(<sym C_pbeta>, <sym q>, <sym shape1>, <sym shape2>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_pbeta;
  Rsh_Fir_deopt(4, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L12_:;
  // C_pbeta1 = force? C_pbeta
  Rsh_Fir_reg_C_pbeta1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_pbeta);
  // checkMissing(C_pbeta1)
  SEXP Rsh_Fir_array_args10[1];
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_C_pbeta1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_pbeta1_;
...
D2_:;
  // deopt 6 [C_pbeta1, q2, shape3]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_pbeta1_;
...
D3_:;
  // deopt 7 [C_pbeta1, q2, shape4, shape5]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_pbeta1_;
...
D4_:;
  // deopt 8 [C_pbeta1, q2, shape4, shape6, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_pbeta1_;
...
D5_:;
  // deopt 9 [C_pbeta1, q2, shape4, shape6, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack5[6];
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_pbeta1_;
...
L17_:;
  ...
  // vargs = dots[q2, shape4, shape6, lower_tail2, log_p2]
  ...
  // r5 = `.Call`(C_pbeta1, vargs, <missing>)
  SEXP Rsh_Fir_array_args16[3];
  Rsh_Fir_array_args16[0] = Rsh_Fir_reg_C_pbeta1_;
...
L19_:;
  // C_pnbeta = ld C_pnbeta
  Rsh_Fir_reg_C_pnbeta = Rsh_Fir_load(Rsh_const(CCP, 14), RHO);
  // check L21() else D6()
  // L21()
  goto L21_;

L20_:;
  // r6 = dyn base2(<sym C_pnbeta>, <sym q>, <sym shape1>, <sym shape2>, <sym ncp>, <sym lower.tail>, <sym log.p>)
...
D6_:;
  ...
  Rsh_Fir_array_deopt_stack6[0] = Rsh_Fir_reg_C_pnbeta;
  Rsh_Fir_deopt(13, 1, Rsh_Fir_array_deopt_stack6, CCP, RHO);
  return R_NilValue;

L21_:;
  // C_pnbeta1 = force? C_pnbeta
  Rsh_Fir_reg_C_pnbeta1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_pnbeta);
  // checkMissing(C_pnbeta1)
  SEXP Rsh_Fir_array_args18[1];
  Rsh_Fir_array_args18[0] = Rsh_Fir_reg_C_pnbeta1_;
...
D7_:;
  // deopt 14 [C_pnbeta1, q3]
  SEXP Rsh_Fir_array_deopt_stack7[2];
  Rsh_Fir_array_deopt_stack7[0] = Rsh_Fir_reg_C_pnbeta1_;
  Rsh_Fir_array_deopt_stack7[1] = Rsh_Fir_reg_q3_;
...
D8_:;
  // deopt 15 [C_pnbeta1, q4, shape7]
  SEXP Rsh_Fir_array_deopt_stack8[3];
  Rsh_Fir_array_deopt_stack8[0] = Rsh_Fir_reg_C_pnbeta1_;
...
D9_:;
  // deopt 16 [C_pnbeta1, q4, shape8, shape9]
  SEXP Rsh_Fir_array_deopt_stack9[4];
  Rsh_Fir_array_deopt_stack9[0] = Rsh_Fir_reg_C_pnbeta1_;
...
D10_:;
  // deopt 17 [C_pnbeta1, q4, shape8, shape10, ncp1]
  SEXP Rsh_Fir_array_deopt_stack10[5];
  Rsh_Fir_array_deopt_stack10[0] = Rsh_Fir_reg_C_pnbeta1_;
...
D11_:;
  // deopt 18 [C_pnbeta1, q4, shape8, shape10, ncp2, lower_tail3]
  SEXP Rsh_Fir_array_deopt_stack11[6];
  Rsh_Fir_array_deopt_stack11[0] = Rsh_Fir_reg_C_pnbeta1_;
...
D12_:;
  // deopt 19 [C_pnbeta1, q4, shape8, shape10, ncp2, lower_tail4, log_p3]
  SEXP Rsh_Fir_array_deopt_stack12[7];
  Rsh_Fir_array_deopt_stack12[0] = Rsh_Fir_reg_C_pnbeta1_;
...
L27_:;
  ...
  // vargs1 = dots[q4, shape8, shape10, ncp2, lower_tail4, log_p4]
  ...
  // r8 = `.Call`(C_pnbeta1, vargs1, <missing>)
  SEXP Rsh_Fir_array_args25[3];
  Rsh_Fir_array_args25[0] = Rsh_Fir_reg_C_pnbeta1_;
