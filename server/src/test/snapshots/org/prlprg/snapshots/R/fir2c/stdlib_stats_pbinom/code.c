...
SEXP Rsh_Fir_user_function_inner710520329_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner710520329_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner710520329
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner710520329_, RHO, CCP);
  // st pbinom = r
...
SEXP Rsh_Fir_user_function_inner710520329_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner710520329 dynamic dispatch ([q, size, prob, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner710520329_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner710520329_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner710520329 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner710520329/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_pbinom;  // C_pbinom
  SEXP Rsh_Fir_reg_C_pbinom1_;  // C_pbinom1
...
L3_:;
  // C_pbinom = ld C_pbinom
  Rsh_Fir_reg_C_pbinom = Rsh_Fir_load(Rsh_const(CCP, 9), RHO);
  // check L5() else D0()
  // L5()
  goto L5_;

L4_:;
  // r = dyn base(<sym C_pbinom>, <sym q>, <sym size>, <sym prob>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_pbinom;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L5_:;
  // C_pbinom1 = force? C_pbinom
  Rsh_Fir_reg_C_pbinom1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_pbinom);
  // checkMissing(C_pbinom1)
  SEXP Rsh_Fir_array_args4[1];
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_C_pbinom1_;
...
D1_:;
  // deopt 2 [C_pbinom1, q1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_pbinom1_;
...
D2_:;
  // deopt 3 [C_pbinom1, q2, size1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_pbinom1_;
...
D3_:;
  // deopt 4 [C_pbinom1, q2, size2, prob1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_pbinom1_;
...
D4_:;
  // deopt 5 [C_pbinom1, q2, size2, prob2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_pbinom1_;
...
D5_:;
  // deopt 6 [C_pbinom1, q2, size2, prob2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack5[6];
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_pbinom1_;
...
L10_:;
  ...
  // vargs = dots[q2, size2, prob2, lower_tail2, log_p2]
  ...
  // r2 = `.Call`(C_pbinom1, vargs, <missing>)
  SEXP Rsh_Fir_array_args10[3];
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_C_pbinom1_;
