...
SEXP Rsh_Fir_user_function_inner373277235_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner373277235_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner373277235
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner373277235_, RHO, CCP);
  // st pchisq = r
...
SEXP Rsh_Fir_user_function_inner373277235_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner373277235 dynamic dispatch ([q, df, ncp, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner373277235_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner373277235_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner373277235 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner373277235/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_pchisq;  // C_pchisq
  SEXP Rsh_Fir_reg_C_pchisq1_;  // C_pchisq1
  ...
  SEXP Rsh_Fir_reg_C_pnchisq;  // C_pnchisq
  SEXP Rsh_Fir_reg_C_pnchisq1_;  // C_pnchisq1
...
L10_:;
  // C_pchisq = ld C_pchisq
  Rsh_Fir_reg_C_pchisq = Rsh_Fir_load(Rsh_const(CCP, 11), RHO);
  // check L12() else D0()
  // L12()
  goto L12_;

L11_:;
  // r3 = dyn base1(<sym C_pchisq>, <sym q>, <sym df>, <sym lower.tail>, <sym log.p>)
  ...
  Rsh_Fir_array_args9[4] = Rsh_const(CCP, 8);
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 5, Rsh_Fir_array_args9, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L5(r3)
  // L5(r3)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_pchisq;
  Rsh_Fir_deopt(4, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L12_:;
  // C_pchisq1 = force? C_pchisq
  Rsh_Fir_reg_C_pchisq1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_pchisq);
  // checkMissing(C_pchisq1)
  SEXP Rsh_Fir_array_args10[1];
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_C_pchisq1_;
...
D1_:;
  // deopt 5 [C_pchisq1, q1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_pchisq1_;
...
D2_:;
  // deopt 6 [C_pchisq1, q2, df1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_pchisq1_;
...
L14_:;
  ...
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_df2_;
...
D3_:;
  // deopt 7 [C_pchisq1, q2, df2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_pchisq1_;
...
D4_:;
  // deopt 8 [C_pchisq1, q2, df2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_pchisq1_;
  Rsh_Fir_array_deopt_stack4[1] = Rsh_Fir_reg_q2_;
  Rsh_Fir_array_deopt_stack4[2] = Rsh_Fir_reg_df2_;
...
L16_:;
  ...
  // vargs = dots[q2, df2, lower_tail2, log_p2]
  ...
  // r5 = `.Call`(C_pchisq1, vargs, <missing>)
  SEXP Rsh_Fir_array_args15[3];
  Rsh_Fir_array_args15[0] = Rsh_Fir_reg_C_pchisq1_;
...
L18_:;
  // C_pnchisq = ld C_pnchisq
  Rsh_Fir_reg_C_pnchisq = Rsh_Fir_load(Rsh_const(CCP, 13), RHO);
  // check L20() else D5()
  // L20()
  goto L20_;

L19_:;
  // r6 = dyn base2(<sym C_pnchisq>, <sym q>, <sym df>, <sym ncp>, <sym lower.tail>, <sym log.p>)
  ...
  Rsh_Fir_array_args16[3] = Rsh_const(CCP, 4);
  Rsh_Fir_array_args16[4] = Rsh_const(CCP, 6);
  Rsh_Fir_array_args16[5] = Rsh_const(CCP, 8);
  ...
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base2_, 6, Rsh_Fir_array_args16, Rsh_Fir_array_arg_names3, CCP, RHO);
  // goto L6(r6)
  // L6(r6)
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_pnchisq;
  Rsh_Fir_deopt(12, 1, Rsh_Fir_array_deopt_stack5, CCP, RHO);
  return R_NilValue;

L20_:;
  // C_pnchisq1 = force? C_pnchisq
  Rsh_Fir_reg_C_pnchisq1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_pnchisq);
  // checkMissing(C_pnchisq1)
  SEXP Rsh_Fir_array_args17[1];
  Rsh_Fir_array_args17[0] = Rsh_Fir_reg_C_pnchisq1_;
...
D6_:;
  // deopt 13 [C_pnchisq1, q3]
  SEXP Rsh_Fir_array_deopt_stack6[2];
  Rsh_Fir_array_deopt_stack6[0] = Rsh_Fir_reg_C_pnchisq1_;
  Rsh_Fir_array_deopt_stack6[1] = Rsh_Fir_reg_q3_;
...
D7_:;
  // deopt 14 [C_pnchisq1, q4, df3]
  SEXP Rsh_Fir_array_deopt_stack7[3];
  Rsh_Fir_array_deopt_stack7[0] = Rsh_Fir_reg_C_pnchisq1_;
  Rsh_Fir_array_deopt_stack7[1] = Rsh_Fir_reg_q4_;
  Rsh_Fir_array_deopt_stack7[2] = Rsh_Fir_reg_df3_;
...
L22_:;
  ...
  Rsh_Fir_array_args19[0] = Rsh_Fir_reg_df4_;
...
D8_:;
  // deopt 15 [C_pnchisq1, q4, df4, ncp1]
  SEXP Rsh_Fir_array_deopt_stack8[4];
  Rsh_Fir_array_deopt_stack8[0] = Rsh_Fir_reg_C_pnchisq1_;
  Rsh_Fir_array_deopt_stack8[1] = Rsh_Fir_reg_q4_;
  Rsh_Fir_array_deopt_stack8[2] = Rsh_Fir_reg_df4_;
  Rsh_Fir_array_deopt_stack8[3] = Rsh_Fir_reg_ncp1_;
...
L23_:;
  ...
  Rsh_Fir_array_args20[0] = Rsh_Fir_reg_ncp2_;
...
D9_:;
  // deopt 16 [C_pnchisq1, q4, df4, ncp2, lower_tail3]
  SEXP Rsh_Fir_array_deopt_stack9[5];
  Rsh_Fir_array_deopt_stack9[0] = Rsh_Fir_reg_C_pnchisq1_;
  Rsh_Fir_array_deopt_stack9[1] = Rsh_Fir_reg_q4_;
  Rsh_Fir_array_deopt_stack9[2] = Rsh_Fir_reg_df4_;
  Rsh_Fir_array_deopt_stack9[3] = Rsh_Fir_reg_ncp2_;
  Rsh_Fir_array_deopt_stack9[4] = Rsh_Fir_reg_lower_tail3_;
...
L24_:;
  ...
  Rsh_Fir_array_args21[0] = Rsh_Fir_reg_lower_tail4_;
...
D10_:;
  // deopt 17 [C_pnchisq1, q4, df4, ncp2, lower_tail4, log_p3]
  SEXP Rsh_Fir_array_deopt_stack10[6];
  Rsh_Fir_array_deopt_stack10[0] = Rsh_Fir_reg_C_pnchisq1_;
  Rsh_Fir_array_deopt_stack10[1] = Rsh_Fir_reg_q4_;
  Rsh_Fir_array_deopt_stack10[2] = Rsh_Fir_reg_df4_;
  Rsh_Fir_array_deopt_stack10[3] = Rsh_Fir_reg_ncp2_;
  Rsh_Fir_array_deopt_stack10[4] = Rsh_Fir_reg_lower_tail4_;
  Rsh_Fir_array_deopt_stack10[5] = Rsh_Fir_reg_log_p3_;
...
L25_:;
  ...
  Rsh_Fir_array_args22[0] = Rsh_Fir_reg_log_p4_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args22, Rsh_Fir_param_types_empty()));
  // vargs1 = dots[q4, df4, ncp2, lower_tail4, log_p4]
  ...
  // r8 = `.Call`(C_pnchisq1, vargs1, <missing>)
  SEXP Rsh_Fir_array_args23[3];
  Rsh_Fir_array_args23[0] = Rsh_Fir_reg_C_pnchisq1_;
  Rsh_Fir_array_args23[1] = Rsh_Fir_reg_vargs1_;
  Rsh_Fir_array_args23[2] = Rsh_const(CCP, 12);
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_builtin(438, CCP, RHO, 3, Rsh_Fir_array_args23, Rsh_Fir_param_types_empty());
  // goto L6(r8)
  // L6(r8)
