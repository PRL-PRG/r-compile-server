...
SEXP Rsh_Fir_user_function_inner3052795091_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner3052795091_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner3052795091
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner3052795091_, RHO, CCP);
  // st pf = r
...
SEXP Rsh_Fir_user_function_inner3052795091_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner3052795091 dynamic dispatch ([q, df1, df2, ncp, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner3052795091_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner3052795091_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner3052795091 version 0 (*, *, *, *, *, * -+> V)

  if (NPARAMS != 6) Rsh_error("FIŘ arity mismatch for inner3052795091/0: expected 6, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_pf;  // C_pf
  SEXP Rsh_Fir_reg_C_pf1_;  // C_pf1
  ...
  SEXP Rsh_Fir_reg_C_pnf;  // C_pnf
  SEXP Rsh_Fir_reg_C_pnf1_;  // C_pnf1
...
L9_:;
  // C_pf = ld C_pf
  Rsh_Fir_reg_C_pf = Rsh_Fir_load(Rsh_const(CCP, 11), RHO);
  // check L11() else D0()
  // L11()
  goto L11_;

L10_:;
  // r3 = dyn base1(<sym C_pf>, <sym q>, <sym df1>, <sym df2>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_pf;
  Rsh_Fir_deopt(4, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L11_:;
  // C_pf1 = force? C_pf
  Rsh_Fir_reg_C_pf1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_pf);
  // checkMissing(C_pf1)
  SEXP Rsh_Fir_array_args9[1];
  Rsh_Fir_array_args9[0] = Rsh_Fir_reg_C_pf1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_pf1_;
...
D2_:;
  // deopt 6 [C_pf1, q2, df3]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_pf1_;
...
D3_:;
  // deopt 7 [C_pf1, q2, df4, df5]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_pf1_;
...
D4_:;
  // deopt 8 [C_pf1, q2, df4, df6, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_pf1_;
...
D5_:;
  // deopt 9 [C_pf1, q2, df4, df6, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack5[6];
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_pf1_;
...
L16_:;
  ...
  // vargs = dots[q2, df4, df6, lower_tail2, log_p2]
  ...
  // r5 = `.Call`(C_pf1, vargs, <missing>)
  SEXP Rsh_Fir_array_args15[3];
  Rsh_Fir_array_args15[0] = Rsh_Fir_reg_C_pf1_;
...
L18_:;
  // C_pnf = ld C_pnf
  Rsh_Fir_reg_C_pnf = Rsh_Fir_load(Rsh_const(CCP, 13), RHO);
  // check L20() else D6()
  // L20()
  goto L20_;

L19_:;
  // r6 = dyn base2(<sym C_pnf>, <sym q>, <sym df1>, <sym df2>, <sym ncp>, <sym lower.tail>, <sym log.p>)
...
D6_:;
  ...
  Rsh_Fir_array_deopt_stack6[0] = Rsh_Fir_reg_C_pnf;
  Rsh_Fir_deopt(13, 1, Rsh_Fir_array_deopt_stack6, CCP, RHO);
  return R_NilValue;

L20_:;
  // C_pnf1 = force? C_pnf
  Rsh_Fir_reg_C_pnf1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_pnf);
  // checkMissing(C_pnf1)
  SEXP Rsh_Fir_array_args17[1];
  Rsh_Fir_array_args17[0] = Rsh_Fir_reg_C_pnf1_;
...
D7_:;
  ...
  Rsh_Fir_array_deopt_stack7[0] = Rsh_Fir_reg_C_pnf1_;
...
D8_:;
  // deopt 15 [C_pnf1, q4, df7]
  SEXP Rsh_Fir_array_deopt_stack8[3];
  Rsh_Fir_array_deopt_stack8[0] = Rsh_Fir_reg_C_pnf1_;
...
D9_:;
  // deopt 16 [C_pnf1, q4, df8, df9]
  SEXP Rsh_Fir_array_deopt_stack9[4];
  Rsh_Fir_array_deopt_stack9[0] = Rsh_Fir_reg_C_pnf1_;
...
D10_:;
  // deopt 17 [C_pnf1, q4, df8, df10, ncp1]
  SEXP Rsh_Fir_array_deopt_stack10[5];
  Rsh_Fir_array_deopt_stack10[0] = Rsh_Fir_reg_C_pnf1_;
...
D11_:;
  // deopt 18 [C_pnf1, q4, df8, df10, ncp2, lower_tail3]
  SEXP Rsh_Fir_array_deopt_stack11[6];
  Rsh_Fir_array_deopt_stack11[0] = Rsh_Fir_reg_C_pnf1_;
...
D12_:;
  // deopt 19 [C_pnf1, q4, df8, df10, ncp2, lower_tail4, log_p3]
  SEXP Rsh_Fir_array_deopt_stack12[7];
  Rsh_Fir_array_deopt_stack12[0] = Rsh_Fir_reg_C_pnf1_;
...
L26_:;
  ...
  // vargs1 = dots[q4, df8, df10, ncp2, lower_tail4, log_p4]
  ...
  // r8 = `.Call`(C_pnf1, vargs1, <missing>)
  SEXP Rsh_Fir_array_args24[3];
  Rsh_Fir_array_args24[0] = Rsh_Fir_reg_C_pnf1_;
