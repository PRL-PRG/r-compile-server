...
SEXP Rsh_Fir_user_function_inner3489514948_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner3489514948_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_promise_inner3489514948_(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner3489514948
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner3489514948_, RHO, CCP);
  // st pgamma = r
...
SEXP Rsh_Fir_user_function_inner3489514948_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner3489514948 dynamic dispatch ([q, shape, rate, scale, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner3489514948_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner3489514948_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner3489514948 version 0 (*, *, *, *, *, * -+> V)

  if (NPARAMS != 6) Rsh_error("FIŘ arity mismatch for inner3489514948/0: expected 6, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_pgamma;  // C_pgamma
  SEXP Rsh_Fir_reg_C_pgamma1_;  // C_pgamma1
...
L1_:;
  ...
  //   return r;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3489514948_, CCP, RHO);
  // goto L2(p)
  // L2(p)
...
L33_:;
  // C_pgamma = ld C_pgamma
  Rsh_Fir_reg_C_pgamma = Rsh_Fir_load(Rsh_const(CCP, 18), RHO);
  // check L35() else D7()
  // L35()
  goto L35_;

L34_:;
  // r20 = dyn base3(<sym C_pgamma>, <sym q>, <sym shape>, <sym scale>, <sym lower.tail>, <sym log.p>)
...
D7_:;
  ...
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_pgamma;
  Rsh_Fir_deopt(32, 1, Rsh_Fir_array_deopt_stack5, CCP, RHO);
  return R_NilValue;

L35_:;
  // C_pgamma1 = force? C_pgamma
  Rsh_Fir_reg_C_pgamma1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_pgamma);
  // checkMissing(C_pgamma1)
  SEXP Rsh_Fir_array_args31[1];
  Rsh_Fir_array_args31[0] = Rsh_Fir_reg_C_pgamma1_;
...
D8_:;
  // deopt 33 [C_pgamma1, q1]
  SEXP Rsh_Fir_array_deopt_stack6[2];
  Rsh_Fir_array_deopt_stack6[0] = Rsh_Fir_reg_C_pgamma1_;
  Rsh_Fir_array_deopt_stack6[1] = Rsh_Fir_reg_q1_;
...
L36_:;
  ...
  Rsh_Fir_array_args32[0] = Rsh_Fir_reg_q2_;
...
D9_:;
  // deopt 34 [C_pgamma1, q2, shape1]
  SEXP Rsh_Fir_array_deopt_stack7[3];
  Rsh_Fir_array_deopt_stack7[0] = Rsh_Fir_reg_C_pgamma1_;
  Rsh_Fir_array_deopt_stack7[1] = Rsh_Fir_reg_q2_;
...
D10_:;
  // deopt 35 [C_pgamma1, q2, shape2, scale3]
  SEXP Rsh_Fir_array_deopt_stack8[4];
  Rsh_Fir_array_deopt_stack8[0] = Rsh_Fir_reg_C_pgamma1_;
  Rsh_Fir_array_deopt_stack8[1] = Rsh_Fir_reg_q2_;
...
D11_:;
  // deopt 36 [C_pgamma1, q2, shape2, scale4, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack9[5];
  Rsh_Fir_array_deopt_stack9[0] = Rsh_Fir_reg_C_pgamma1_;
  Rsh_Fir_array_deopt_stack9[1] = Rsh_Fir_reg_q2_;
...
D12_:;
  // deopt 37 [C_pgamma1, q2, shape2, scale4, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack10[6];
  Rsh_Fir_array_deopt_stack10[0] = Rsh_Fir_reg_C_pgamma1_;
  Rsh_Fir_array_deopt_stack10[1] = Rsh_Fir_reg_q2_;
...
L40_:;
  ...
  // vargs = dots[q2, shape2, scale4, lower_tail2, log_p2]
  ...
  // r22 = `.Call`(C_pgamma1, vargs, <missing>)
  SEXP Rsh_Fir_array_args37[3];
  Rsh_Fir_array_args37[0] = Rsh_Fir_reg_C_pgamma1_;
