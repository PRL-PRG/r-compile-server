...
SEXP Rsh_Fir_user_function_inner1303976212_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner1303976212_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner1303976212
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner1303976212_, RHO, CCP);
  // st pgeom = r
...
SEXP Rsh_Fir_user_function_inner1303976212_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner1303976212 dynamic dispatch ([q, prob, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner1303976212_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner1303976212_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner1303976212 version 0 (*, *, *, * -+> V)

  if (NPARAMS != 4) Rsh_error("FIŘ arity mismatch for inner1303976212/0: expected 4, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_pgeom;  // C_pgeom
  SEXP Rsh_Fir_reg_C_pgeom1_;  // C_pgeom1
  ...
  (void)(Rsh_Fir_reg_q);
  // st prob = prob
  Rsh_Fir_store(Rsh_const(CCP, 2), Rsh_Fir_reg_prob, RHO);
...
L3_:;
  // C_pgeom = ld C_pgeom
  Rsh_Fir_reg_C_pgeom = Rsh_Fir_load(Rsh_const(CCP, 8), RHO);
  // check L5() else D0()
  // L5()
  goto L5_;

L4_:;
  // r = dyn base(<sym C_pgeom>, <sym q>, <sym prob>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_pgeom;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L5_:;
  // C_pgeom1 = force? C_pgeom
  Rsh_Fir_reg_C_pgeom1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_pgeom);
  // checkMissing(C_pgeom1)
  SEXP Rsh_Fir_array_args4[1];
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_C_pgeom1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_pgeom1_;
...
D2_:;
  // deopt 3 [C_pgeom1, q2, prob1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_pgeom1_;
  Rsh_Fir_array_deopt_stack2[1] = Rsh_Fir_reg_q2_;
  Rsh_Fir_array_deopt_stack2[2] = Rsh_Fir_reg_prob1_;
...
L7_:;
  ...
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_prob2_;
...
D3_:;
  // deopt 4 [C_pgeom1, q2, prob2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_pgeom1_;
  Rsh_Fir_array_deopt_stack3[1] = Rsh_Fir_reg_q2_;
  Rsh_Fir_array_deopt_stack3[2] = Rsh_Fir_reg_prob2_;
...
D4_:;
  // deopt 5 [C_pgeom1, q2, prob2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_pgeom1_;
  Rsh_Fir_array_deopt_stack4[1] = Rsh_Fir_reg_q2_;
  Rsh_Fir_array_deopt_stack4[2] = Rsh_Fir_reg_prob2_;
...
L9_:;
  ...
  // vargs = dots[q2, prob2, lower_tail2, log_p2]
  SEXP Rsh_Fir_array_vector_values[4];
  Rsh_Fir_array_vector_values[0] = Rsh_Fir_reg_q2_;
  Rsh_Fir_array_vector_values[1] = Rsh_Fir_reg_prob2_;
  ...
  // r2 = `.Call`(C_pgeom1, vargs, <missing>)
  SEXP Rsh_Fir_array_args9[3];
  Rsh_Fir_array_args9[0] = Rsh_Fir_reg_C_pgeom1_;
