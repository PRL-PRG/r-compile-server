...
SEXP Rsh_Fir_user_function_inner2497288931_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner2497288931_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner2497288931
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner2497288931_, RHO, CCP);
  // st phyper = r
...
SEXP Rsh_Fir_user_function_inner2497288931_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner2497288931 dynamic dispatch ([q, m, n, k, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner2497288931_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner2497288931_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner2497288931 version 0 (*, *, *, *, *, * -+> V)

  if (NPARAMS != 6) Rsh_error("FIŘ arity mismatch for inner2497288931/0: expected 6, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_phyper;  // C_phyper
  SEXP Rsh_Fir_reg_C_phyper1_;  // C_phyper1
...
L3_:;
  // C_phyper = ld C_phyper
  Rsh_Fir_reg_C_phyper = Rsh_Fir_load(Rsh_const(CCP, 10), RHO);
  // check L5() else D0()
  // L5()
  goto L5_;

L4_:;
  // r = dyn base(<sym C_phyper>, <sym q>, <sym m>, <sym n>, <sym k>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_phyper;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L5_:;
  // C_phyper1 = force? C_phyper
  Rsh_Fir_reg_C_phyper1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_phyper);
  // checkMissing(C_phyper1)
  SEXP Rsh_Fir_array_args4[1];
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_C_phyper1_;
...
D1_:;
  // deopt 2 [C_phyper1, q1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_phyper1_;
...
D2_:;
  // deopt 3 [C_phyper1, q2, m1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_phyper1_;
...
D3_:;
  // deopt 4 [C_phyper1, q2, m2, n1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_phyper1_;
...
D4_:;
  // deopt 5 [C_phyper1, q2, m2, n2, k1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_phyper1_;
...
D5_:;
  // deopt 6 [C_phyper1, q2, m2, n2, k2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack5[6];
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_phyper1_;
...
D6_:;
  // deopt 7 [C_phyper1, q2, m2, n2, k2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack6[7];
  Rsh_Fir_array_deopt_stack6[0] = Rsh_Fir_reg_C_phyper1_;
...
L11_:;
  ...
  // vargs = dots[q2, m2, n2, k2, lower_tail2, log_p2]
  ...
  // r2 = `.Call`(C_phyper1, vargs, <missing>)
  SEXP Rsh_Fir_array_args11[3];
  Rsh_Fir_array_args11[0] = Rsh_Fir_reg_C_phyper1_;
