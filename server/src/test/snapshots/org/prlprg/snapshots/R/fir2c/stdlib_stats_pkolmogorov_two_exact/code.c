...
SEXP Rsh_Fir_user_version_inner3503827405_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_C_pkolmogorov_two_exact;  // C_pkolmogorov_two_exact
  SEXP Rsh_Fir_reg_C_pkolmogorov_two_exact1_;  // C_pkolmogorov_two_exact1
...
L3_:;
  // C_pkolmogorov_two_exact = ld C_pkolmogorov_two_exact
  Rsh_Fir_reg_C_pkolmogorov_two_exact = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // check L5() else D0()
  // L5()
  goto L5_;

L4_:;
  // r = dyn base(<sym C_pkolmogorov_two_exact>, <sym q>, <sym n>)
...
D0_:;
  // deopt 1 [C_pkolmogorov_two_exact]
  SEXP Rsh_Fir_array_deopt_stack[1];
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_pkolmogorov_two_exact;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L5_:;
  // C_pkolmogorov_two_exact1 = force? C_pkolmogorov_two_exact
  Rsh_Fir_reg_C_pkolmogorov_two_exact1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_pkolmogorov_two_exact);
  // checkMissing(C_pkolmogorov_two_exact1)
  SEXP Rsh_Fir_array_args3[1];
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_C_pkolmogorov_two_exact1_;
...
D1_:;
  // deopt 2 [C_pkolmogorov_two_exact1, q1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_pkolmogorov_two_exact1_;
...
L6_:;
  ...
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_q2_;
...
D2_:;
  // deopt 3 [C_pkolmogorov_two_exact1, q2, n1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_pkolmogorov_two_exact1_;
...
L7_:;
  ...
  // r2 = `.Call`(C_pkolmogorov_two_exact1, vargs, <missing>)
  SEXP Rsh_Fir_array_args6[3];
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_C_pkolmogorov_two_exact1_;
...
L12_:;
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_builtin(67, CCP, RHO, 2, Rsh_Fir_array_args11, Rsh_Fir_param_types_empty());
  // popenv
  Rsh_Fir_pop_env(&RHO);
  (void)(R_NilValue);
  // return r3
