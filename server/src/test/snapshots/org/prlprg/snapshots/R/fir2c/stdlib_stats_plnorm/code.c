...
SEXP Rsh_Fir_user_function_inner56925504_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner56925504_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner56925504
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner56925504_, RHO, CCP);
  // st plnorm = r
...
SEXP Rsh_Fir_user_function_inner56925504_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner56925504 dynamic dispatch ([q, meanlog, sdlog, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner56925504_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner56925504_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner56925504 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner56925504/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_plnorm;  // C_plnorm
  SEXP Rsh_Fir_reg_C_plnorm1_;  // C_plnorm1
...
L5_:;
  // C_plnorm = ld C_plnorm
  Rsh_Fir_reg_C_plnorm = Rsh_Fir_load(Rsh_const(CCP, 11), RHO);
  // check L7() else D0()
  // L7()
  goto L7_;

L6_:;
  // r = dyn base(<sym C_plnorm>, <sym q>, <sym meanlog>, <sym sdlog>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_plnorm;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L7_:;
  // C_plnorm1 = force? C_plnorm
  Rsh_Fir_reg_C_plnorm1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_plnorm);
  // checkMissing(C_plnorm1)
  SEXP Rsh_Fir_array_args6[1];
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_C_plnorm1_;
...
D1_:;
  // deopt 2 [C_plnorm1, q1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_plnorm1_;
...
D2_:;
  // deopt 3 [C_plnorm1, q2, meanlog1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_plnorm1_;
...
D3_:;
  // deopt 4 [C_plnorm1, q2, meanlog2, sdlog1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_plnorm1_;
...
D4_:;
  // deopt 5 [C_plnorm1, q2, meanlog2, sdlog2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_plnorm1_;
...
D5_:;
  // deopt 6 [C_plnorm1, q2, meanlog2, sdlog2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack5[6];
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_plnorm1_;
...
L12_:;
  ...
  // vargs = dots[q2, meanlog2, sdlog2, lower_tail2, log_p2]
  ...
  // r2 = `.Call`(C_plnorm1, vargs, <missing>)
  SEXP Rsh_Fir_array_args12[3];
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_C_plnorm1_;
