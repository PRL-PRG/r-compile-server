...
SEXP Rsh_Fir_user_version_inner3101168155_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_C_plogis;  // C_plogis
  SEXP Rsh_Fir_reg_C_plogis1_;  // C_plogis1
...
L5_:;
  // C_plogis = ld C_plogis
  Rsh_Fir_reg_C_plogis = Rsh_Fir_load(Rsh_const(CCP, 11), RHO);
  // check L7() else D0()
  // L7()
  goto L7_;

L6_:;
  // r = dyn base(<sym C_plogis>, <sym q>, <sym location>, <sym scale>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_plogis;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L7_:;
  // C_plogis1 = force? C_plogis
  Rsh_Fir_reg_C_plogis1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_plogis);
  // checkMissing(C_plogis1)
  SEXP Rsh_Fir_array_args6[1];
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_C_plogis1_;
...
D1_:;
  // deopt 2 [C_plogis1, q1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_plogis1_;
...
D2_:;
  // deopt 3 [C_plogis1, q2, location1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_plogis1_;
...
D3_:;
  // deopt 4 [C_plogis1, q2, location2, scale1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_plogis1_;
...
D4_:;
  // deopt 5 [C_plogis1, q2, location2, scale2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_plogis1_;
...
D5_:;
  // deopt 6 [C_plogis1, q2, location2, scale2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack5[6];
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_plogis1_;
...
L12_:;
  ...
  // r2 = `.Call`(C_plogis1, vargs, <missing>)
  SEXP Rsh_Fir_array_args12[3];
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_C_plogis1_;
