...
SEXP Rsh_Fir_user_function_inner500754868_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner500754868_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner500754868_, RHO, CCP);
  // st pnorm = r
...
SEXP Rsh_Fir_user_function_inner500754868_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner500754868 dynamic dispatch ([q, mean, sd, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner500754868_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner500754868_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner500754868 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner500754868/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_pnorm;  // C_pnorm
  SEXP Rsh_Fir_reg_C_pnorm1_;  // C_pnorm1
...
L5_:;
  // C_pnorm = ld C_pnorm
  Rsh_Fir_reg_C_pnorm = Rsh_Fir_load(Rsh_const(CCP, 11), RHO);
  // check L7() else D0()
  // L7()
  goto L7_;
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_pnorm;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L7_:;
  // C_pnorm1 = force? C_pnorm
  Rsh_Fir_reg_C_pnorm1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_pnorm);
  // checkMissing(C_pnorm1)
  SEXP Rsh_Fir_array_args6[1];
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_C_pnorm1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_pnorm1_;
...
D2_:;
  ...
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_pnorm1_;
...
D3_:;
  ...
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_pnorm1_;
...
D4_:;
  ...
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_pnorm1_;
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_pnorm1_;
...
L12_:;
  ...
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_C_pnorm1_;
