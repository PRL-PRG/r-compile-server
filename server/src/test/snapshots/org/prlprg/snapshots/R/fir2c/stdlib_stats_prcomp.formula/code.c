...
SEXP Rsh_Fir_user_version_inner4130229875_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_prcomp_default;  // prcomp_default
...
L54_:;
  // r32 = dyn attr__(l4, NULL, "intercept", 0)
...
L57_:;
  ...
  // prcomp_default = ldf `prcomp.default`
  Rsh_Fir_reg_prcomp_default = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 36), RHO);
  // check L58() else D26()
  // L58()
  goto L58_;
...
L58_:;
  ...
  // r37 = dyn prcomp_default[, `...`](p6, ddd2)
  ...
  Rsh_Fir_reg_r37_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_prcomp_default, 2, Rsh_Fir_array_args44, Rsh_Fir_array_arg_names18, CCP, RHO);
  // check L59() else D27()
  // L59()
  goto L59_;
...
L86_:;
  ...
  Rsh_Fir_reg_napredict = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 45), RHO);
  // check L87() else D34()
  // L87()
  goto L87_;
...
L91_:;
  ...
  Rsh_Fir_array_args82[1] = Rsh_const(CCP, 35);
