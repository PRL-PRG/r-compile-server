...
SEXP Rsh_Fir_user_function_inner685017767_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner685017767_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner685017767
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner685017767_, RHO, CCP);
  // st psignrank = r
...
SEXP Rsh_Fir_user_function_inner685017767_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner685017767 dynamic dispatch ([q, n, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner685017767_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner685017767_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner685017767 version 0 (*, *, *, * -+> V)

  if (NPARAMS != 4) Rsh_error("FIŘ arity mismatch for inner685017767/0: expected 4, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_psignrank;  // C_psignrank
  SEXP Rsh_Fir_reg_C_psignrank1_;  // C_psignrank1
...
L6_:;
  // C_psignrank = ld C_psignrank
  Rsh_Fir_reg_C_psignrank = Rsh_Fir_load(Rsh_const(CCP, 10), RHO);
  // check L8() else D0()
  // L8()
  goto L8_;

L7_:;
  // r3 = dyn base1(<sym C_psignrank>, <sym q>, <sym n>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_psignrank;
  Rsh_Fir_deopt(4, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L8_:;
  // C_psignrank1 = force? C_psignrank
  Rsh_Fir_reg_C_psignrank1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_psignrank);
  // checkMissing(C_psignrank1)
  SEXP Rsh_Fir_array_args7[1];
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_C_psignrank1_;
...
D1_:;
  // deopt 5 [C_psignrank1, q1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_psignrank1_;
...
D2_:;
  // deopt 6 [C_psignrank1, q2, n1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_psignrank1_;
...
D3_:;
  // deopt 7 [C_psignrank1, q2, n2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_psignrank1_;
...
D4_:;
  // deopt 8 [C_psignrank1, q2, n2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_psignrank1_;
...
L12_:;
  ...
  // vargs = dots[q2, n2, lower_tail2, log_p2]
  ...
  // r5 = `.Call`(C_psignrank1, vargs, <missing>)
  SEXP Rsh_Fir_array_args12[3];
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_C_psignrank1_;
