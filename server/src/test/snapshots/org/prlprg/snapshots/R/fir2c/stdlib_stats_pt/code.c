...
SEXP Rsh_Fir_user_function_inner2468554270_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner2468554270_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner2468554270
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner2468554270_, RHO, CCP);
  // st pt = r
...
SEXP Rsh_Fir_user_function_inner2468554270_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner2468554270 dynamic dispatch ([q, df, ncp, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner2468554270_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner2468554270_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner2468554270 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner2468554270/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_pt;  // C_pt
  SEXP Rsh_Fir_reg_C_pt1_;  // C_pt1
  ...
  SEXP Rsh_Fir_reg_C_pnt;  // C_pnt
  SEXP Rsh_Fir_reg_C_pnt1_;  // C_pnt1
...
L9_:;
  // C_pt = ld C_pt
  Rsh_Fir_reg_C_pt = Rsh_Fir_load(Rsh_const(CCP, 10), RHO);
  // check L11() else D0()
  // L11()
  goto L11_;

L10_:;
  // r3 = dyn base1(<sym C_pt>, <sym q>, <sym df>, <sym lower.tail>, <sym log.p>)
  ...
  Rsh_Fir_array_args8[4] = Rsh_const(CCP, 7);
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 5, Rsh_Fir_array_args8, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L4(r3)
  // L4(r3)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_pt;
  Rsh_Fir_deopt(4, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L11_:;
  // C_pt1 = force? C_pt
  Rsh_Fir_reg_C_pt1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_pt);
  // checkMissing(C_pt1)
  SEXP Rsh_Fir_array_args9[1];
  Rsh_Fir_array_args9[0] = Rsh_Fir_reg_C_pt1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_pt1_;
...
L12_:;
  ...
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_q2_;
...
D2_:;
  // deopt 6 [C_pt1, q2, df1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_pt1_;
...
D3_:;
  // deopt 7 [C_pt1, q2, df2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_pt1_;
...
L14_:;
  ...
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_lower_tail2_;
...
D4_:;
  // deopt 8 [C_pt1, q2, df2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_pt1_;
...
L15_:;
  ...
  Rsh_Fir_array_args13[0] = Rsh_Fir_reg_log_p2_;
  ...
  // r5 = `.Call`(C_pt1, vargs, <missing>)
  SEXP Rsh_Fir_array_args14[3];
  Rsh_Fir_array_args14[0] = Rsh_Fir_reg_C_pt1_;
  Rsh_Fir_array_args14[1] = Rsh_Fir_reg_vargs;
  Rsh_Fir_array_args14[2] = Rsh_const(CCP, 11);
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_builtin(438, CCP, RHO, 3, Rsh_Fir_array_args14, Rsh_Fir_param_types_empty());
  // goto L4(r5)
  // L4(r5)
...
L17_:;
  // C_pnt = ld C_pnt
  Rsh_Fir_reg_C_pnt = Rsh_Fir_load(Rsh_const(CCP, 12), RHO);
  // check L19() else D5()
  // L19()
  goto L19_;

L18_:;
  // r6 = dyn base2(<sym C_pnt>, <sym q>, <sym df>, <sym ncp>, <sym lower.tail>, <sym log.p>)
  ...
  Rsh_Fir_array_args15[3] = Rsh_const(CCP, 3);
  Rsh_Fir_array_args15[4] = Rsh_const(CCP, 5);
  Rsh_Fir_array_args15[5] = Rsh_const(CCP, 7);
  ...
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base2_, 6, Rsh_Fir_array_args15, Rsh_Fir_array_arg_names3, CCP, RHO);
  // goto L5(r6)
  // L5(r6)
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_pnt;
  Rsh_Fir_deopt(12, 1, Rsh_Fir_array_deopt_stack5, CCP, RHO);
  return R_NilValue;

L19_:;
  // C_pnt1 = force? C_pnt
  Rsh_Fir_reg_C_pnt1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_pnt);
  // checkMissing(C_pnt1)
  SEXP Rsh_Fir_array_args16[1];
  Rsh_Fir_array_args16[0] = Rsh_Fir_reg_C_pnt1_;
...
D6_:;
  ...
  Rsh_Fir_array_deopt_stack6[0] = Rsh_Fir_reg_C_pnt1_;
...
L20_:;
  ...
  Rsh_Fir_array_args17[0] = Rsh_Fir_reg_q4_;
...
D7_:;
  // deopt 14 [C_pnt1, q4, df3]
  SEXP Rsh_Fir_array_deopt_stack7[3];
  Rsh_Fir_array_deopt_stack7[0] = Rsh_Fir_reg_C_pnt1_;
...
L21_:;
  ...
  Rsh_Fir_array_args18[0] = Rsh_Fir_reg_df4_;
...
D8_:;
  // deopt 15 [C_pnt1, q4, df4, ncp1]
  SEXP Rsh_Fir_array_deopt_stack8[4];
  Rsh_Fir_array_deopt_stack8[0] = Rsh_Fir_reg_C_pnt1_;
...
L22_:;
  ...
  Rsh_Fir_reg_lower_tail3_ = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // check L23() else D9()
  // L23()
  goto L23_;

D9_:;
  // deopt 16 [C_pnt1, q4, df4, ncp2, lower_tail3]
  SEXP Rsh_Fir_array_deopt_stack9[5];
  Rsh_Fir_array_deopt_stack9[0] = Rsh_Fir_reg_C_pnt1_;
...
L23_:;
  ...
  Rsh_Fir_array_args20[0] = Rsh_Fir_reg_lower_tail4_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args20, Rsh_Fir_param_types_empty()));
  // log_p3 = ld `log.p`
  Rsh_Fir_reg_log_p3_ = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // check L24() else D10()
  // L24()
  goto L24_;

D10_:;
  // deopt 17 [C_pnt1, q4, df4, ncp2, lower_tail4, log_p3]
  SEXP Rsh_Fir_array_deopt_stack10[6];
  Rsh_Fir_array_deopt_stack10[0] = Rsh_Fir_reg_C_pnt1_;
...
L24_:;
  ...
  Rsh_Fir_array_args21[0] = Rsh_Fir_reg_log_p4_;
  ...
  // r8 = `.Call`(C_pnt1, vargs1, <missing>)
  SEXP Rsh_Fir_array_args22[3];
  Rsh_Fir_array_args22[0] = Rsh_Fir_reg_C_pnt1_;
  Rsh_Fir_array_args22[1] = Rsh_Fir_reg_vargs1_;
  Rsh_Fir_array_args22[2] = Rsh_const(CCP, 11);
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_builtin(438, CCP, RHO, 3, Rsh_Fir_array_args22, Rsh_Fir_param_types_empty());
  // goto L5(r8)
  // L5(r8)
