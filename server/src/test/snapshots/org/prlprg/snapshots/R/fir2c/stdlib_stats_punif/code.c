...
SEXP Rsh_Fir_user_function_inner2221756414_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner2221756414_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner2221756414
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner2221756414_, RHO, CCP);
  // st punif = r
...
SEXP Rsh_Fir_user_function_inner2221756414_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner2221756414 dynamic dispatch ([q, min, max, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner2221756414_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner2221756414_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner2221756414 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner2221756414/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_punif;  // C_punif
  SEXP Rsh_Fir_reg_C_punif1_;  // C_punif1
...
L5_:;
  // C_punif = ld C_punif
  Rsh_Fir_reg_C_punif = Rsh_Fir_load(Rsh_const(CCP, 11), RHO);
  // check L7() else D0()
  // L7()
  goto L7_;

L6_:;
  // r = dyn base(<sym C_punif>, <sym q>, <sym min>, <sym max>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_punif;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L7_:;
  // C_punif1 = force? C_punif
  Rsh_Fir_reg_C_punif1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_punif);
  // checkMissing(C_punif1)
  SEXP Rsh_Fir_array_args6[1];
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_C_punif1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_punif1_;
...
D2_:;
  // deopt 3 [C_punif1, q2, min1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_punif1_;
...
D3_:;
  // deopt 4 [C_punif1, q2, min2, max1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_punif1_;
...
L10_:;
  ...
  Rsh_Fir_array_args9[0] = Rsh_Fir_reg_max2_;
...
D4_:;
  // deopt 5 [C_punif1, q2, min2, max2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_punif1_;
  Rsh_Fir_array_deopt_stack4[1] = Rsh_Fir_reg_q2_;
  Rsh_Fir_array_deopt_stack4[2] = Rsh_Fir_reg_min2_;
  Rsh_Fir_array_deopt_stack4[3] = Rsh_Fir_reg_max2_;
...
D5_:;
  // deopt 6 [C_punif1, q2, min2, max2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack5[6];
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_punif1_;
  Rsh_Fir_array_deopt_stack5[1] = Rsh_Fir_reg_q2_;
  Rsh_Fir_array_deopt_stack5[2] = Rsh_Fir_reg_min2_;
  Rsh_Fir_array_deopt_stack5[3] = Rsh_Fir_reg_max2_;
...
L12_:;
  ...
  // vargs = dots[q2, min2, max2, lower_tail2, log_p2]
  ...
  // r2 = `.Call`(C_punif1, vargs, <missing>)
  SEXP Rsh_Fir_array_args12[3];
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_C_punif1_;
