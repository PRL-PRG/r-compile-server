...
SEXP Rsh_Fir_user_function_inner3446455210_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner3446455210_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner3446455210
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner3446455210_, RHO, CCP);
  // st pweibull = r
...
SEXP Rsh_Fir_user_function_inner3446455210_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner3446455210 dynamic dispatch ([q, shape, scale, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner3446455210_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner3446455210_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner3446455210 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner3446455210/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_pweibull;  // C_pweibull
  SEXP Rsh_Fir_reg_C_pweibull1_;  // C_pweibull1
...
L4_:;
  // C_pweibull = ld C_pweibull
  Rsh_Fir_reg_C_pweibull = Rsh_Fir_load(Rsh_const(CCP, 10), RHO);
  // check L6() else D0()
  // L6()
  goto L6_;

L5_:;
  // r = dyn base(<sym C_pweibull>, <sym q>, <sym shape>, <sym scale>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_pweibull;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L6_:;
  // C_pweibull1 = force? C_pweibull
  Rsh_Fir_reg_C_pweibull1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_pweibull);
  // checkMissing(C_pweibull1)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_C_pweibull1_;
...
D1_:;
  // deopt 2 [C_pweibull1, q1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_pweibull1_;
...
D2_:;
  // deopt 3 [C_pweibull1, q2, shape1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_pweibull1_;
...
L8_:;
  ...
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_shape2_;
...
D3_:;
  // deopt 4 [C_pweibull1, q2, shape2, scale1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_pweibull1_;
...
D4_:;
  // deopt 5 [C_pweibull1, q2, shape2, scale2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_pweibull1_;
...
D5_:;
  // deopt 6 [C_pweibull1, q2, shape2, scale2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack5[6];
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_pweibull1_;
  Rsh_Fir_array_deopt_stack5[1] = Rsh_Fir_reg_q2_;
  Rsh_Fir_array_deopt_stack5[2] = Rsh_Fir_reg_shape2_;
...
L11_:;
  ...
  // vargs = dots[q2, shape2, scale2, lower_tail2, log_p2]
  ...
  // r2 = `.Call`(C_pweibull1, vargs, <missing>)
  SEXP Rsh_Fir_array_args11[3];
  Rsh_Fir_array_args11[0] = Rsh_Fir_reg_C_pweibull1_;
