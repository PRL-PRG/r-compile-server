...
SEXP Rsh_Fir_user_function_inner284608428_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner284608428_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner284608428
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner284608428_, RHO, CCP);
  // st pwilcox = r
...
SEXP Rsh_Fir_user_function_inner284608428_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner284608428 dynamic dispatch ([q, m, n, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner284608428_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner284608428_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner284608428 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner284608428/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_pwilcox;  // C_pwilcox
  SEXP Rsh_Fir_reg_C_pwilcox1_;  // C_pwilcox1
...
L6_:;
  // C_pwilcox = ld C_pwilcox
  Rsh_Fir_reg_C_pwilcox = Rsh_Fir_load(Rsh_const(CCP, 11), RHO);
  // check L8() else D0()
  // L8()
  goto L8_;

L7_:;
  // r3 = dyn base1(<sym C_pwilcox>, <sym q>, <sym m>, <sym n>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_pwilcox;
  Rsh_Fir_deopt(4, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L8_:;
  // C_pwilcox1 = force? C_pwilcox
  Rsh_Fir_reg_C_pwilcox1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_pwilcox);
  // checkMissing(C_pwilcox1)
  SEXP Rsh_Fir_array_args7[1];
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_C_pwilcox1_;
...
D1_:;
  // deopt 5 [C_pwilcox1, q1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_pwilcox1_;
...
D2_:;
  // deopt 6 [C_pwilcox1, q2, m1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_pwilcox1_;
...
D3_:;
  // deopt 7 [C_pwilcox1, q2, m2, n1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_pwilcox1_;
...
D4_:;
  // deopt 8 [C_pwilcox1, q2, m2, n2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_pwilcox1_;
...
D5_:;
  // deopt 9 [C_pwilcox1, q2, m2, n2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack5[6];
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_pwilcox1_;
...
L13_:;
  ...
  // vargs = dots[q2, m2, n2, lower_tail2, log_p2]
  ...
  // r5 = `.Call`(C_pwilcox1, vargs, <missing>)
  SEXP Rsh_Fir_array_args13[3];
  Rsh_Fir_array_args13[0] = Rsh_Fir_reg_C_pwilcox1_;
