...
SEXP Rsh_Fir_user_function_inner1095887112_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner1095887112_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner1095887112
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner1095887112_, RHO, CCP);
  // st qbinom = r
...
SEXP Rsh_Fir_user_function_inner1095887112_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner1095887112 dynamic dispatch ([p, size, prob, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner1095887112_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner1095887112_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner1095887112 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner1095887112/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_qbinom;  // C_qbinom
  SEXP Rsh_Fir_reg_C_qbinom1_;  // C_qbinom1
...
L3_:;
  // C_qbinom = ld C_qbinom
  Rsh_Fir_reg_C_qbinom = Rsh_Fir_load(Rsh_const(CCP, 9), RHO);
  // check L5() else D0()
  // L5()
  goto L5_;

L4_:;
  // r = dyn base(<sym C_qbinom>, <sym p>, <sym size>, <sym prob>, <sym lower.tail>, <sym log.p>)
  ...
  Rsh_Fir_array_args3[4] = Rsh_const(CCP, 5);
  ...
  Rsh_Fir_reg_r1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 6, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names, CCP, RHO);
  // goto L2(r)
  // L2(r)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_qbinom;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L5_:;
  // C_qbinom1 = force? C_qbinom
  Rsh_Fir_reg_C_qbinom1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_qbinom);
  // checkMissing(C_qbinom1)
  SEXP Rsh_Fir_array_args4[1];
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_C_qbinom1_;
...
D1_:;
  // deopt 2 [C_qbinom1, p1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_qbinom1_;
...
D2_:;
  // deopt 3 [C_qbinom1, p2, size1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_qbinom1_;
...
L7_:;
  ...
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_size2_;
...
D3_:;
  // deopt 4 [C_qbinom1, p2, size2, prob1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_qbinom1_;
...
L8_:;
  ...
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_prob2_;
...
D4_:;
  // deopt 5 [C_qbinom1, p2, size2, prob2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_qbinom1_;
  Rsh_Fir_array_deopt_stack4[1] = Rsh_Fir_reg_p2_;
  Rsh_Fir_array_deopt_stack4[2] = Rsh_Fir_reg_size2_;
  Rsh_Fir_array_deopt_stack4[3] = Rsh_Fir_reg_prob2_;
...
L9_:;
  ...
  Rsh_Fir_array_args8[0] = Rsh_Fir_reg_lower_tail2_;
...
D5_:;
  // deopt 6 [C_qbinom1, p2, size2, prob2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack5[6];
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_qbinom1_;
  Rsh_Fir_array_deopt_stack5[1] = Rsh_Fir_reg_p2_;
  Rsh_Fir_array_deopt_stack5[2] = Rsh_Fir_reg_size2_;
  Rsh_Fir_array_deopt_stack5[3] = Rsh_Fir_reg_prob2_;
...
L10_:;
  ...
  Rsh_Fir_array_args9[0] = Rsh_Fir_reg_log_p2_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args9, Rsh_Fir_param_types_empty()));
  // vargs = dots[p2, size2, prob2, lower_tail2, log_p2]
  ...
  // r2 = `.Call`(C_qbinom1, vargs, <missing>)
  SEXP Rsh_Fir_array_args10[3];
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_C_qbinom1_;
