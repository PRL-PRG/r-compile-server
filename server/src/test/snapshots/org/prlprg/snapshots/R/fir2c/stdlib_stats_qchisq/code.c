...
SEXP Rsh_Fir_user_function_inner3729712916_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner3729712916_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner3729712916
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner3729712916_, RHO, CCP);
  // st qchisq = r
...
SEXP Rsh_Fir_user_function_inner3729712916_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner3729712916 dynamic dispatch ([p, df, ncp, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner3729712916_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner3729712916_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner3729712916 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner3729712916/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_qchisq;  // C_qchisq
  SEXP Rsh_Fir_reg_C_qchisq1_;  // C_qchisq1
  ...
  SEXP Rsh_Fir_reg_C_qnchisq;  // C_qnchisq
  SEXP Rsh_Fir_reg_C_qnchisq1_;  // C_qnchisq1
...
L10_:;
  // C_qchisq = ld C_qchisq
  Rsh_Fir_reg_C_qchisq = Rsh_Fir_load(Rsh_const(CCP, 11), RHO);
  // check L12() else D0()
  // L12()
  goto L12_;

L11_:;
  // r3 = dyn base1(<sym C_qchisq>, <sym p>, <sym df>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_qchisq;
  Rsh_Fir_deopt(4, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L12_:;
  // C_qchisq1 = force? C_qchisq
  Rsh_Fir_reg_C_qchisq1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_qchisq);
  // checkMissing(C_qchisq1)
  SEXP Rsh_Fir_array_args10[1];
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_C_qchisq1_;
...
D1_:;
  // deopt 5 [C_qchisq1, p1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_qchisq1_;
...
D2_:;
  // deopt 6 [C_qchisq1, p2, df1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_qchisq1_;
...
D3_:;
  // deopt 7 [C_qchisq1, p2, df2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_qchisq1_;
...
D4_:;
  // deopt 8 [C_qchisq1, p2, df2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_qchisq1_;
...
L16_:;
  ...
  // vargs = dots[p2, df2, lower_tail2, log_p2]
  ...
  // r5 = `.Call`(C_qchisq1, vargs, <missing>)
  SEXP Rsh_Fir_array_args15[3];
  Rsh_Fir_array_args15[0] = Rsh_Fir_reg_C_qchisq1_;
...
L18_:;
  // C_qnchisq = ld C_qnchisq
  Rsh_Fir_reg_C_qnchisq = Rsh_Fir_load(Rsh_const(CCP, 13), RHO);
  // check L20() else D5()
  // L20()
  goto L20_;

L19_:;
  // r6 = dyn base2(<sym C_qnchisq>, <sym p>, <sym df>, <sym ncp>, <sym lower.tail>, <sym log.p>)
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_qnchisq;
  Rsh_Fir_deopt(12, 1, Rsh_Fir_array_deopt_stack5, CCP, RHO);
  return R_NilValue;

L20_:;
  // C_qnchisq1 = force? C_qnchisq
  Rsh_Fir_reg_C_qnchisq1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_qnchisq);
  // checkMissing(C_qnchisq1)
  SEXP Rsh_Fir_array_args17[1];
  Rsh_Fir_array_args17[0] = Rsh_Fir_reg_C_qnchisq1_;
...
D6_:;
  // deopt 13 [C_qnchisq1, p3]
  SEXP Rsh_Fir_array_deopt_stack6[2];
  Rsh_Fir_array_deopt_stack6[0] = Rsh_Fir_reg_C_qnchisq1_;
  Rsh_Fir_array_deopt_stack6[1] = Rsh_Fir_reg_p3_;
...
D7_:;
  // deopt 14 [C_qnchisq1, p4, df3]
  SEXP Rsh_Fir_array_deopt_stack7[3];
  Rsh_Fir_array_deopt_stack7[0] = Rsh_Fir_reg_C_qnchisq1_;
  Rsh_Fir_array_deopt_stack7[1] = Rsh_Fir_reg_p4_;
...
D8_:;
  // deopt 15 [C_qnchisq1, p4, df4, ncp1]
  SEXP Rsh_Fir_array_deopt_stack8[4];
  Rsh_Fir_array_deopt_stack8[0] = Rsh_Fir_reg_C_qnchisq1_;
...
D9_:;
  // deopt 16 [C_qnchisq1, p4, df4, ncp2, lower_tail3]
  SEXP Rsh_Fir_array_deopt_stack9[5];
  Rsh_Fir_array_deopt_stack9[0] = Rsh_Fir_reg_C_qnchisq1_;
...
D10_:;
  // deopt 17 [C_qnchisq1, p4, df4, ncp2, lower_tail4, log_p3]
  SEXP Rsh_Fir_array_deopt_stack10[6];
  Rsh_Fir_array_deopt_stack10[0] = Rsh_Fir_reg_C_qnchisq1_;
...
L25_:;
  ...
  // vargs1 = dots[p4, df4, ncp2, lower_tail4, log_p4]
  ...
  // r8 = `.Call`(C_qnchisq1, vargs1, <missing>)
  SEXP Rsh_Fir_array_args23[3];
  Rsh_Fir_array_args23[0] = Rsh_Fir_reg_C_qnchisq1_;
