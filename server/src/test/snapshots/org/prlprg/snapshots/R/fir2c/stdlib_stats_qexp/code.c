...
SEXP Rsh_Fir_user_function_inner1918990004_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner1918990004_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner1918990004
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner1918990004_, RHO, CCP);
  // st qexp = r
...
SEXP Rsh_Fir_user_function_inner1918990004_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner1918990004 dynamic dispatch ([p, rate, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner1918990004_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner1918990004_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner1918990004 version 0 (*, *, *, * -+> V)

  if (NPARAMS != 4) Rsh_error("FIŘ arity mismatch for inner1918990004/0: expected 4, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_qexp;  // C_qexp
  SEXP Rsh_Fir_reg_C_qexp1_;  // C_qexp1
...
L4_:;
  // C_qexp = ld C_qexp
  Rsh_Fir_reg_C_qexp = Rsh_Fir_load(Rsh_const(CCP, 9), RHO);
  // check L6() else D0()
  // L6()
  goto L6_;

L5_:;
  // r = dyn base(<sym C_qexp>, <sym p>, <lang `/`(1.0, rate)>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_qexp;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L6_:;
  // C_qexp1 = force? C_qexp
  Rsh_Fir_reg_C_qexp1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_qexp);
  // checkMissing(C_qexp1)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_C_qexp1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_qexp1_;
...
D2_:;
  // deopt 4 [C_qexp1, p2, 1.0, rate1]
  SEXP Rsh_Fir_array_deopt_stack2[4];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_qexp1_;
...
D3_:;
  // deopt 6 [C_qexp1, p2, r2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_qexp1_;
...
D4_:;
  // deopt 7 [C_qexp1, p2, r2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_qexp1_;
...
L10_:;
  ...
  // vargs = dots[p2, r2, lower_tail2, log_p2]
  ...
  // r3 = `.Call`(C_qexp1, vargs, <missing>)
  SEXP Rsh_Fir_array_args11[3];
  Rsh_Fir_array_args11[0] = Rsh_Fir_reg_C_qexp1_;
