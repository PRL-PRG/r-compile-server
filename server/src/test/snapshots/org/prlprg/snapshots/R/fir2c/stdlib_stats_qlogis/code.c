...
SEXP Rsh_Fir_user_version_inner4034522492_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_C_qlogis;  // C_qlogis
  SEXP Rsh_Fir_reg_C_qlogis1_;  // C_qlogis1
...
L5_:;
  ...
  Rsh_Fir_reg_C_qlogis = Rsh_Fir_load(Rsh_const(CCP, 11), RHO);
  // check L7() else D0()
  // L7()
  goto L7_;
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_qlogis;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L7_:;
  // C_qlogis1 = force? C_qlogis
  Rsh_Fir_reg_C_qlogis1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_qlogis);
  // checkMissing(C_qlogis1)
  SEXP Rsh_Fir_array_args6[1];
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_C_qlogis1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_qlogis1_;
...
D2_:;
  ...
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_qlogis1_;
...
D3_:;
  ...
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_qlogis1_;
...
D4_:;
  ...
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_qlogis1_;
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_qlogis1_;
...
L12_:;
  ...
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_C_qlogis1_;
