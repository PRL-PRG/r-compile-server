...
SEXP Rsh_Fir_user_function_inner3881977636_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner3881977636_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner3881977636
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner3881977636_, RHO, CCP);
  // st qnbinom = r
...
SEXP Rsh_Fir_user_function_inner3881977636_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner3881977636 dynamic dispatch ([p, size, prob, mu, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner3881977636_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner3881977636_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner3881977636 version 0 (*, *, *, *, *, * -+> V)

  if (NPARAMS != 6) Rsh_error("FIŘ arity mismatch for inner3881977636/0: expected 6, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_qnbinom_mu;  // C_qnbinom_mu
  SEXP Rsh_Fir_reg_C_qnbinom_mu1_;  // C_qnbinom_mu1
  ...
  SEXP Rsh_Fir_reg_C_qnbinom;  // C_qnbinom
  SEXP Rsh_Fir_reg_C_qnbinom1_;  // C_qnbinom1
...
L18_:;
  // C_qnbinom_mu = ld C_qnbinom_mu
  Rsh_Fir_reg_C_qnbinom_mu = Rsh_Fir_load(Rsh_const(CCP, 13), RHO);
  // check L20() else D2()
  // L20()
  goto L20_;

L19_:;
  // r10 = dyn base2(<sym C_qnbinom_mu>, <sym p>, <sym size>, <sym mu>, <sym lower.tail>, <sym log.p>)
...
D2_:;
  // deopt 15 [C_qnbinom_mu]
  SEXP Rsh_Fir_array_deopt_stack1[1];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_qnbinom_mu;
  Rsh_Fir_deopt(15, 1, Rsh_Fir_array_deopt_stack1, CCP, RHO);
  return R_NilValue;

L20_:;
  // C_qnbinom_mu1 = force? C_qnbinom_mu
  Rsh_Fir_reg_C_qnbinom_mu1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_qnbinom_mu);
  // checkMissing(C_qnbinom_mu1)
  SEXP Rsh_Fir_array_args16[1];
  Rsh_Fir_array_args16[0] = Rsh_Fir_reg_C_qnbinom_mu1_;
...
D3_:;
  // deopt 16 [C_qnbinom_mu1, p1]
  SEXP Rsh_Fir_array_deopt_stack2[2];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_qnbinom_mu1_;
  Rsh_Fir_array_deopt_stack2[1] = Rsh_Fir_reg_p1_;
...
D4_:;
  // deopt 17 [C_qnbinom_mu1, p2, size1]
  SEXP Rsh_Fir_array_deopt_stack3[3];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_qnbinom_mu1_;
...
D5_:;
  // deopt 18 [C_qnbinom_mu1, p2, size2, mu1]
  SEXP Rsh_Fir_array_deopt_stack4[4];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_qnbinom_mu1_;
...
D6_:;
  // deopt 19 [C_qnbinom_mu1, p2, size2, mu2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack5[5];
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_qnbinom_mu1_;
...
D7_:;
  // deopt 20 [C_qnbinom_mu1, p2, size2, mu2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack6[6];
  Rsh_Fir_array_deopt_stack6[0] = Rsh_Fir_reg_C_qnbinom_mu1_;
...
L25_:;
  ...
  // vargs = dots[p2, size2, mu2, lower_tail2, log_p2]
  ...
  // r12 = `.Call`(C_qnbinom_mu1, vargs, <missing>)
  SEXP Rsh_Fir_array_args22[3];
  Rsh_Fir_array_args22[0] = Rsh_Fir_reg_C_qnbinom_mu1_;
...
L27_:;
  // C_qnbinom = ld C_qnbinom
  Rsh_Fir_reg_C_qnbinom = Rsh_Fir_load(Rsh_const(CCP, 15), RHO);
  // check L29() else D8()
  // L29()
  goto L29_;

L28_:;
  // r13 = dyn base3(<sym C_qnbinom>, <sym p>, <sym size>, <sym prob>, <sym lower.tail>, <sym log.p>)
...
D8_:;
  ...
  Rsh_Fir_array_deopt_stack7[0] = Rsh_Fir_reg_C_qnbinom;
  Rsh_Fir_deopt(24, 1, Rsh_Fir_array_deopt_stack7, CCP, RHO);
  return R_NilValue;

L29_:;
  // C_qnbinom1 = force? C_qnbinom
  Rsh_Fir_reg_C_qnbinom1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_qnbinom);
  // checkMissing(C_qnbinom1)
  SEXP Rsh_Fir_array_args24[1];
  Rsh_Fir_array_args24[0] = Rsh_Fir_reg_C_qnbinom1_;
...
D9_:;
  // deopt 25 [C_qnbinom1, p3]
  SEXP Rsh_Fir_array_deopt_stack8[2];
  Rsh_Fir_array_deopt_stack8[0] = Rsh_Fir_reg_C_qnbinom1_;
...
D10_:;
  // deopt 26 [C_qnbinom1, p4, size3]
  SEXP Rsh_Fir_array_deopt_stack9[3];
  Rsh_Fir_array_deopt_stack9[0] = Rsh_Fir_reg_C_qnbinom1_;
...
D11_:;
  // deopt 27 [C_qnbinom1, p4, size4, prob1]
  SEXP Rsh_Fir_array_deopt_stack10[4];
  Rsh_Fir_array_deopt_stack10[0] = Rsh_Fir_reg_C_qnbinom1_;
...
D12_:;
  // deopt 28 [C_qnbinom1, p4, size4, prob2, lower_tail3]
  SEXP Rsh_Fir_array_deopt_stack11[5];
  Rsh_Fir_array_deopt_stack11[0] = Rsh_Fir_reg_C_qnbinom1_;
...
D13_:;
  // deopt 29 [C_qnbinom1, p4, size4, prob2, lower_tail4, log_p3]
  SEXP Rsh_Fir_array_deopt_stack12[6];
  Rsh_Fir_array_deopt_stack12[0] = Rsh_Fir_reg_C_qnbinom1_;
...
L34_:;
  ...
  // vargs1 = dots[p4, size4, prob2, lower_tail4, log_p4]
  ...
  // r15 = `.Call`(C_qnbinom1, vargs1, <missing>)
  SEXP Rsh_Fir_array_args30[3];
  Rsh_Fir_array_args30[0] = Rsh_Fir_reg_C_qnbinom1_;
