...
SEXP Rsh_Fir_user_function_inner4120029555_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner4120029555_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner4120029555
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner4120029555_, RHO, CCP);
  // st qnorm = r
...
SEXP Rsh_Fir_user_function_inner4120029555_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner4120029555 dynamic dispatch ([p, mean, sd, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner4120029555_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner4120029555_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner4120029555 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner4120029555/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_qnorm;  // C_qnorm
  SEXP Rsh_Fir_reg_C_qnorm1_;  // C_qnorm1
...
L5_:;
  // C_qnorm = ld C_qnorm
  Rsh_Fir_reg_C_qnorm = Rsh_Fir_load(Rsh_const(CCP, 11), RHO);
  // check L7() else D0()
  // L7()
  goto L7_;

L6_:;
  // r = dyn base(<sym C_qnorm>, <sym p>, <sym mean>, <sym sd>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_qnorm;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L7_:;
  // C_qnorm1 = force? C_qnorm
  Rsh_Fir_reg_C_qnorm1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_qnorm);
  // checkMissing(C_qnorm1)
  SEXP Rsh_Fir_array_args6[1];
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_C_qnorm1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_qnorm1_;
...
D2_:;
  // deopt 3 [C_qnorm1, p2, mean1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_qnorm1_;
...
L9_:;
  ...
  Rsh_Fir_array_args8[0] = Rsh_Fir_reg_mean2_;
...
D3_:;
  // deopt 4 [C_qnorm1, p2, mean2, sd1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_qnorm1_;
...
L10_:;
  ...
  Rsh_Fir_array_args9[0] = Rsh_Fir_reg_sd2_;
...
D4_:;
  // deopt 5 [C_qnorm1, p2, mean2, sd2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_qnorm1_;
...
D5_:;
  // deopt 6 [C_qnorm1, p2, mean2, sd2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack5[6];
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_qnorm1_;
  Rsh_Fir_array_deopt_stack5[1] = Rsh_Fir_reg_p2_;
  Rsh_Fir_array_deopt_stack5[2] = Rsh_Fir_reg_mean2_;
  Rsh_Fir_array_deopt_stack5[3] = Rsh_Fir_reg_sd2_;
...
L12_:;
  ...
  // vargs = dots[p2, mean2, sd2, lower_tail2, log_p2]
  ...
  // r2 = `.Call`(C_qnorm1, vargs, <missing>)
  SEXP Rsh_Fir_array_args12[3];
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_C_qnorm1_;
