...
SEXP Rsh_Fir_user_function_inner1256269000_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner1256269000_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner1256269000
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner1256269000_, RHO, CCP);
  // st qsignrank = r
...
SEXP Rsh_Fir_user_function_inner1256269000_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner1256269000 dynamic dispatch ([p, n, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner1256269000_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner1256269000_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner1256269000 version 0 (*, *, *, * -+> V)

  if (NPARAMS != 4) Rsh_error("FIŘ arity mismatch for inner1256269000/0: expected 4, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_qsignrank;  // C_qsignrank
  SEXP Rsh_Fir_reg_C_qsignrank1_;  // C_qsignrank1
...
L4_:;
  ...
  // r2 = dyn on_exit(<lang .External(C_signrank_free)>)
...
L5_:;
  // r = dyn base(<lang .External(C_signrank_free)>)
...
L6_:;
  // C_qsignrank = ld C_qsignrank
  Rsh_Fir_reg_C_qsignrank = Rsh_Fir_load(Rsh_const(CCP, 10), RHO);
  // check L8() else D0()
  // L8()
  goto L8_;

L7_:;
  // r3 = dyn base1(<sym C_qsignrank>, <sym p>, <sym n>, <sym lower.tail>, <sym log.p>)
  ...
  Rsh_Fir_array_args6[4] = Rsh_const(CCP, 6);
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 5, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L3(r3)
  // L3(r3)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_qsignrank;
  Rsh_Fir_deopt(4, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L8_:;
  // C_qsignrank1 = force? C_qsignrank
  Rsh_Fir_reg_C_qsignrank1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_qsignrank);
  // checkMissing(C_qsignrank1)
  SEXP Rsh_Fir_array_args7[1];
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_C_qsignrank1_;
...
D1_:;
  // deopt 5 [C_qsignrank1, p1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_qsignrank1_;
...
D2_:;
  // deopt 6 [C_qsignrank1, p2, n1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_qsignrank1_;
  Rsh_Fir_array_deopt_stack2[1] = Rsh_Fir_reg_p2_;
  Rsh_Fir_array_deopt_stack2[2] = Rsh_Fir_reg_n1_;
...
D3_:;
  // deopt 7 [C_qsignrank1, p2, n2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_qsignrank1_;
  Rsh_Fir_array_deopt_stack3[1] = Rsh_Fir_reg_p2_;
  Rsh_Fir_array_deopt_stack3[2] = Rsh_Fir_reg_n2_;
...
D4_:;
  // deopt 8 [C_qsignrank1, p2, n2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_qsignrank1_;
  Rsh_Fir_array_deopt_stack4[1] = Rsh_Fir_reg_p2_;
  Rsh_Fir_array_deopt_stack4[2] = Rsh_Fir_reg_n2_;
...
L12_:;
  ...
  // vargs = dots[p2, n2, lower_tail2, log_p2]
  SEXP Rsh_Fir_array_vector_values[4];
  Rsh_Fir_array_vector_values[0] = Rsh_Fir_reg_p2_;
  Rsh_Fir_array_vector_values[1] = Rsh_Fir_reg_n2_;
  ...
  // r5 = `.Call`(C_qsignrank1, vargs, <missing>)
  SEXP Rsh_Fir_array_args12[3];
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_C_qsignrank1_;
