...
SEXP Rsh_Fir_user_function_inner1300358015_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner1300358015_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner1300358015
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner1300358015_, RHO, CCP);
  // st qt = r
...
SEXP Rsh_Fir_user_function_inner1300358015_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner1300358015 dynamic dispatch ([p, df, ncp, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner1300358015_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner1300358015_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner1300358015 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner1300358015/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_qt;  // C_qt
  SEXP Rsh_Fir_reg_C_qt1_;  // C_qt1
  ...
  SEXP Rsh_Fir_reg_C_qnt;  // C_qnt
  SEXP Rsh_Fir_reg_C_qnt1_;  // C_qnt1
...
L9_:;
  // C_qt = ld C_qt
  Rsh_Fir_reg_C_qt = Rsh_Fir_load(Rsh_const(CCP, 10), RHO);
  // check L11() else D0()
  // L11()
  goto L11_;

L10_:;
  // r3 = dyn base1(<sym C_qt>, <sym p>, <sym df>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_qt;
  Rsh_Fir_deopt(4, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L11_:;
  // C_qt1 = force? C_qt
  Rsh_Fir_reg_C_qt1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_qt);
  // checkMissing(C_qt1)
  SEXP Rsh_Fir_array_args9[1];
  Rsh_Fir_array_args9[0] = Rsh_Fir_reg_C_qt1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_qt1_;
...
D2_:;
  // deopt 6 [C_qt1, p2, df1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_qt1_;
...
D3_:;
  // deopt 7 [C_qt1, p2, df2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_qt1_;
...
D4_:;
  // deopt 8 [C_qt1, p2, df2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_qt1_;
...
L15_:;
  ...
  // r5 = `.Call`(C_qt1, vargs, <missing>)
  SEXP Rsh_Fir_array_args14[3];
  Rsh_Fir_array_args14[0] = Rsh_Fir_reg_C_qt1_;
...
L17_:;
  // C_qnt = ld C_qnt
  Rsh_Fir_reg_C_qnt = Rsh_Fir_load(Rsh_const(CCP, 12), RHO);
  // check L19() else D5()
  // L19()
  goto L19_;

L18_:;
  // r6 = dyn base2(<sym C_qnt>, <sym p>, <sym df>, <sym ncp>, <sym lower.tail>, <sym log.p>)
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_qnt;
  Rsh_Fir_deopt(12, 1, Rsh_Fir_array_deopt_stack5, CCP, RHO);
  return R_NilValue;

L19_:;
  // C_qnt1 = force? C_qnt
  Rsh_Fir_reg_C_qnt1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_qnt);
  // checkMissing(C_qnt1)
  SEXP Rsh_Fir_array_args16[1];
  Rsh_Fir_array_args16[0] = Rsh_Fir_reg_C_qnt1_;
...
D6_:;
  ...
  Rsh_Fir_array_deopt_stack6[0] = Rsh_Fir_reg_C_qnt1_;
...
D7_:;
  // deopt 14 [C_qnt1, p4, df3]
  SEXP Rsh_Fir_array_deopt_stack7[3];
  Rsh_Fir_array_deopt_stack7[0] = Rsh_Fir_reg_C_qnt1_;
...
D8_:;
  // deopt 15 [C_qnt1, p4, df4, ncp1]
  SEXP Rsh_Fir_array_deopt_stack8[4];
  Rsh_Fir_array_deopt_stack8[0] = Rsh_Fir_reg_C_qnt1_;
...
D9_:;
  // deopt 16 [C_qnt1, p4, df4, ncp2, lower_tail3]
  SEXP Rsh_Fir_array_deopt_stack9[5];
  Rsh_Fir_array_deopt_stack9[0] = Rsh_Fir_reg_C_qnt1_;
...
D10_:;
  // deopt 17 [C_qnt1, p4, df4, ncp2, lower_tail4, log_p3]
  SEXP Rsh_Fir_array_deopt_stack10[6];
  Rsh_Fir_array_deopt_stack10[0] = Rsh_Fir_reg_C_qnt1_;
...
L24_:;
  ...
  // r8 = `.Call`(C_qnt1, vargs1, <missing>)
  SEXP Rsh_Fir_array_args22[3];
  Rsh_Fir_array_args22[0] = Rsh_Fir_reg_C_qnt1_;
