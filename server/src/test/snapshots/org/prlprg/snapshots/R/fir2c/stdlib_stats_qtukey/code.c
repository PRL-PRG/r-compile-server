...
SEXP Rsh_Fir_user_function_inner961342762_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner961342762_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner961342762
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner961342762_, RHO, CCP);
  // st qtukey = r
...
SEXP Rsh_Fir_user_function_inner961342762_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner961342762 dynamic dispatch ([p, nmeans, df, nranges, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner961342762_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner961342762_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner961342762 version 0 (*, *, *, *, *, * -+> V)

  if (NPARAMS != 6) Rsh_error("FIŘ arity mismatch for inner961342762/0: expected 6, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_qtukey;  // C_qtukey
  SEXP Rsh_Fir_reg_C_qtukey1_;  // C_qtukey1
...
L4_:;
  // C_qtukey = ld C_qtukey
  Rsh_Fir_reg_C_qtukey = Rsh_Fir_load(Rsh_const(CCP, 11), RHO);
  // check L6() else D0()
  // L6()
  goto L6_;

L5_:;
  // r = dyn base(<sym C_qtukey>, <sym p>, <sym nranges>, <sym nmeans>, <sym df>, <sym lower.tail>, <sym log.p>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_qtukey;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L6_:;
  // C_qtukey1 = force? C_qtukey
  Rsh_Fir_reg_C_qtukey1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_qtukey);
  // checkMissing(C_qtukey1)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_C_qtukey1_;
...
D1_:;
  // deopt 2 [C_qtukey1, p1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_qtukey1_;
...
D2_:;
  // deopt 3 [C_qtukey1, p2, nranges1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_qtukey1_;
...
D3_:;
  // deopt 4 [C_qtukey1, p2, nranges2, nmeans1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_qtukey1_;
...
D4_:;
  // deopt 5 [C_qtukey1, p2, nranges2, nmeans2, df1]
  SEXP Rsh_Fir_array_deopt_stack4[5];
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_qtukey1_;
...
D5_:;
  // deopt 6 [C_qtukey1, p2, nranges2, nmeans2, df2, lower_tail1]
  SEXP Rsh_Fir_array_deopt_stack5[6];
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_qtukey1_;
...
D6_:;
  // deopt 7 [C_qtukey1, p2, nranges2, nmeans2, df2, lower_tail2, log_p1]
  SEXP Rsh_Fir_array_deopt_stack6[7];
  Rsh_Fir_array_deopt_stack6[0] = Rsh_Fir_reg_C_qtukey1_;
...
L12_:;
  ...
  // vargs = dots[p2, nranges2, nmeans2, df2, lower_tail2, log_p2]
  ...
  // r2 = `.Call`(C_qtukey1, vargs, <missing>)
  SEXP Rsh_Fir_array_args12[3];
  Rsh_Fir_array_args12[0] = Rsh_Fir_reg_C_qtukey1_;
