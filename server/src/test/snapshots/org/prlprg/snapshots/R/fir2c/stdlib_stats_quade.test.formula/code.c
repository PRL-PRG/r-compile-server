...
SEXP Rsh_Fir_user_version_inner751963283_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_quade_test;  // quade_test
...
L125_:;
  ...
  // quade_test = ldf `quade.test`
  Rsh_Fir_reg_quade_test = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 43), RHO);
  // check L126() else D29()
  // L126()
  goto L126_;
...
L126_:;
  ...
  Rsh_Fir_reg_r93_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_quade_test, 3, Rsh_Fir_array_args151, Rsh_Fir_array_arg_names39, CCP, RHO);
  // check L127() else D30()
  // L127()
  goto L127_;
