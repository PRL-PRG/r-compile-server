...
SEXP Rsh_Fir_user_function_inner2770762601_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner2770762601_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner2770762601_, RHO, CCP);
  // st qweibull = r
...
SEXP Rsh_Fir_user_function_inner2770762601_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner2770762601 dynamic dispatch ([p, shape, scale, `lower.tail`, `log.p`])

  return Rsh_Fir_user_version_inner2770762601_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner2770762601_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner2770762601 version 0 (*, *, *, *, * -+> V)

  if (NPARAMS != 5) Rsh_error("FIŘ arity mismatch for inner2770762601/0: expected 5, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_qweibull;  // C_qweibull
  SEXP Rsh_Fir_reg_C_qweibull1_;  // C_qweibull1
...
L4_:;
  ...
  Rsh_Fir_reg_C_qweibull = Rsh_Fir_load(Rsh_const(CCP, 10), RHO);
  // check L6() else D0()
  // L6()
  goto L6_;
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_qweibull;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L6_:;
  // C_qweibull1 = force? C_qweibull
  Rsh_Fir_reg_C_qweibull1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_qweibull);
  // checkMissing(C_qweibull1)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_C_qweibull1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_qweibull1_;
...
D2_:;
  ...
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_qweibull1_;
...
D3_:;
  ...
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_qweibull1_;
...
D4_:;
  ...
  Rsh_Fir_array_deopt_stack4[0] = Rsh_Fir_reg_C_qweibull1_;
...
D5_:;
  ...
  Rsh_Fir_array_deopt_stack5[0] = Rsh_Fir_reg_C_qweibull1_;
...
L11_:;
  ...
  Rsh_Fir_array_args11[0] = Rsh_Fir_reg_C_qweibull1_;
