...
SEXP Rsh_Fir_user_version_inner64320599_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  // naresid = ldf naresid
  Rsh_Fir_reg_naresid = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 3), RHO);
  // check L0() else D0()
  // L0()
  goto L0_;
...
L0_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_naresid, 2, Rsh_Fir_array_args12, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
L1_:;
  ...
  Rsh_Fir_array_args2[1] = Rsh_Fir_reg_object2_;
...
L2_:;
  ...
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_object4_;
...
SEXP Rsh_Fir_user_promise_inner64320599_1(SEXP CCP, SEXP RHO) {
  ...
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_object6_;
...
L1_:;
  ...
  Rsh_Fir_array_args8[1] = Rsh_Fir_reg_object6_;
...
L2_:;
  ...
  Rsh_Fir_array_args10[0] = Rsh_Fir_reg_object8_;
