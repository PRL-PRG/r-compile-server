...
SEXP Rsh_Fir_user_version_inner1410043808_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_C_rlogis;  // C_rlogis
  SEXP Rsh_Fir_reg_C_rlogis1_;  // C_rlogis1
...
L3_:;
  // C_rlogis = ld C_rlogis
  Rsh_Fir_reg_C_rlogis = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // check L5() else D0()
  // L5()
  goto L5_;

L4_:;
  // r = dyn base(<sym C_rlogis>, <sym n>, <sym location>, <sym scale>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_rlogis;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L5_:;
  // C_rlogis1 = force? C_rlogis
  Rsh_Fir_reg_C_rlogis1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_rlogis);
  // checkMissing(C_rlogis1)
  SEXP Rsh_Fir_array_args4[1];
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_C_rlogis1_;
...
D1_:;
  // deopt 2 [C_rlogis1, n1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_rlogis1_;
...
D2_:;
  // deopt 3 [C_rlogis1, n2, location1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_rlogis1_;
...
D3_:;
  // deopt 4 [C_rlogis1, n2, location2, scale1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_rlogis1_;
...
L8_:;
  ...
  // r2 = `.Call`(C_rlogis1, vargs, <missing>)
  SEXP Rsh_Fir_array_args8[3];
  Rsh_Fir_array_args8[0] = Rsh_Fir_reg_C_rlogis1_;
