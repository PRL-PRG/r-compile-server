...
SEXP Rsh_Fir_user_version_inner1877071976_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_C_rmultinom;  // C_rmultinom
  SEXP Rsh_Fir_reg_C_rmultinom1_;  // C_rmultinom1
...
L1_:;
  // C_rmultinom = ld C_rmultinom
  Rsh_Fir_reg_C_rmultinom = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // check L3() else D0()
  // L3()
  goto L3_;

L2_:;
  // r = dyn base(<sym C_rmultinom>, <sym n>, <sym size>, <sym prob>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_rmultinom;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L3_:;
  // C_rmultinom1 = force? C_rmultinom
  Rsh_Fir_reg_C_rmultinom1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_rmultinom);
  // checkMissing(C_rmultinom1)
  SEXP Rsh_Fir_array_args2[1];
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg_C_rmultinom1_;
...
D1_:;
  // deopt 2 [C_rmultinom1, n1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_rmultinom1_;
...
D2_:;
  // deopt 3 [C_rmultinom1, n2, size1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_rmultinom1_;
...
D3_:;
  // deopt 4 [C_rmultinom1, n2, size2, prob1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_rmultinom1_;
...
L6_:;
  ...
  // r2 = `.Call`(C_rmultinom1, vargs, <missing>)
  SEXP Rsh_Fir_array_args6[3];
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_C_rmultinom1_;
