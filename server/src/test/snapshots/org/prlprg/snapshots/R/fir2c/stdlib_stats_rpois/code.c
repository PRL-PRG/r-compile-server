...
SEXP Rsh_Fir_user_function_inner611997541_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner611997541_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner611997541
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner611997541_, RHO, CCP);
  // st rpois = r
...
SEXP Rsh_Fir_user_function_inner611997541_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner611997541 dynamic dispatch ([n, lambda])

  return Rsh_Fir_user_version_inner611997541_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner611997541_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner611997541 version 0 (*, * -+> V)

  if (NPARAMS != 2) Rsh_error("FIŘ arity mismatch for inner611997541/0: expected 2, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_rpois;  // C_rpois
  SEXP Rsh_Fir_reg_C_rpois1_;  // C_rpois1
...
L1_:;
  // C_rpois = ld C_rpois
  Rsh_Fir_reg_C_rpois = Rsh_Fir_load(Rsh_const(CCP, 4), RHO);
  // check L3() else D0()
  // L3()
  goto L3_;

L2_:;
  // r = dyn base(<sym C_rpois>, <sym n>, <sym lambda>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_rpois;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L3_:;
  // C_rpois1 = force? C_rpois
  Rsh_Fir_reg_C_rpois1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_rpois);
  // checkMissing(C_rpois1)
  SEXP Rsh_Fir_array_args2[1];
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg_C_rpois1_;
...
D1_:;
  ...
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_rpois1_;
...
D2_:;
  // deopt 3 [C_rpois1, n2, lambda1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_rpois1_;
...
L5_:;
  ...
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_lambda2_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args4, Rsh_Fir_param_types_empty()));
  // vargs = dots[n2, lambda2]
  ...
  // r2 = `.Call`(C_rpois1, vargs, <missing>)
  SEXP Rsh_Fir_array_args5[3];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_C_rpois1_;
