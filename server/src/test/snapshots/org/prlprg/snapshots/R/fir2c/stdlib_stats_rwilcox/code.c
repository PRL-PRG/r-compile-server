...
SEXP Rsh_Fir_user_function_inner1743794305_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner1743794305_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner1743794305
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner1743794305_, RHO, CCP);
  // st rwilcox = r
...
SEXP Rsh_Fir_user_function_inner1743794305_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner1743794305 dynamic dispatch ([nn, m, n])

  return Rsh_Fir_user_version_inner1743794305_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner1743794305_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner1743794305 version 0 (*, *, * -+> V)

  if (NPARAMS != 3) Rsh_error("FIŘ arity mismatch for inner1743794305/0: expected 3, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_rwilcox;  // C_rwilcox
  SEXP Rsh_Fir_reg_C_rwilcox1_;  // C_rwilcox1
...
L1_:;
  // C_rwilcox = ld C_rwilcox
  Rsh_Fir_reg_C_rwilcox = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // check L3() else D0()
  // L3()
  goto L3_;

L2_:;
  // r = dyn base(<sym C_rwilcox>, <sym nn>, <sym m>, <sym n>)
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_rwilcox;
  Rsh_Fir_deopt(1, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L3_:;
  // C_rwilcox1 = force? C_rwilcox
  Rsh_Fir_reg_C_rwilcox1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_rwilcox);
  // checkMissing(C_rwilcox1)
  SEXP Rsh_Fir_array_args2[1];
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg_C_rwilcox1_;
...
D1_:;
  // deopt 2 [C_rwilcox1, nn1]
  SEXP Rsh_Fir_array_deopt_stack1[2];
  Rsh_Fir_array_deopt_stack1[0] = Rsh_Fir_reg_C_rwilcox1_;
...
D2_:;
  // deopt 3 [C_rwilcox1, nn2, m1]
  SEXP Rsh_Fir_array_deopt_stack2[3];
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_C_rwilcox1_;
...
D3_:;
  // deopt 4 [C_rwilcox1, nn2, m2, n1]
  SEXP Rsh_Fir_array_deopt_stack3[4];
  Rsh_Fir_array_deopt_stack3[0] = Rsh_Fir_reg_C_rwilcox1_;
...
L6_:;
  ...
  // r2 = `.Call`(C_rwilcox1, vargs, <missing>)
  SEXP Rsh_Fir_array_args6[3];
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_C_rwilcox1_;
