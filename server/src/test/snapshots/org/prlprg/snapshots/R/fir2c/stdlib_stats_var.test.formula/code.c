...
SEXP Rsh_Fir_user_version_inner751963283_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_var_test;  // var_test
  SEXP Rsh_Fir_reg_DATA;  // DATA
  SEXP Rsh_Fir_reg_DATA1_;  // DATA1
...
L83_:;
  ...
  // var_test = ldf `var.test`
  Rsh_Fir_reg_var_test = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 58), RHO);
  // check L84() else D34()
  // L84()
  goto L84_;
...
L84_:;
  ...
  // r78 = dyn var_test[x, y, `...`](p11, p12, ddd2)
  ...
  Rsh_Fir_reg_r78_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_var_test, 3, Rsh_Fir_array_args107, Rsh_Fir_array_arg_names37, CCP, RHO);
  // check L85() else D35()
  // L85()
  goto L85_;
