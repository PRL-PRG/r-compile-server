...
L1_:;
  ...
  // r5 = dyn _vcov_aliased[, , complete](p, p1, p2)
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__vcov_aliased, 3, Rsh_Fir_array_args14, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L2() else D1()
  // L2()
  goto L2_;
...
SEXP Rsh_Fir_user_promise_inner1017016219_2(SEXP CCP, SEXP RHO) {
  ...
  Rsh_Fir_array_args13[0] = Rsh_Fir_reg_complete2_;
