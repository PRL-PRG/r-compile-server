...
L0_:;
  ...
  // r2 = dyn Sys_getenv[, unset, names]("R_OSTYPE", p, FALSE)
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_Sys_getenv, 3, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
