...
SEXP Rsh_Fir_user_version_inner2501545716_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_trimws;  // trimws
...
L4_:;
  ...
  // r5 = dyn gsub2("([[:alnum:]])--([[:alnum:]])", "\\1-\\2", p2)
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_gsub2_, 3, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L5() else D5()
  // L5()
  goto L5_;
...
L6_:;
  ...
  Rsh_Fir_array_arg_names3[3] = Rsh_const(CCP, 8);
...
L9_:;
  ...
  // trimws = ldf trimws
  Rsh_Fir_reg_trimws = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 15), RHO);
  // check L10() else D10()
  // L10()
  goto L10_;
...
L10_:;
  ...
  Rsh_Fir_reg_r11_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_trimws, 1, Rsh_Fir_array_args11, Rsh_Fir_array_arg_names5, CCP, RHO);
  // check L11() else D11()
  // L11()
  goto L11_;
