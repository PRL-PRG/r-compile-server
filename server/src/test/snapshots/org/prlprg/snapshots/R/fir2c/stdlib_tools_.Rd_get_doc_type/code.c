...
L0_:;
  ...
  // if c2 then L16() else L17(r1)
  if (Rsh_Fir_is_true(Rsh_Fir_reg_c2_)) {
  // L16()
    goto L16_;
  } else {
  // L17(r1)
    Rsh_Fir_reg_r12_ = Rsh_Fir_reg_r1_;
    goto L17_;
  }
...
L4_:;
  // r = dyn base(<lang `$`(attr(x, "meta"), docType)>, <lang .Rd_get_metadata(x, "docType")>, "")
  ...
  Rsh_Fir_reg_r1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 3, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names, CCP, RHO);
  // goto L0(r)
  // L0(r)
...
L9_:;
  // _Rd_get_metadata = ldf `.Rd_get_metadata`
  Rsh_Fir_reg__Rd_get_metadata = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 8), RHO);
  // check L13() else D2()
  // L13()
  goto L13_;
...
L11_:;
  ...
  Rsh_Fir_reg_r7_ = Rsh_Fir_call_builtin(17, CCP, RHO, 2, Rsh_Fir_array_args10, Rsh_Fir_param_types_empty());
  // goto L9(r7)
  // L9(r7)
...
L13_:;
  ...
  // r9 = dyn _Rd_get_metadata(p, "docType")
  ...
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__Rd_get_metadata, 2, Rsh_Fir_array_args13, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L14() else D3()
  // L14()
  goto L14_;
...
L14_:;
  ...
  Rsh_Fir_reg_r10_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c1_, 3, Rsh_Fir_array_args14, Rsh_Fir_array_arg_names4, CCP, RHO);
  // check L15() else D4()
  // L15()
  goto L15_;
...
L16_:;
  ...
  // L17(dr2)
    Rsh_Fir_reg_r12_ = Rsh_Fir_reg_dr2_;
    goto L17_;
  }
...
L17_:;
  ...
  Rsh_Fir_reg_r13_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 2, Rsh_Fir_array_args17, Rsh_Fir_array_arg_names5, CCP, RHO);
  // goto L2(r13)
  // L2(r13)
