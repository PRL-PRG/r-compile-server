...
SEXP Rsh_Fir_user_version_inner2708337952_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg__get_S3_generics_in_env;  // _get_S3_generics_in_env
  SEXP Rsh_Fir_reg__BaseNamespaceEnv;  // _BaseNamespaceEnv
  SEXP Rsh_Fir_reg__BaseNamespaceEnv1_;  // _BaseNamespaceEnv1
  SEXP Rsh_Fir_reg_p;  // p
  SEXP Rsh_Fir_reg_r3_;  // r3
  SEXP Rsh_Fir_reg__get_internal_S3_generics;  // _get_internal_S3_generics
  SEXP Rsh_Fir_reg_r4_;  // r4
  SEXP Rsh_Fir_reg__get_S3_group_generics;  // _get_S3_group_generics
...
L1_:;
  // _get_S3_generics_in_env = ldf `.get_S3_generics_in_env`
  Rsh_Fir_reg__get_S3_generics_in_env = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 2), RHO);
  // check L3() else D0()
  // L3()
  goto L3_;

L2_:;
  // r = dyn base(<lang .get_S3_generics_in_env(.BaseNamespaceEnv)>, <lang .get_internal_S3_generics()>, <lang .get_S3_group_generics()>)
...
L3_:;
  ...
  //   return _BaseNamespaceEnv1;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2708337952_, CCP, RHO);
  // r3 = dyn _get_S3_generics_in_env(p)
  SEXP Rsh_Fir_array_args3[1];
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_p;
  SEXP Rsh_Fir_array_arg_names1[1];
  Rsh_Fir_array_arg_names1[0] = R_MissingArg;
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__get_S3_generics_in_env, 1, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L4() else D1()
  // L4()
  goto L4_;
...
L4_:;
  // _get_internal_S3_generics = ldf `.get_internal_S3_generics`
  Rsh_Fir_reg__get_internal_S3_generics = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 7), RHO);
  // check L5() else D2()
  // L5()
  goto L5_;
...
L5_:;
  // r4 = dyn _get_internal_S3_generics()
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__get_internal_S3_generics, 0, NULL, NULL, CCP, RHO);
  // check L6() else D3()
  // L6()
  goto L6_;
...
L6_:;
  // _get_S3_group_generics = ldf `.get_S3_group_generics`
  Rsh_Fir_reg__get_S3_group_generics = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 8), RHO);
  // check L7() else D4()
  // L7()
  goto L7_;
...
L7_:;
  // r5 = dyn _get_S3_group_generics()
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__get_S3_group_generics, 0, NULL, NULL, CCP, RHO);
  // check L8() else D5()
  // L8()
  goto L8_;
...
L8_:;
  ...
  Rsh_Fir_array_args4[1] = Rsh_Fir_reg_r4_;
  Rsh_Fir_array_args4[2] = Rsh_Fir_reg_r5_;
...
SEXP Rsh_Fir_user_promise_inner2708337952_(SEXP CCP, SEXP RHO) {
  ...
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg__BaseNamespaceEnv1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args2, Rsh_Fir_param_types_empty()));
  // return _BaseNamespaceEnv1
  return Rsh_Fir_reg__BaseNamespaceEnv1_;
}
