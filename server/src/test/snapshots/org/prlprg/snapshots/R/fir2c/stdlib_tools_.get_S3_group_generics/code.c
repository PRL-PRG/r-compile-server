...
L1_:;
  ...
  // r2 = dyn c("Ops", "Math", "Summary", "Complex", "matrixOps")
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c, 5, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L3() else D0()
  // L3()
  goto L3_;

L2_:;
  // r = dyn base("Ops", "Math", "Summary", "Complex", "matrixOps")
