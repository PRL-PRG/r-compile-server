...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  // st `.get_unload_function_calls_in_file` = r
...
L63_:;
  ...
  // L1():
  //   c43 = ldf c in base;
  //   r33 = dyn c43(".Last.lib", ".onDetach");
  //   goto L0(r33);
  // L2():
  //   r31 = dyn base7(".Last.lib", ".onDetach");
  //   goto L0(r31);
  // }
...
L88_:;
  ...
  Rsh_Fir_array_args95[1] = Rsh_const(CCP, 39);
...
L1_:;
  ...
  Rsh_Fir_reg_r33_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c43_, 2, Rsh_Fir_array_args71, Rsh_Fir_array_arg_names18, CCP, RHO);
  // goto L0(r33)
  // L0(r33)
...
L2_:;
  ...
  Rsh_Fir_reg_r31_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base7_, 2, Rsh_Fir_array_args72, Rsh_Fir_array_arg_names19, CCP, RHO);
  // goto L0(r31)
  // L0(r31)
