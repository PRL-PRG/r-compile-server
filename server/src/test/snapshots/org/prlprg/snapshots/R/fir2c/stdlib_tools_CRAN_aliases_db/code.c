...
SEXP Rsh_Fir_user_version_inner2708337952_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_CRAN_baseurl_for_src_area;  // CRAN_baseurl_for_src_area
  ...
  Rsh_Fir_reg_read_CRAN_object = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 1), RHO);
  // check L0() else D0()
  // L0()
  goto L0_;
...
L0_:;
  // p = prom<V +>{
  //   CRAN_baseurl_for_src_area = ldf CRAN_baseurl_for_src_area;
  //   r = dyn CRAN_baseurl_for_src_area();
  //   return r;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2708337952_, CCP, RHO);
  // r2 = dyn read_CRAN_object(p, "src/contrib/Meta/aliases.rds")
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_read_CRAN_object, 2, Rsh_Fir_array_args, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
SEXP Rsh_Fir_user_promise_inner2708337952_(SEXP CCP, SEXP RHO) {
  // CRAN_baseurl_for_src_area = ldf CRAN_baseurl_for_src_area
  Rsh_Fir_reg_CRAN_baseurl_for_src_area = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 2), RHO);
  // r = dyn CRAN_baseurl_for_src_area()
  Rsh_Fir_reg_r1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_CRAN_baseurl_for_src_area, 0, NULL, NULL, CCP, RHO);
  // return r
