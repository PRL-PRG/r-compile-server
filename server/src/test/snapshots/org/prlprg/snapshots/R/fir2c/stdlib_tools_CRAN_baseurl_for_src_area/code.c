...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  // st CRAN_baseurl_for_src_area = r
...
SEXP Rsh_Fir_user_version_inner2708337952_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg__get_CRAN_repository_URL;  // _get_CRAN_repository_URL
...
L0_:;
  // p = prom<V +>{
  //   _get_CRAN_repository_URL = ldf `.get_CRAN_repository_URL`;
  //   r = dyn _get_CRAN_repository_URL();
  //   return r;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner2708337952_, CCP, RHO);
  // r2 = dyn Sys_getenv("R_CRAN_SRC", p)
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_Sys_getenv, 2, Rsh_Fir_array_args, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
SEXP Rsh_Fir_user_promise_inner2708337952_(SEXP CCP, SEXP RHO) {
  // _get_CRAN_repository_URL = ldf `.get_CRAN_repository_URL`
  Rsh_Fir_reg__get_CRAN_repository_URL = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 2), RHO);
  // r = dyn _get_CRAN_repository_URL()
  Rsh_Fir_reg_r1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg__get_CRAN_repository_URL, 0, NULL, NULL, CCP, RHO);
  // return r
