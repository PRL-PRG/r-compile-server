...
L0_:;
  ...
  // r2 = dyn read_CRAN_object(p, "web/checks/check_issues.rds")
...
SEXP Rsh_Fir_user_promise_inner2708337952_(SEXP CCP, SEXP RHO) {
  // CRAN_baseurl_for_web_area = ldf CRAN_baseurl_for_web_area
  Rsh_Fir_reg_CRAN_baseurl_for_web_area = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 2), RHO);
  // r = dyn CRAN_baseurl_for_web_area()
