...
SEXP Rsh_Fir_user_version_inner2501545716_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_baseurl;  // baseurl
  SEXP Rsh_Fir_reg_baseurl1_;  // baseurl1
  ...
  (void)(Rsh_Fir_reg_x);
  // st baseurl = "https://bugs.R-project.org/show_bug.cgi?id"
  Rsh_Fir_store(Rsh_const(CCP, 3), Rsh_const(CCP, 2), RHO);
  (void)(Rsh_const(CCP, 2));
  // sprintf = ldf sprintf
  Rsh_Fir_reg_sprintf = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 4), RHO);
  // check L0() else D0()
  // L0()
  goto L0_;
...
L0_:;
  // p = prom<V +>{
  //   baseurl = ld baseurl;
  //   baseurl1 = force? baseurl;
  //   checkMissing(baseurl1);
  //   return baseurl1;
  // }
  ...
  // r3 = dyn sprintf("\\href{%s=%s}{PR#%s}", p, p1, p2)
  ...
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_sprintf, 4, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
SEXP Rsh_Fir_user_promise_inner2501545716_(SEXP CCP, SEXP RHO) {
  // baseurl = ld baseurl
  Rsh_Fir_reg_baseurl = Rsh_Fir_load(Rsh_const(CCP, 3), RHO);
  // baseurl1 = force? baseurl
  Rsh_Fir_reg_baseurl1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_baseurl);
  // checkMissing(baseurl1)
  SEXP Rsh_Fir_array_args[1];
  Rsh_Fir_array_args[0] = Rsh_Fir_reg_baseurl1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args, Rsh_Fir_param_types_empty()));
  // return baseurl1
  return Rsh_Fir_reg_baseurl1_;
}
SEXP Rsh_Fir_user_promise_inner2501545716_1(SEXP CCP, SEXP RHO) {
  // x1 = ld x
