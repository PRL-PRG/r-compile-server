...
SEXP Rsh_Fir_user_version_inner2708337952_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_getRfuns;  // getRfuns
...
L10_:;
  // getRfuns = ldf getRfuns
  Rsh_Fir_reg_getRfuns = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 7), RHO);
  // check L11() else D1()
  // L11()
  goto L11_;
...
L11_:;
  // r3 = dyn getRfuns()
  Rsh_Fir_reg_r3_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_getRfuns, 0, NULL, NULL, CCP, RHO);
  // check L12() else D2()
  // L12()
  goto L12_;
