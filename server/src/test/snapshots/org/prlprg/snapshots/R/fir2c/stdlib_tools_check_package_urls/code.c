...
SEXP Rsh_Fir_user_version_inner3222564391_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_url_db_from_package_sources;  // url_db_from_package_sources
  SEXP Rsh_Fir_reg_dir1_;  // dir1
  SEXP Rsh_Fir_reg_dir2_;  // dir2
  SEXP Rsh_Fir_reg_p;  // p
  SEXP Rsh_Fir_reg_r1_;  // r1
  SEXP Rsh_Fir_reg_check_url_db;  // check_url_db
...
L0_:;
  ...
  // url_db_from_package_sources = ldf url_db_from_package_sources
  Rsh_Fir_reg_url_db_from_package_sources = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 4), RHO);
  // check L1() else D0()
  // L1()
  goto L1_;
...
L1_:;
  ...
  // r1 = dyn url_db_from_package_sources(p)
  SEXP Rsh_Fir_array_args2[1];
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg_p;
  SEXP Rsh_Fir_array_arg_names[1];
  Rsh_Fir_array_arg_names[0] = R_MissingArg;
  Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_url_db_from_package_sources, 1, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L2() else D1()
  // L2()
  goto L2_;
...
L2_:;
  ...
  // check_url_db = ldf check_url_db
  Rsh_Fir_reg_check_url_db = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 6), RHO);
  // check L3() else D2()
  // L3()
  goto L3_;
...
L3_:;
  ...
  // r4 = dyn check_url_db[, verbose, parallel](p1, p2, TRUE)
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_check_url_db, 3, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L4() else D3()
  // L4()
  goto L4_;
...
SEXP Rsh_Fir_user_promise_inner3222564391_1(SEXP CCP, SEXP RHO) {
  // db = ld db
  Rsh_Fir_reg_db = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // db1 = force? db
