...
L1_:;
  ...
  // r2 = dyn c("^\\.Rbuildignore$", "(^|/)\\.DS_Store$", "^\\.(RData|Rhistory)$", "~$", "\\.bak$", "\\.swp$", "(^|/)\\.#[^/]*$", "(^|/)#[^/]*#$", "^TITLE$", "^data/00Index$", "^inst/doc/00Index\\.dcf$", "^config\\.(cache|log|status)$", "(^|/)autom4te\\.cache$", "^src/.*\\.d$", "^src/Makedeps$", "^src/so_locations$", "^inst/doc/Rplots\\.(ps|pdf)$")
  SEXP Rsh_Fir_array_args1[17];
  ...
  Rsh_Fir_array_args1[5] = Rsh_const(CCP, 7);
  Rsh_Fir_array_args1[6] = Rsh_const(CCP, 8);
  Rsh_Fir_array_args1[7] = Rsh_const(CCP, 9);
  Rsh_Fir_array_args1[8] = Rsh_const(CCP, 10);
  Rsh_Fir_array_args1[9] = Rsh_const(CCP, 11);
  Rsh_Fir_array_args1[10] = Rsh_const(CCP, 12);
  Rsh_Fir_array_args1[11] = Rsh_const(CCP, 13);
  Rsh_Fir_array_args1[12] = Rsh_const(CCP, 14);
  Rsh_Fir_array_args1[13] = Rsh_const(CCP, 15);
  Rsh_Fir_array_args1[14] = Rsh_const(CCP, 16);
  Rsh_Fir_array_args1[15] = Rsh_const(CCP, 17);
  Rsh_Fir_array_args1[16] = Rsh_const(CCP, 18);
  SEXP Rsh_Fir_array_arg_names[17];
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_c, 17, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L3() else D0()
  // L3()
  goto L3_;

L2_:;
  // r = dyn base("^\\.Rbuildignore$", "(^|/)\\.DS_Store$", "^\\.(RData|Rhistory)$", "~$", "\\.bak$", "\\.swp$", "(^|/)\\.#[^/]*$", "(^|/)#[^/]*#$", "^TITLE$", "^data/00Index$", "^inst/doc/00Index\\.dcf$", "^config\\.(cache|log|status)$", "(^|/)autom4te\\.cache$", "^src/.*\\.d$", "^src/Makedeps$", "^src/so_locations$", "^inst/doc/Rplots\\.(ps|pdf)$")
  SEXP Rsh_Fir_array_args2[17];
  ...
  Rsh_Fir_array_args2[6] = Rsh_const(CCP, 8);
  Rsh_Fir_array_args2[7] = Rsh_const(CCP, 9);
  Rsh_Fir_array_args2[8] = Rsh_const(CCP, 10);
  Rsh_Fir_array_args2[9] = Rsh_const(CCP, 11);
  Rsh_Fir_array_args2[10] = Rsh_const(CCP, 12);
  Rsh_Fir_array_args2[11] = Rsh_const(CCP, 13);
  Rsh_Fir_array_args2[12] = Rsh_const(CCP, 14);
  Rsh_Fir_array_args2[13] = Rsh_const(CCP, 15);
  Rsh_Fir_array_args2[14] = Rsh_const(CCP, 16);
  Rsh_Fir_array_args2[15] = Rsh_const(CCP, 17);
  Rsh_Fir_array_args2[16] = Rsh_const(CCP, 18);
  SEXP Rsh_Fir_array_arg_names1[17];
  ...
  Rsh_Fir_reg_r1 = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base, 17, Rsh_Fir_array_args2, Rsh_Fir_array_arg_names1, CCP, RHO);
  // goto L0(r)
  // L0(r)
...
D0_:;
  ...
  Rsh_Fir_deopt(20, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;
