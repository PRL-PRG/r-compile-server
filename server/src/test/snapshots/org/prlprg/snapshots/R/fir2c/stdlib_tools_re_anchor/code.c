...
L4_:;
  ...
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_s2_;
...
L7_:;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_paste0_, 3, Rsh_Fir_array_args6, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L8() else D3()
  // L8()
  goto L8_;
...
SEXP Rsh_Fir_user_promise_inner1236783023_(SEXP CCP, SEXP RHO) {
  ...
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_s4_;
