...
SEXP Rsh_Fir_user_version_inner2501545716_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_urlify;  // urlify
  ...
  (void)(Rsh_Fir_reg_x);
  // urlify = ldf urlify
  Rsh_Fir_reg_urlify = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 2), RHO);
  // check L0() else D0()
  // L0()
  goto L0_;
...
L0_:;
  ...
  // r1 = dyn urlify[, reserved, repeated](p, "][#?/&;=%", TRUE)
  ...
  Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_urlify, 3, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
