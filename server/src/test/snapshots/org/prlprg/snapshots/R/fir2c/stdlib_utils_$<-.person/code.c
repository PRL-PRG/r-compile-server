...
L2_:;
  ...
  Rsh_Fir_reg_r13_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_rep_len, 2, Rsh_Fir_array_args1, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L24() else D8()
  // L24()
  goto L24_;
...
L5_:;
  ...
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_r20_;
...
L8_:;
  ...
  Rsh_Fir_reg_x3_ = Rsh_Fir_call_builtin(16, CCP, RHO, 4, Rsh_Fir_array_args7, Rsh_Fir_param_types_empty());
  // st i = x3
  Rsh_Fir_store(Rsh_const(CCP, 12), Rsh_Fir_reg_x3_, RHO);
  (void)(Rsh_Fir_reg_x3_);
  // _person_elt_fld_gets = ldf `.person_elt_fld_gets`
  Rsh_Fir_reg__person_elt_fld_gets = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 13), RHO);
  // check L34() else D13()
  // L34()
  goto L34_;
...
L10_:;
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_match_arg, 2, Rsh_Fir_array_args10, Rsh_Fir_array_arg_names1, CCP, RHO);
  // check L11() else D1()
  // L11()
  goto L11_;
...
L14_:;
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_unclass, 1, Rsh_Fir_array_args14, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L15() else D3()
  // L15()
  goto L15_;
...
L16_:;
  ...
  Rsh_Fir_reg__listify = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 17), RHO);
  // check L18() else D4()
  // L18()
  goto L18_;

L17_:;
  // r6 = dyn base1(<lang .listify(value)>, <lang length(y)>)
  ...
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 2, Rsh_Fir_array_args15, Rsh_Fir_array_arg_names4, CCP, RHO);
  // goto L1(r6)
  // L1(r6)
...
L18_:;
  ...
  Rsh_Fir_reg_r9_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__listify, 1, Rsh_Fir_array_args17, Rsh_Fir_array_arg_names5, CCP, RHO);
  // check L19() else D5()
  // L19()
  goto L19_;
...
L21_:;
  ...
  Rsh_Fir_reg_r10_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base2_, 1, Rsh_Fir_array_args19, Rsh_Fir_array_arg_names6, CCP, RHO);
  // goto L2(r10)
  // L2(r10)
...
L22_:;
  ...
  Rsh_Fir_reg_r12_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_length, 1, Rsh_Fir_array_args21, Rsh_Fir_array_arg_names7, CCP, RHO);
  // check L23() else D7()
  // L23()
  goto L23_;
...
L25_:;
  ...
  Rsh_Fir_array_args22[0] = Rsh_Fir_reg_name4_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args22, Rsh_Fir_param_types_empty()));
  // r14 = `==`(name4, "role")
  SEXP Rsh_Fir_array_args23[2];
  Rsh_Fir_array_args23[0] = Rsh_Fir_reg_name4_;
  Rsh_Fir_array_args23[1] = Rsh_const(CCP, 21);
  Rsh_Fir_reg_r14_ = Rsh_Fir_call_builtin(74, CCP, RHO, 2, Rsh_Fir_array_args23, Rsh_Fir_param_types_empty());
  // c = `as.logical`(r14)
...
L26_:;
  // lapply = ldf lapply
  Rsh_Fir_reg_lapply = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 22), RHO);
  // check L27() else D10()
  // L27()
  goto L27_;
...
L27_:;
  ...
  Rsh_Fir_reg_r17_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_lapply, 2, Rsh_Fir_array_args27, Rsh_Fir_array_arg_names8, CCP, RHO);
  // check L28() else D11()
  // L28()
  goto L28_;
...
L31_:;
  ...
  Rsh_Fir_reg_r19_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base3_, 1, Rsh_Fir_array_args28, Rsh_Fir_array_arg_names9, CCP, RHO);
  // goto L5(r19)
  // L5(r19)
...
L32_:;
  ...
  Rsh_Fir_reg_r21_ = Rsh_Fir_call_builtin(424, CCP, RHO, 1, Rsh_Fir_array_args30, Rsh_Fir_param_types_empty());
  // goto L5(r21)
  // L5(r21)
...
L34_:;
  ...
  // r27 = dyn _person_elt_fld_gets(p5, p6, p7)
  SEXP Rsh_Fir_array_args45[3];
  Rsh_Fir_array_args45[0] = Rsh_Fir_reg_p5_;
  Rsh_Fir_array_args45[1] = Rsh_Fir_reg_p6_;
  Rsh_Fir_array_args45[2] = Rsh_Fir_reg_p7_;
  SEXP Rsh_Fir_array_arg_names12[3];
  Rsh_Fir_array_arg_names12[0] = R_MissingArg;
  Rsh_Fir_array_arg_names12[1] = R_MissingArg;
  Rsh_Fir_array_arg_names12[2] = R_MissingArg;
  Rsh_Fir_reg_r27_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__person_elt_fld_gets, 3, Rsh_Fir_array_args45, Rsh_Fir_array_arg_names12, CCP, RHO);
  // check L35() else D14()
  // L35()
  goto L35_;
...
L42_:;
  ...
  Rsh_Fir_array_args52[0] = Rsh_Fir_reg_x5_;
  ...
  Rsh_Fir_array_args53[0] = Rsh_Fir_reg_x5_;
...
D20_:;
  ...
  Rsh_Fir_array_deopt_stack17[0] = Rsh_Fir_reg_y8_;
...
L46_:;
  ...
  Rsh_Fir_array_args55[0] = Rsh_Fir_reg_y9_;
...
SEXP Rsh_Fir_user_promise_inner247789382_1(SEXP CCP, SEXP RHO) {
  // person_field_names = ld person_field_names
  Rsh_Fir_reg_person_field_names = Rsh_Fir_load(Rsh_const(CCP, 15), RHO);
  // person_field_names1 = force? person_field_names
...
SEXP Rsh_Fir_user_promise_inner247789382_2(SEXP CCP, SEXP RHO) {
  ...
  Rsh_Fir_array_args16[0] = Rsh_Fir_reg_value2_;
...
SEXP Rsh_Fir_user_promise_inner247789382_3(SEXP CCP, SEXP RHO) {
  ...
  Rsh_Fir_array_args25[0] = Rsh_Fir_reg_value4_;
...
SEXP Rsh_Fir_user_promise_inner247789382_4(SEXP CCP, SEXP RHO) {
  // _canonicalize_person_role = ld `.canonicalize_person_role`
  Rsh_Fir_reg__canonicalize_person_role = Rsh_Fir_load(Rsh_const(CCP, 23), RHO);
  // _canonicalize_person_role1 = force? _canonicalize_person_role
  Rsh_Fir_reg__canonicalize_person_role1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg__canonicalize_person_role);
  // checkMissing(_canonicalize_person_role1)
  SEXP Rsh_Fir_array_args26[1];
  Rsh_Fir_array_args26[0] = Rsh_Fir_reg__canonicalize_person_role1_;
...
SEXP Rsh_Fir_user_promise_inner247789382_5(SEXP CCP, SEXP RHO) {
  // y4 = ld y
  Rsh_Fir_reg_y4_ = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // y5 = force? y4
  Rsh_Fir_reg_y5_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_y4_);
  // checkMissing(y5)
  SEXP Rsh_Fir_array_args32[1];
  Rsh_Fir_array_args32[0] = Rsh_Fir_reg_y5_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args32, Rsh_Fir_param_types_empty()));
  // c2 = `is.object`(y5)
  SEXP Rsh_Fir_array_args33[1];
  Rsh_Fir_array_args33[0] = Rsh_Fir_reg_y5_;
...
L1_:;
  ...
  Rsh_Fir_array_args34[1] = Rsh_Fir_reg_y5_;
...
L2_:;
  ...
  Rsh_Fir_array_args36[1] = Rsh_Fir_reg_i6_;
  SEXP Rsh_Fir_array_arg_names10[2];
  Rsh_Fir_array_arg_names10[0] = R_MissingArg;
  Rsh_Fir_array_arg_names10[1] = R_MissingArg;
  Rsh_Fir_reg_r22_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___, 2, Rsh_Fir_array_args36, Rsh_Fir_array_arg_names10, CCP, RHO);
  // goto L0(r22)
  // L0(r22)
...
SEXP Rsh_Fir_user_promise_inner247789382_6(SEXP CCP, SEXP RHO) {
  ...
  Rsh_Fir_array_args38[0] = Rsh_Fir_reg_name6_;
...
SEXP Rsh_Fir_user_promise_inner247789382_7(SEXP CCP, SEXP RHO) {
  ...
  Rsh_Fir_array_args40[0] = Rsh_Fir_reg_value6_;
  Rsh_Fir_reg_c3_ = Rsh_Fir_call_builtin(397, CCP, RHO, 1, Rsh_Fir_array_args40, Rsh_Fir_param_types_empty());
  // if c3 then L1() else L2(value6)
...
L1_:;
  ...
  Rsh_Fir_array_args41[1] = Rsh_Fir_reg_value6_;
...
L2_:;
  ...
  Rsh_Fir_array_args43[0] = Rsh_Fir_reg_value8_;
  Rsh_Fir_array_args43[1] = Rsh_Fir_reg_i8_;
  SEXP Rsh_Fir_array_arg_names11[2];
  Rsh_Fir_array_arg_names11[0] = R_MissingArg;
  Rsh_Fir_array_arg_names11[1] = R_MissingArg;
  Rsh_Fir_reg_r25_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg___1_, 2, Rsh_Fir_array_args43, Rsh_Fir_array_arg_names11, CCP, RHO);
  // goto L0(r25)
  // L0(r25)
