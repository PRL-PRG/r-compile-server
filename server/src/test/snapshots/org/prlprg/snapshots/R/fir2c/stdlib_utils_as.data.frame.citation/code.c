...
L1_:;
  ...
  Rsh_Fir_reg_as_bibentry = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 7), RHO);
  // check L2() else D0()
  // L2()
  goto L2_;
...
L2_:;
  ...
  // r1 = dyn as_bibentry(p)
  SEXP Rsh_Fir_array_args3[1];
  Rsh_Fir_array_args3[0] = Rsh_Fir_reg_p;
  SEXP Rsh_Fir_array_arg_names[1];
  Rsh_Fir_array_arg_names[0] = R_MissingArg;
  Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_as_bibentry, 1, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L3() else D1()
  // L3()
  goto L3_;
...
L4_:;
  // r2 = dyn NextMethod()
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_NextMethod, 0, NULL, NULL, CCP, RHO);
  // check L5() else D3()
  // L5()
  goto L5_;
