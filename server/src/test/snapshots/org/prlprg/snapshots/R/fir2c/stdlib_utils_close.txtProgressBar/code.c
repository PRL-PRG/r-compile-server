...
L2_:;
  ...
  // r1 = dyn dx2()
  Rsh_Fir_reg_r1_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_dx2_, 0, NULL, NULL, CCP, RHO);
  // check L6() else D1()
  // L6()
  goto L6_;
...
L3_:;
  ...
  Rsh_Fir_array_args3[1] = Rsh_Fir_reg_con2_;
...
L4_:;
  ...
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_con4_;
...
L7_:;
  ...
  // r4 = dyn invisible(NULL)
  SEXP Rsh_Fir_array_args8[1];
  Rsh_Fir_array_args8[0] = Rsh_const(CCP, 6);
  SEXP Rsh_Fir_array_arg_names[1];
  Rsh_Fir_array_arg_names[0] = R_MissingArg;
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_invisible, 1, Rsh_Fir_array_args8, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L9() else D2()
  // L9()
  goto L9_;
