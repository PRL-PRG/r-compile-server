...
SEXP Rsh_Fir_user_version_inner1031285476_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_C_clrhash_Ext;  // C_clrhash_Ext
  SEXP Rsh_Fir_reg_C_clrhash_Ext1_;  // C_clrhash_Ext1
...
L1_:;
  ...
  Rsh_Fir_reg_invisible = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 2), RHO);
  // r5 = dyn invisible(r3)
...
L3_:;
  // r = dyn base(<lang .External(C_clrhash_Ext, h)>)
...
L4_:;
  // C_clrhash_Ext = ld C_clrhash_Ext
  Rsh_Fir_reg_C_clrhash_Ext = Rsh_Fir_load(Rsh_const(CCP, 5), RHO);
  // check L6() else D0()
  // L6()
  goto L6_;

L5_:;
  // r2 = dyn base1(<sym C_clrhash_Ext>, <sym h>)
...
D0_:;
  // deopt 4 [C_clrhash_Ext]
  SEXP Rsh_Fir_array_deopt_stack[1];
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_clrhash_Ext;
  Rsh_Fir_deopt(4, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L6_:;
  // C_clrhash_Ext1 = force? C_clrhash_Ext
  Rsh_Fir_reg_C_clrhash_Ext1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_clrhash_Ext);
  // checkMissing(C_clrhash_Ext1)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_C_clrhash_Ext1_;
...
L7_:;
  ...
  // r4 = dyn _External(C_clrhash_Ext1, h2)
  SEXP Rsh_Fir_array_args7[2];
  Rsh_Fir_array_args7[0] = Rsh_Fir_reg_C_clrhash_Ext1_;
  Rsh_Fir_array_args7[1] = Rsh_Fir_reg_h2_;
  SEXP Rsh_Fir_array_arg_names3[2];
  Rsh_Fir_array_arg_names3[0] = R_MissingArg;
  Rsh_Fir_array_arg_names3[1] = R_MissingArg;
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__External, 2, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L8() else D2()
  // L8()
  goto L8_;
