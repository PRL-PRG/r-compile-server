...
SEXP Rsh_Fir_user_version_inner2708337952_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_C_flushconsole;  // C_flushconsole
  SEXP Rsh_Fir_reg_C_flushconsole1_;  // C_flushconsole1
...
L4_:;
  ...
  Rsh_Fir_reg_C_flushconsole = Rsh_Fir_load(Rsh_const(CCP, 4), RHO);
  // check L6() else D0()
  // L6()
  goto L6_;
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_flushconsole;
  Rsh_Fir_deopt(3, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L6_:;
  // C_flushconsole1 = force? C_flushconsole
  Rsh_Fir_reg_C_flushconsole1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_flushconsole);
  // checkMissing(C_flushconsole1)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_C_flushconsole1_;
  ...
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_C_flushconsole1_;
