...
SEXP Rsh_Fir_user_version_inner2501545716_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_C_ishashtab_Ext;  // C_ishashtab_Ext
  SEXP Rsh_Fir_reg_C_ishashtab_Ext1_;  // C_ishashtab_Ext1
...
L1_:;
  // C_ishashtab_Ext = ld C_ishashtab_Ext
  Rsh_Fir_reg_C_ishashtab_Ext = Rsh_Fir_load(Rsh_const(CCP, 3), RHO);
  // check L3() else D0()
  // L3()
  goto L3_;

L2_:;
  // r = dyn base(<sym C_ishashtab_Ext>, <sym x>)
...
D0_:;
  // deopt 2 [C_ishashtab_Ext]
  SEXP Rsh_Fir_array_deopt_stack[1];
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_ishashtab_Ext;
  Rsh_Fir_deopt(2, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L3_:;
  // C_ishashtab_Ext1 = force? C_ishashtab_Ext
  Rsh_Fir_reg_C_ishashtab_Ext1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_ishashtab_Ext);
  // checkMissing(C_ishashtab_Ext1)
  SEXP Rsh_Fir_array_args2[1];
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg_C_ishashtab_Ext1_;
...
L4_:;
  ...
  // r2 = dyn _External(C_ishashtab_Ext1, x2)
  SEXP Rsh_Fir_array_args4[2];
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_C_ishashtab_Ext1_;
