...
SEXP Rsh_Fir_user_function_inner240890467_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner240890467_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner240890467
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner240890467_, RHO, CCP);
  // st maphash = r
...
SEXP Rsh_Fir_user_function_inner240890467_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner240890467 dynamic dispatch ([h, FUN])

  return Rsh_Fir_user_version_inner240890467_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner240890467_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner240890467 version 0 (*, * -+> V)

  if (NPARAMS != 2) Rsh_error("FIŘ arity mismatch for inner240890467/0: expected 2, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_maphash_Ext;  // C_maphash_Ext
  SEXP Rsh_Fir_reg_C_maphash_Ext1_;  // C_maphash_Ext1
...
L3_:;
  // r = dyn base(<lang .External(C_maphash_Ext, h, FUN)>)
...
L4_:;
  // C_maphash_Ext = ld C_maphash_Ext
  Rsh_Fir_reg_C_maphash_Ext = Rsh_Fir_load(Rsh_const(CCP, 6), RHO);
  // check L6() else D0()
  // L6()
  goto L6_;

L5_:;
  // r2 = dyn base1(<sym C_maphash_Ext>, <sym h>, <sym FUN>)
...
D0_:;
  // deopt 4 [C_maphash_Ext]
  SEXP Rsh_Fir_array_deopt_stack[1];
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_maphash_Ext;
  Rsh_Fir_deopt(4, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L6_:;
  // C_maphash_Ext1 = force? C_maphash_Ext
  Rsh_Fir_reg_C_maphash_Ext1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_maphash_Ext);
  // checkMissing(C_maphash_Ext1)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_C_maphash_Ext1_;
...
D2_:;
  ...
  Rsh_Fir_array_deopt_stack2[0] = Rsh_Fir_reg_FUN1_;
...
L8_:;
  ...
  // r4 = dyn _External(C_maphash_Ext1, h2, FUN2)
  SEXP Rsh_Fir_array_args8[3];
  Rsh_Fir_array_args8[0] = Rsh_Fir_reg_C_maphash_Ext1_;
  Rsh_Fir_array_args8[1] = Rsh_Fir_reg_h2_;
  Rsh_Fir_array_args8[2] = Rsh_Fir_reg_FUN2_;
