...
SEXP Rsh_Fir_user_version_inner1031285476_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_C_numhash_Ext;  // C_numhash_Ext
  SEXP Rsh_Fir_reg_C_numhash_Ext1_;  // C_numhash_Ext1
...
L1_:;
  ...
  Rsh_Fir_reg_C_numhash_Ext = Rsh_Fir_load(Rsh_const(CCP, 3), RHO);
  // check L3() else D0()
  // L3()
  goto L3_;
...
D0_:;
  ...
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_numhash_Ext;
  Rsh_Fir_deopt(2, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L3_:;
  // C_numhash_Ext1 = force? C_numhash_Ext
  Rsh_Fir_reg_C_numhash_Ext1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_numhash_Ext);
  // checkMissing(C_numhash_Ext1)
  SEXP Rsh_Fir_array_args2[1];
  Rsh_Fir_array_args2[0] = Rsh_Fir_reg_C_numhash_Ext1_;
...
L4_:;
  ...
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_C_numhash_Ext1_;
