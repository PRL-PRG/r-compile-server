...
SEXP Rsh_Fir_user_version_inner80654505_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_print_bibentry;  // print_bibentry
...
L0_:;
  ...
  // print_bibentry = ldf `print.bibentry`
  Rsh_Fir_reg_print_bibentry = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 5), RHO);
  // check L1() else D0()
  // L1()
  goto L1_;
...
L1_:;
  ...
  // r2 = dyn print_bibentry[, style, `...`](p, p1, ddd1)
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_print_bibentry, 3, Rsh_Fir_array_args3, Rsh_Fir_array_arg_names, CCP, RHO);
  // check L2() else D1()
  // L2()
  goto L2_;
