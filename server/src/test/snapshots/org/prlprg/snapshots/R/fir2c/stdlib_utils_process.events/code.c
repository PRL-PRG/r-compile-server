...
SEXP Rsh_Fir_user_version_inner2708337952_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  SEXP Rsh_Fir_reg_C_processevents;  // C_processevents
  SEXP Rsh_Fir_reg_C_processevents1_;  // C_processevents1
...
L1_:;
  ...
  Rsh_Fir_reg_invisible = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Base, Rsh_const(CCP, 1), RHO);
  // r5 = dyn invisible(r3)
...
L3_:;
  // r = dyn base(<lang .Call(C_processevents)>)
...
L4_:;
  // C_processevents = ld C_processevents
  Rsh_Fir_reg_C_processevents = Rsh_Fir_load(Rsh_const(CCP, 4), RHO);
  // check L6() else D0()
  // L6()
  goto L6_;

L5_:;
  // r2 = dyn base1(<sym C_processevents>)
  SEXP Rsh_Fir_array_args4[1];
  Rsh_Fir_array_args4[0] = Rsh_const(CCP, 4);
  SEXP Rsh_Fir_array_arg_names2[1];
  Rsh_Fir_array_arg_names2[0] = R_MissingArg;
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 1, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L1(r2)
  // L1(r2)
...
D0_:;
  // deopt 3 [C_processevents]
  SEXP Rsh_Fir_array_deopt_stack[1];
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_processevents;
  Rsh_Fir_deopt(3, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L6_:;
  // C_processevents1 = force? C_processevents
  Rsh_Fir_reg_C_processevents1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_processevents);
  // checkMissing(C_processevents1)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_C_processevents1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args5, Rsh_Fir_param_types_empty()));
  // vargs = dots[]
  Rsh_Fir_reg_vargs = Rsh_Fir_mk_vector(Rsh_Fir_kind_dots, 0, NULL, NULL);
  // r4 = `.Call`(C_processevents1, vargs, <missing>)
  SEXP Rsh_Fir_array_args6[3];
  Rsh_Fir_array_args6[0] = Rsh_Fir_reg_C_processevents1_;
  Rsh_Fir_array_args6[1] = Rsh_Fir_reg_vargs;
  Rsh_Fir_array_args6[2] = Rsh_const(CCP, 5);
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_builtin(438, CCP, RHO, 3, Rsh_Fir_array_args6, Rsh_Fir_param_types_empty());
  // goto L1(r4)
  // L1(r4)
