...
SEXP Rsh_Fir_user_function_inner3444260600_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner3444260600_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_promise_inner3444260600_(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner3444260600_1(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner3444260600_2(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner3444260600_3(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner3444260600_4(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner3444260600_5(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner3444260600_6(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner3444260600
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner3444260600_, RHO, CCP);
  // st `read.csv2` = r
...
SEXP Rsh_Fir_user_function_inner3444260600_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner3444260600 dynamic dispatch ([file, header, sep, quote, dec, fill, `comment.char`, `...`])

  return Rsh_Fir_user_version_inner3444260600_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner3444260600_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner3444260600 version 0 (*, *, *, *, *, *, *, dots -+> V)

  if (NPARAMS != 8) Rsh_error("FIŘ arity mismatch for inner3444260600/0: expected 8, got %d", NPARAMS);
...
L6_:;
  ...
  //   return file2;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3444260600_, CCP, RHO);
  // p1 = prom<V +>{
  //   header1 = ld header;
  ...
  //   return header2;
  // }
  Rsh_Fir_reg_p1_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3444260600_1, CCP, RHO);
  // p2 = prom<V +>{
  //   sep1 = ld sep;
  //   sep2 = force? sep1;
  //   checkMissing(sep2);
  //   return sep2;
  // }
  Rsh_Fir_reg_p2_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3444260600_2, CCP, RHO);
  // p3 = prom<V +>{
  //   quote1 = ld quote;
  //   quote2 = force? quote1;
  //   checkMissing(quote2);
  //   return quote2;
  // }
  Rsh_Fir_reg_p3_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3444260600_3, CCP, RHO);
  // p4 = prom<V +>{
  //   dec1 = ld dec;
  //   dec2 = force? dec1;
  //   checkMissing(dec2);
  //   return dec2;
  // }
  Rsh_Fir_reg_p4_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3444260600_4, CCP, RHO);
  // p5 = prom<V +>{
  //   fill1 = ld fill;
  //   fill2 = force? fill1;
  //   checkMissing(fill2);
  //   return fill2;
  // }
  Rsh_Fir_reg_p5_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3444260600_5, CCP, RHO);
  // p6 = prom<V +>{
  ...
  // }
  Rsh_Fir_reg_p6_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner3444260600_6, CCP, RHO);
  // ddd1 = ld `...`
