...
L0_:;
  ...
  // L1():
  //   rep = ldf rep in base;
  //   r2 = dyn rep(<lang unclass(x)>, <sym ...>);
  //   goto L0(r2);
  // L2():
  //   r = dyn base(<lang unclass(x)>, <sym ...>);
  //   goto L0(r);
  // }
  ...
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_structure, 2, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names4, CCP, RHO);
  // check L1() else D1()
  // L1()
  goto L1_;
...
L1_:;
  ...
  Rsh_Fir_reg_r6_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_class, 1, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L0(r6)
  // L0(r6)
