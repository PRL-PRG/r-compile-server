...
SEXP Rsh_Fir_user_function_inner4026975254_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner4026975254_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner4026975254
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner4026975254_, RHO, CCP);
  // st sethash = r
...
SEXP Rsh_Fir_user_function_inner4026975254_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner4026975254 dynamic dispatch ([h, key, value])

  return Rsh_Fir_user_version_inner4026975254_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner4026975254_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner4026975254 version 0 (*, *, * -+> V)

  if (NPARAMS != 3) Rsh_error("FIŘ arity mismatch for inner4026975254/0: expected 3, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_C_sethash_Ext;  // C_sethash_Ext
  SEXP Rsh_Fir_reg_C_sethash_Ext1_;  // C_sethash_Ext1
...
L3_:;
  // r = dyn base(<lang .External(C_sethash_Ext, h, key, value)>)
...
L4_:;
  // C_sethash_Ext = ld C_sethash_Ext
  Rsh_Fir_reg_C_sethash_Ext = Rsh_Fir_load(Rsh_const(CCP, 7), RHO);
  // check L6() else D0()
  // L6()
  goto L6_;

L5_:;
  // r2 = dyn base1(<sym C_sethash_Ext>, <sym h>, <sym key>, <sym value>)
  ...
  Rsh_Fir_reg_r2_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_base1_, 4, Rsh_Fir_array_args4, Rsh_Fir_array_arg_names2, CCP, RHO);
  // goto L1(r2)
  // L1(r2)
...
D0_:;
  // deopt 4 [C_sethash_Ext]
  SEXP Rsh_Fir_array_deopt_stack[1];
  Rsh_Fir_array_deopt_stack[0] = Rsh_Fir_reg_C_sethash_Ext;
  Rsh_Fir_deopt(4, 1, Rsh_Fir_array_deopt_stack, CCP, RHO);
  return R_NilValue;

L6_:;
  // C_sethash_Ext1 = force? C_sethash_Ext
  Rsh_Fir_reg_C_sethash_Ext1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_C_sethash_Ext);
  // checkMissing(C_sethash_Ext1)
  SEXP Rsh_Fir_array_args5[1];
  Rsh_Fir_array_args5[0] = Rsh_Fir_reg_C_sethash_Ext1_;
...
L9_:;
  ...
  // r4 = dyn _External(C_sethash_Ext1, h2, key2, value2)
  SEXP Rsh_Fir_array_args9[4];
  Rsh_Fir_array_args9[0] = Rsh_Fir_reg_C_sethash_Ext1_;
  Rsh_Fir_array_args9[1] = Rsh_Fir_reg_h2_;
  Rsh_Fir_array_args9[2] = Rsh_Fir_reg_key2_;
  ...
  Rsh_Fir_reg_r4_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__External, 4, Rsh_Fir_array_args9, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L10() else D4()
  // L10()
  goto L10_;
