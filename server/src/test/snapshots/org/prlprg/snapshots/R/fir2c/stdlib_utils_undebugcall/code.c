...
SEXP Rsh_Fir_user_function_inner1966010878_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES);
SEXP Rsh_Fir_user_version_inner1966010878_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS);
SEXP Rsh_Fir_user_promise_inner1966010878_(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_promise_inner1966010878_1(SEXP CCP, SEXP RHO);
SEXP Rsh_Fir_user_function_main(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
...
SEXP Rsh_Fir_user_version_main_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  ...
  (void)(R_NilValue);
  // r = clos inner1966010878
  Rsh_Fir_reg_r = Rsh_Fir_make_closure(&Rsh_Fir_user_function_inner1966010878_, RHO, CCP);
  // st undebugcall = r
...
SEXP Rsh_Fir_user_function_inner1966010878_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS, Rsh_Fir_Type const *PARAM_TYPES) {
  // FIR inner1966010878 dynamic dispatch ([call])

  return Rsh_Fir_user_version_inner1966010878_v0_(CCP, RHO, NPARAMS, PARAMS);
}
SEXP Rsh_Fir_user_version_inner1966010878_v0_(SEXP CCP, SEXP RHO, int NPARAMS, SEXP const *PARAMS) {
  // FIR inner1966010878 version 0 (* -+> V)

  if (NPARAMS != 1) Rsh_error("FIŘ arity mismatch for inner1966010878/0: expected 1, got %d", NPARAMS);
  ...
  SEXP Rsh_Fir_reg_undebug1_;  // undebug1
...
L0_:;
  ...
  Rsh_Fir_reg__debugcall = Rsh_Fir_load_fun(Rsh_Fir_LoadFun_Local, Rsh_const(CCP, 3), RHO);
  // check L4() else D0()
  // L4()
  goto L4_;
...
L4_:;
  ...
  //   return call2;
  // }
  Rsh_Fir_reg_p = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner1966010878_, CCP, RHO);
  // p1 = prom<V +>{
  //   undebug = ld undebug;
  //   undebug1 = force? undebug;
  //   checkMissing(undebug1);
  //   return undebug1;
  // }
  Rsh_Fir_reg_p1_ = Rsh_Fir_make_promise(&Rsh_Fir_user_promise_inner1966010878_1, CCP, RHO);
  // r5 = dyn _debugcall(p, p1)
  ...
  Rsh_Fir_reg_r5_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg__debugcall, 2, Rsh_Fir_array_args5, Rsh_Fir_array_arg_names2, CCP, RHO);
  // check L5() else D1()
  // L5()
  goto L5_;
...
L6_:;
  ...
  // r8 = dyn invisible(NULL)
  SEXP Rsh_Fir_array_args7[1];
  Rsh_Fir_array_args7[0] = Rsh_const(CCP, 6);
  SEXP Rsh_Fir_array_arg_names3[1];
  Rsh_Fir_array_arg_names3[0] = R_MissingArg;
  Rsh_Fir_reg_r8_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_invisible, 1, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names3, CCP, RHO);
  // check L8() else D2()
  // L8()
  goto L8_;
...
SEXP Rsh_Fir_user_promise_inner1966010878_1(SEXP CCP, SEXP RHO) {
  // undebug = ld undebug
  Rsh_Fir_reg_undebug = Rsh_Fir_load(Rsh_const(CCP, 4), RHO);
  // undebug1 = force? undebug
  Rsh_Fir_reg_undebug1_ = Rsh_Fir_maybe_force(Rsh_Fir_reg_undebug);
  // checkMissing(undebug1)
  SEXP Rsh_Fir_array_args4[1];
  Rsh_Fir_array_args4[0] = Rsh_Fir_reg_undebug1_;
  (void)(Rsh_Fir_intrinsic_checkMissing(CCP, RHO, 1, Rsh_Fir_array_args4, Rsh_Fir_param_types_empty()));
  // return undebug1
  return Rsh_Fir_reg_undebug1_;
}
