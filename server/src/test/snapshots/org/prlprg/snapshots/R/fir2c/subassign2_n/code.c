...
L4_:;
  ...
  // r10 = dyn ____(l2, 42, 1.0, 2.0, 1.0)
  ...
  Rsh_Fir_array_args7[3] = Rsh_const(CCP, 4);
  ...
  Rsh_Fir_reg_r10_ = Rsh_Fir_call_dynamic(Rsh_Fir_reg_____, 5, Rsh_Fir_array_args7, Rsh_Fir_array_arg_names3, CCP, RHO);
  // goto L0(r10)
  // L0(r10)
