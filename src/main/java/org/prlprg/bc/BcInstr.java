...
/**
 * A single bytecode instruction, consists of an operation and arguments.
 * The operation is determined by its subtype, arguments are determined by its fields.
 */
@Immutable
public sealed interface BcInstr {
    ...
    // ???: call-idx can be negative? We make TypedIdx null to support this case, but not sure if it's possible.
...
class BcInstrs {
     ...
     * @apiNote This has to be in a separate class because it's package-private but interface methods are public.
     */
    static Pair<BcInstr, Integer> fromRaw(
            ImmutableIntArray bytecodes,
            int i,
            BcLabel.Factory Label,
            ConstPool.MakeIdx makePoolIdx
    ) {
        BcOp op;
        try {
        ...
        try {
            var instr = switch (op) {
                ...
                case BRIFNOT -> new BcInstr.BrIfNot(makePoolIdx.lang(bytecodes.get(i++)), Label.make(bytecodes.get(i++)));
                case POP -> new BcInstr.Pop();
                case DUP -> new BcInstr.Dup();
                case PRINTVALUE -> new BcInstr.PrintValue();
                case STARTLOOPCNTXT -> new BcInstr.StartLoopCntxt(bytecodes.get(i++) != 0, Label.make(bytecodes.get(i++)));
                ...
                case STARTFOR -> new BcInstr.StartFor(makePoolIdx.lang(bytecodes.get(i++)), makePoolIdx.sym(bytecodes.get(i++)), Label.make(bytecodes.get(i++)));
                ...
                case STARTSUBSET -> new BcInstr.StartSubset(makePoolIdx.lang(bytecodes.get(i++)), Label.make(bytecodes.get(i++)));
                case DFLTSUBSET -> new BcInstr.DfltSubset();
                case STARTSUBASSIGN -> new BcInstr.StartSubassign(makePoolIdx.lang(bytecodes.get(i++)), Label.make(bytecodes.get(i++)));
                case DFLTSUBASSIGN -> new BcInstr.DfltSubassign();
                case STARTC -> new BcInstr.StartC(makePoolIdx.lang(bytecodes.get(i++)), Label.make(bytecodes.get(i++)));
                case DFLTC -> new BcInstr.DfltC();
                case STARTSUBSET2 -> new BcInstr.StartSubset2(makePoolIdx.lang(bytecodes.get(i++)), Label.make(bytecodes.get(i++)));
                case DFLTSUBSET2 -> new BcInstr.DfltSubset2();
                case STARTSUBASSIGN2 -> new BcInstr.StartSubassign2(makePoolIdx.lang(bytecodes.get(i++)), Label.make(bytecodes.get(i++)));
                case DFLTSUBASSIGN2 -> new BcInstr.DfltSubassign2();
                case DOLLAR -> new BcInstr.Dollar(makePoolIdx.lang(bytecodes.get(i++)), makePoolIdx.sym(bytecodes.get(i++)));
                case DOLLARGETS -> new BcInstr.DollarGets(makePoolIdx.lang(bytecodes.get(i++)), makePoolIdx.sym(bytecodes.get(i++)));
                ...
                case MATSUBASSIGN -> new BcInstr.MatSubassign(makePoolIdx.langOrNegative(bytecodes.get(i++)));
                case AND1ST -> new BcInstr.And1st(makePoolIdx.lang(bytecodes.get(i++)), Label.make(bytecodes.get(i++)));
                case AND2ND -> new BcInstr.And2nd(makePoolIdx.lang(bytecodes.get(i++)));
                case OR1ST -> new BcInstr.Or1st(makePoolIdx.lang(bytecodes.get(i++)), Label.make(bytecodes.get(i++)));
                ...
                case SETTER_CALL -> new BcInstr.SetterCall(makePoolIdx.lang(bytecodes.get(i++)), makePoolIdx.any(bytecodes.get(i++)));
                ...
                case SWITCH -> new BcInstr.Switch(makePoolIdx.lang(bytecodes.get(i++)), makePoolIdx.strOrNilOrOther(bytecodes.get(i++)), makePoolIdx.intOrOther(bytecodes.get(i++)), makePoolIdx.intOrOther(bytecodes.get(i++)));
                case RETURNJMP -> new BcInstr.ReturnJmp();
                case STARTSUBSET_N -> new BcInstr.StartSubsetN(makePoolIdx.lang(bytecodes.get(i++)), Label.make(bytecodes.get(i++)));
                case STARTSUBASSIGN_N -> new BcInstr.StartSubassignN(makePoolIdx.lang(bytecodes.get(i++)), Label.make(bytecodes.get(i++)));
                case VECSUBSET2 -> new BcInstr.VecSubset2(makePoolIdx.langOrNegative(bytecodes.get(i++)));
                case MATSUBSET2 -> new BcInstr.MatSubset2(makePoolIdx.langOrNegative(bytecodes.get(i++)));
                ...
                case STARTSUBSET2_N -> new BcInstr.StartSubset2N(makePoolIdx.lang(bytecodes.get(i++)), Label.make(bytecodes.get(i++)));
                case STARTSUBASSIGN2_N -> new BcInstr.StartSubassign2N(makePoolIdx.lang(bytecodes.get(i++)), Label.make(bytecodes.get(i++)));
                case SUBSET_N -> new BcInstr.SubsetN(makePoolIdx.langOrNegative(bytecodes.get(i++)), bytecodes.get(i++));
                case SUBSET2_N -> new BcInstr.Subset2N(makePoolIdx.langOrNegative(bytecodes.get(i++)), bytecodes.get(i++));
                case SUBASSIGN_N -> new BcInstr.SubassignN(makePoolIdx.langOrNegative(bytecodes.get(i++)), bytecodes.get(i++));
                case SUBASSIGN2_N -> new BcInstr.Subassign2N(makePoolIdx.langOrNegative(bytecodes.get(i++)), bytecodes.get(i++));
                ...
                case MATH1 -> new BcInstr.Math1(makePoolIdx.lang(bytecodes.get(i++)), bytecodes.get(i++));
                case DOTCALL -> new BcInstr.DotCall(makePoolIdx.lang(bytecodes.get(i++)), bytecodes.get(i++));
                ...
                case BASEGUARD -> new BcInstr.BaseGuard(makePoolIdx.lang(bytecodes.get(i++)), Label.make(bytecodes.get(i++)));
            ...
            throw new BcFromRawException("invalid opcode " + op + " (arguments, unexpected end of bytecode stream)");
        }
    }
     ...
     * @param bytecodes The full list of GNU-R bytecodes including ones before and after this one.
     * @param i The index in the list where this instruction starts.
     * @return The size of the instruction (we don't return next position because it can be computed from this).
     * @apiNote This has to be in a separate class because it's package-private but interface methods are public.
     */
    ...
    static int sizeFromRaw(ImmutableIntArray bytecodes, int i) {
        ...
        try {
            ...
            throw new BcFromRawException("invalid opcode (arguments, unexpected end of bytecode stream) " + op);
        }
    }
}
