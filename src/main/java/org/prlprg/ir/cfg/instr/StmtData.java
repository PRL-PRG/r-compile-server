...
import org.prlprg.ir.effect.Errors;
import org.prlprg.ir.effect.Forces;
import org.prlprg.ir.effect.Loads;
import org.prlprg.ir.effect.ReadsEnv;
...
public sealed interface StmtData extends InstrData {
  ...
  @Effect(value = Errors.class)
  @Outputs("val|prom")
  @OutputsGeneric(GenericOutput.INTERSECT_VALUE)
  ...
  //  record Force(Node<? extends SEXP> maybeProm, @Nullable FrameState fs, Node<? extends EnvSXP>
  // env) implements StmtData {}
  //
  //  @Outputs("sexp")
  ...
  //
  //  /**
  //   * Unlike PIR, unary operations are guarnateed not to dispatch, because we compile the
  // dispatch
  //   * case separately.
  //   */
  ...
  //
  //  /**
  //   * Unlike PIR, binary operations are guarnateed not to dispatch, because we compile the
  // dispatch
  //   * case separately.
  //   */
  ...
  //
  //  /**
  //   * Doesn't have {@link REffect#ReadsEnvArg} because it doesn't read the "environment" part of
  // the
