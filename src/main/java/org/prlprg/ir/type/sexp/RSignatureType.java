...
public sealed interface RSignatureType {
   ...
   */
  static RSignatureType of(
      List<RParameterType> parameters, REffects fallbackEffects, RSexpType fallbackReturnType) {
  ...
  default @Nullable @Unmodifiable RSignatureTypeNormalizedArity normalizeToMatch(
    ...
    var normalizedTypes = new RSexpType[parameters().size()];
   ...
   * <p>The arguments must be normalized with {@link #normalizeToMatch(List)}
   */
  RSexpType returnType(@Nullable RSignatureTypeNormalizedArity arguments);
...
final class RSignatureTypeImpl implements RSignatureType {
  ...
  private final RSexpType fallbackReturnType;
  ...
  @Override
  public RSexpType returnType(@Nullable RSignatureTypeNormalizedArity arguments) {
