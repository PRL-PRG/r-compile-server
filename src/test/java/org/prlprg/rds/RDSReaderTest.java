...
public class RDSReaderTest implements Tests {
    ...
    public void testInts() throws Exception {
        var sexp = RDSReader.readStream(rsession, getResourceAsStream("ints.rds"));
    ...
    public void testLgls() throws Exception {
        var sexp = RDSReader.readStream(rsession, getResourceAsStream("lgls.rds"));
    ...
    public void testReals() throws Exception {
        var sexp = RDSReader.readStream(rsession, getResourceAsStream("reals.rds"));
    ...
    public void testFakeList() throws Exception {
        var sexp = RDSReader.readStream(rsession, getResourceAsStream("list.rds"));
    ...
    public void testList2() throws Exception {
        var sexp = RDSReader.readStream(rsession, getResourceAsStream("list2.rds"));
    ...
    public void testClosure() throws Exception {
        ...
        var sexp = RDSReader.readStream(rsession, getResourceAsStream("closure.rds"));
    ...
    public void testClosureBC() throws Exception {
        ...
        var sexp = RDSReader.readStream(rsession, getResourceAsStream("closure-bc.rds"));
    ...
    public void testClosureBC2() throws Exception {
        ...
        var sexp = RDSReader.readStream(rsession, getResourceAsStream("closure-bc2.rds"));
